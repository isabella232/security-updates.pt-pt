...
ms:assetid: 'ms08-009'
ms:contentKeyID: 61234330
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms08-009(v=Security.10)'
---
...
Vulnerabilidade no Microsoft Word poderia permitir Execução Remota de Código (947077)
-------------------------------------------------------------------------------------
...
Os utilizadores que executam o Office XP (Word 2002) e versões posteriores dispõem de uma funcionalidade incorporada que solicitará a permissão do utilizador para Abrir, Guardar ou Cancelar antes de abrir um documento. Este factor atenuante reduz a classificação da vulnerabilidade de Crítica para Importante, porque requer mais do que a acção de um único utilizador para que a exploração possa ser efectuada.
  
**Utilizo o Microsoft Office 2003 Service Pack 3. Por que razão continuo a receber esta actualização?**    
O Microsoft Office 2003 Service Pack 3 não é afectado pelas vulnerabilidades de segurança documentadas neste boletim. Contudo, os utilizadores continuarão a receber esta actualização porque os ficheiros actualizados do Microsoft Office 2003 Service Pack 3 são mais recentes (com números de versão superiores) do que os ficheiros fornecidos com o Microsoft Office 2003 Service Pack 3. Esta actualização foi testada minuciosamente, mas tal como em todas as actualizações, recomendamos que os utilizadores executem os testes apropriados nos respectivos ambientes e nas configurações dos seus sistemas.
...
Não, o mecanismo de actualização está a funcionar correctamente na medida em que o pacote de actualizações dispõe de uma versão mais recente, oferecendo deste modo a actualização.
...
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória no Word – CVE-2008-0109</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Corrupção de Memória no Word – CVE-2008-0109  
---------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Word processa ficheiros Word especialmente concebidos para o efeito. A vulnerabilidade poderia permitir a execução remota de código se um utilizador abrisse um ficheiro Word que incluísse um valor mal formado. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-0109](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Word - CVE-2008-0109
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Word - CVE-2008-0109
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Word - CVE-2008-0109
...
A vulnerabilidade é causada por um erro de cálculo da memória ao analisar um ficheiro Word especialmente concebido para o efeito. O erro pode corromper a memória do sistema de tal modo que um intruso poderia executar código arbitrário.
...
A actualização elimina a vulnerabilidade modificando a forma como o Word calcula a memória que é necessário atribuir ao abrir ficheiros Word.
...
|------------------|------------|-------------|-------|-----------|  
| Winword.exe      | 9.0.0.8966 | 20-Out-2007 | 07:09 | 8,835,124 |
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Inclusão em Service Packs Futuros</strong></td>
<td style="border:1px solid black;">Não existem outros service packs planeados para este software. A actualização para esta questão poderá ser incluída num conjunto de actualizações futuro.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Implementação</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para o Word 2003: office2003-KB943983-FullFile-ENU /q:a
Para o Word Viewer 2003: office2003-KB943992-FullFile-ENU /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalação sem reiniciar</td>
<td style="border:1px solid black;">Para o Word 2003: office2003-KB943983-FullFile-ENU /r:n
Para o Word Viewer 2003: office2003-KB943992-FullFile-ENU /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Ficheiro log da actualização</td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="even">
<td style="border:1px solid black;">Informações adicionais</td>
<td style="border:1px solid black;">Consultar a subsecção Orientações e ferramentas de detecção e implementação.
Para funcionalidades que pode instalar selectivamente, consulte a subsecção <strong>Funcionalidades do Office para instalações administrativas</strong>, nesta secção.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Requisito de Reinício</strong></td>
...
Para todas as edições suportadas do Word 2003:
  
| Nome do Ficheiro | Versão      | Data        | Hora  | Tamanho    |  
|------------------|-------------|-------------|-------|------------|  
| Winword.exe      | 11.0.8202.0 | 20-Nov-2007 | 03:35 | 12,311,048 |
  
Para todas as edições suportadas do Word Viewer 2003:
...
-   Rubén Santamarta, da [Reversemode.com](http://reversemode.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Word (CVE-2008-0109).
...
-   V1.2 (10 de Setembro de 2008): Boletim actualizado: Adicionada entrada às Perguntas Mais Frequentes sobre a Actualização para clarificar a razão pela qual pode ser disponibilizada esta actualização para versões não vulneráveis do Microsoft Office.
