---
TOCTitle: 'MS11-017'
Title: 'Microsoft Security Bulletin MS11-017 - Importante'
ms:assetid: 'ms11-017'
ms:contentKeyID: 61234998
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-017(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-017 - Importante
=================================================

Vulnerabilidade no Cliente de Ambiente de Trabalho Remoto Poderia Permitir Execução Remota de Código (2508062)
--------------------------------------------------------------------------------------------------------------

Data de publicação: 8 de março de 2011 | Updated: 4 de maio de 2011
...
Esta actualização de segurança está classificada como Importante para Cliente de Ligação ao Ambiente de Trabalho Remoto 5.2, Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0, Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1 e Cliente de Ligação ao Ambiente de Trabalho Remoto 7.0. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o Ambiente de Trabalho Remoto do Windows carrega bibliotecas externas. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Questões Conhecidas.** O [Artigo 2508062 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2508062) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
<tr>
<th colspan="5">
Cliente de Ligação ao Ambiente de Trabalho Remoto 5.2
</th>
</tr>
<tr>
...
<tr>
<th colspan="5">
Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0 e Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1
</th>
</tr>
...
<tr>
<th colspan="5">
Cliente de Ligação ao Ambiente de Trabalho Remoto 7.0
</th>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
|-------------------------------------------------------------------------|-------------------------------------------------------|
| Windows XP Professional x64 Edition Service Pack 2                      | Cliente de Ligação ao Ambiente de Trabalho Remoto 5.2 |
| Windows Server 2003 Service Pack 2                                      | Cliente de Ligação ao Ambiente de Trabalho Remoto 5.2 |
| Windows Server 2003 x64 Edition Service Pack 2                          | Cliente de Ligação ao Ambiente de Trabalho Remoto 5.2 |
| Windows Server 2003 com SP2 para sistemas baseados em Itanium           | Cliente de Ligação ao Ambiente de Trabalho Remoto 5.2 |
| Windows 7 para sistemas de 32 bits Service Pack 1                       | Cliente de Ligação ao Ambiente de Trabalho Remoto 7.1 |
| Windows 7 para sistemas baseados em x64 Service Pack 1                  | Cliente de Ligação ao Ambiente de Trabalho Remoto 7.1 |
| Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1     | Cliente de Ligação ao Ambiente de Trabalho Remoto 7.1 |
| Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1 | Cliente de Ligação ao Ambiente de Trabalho Remoto 7.1 |
...
<th style="border:1px solid black;" >
Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Ambiente de Trabalho Remoto - CVE-2011-0029
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<tr>
<td style="border:1px solid black;">
Cliente de Ligação ao Ambiente de Trabalho Remoto 5.2 no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1 no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0 no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0 no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Multilingual User Interface (MUI) do Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0 no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 6.0 no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 6.1 no Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 6.1 no Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 6.1 no Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 6.1 no Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 6.1 no Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 7.0 no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 7.0 no Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 7.0 no Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 7.0 no Windows 7 para sistemas de 32 bits
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 7.0 no Windows 7 para sistemas baseados em x64
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 7.0 no Windows Server 2008 R2 para sistemas baseados em x64\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Ligação ao Ambiente de Trabalho Remoto 7.0 no Windows Server 2008 R2 para sistemas baseados em Itanium
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Ambiente de Trabalho Remoto do Windows processa o carregamento de ficheiros DLL. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029).

#### Factores Atenuantes para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Ambiente de Trabalho Remoto - CVE-2011-0029
...
-   Para um ataque ser bem sucedido, um utilizador terá de visitar uma localização não fidedigna do sistema de ficheiro remoto ou partilha WebDAV e abrir um ficheiro .rdp.
...
#### Soluções Alternativas para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Ambiente de Trabalho Remoto - CVE-2011-0029
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Ambiente de Trabalho Remoto - CVE-2011-0029
...
A vulnerabilidade é provocada quando o Ambiente de Trabalho Remoto do Windows restringe incorrectamente o caminho utilizado para carregar bibliotecas externas.

**O que é o Ambiente de Trabalho Remoto do Windows?**  
A funcionalidade de ambiente de trabalho remoto do Windows permite o acesso a todos os programas, recursos e acessórios num computador do utilizador a partir de um segundo computador baseado em Windows. Uma vez ligado, o ambiente de trabalho remoto permite controlo sobre o rato e teclado do primeiro computador ao mesmo tempo que apresenta tudo o que se passa no ecrã.
...
Um intruso poderia convencer um utilizador a abrir um ficheiro de configuração de Ambiente de Trabalho Remoto (.rdp) legítimo localizado no mesmo directório de rede que um ficheiro de biblioteca de hiperligação dinâmica (DLL) especialmente concebido. Nessa altura, ao abrir o ficheiro .rdp, o Ambiente de Trabalho Remoto do Windows poderia tentar carregar o ficheiro DLL e executar qualquer código aí contido.

Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade ao enviar um ficheiro .rdp legítimo em anexo a um utilizador e convencer o utilizador a colocar o anexo num directório que contenha um ficheiro DLL especialmente concebido e depois a abrir o ficheiro .rdp. Nessa altura, ao abrir o ficheiro .rdp, o Ambiente de Trabalho Remoto do Windows poderia tentar carregar o ficheiro DLL e executar qualquer código aí contido.

Num cenário de rede, um intruso poderia colocar um ficheiro .rdp legítimo e um ficheiro DLL especialmente concebido numa localização UNC ou WebDAV e convencer o utilizador a abrir o ficheiro .rdp.
...
A actualização de segurança resolve esta vulnerabilidade corrigindo a forma como o Ambiente de Trabalho Remoto do Windows carrega bibliotecas externas.

**Esta vulnerabilidade está relacionada com o Aviso de Segurança da Microsoft 2269637?**  
Sim, a vulnerabilidade resolvida por esta actualização está relacionada com a classe de vulnerabilidades, descrita em [Aviso de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afecta o modo como as aplicações carregam bibliotecas externas. Esta actualização de segurança resolve uma instância particular deste tipo de vulnerabilidade.

**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029).
...
| Windows 7 para sistemas de 32 bits Pack 1                                                                                    | Não     | Não               | Sim               | Sim                        |
...
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 5.2 no Windows XP Service Pack 3:<br />
WindowsXP-KB2483618-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.1 no Windows XP Service Pack 3:<br />
WindowsXP-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 7.0 no Windows XP Service Pack 3:<br />
WindowsXP-KB2483614-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.0 no Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 5.2<br />
KB2483618.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.0 e Ligação ao Ambiente de Trabalho Remoto 6.1:<br />
KB2481109.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 7.0:<br />
KB2483614.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 5.2<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2483618$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.0 e Ligação ao Ambiente de Trabalho Remoto 6.1:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2481109$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 7.0:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2483614$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 5.2<br />
Consulte o <a href="http://support.microsoft.com/kb/2483618">Artigo 2483618 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.0 e Ligação ao Ambiente de Trabalho Remoto 6.1:<br />
Consulte o <a href="http://support.microsoft.com/kb/2481109">Artigo 2481109 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 7.0:<br />
Consulte o <a href="http://support.microsoft.com/kb/2483614">Artigo 2483614 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.0 no Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Multilingual User Interface (MUI) do Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0 no Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB2483619-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.0 no Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2481109-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalação sem reiniciar</td>
...
<tr class="odd">
<td style="border:1px solid black;">Ficheiro de registo da actualização</td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.0:<br />
KB2481109.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Multilingual User Interface (MUI) do Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0:<br />
KB2483619.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Informações adicionais</td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Multilingual User Interface (MUI) do Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2483619$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.0:<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Multilingual User Interface (MUI) do Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0:<br />
Consulte o <a href="http://support.microsoft.com/kb/2483619">Artigo 2483619 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.0:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.1 no Windows Vista Service Pack 1 e Windows Vista Service Pack 2:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 7.0 no Windows Vista Service Pack 1 e Windows Vista Service Pack 2:<br />
Windows6.0-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.1 no Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.1:<br />
Consulte o <a href="http://support.microsoft.com/kb/2481109">Artigo 2481109 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.1 em todas as edições de 32 bits suportadas do Windows Server 2008:<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.1 em todas as edições baseadas em x64 suportadas do Windows Server 2008:<br />
Windows6.0-KB2481109-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 6.1 em todas as edições baseadas em Itanium suportadas do Windows Server 2008:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2481109">Artigo 2481109 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> Não existe uma chave de registo para validar a presença desta actualização.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 7.0 em todas edições suportadas de 32 bits da versão original do Windows 7:<br />
Windows6.1-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 7.0 em todas edições suportadas baseadas em x64 da versão original do Windows 7:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2483614">Artigo 2483614 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> Não existe uma chave de registo para validar a presença desta actualização.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 7.0 em todas edições suportadas baseadas em x64 da versão original do Windows Server 2008 R2:<br />
Windows6.1-KB2483614-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Ligação ao Ambiente de Trabalho Remoto 7.0 em todas edições suportadas baseadas em Itanium da versão original do Windows Server 2008 R2:<br />
...
-   Eyal Gruner, da [Versafe Anti Fraud](http://www.versafe-login.com/), por fornecer informações sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Ambiente de Trabalho Remoto (CVE-2011-0029)
...
-   V1.1 (8 de Março de 2011): Correcção das entradas na tabela do Systems Management Server para SMS 2.0 e SMS 2003 com SUIT para Windows XP Service Pack 3 e Windows Server 2003 Service Pack 2. Estas são apenas alterações informativas. Não foram efectuadas alterações aos ficheiros da actualização de segurança ou à lógica de detecção.  
-   V1.2 (9 de Março de 2011): Correcção das entradas de componentes de **Software Não Afectado** para as versões Service Pack 1 do Windows 7 e do Windows Server 2008 R2 de Cliente de Ligação ao Ambiente de Trabalho Remoto 7.0 para Cliente de Ligação ao Ambiente de Trabalho Remoto 7.1. Estas são apenas alterações informativas. Não foram efectuadas alterações aos ficheiros da actualização de segurança ou à lógica de detecção.  
-   V1.3 (13 de Abril de 2011): Corrigida a informação relativa à substituição do boletim para o Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0 em edições suportadas do Windows Server 2003 e Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1 em edições suportadas do Windows Vista. Esta é apenas uma alteração de boletim. Não foram efectuadas alterações à detecção nem aos ficheiros de actualização de segurança.  
-   V1.4 (15 de Abril de 2011): Corrigida a informação relativa à substituição do boletim para o Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0 em edições suportadas do Windows Server 2003 e Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1 em edições suportadas do Windows Server 2008. Esta é apenas uma alteração de boletim. Não foram efectuadas alterações à detecção nem aos ficheiros de actualização de segurança.  
-   V1.5 (4 de Maio de 2011): Correcção de informações relativas à substituição do boletim para Cliente de Ligação ao Ambiente de Trabalho Remoto 5.2 em edições suportadas do Windows XP Service Pack 3. Esta é apenas uma alteração de boletim. Não foram efectuadas alterações à detecção nem aos ficheiros de actualização de segurança.
