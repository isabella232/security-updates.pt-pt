---
TOCTitle: 'MS11-010'
Title: 'Microsoft Security Bulletin MS11-010 - Importante'
ms:assetid: 'ms11-010'
ms:contentKeyID: 61234991
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-010(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-010 - Importante
=================================================

Vulnerabilidade no Windows Client/Server Run-time Subsystem Poderia Permitir Elevação de Privilégios (2476687)
--------------------------------------------------------------------------------------------------------------
...
Esta actualização de segurança resolve uma vulnerabilidade no Microsoft Windows Client/Server Run-time Subsystem (CSRSS) no Windows XP e no Windows Server 2003, comunicada de forma privada. Esta actualização de segurança está classificada como Importante para todas as edições suportadas destes sistemas operativos. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cfa10178-9859-4e03-bedc-e3f5297a0251)                                     | Elevação de Privilégios     | Importante                          | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9f0b7b77-5b90-4a4b-97a4-0c1ce6a70126)            | Elevação de Privilégios     | Importante                          | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aed08b96-24cc-4e23-8fd5-c7e52f8ef41a)                            | Elevação de Privilégios     | Importante                          | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ca7879e1-e295-445d-a658-0a31be1928cc)                | Elevação de Privilégios     | Importante                          | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=50855101-a15c-4c81-ad81-a7fe3f1d2026) | Elevação de Privilégios     | Importante                          | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Elevação de Privilégios no CSRSS - CVE-2011-0030</th>
...
Vulnerabilidade de Elevação de Privilégios no CSRSS - CVE-2011-0030  
-------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na forma como o Windows Client/Server Run-time Subsystem (CSRSS) termina um processo quando um utilizador termina sessão. Um intruso que explorasse esta vulnerabilidade com sucesso poderia executar código concebido para monitorizar as acções de um utilizador que iniciasse sessão posteriormente no sistema. Isto poderia permitir a divulgação de informações confidenciais ou o acesso a dados nos sistemas afectados que estivessem acessíveis ao utilizador com sessão iniciada. Este dados importantes poderiam incluir credenciais de início de sessão dos utilizadores seguintes, que um intruso poderia utilizar posteriormente para elevação de privilégios ou para executar código como um utilizador diferente no sistema. Tenha em atenção que esta vulnerabilidade não permitiria que um intruso executasse o código ou elevasse os seus direitos de utilizador directamente. Poderia ser usada para recolher informações úteis para tentar comprometer ainda mais o sistema afectado. Se um utilizador com privilégios de administrador iniciasse posteriormente sessão no sistema, o intruso poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios sobre o sistema.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0030](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0030).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação de Privilégios no CSRSS - CVE-2011-0030
...
#### Soluções Alternativas para a Vulnerabilidade de Elevação de Privilégios no CSRSS - CVE-2011-0030
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação de Privilégios no CSRSS - CVE-2011-0030
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios sobre o sistema. Para tentar explorar a vulnerabilidade, um intruso teria que conseguir iniciar sessão no sistema e executar um programa.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando o Windows Client/Server Run-time Subsystem (CSRSS) não termina correctamente os processos de utilizador quando um utilizador termina sessão num sistema.
...
Um intruso que explorasse esta vulnerabilidade com sucesso poderia executar código concebido para monitorizar as acções de um utilizador que iniciasse sessão posteriormente no sistema. Isto poderia permitir a divulgação de informações confidenciais ou o acesso a dados nos sistemas afectados que estivessem acessíveis ao utilizador com sessão iniciada. Este dados importantes incluem credenciais que um intruso poderia utilizar posteriormente para elevar os seus privilégios ou para executar código como um utilizador diferente no sistema. Assim que as informações confidenciais forem expostas, um intruso que explorasse esta vulnerabilidade com sucesso poderia executar código com o nível de privilégios de um utilizador que tenha posteriormente iniciado sessão no sistema. Se um administrador iniciasse sessão no sistema, o código do intruso seria executado com privilégios elevados.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2476687$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2476687">Artigo 2476687 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Sihan Qing (Professor), Weiping Wen (Professor Associado), Liang Yi e Husheng Zhou (Licenciados), [Departamento de Segurança de Informações, Universidade de Pequim](http://www.ss.pku.edu.cn/en/), por fornecerem informações sobre a Vulnerabilidade de Elevação de Privilégios no CSRSS (CVE-2011-0030)
