...
ms:assetid: 'ms11-036'
ms:contentKeyID: 61235017
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-036(v=Security.10)'
---
...
Vulnerabilidades no Microsoft PowerPoint Poderiam Permitir Execução Remota de Código (2545814)
----------------------------------------------------------------------------------------------
...
**Questões Conhecidas.** O [Artigo 2545814 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2545814) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
Suites do Microsoft Office e Outro Software
</th>
<th style="border:1px solid black;" >
Componentes
</th>
...
<sup>[1]</sup>As actualizações de segurança para Microsoft Office 2004 para Mac (KB2555786), Microsoft Office 2008 para Mac (KB2555785) e Conversor de Formato de Ficheiros Open XML para Mac (KB2555787) estão disponíveis a partir de 14 de Junho de 2011. Consulte as entradas na secção de **Perguntas Mais Frequentes relativas a Esta Actualização de Segurança**, que explicam como obter estas actualizações.
...
A Microsoft reviu este boletim para anunciar que as actualizações de segurança para Microsoft Office para Mac, que não estavam disponíveis quando este boletim foi publicado originalmente, estão agora disponíveis no boletim [MS11-045](http://go.microsoft.com/fwlink/?linkid=217502).

**Onde se encontram as actualizações de segurança para o Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac e Conversor de Formato de Ficheiros Open XML para Mac?**  
Para além de resolver as vulnerabilidades descritas no boletim MS11-045, as actualizações de segurança para Microsoft Office 2004 para Mac (KB2555786), Microsoft Office 2008 para Mac (KB2555785) e Conversor de Formato de Ficheiros Open XML para Mac (KB2555787) também resolvem uma vulnerabilidade descrita neste boletim. Consulte o boletim [MS11-045](http://go.microsoft.com/fwlink/?linkid=217502) para obter mais informações e ligações de transferência.
...
Quando a funcionalidade de Validação de Ficheiros do Office está activada no Microsoft PowerPoint 2003 e no Microsoft PowerPoint 2007, os ficheiros especialmente concebidos para o efeito que poderiam ser utilizados para explorar as vulnerabilidades não se abrem automaticamente; em vez disso, por predefinição, é pedido ao utilizador que opte por abrir ou não esse ficheiro. Um utilizador teria de clicar no aviso para abrir o ficheiro antes que qualquer uma das vulnerabilidades pudesse ser explorada. Para obter mais informações sobre a Validação de Ficheiros do Office no Microsoft PowerPoint 2003 ou Microsoft PowerPoint 2007, consulte o [Aviso de Segurança da Microsoft 2501584](http://technet.microsoft.com/security/advisory/2501584).

**Quais são as vantagens se desactivar a abertura de ficheiros que falham na validação de ficheiros no PowerPoint 2003 e no PowerPoint 2007?**  
Ao configurar a Validação de Ficheiros do Office para não permitir a abertura de ficheiros suspeitos no PowerPoint 2003 e PowerPoint 2007, a solução automática de **correcção da Microsoft** "Desactivar a abertura de documentos no PowerPoint 2003 e no PowerPoint 2007", disponível no [Artigo 2501584 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2501584), bloqueia os vectores de ataque para que não explorem as vulnerabilidades descritas em CVE-2011-1269 e CVE-2011-1270. Os clientes podem optar por aplicar a solução de correcção como uma solução alternativa se optarem por apenas instalar posteriormente a actualização de segurança para o PowerPoint 2003 ou PowerPoint 2007.
Consulte o [Artigo 2501584 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2501584) para obter instruções sobre como aplicar a solução de correcção automática "Desactivar a abertura de documentos no PowerPoint 2003 e no PowerPoint 2007", ou consulte as secções de Soluções Alternativas para CVE-2011-1269 e CVE-2011-1270, na secção de informações sobre as vulnerabilidades deste boletim, para obter instruções sobre como aplicar a solução manualmente.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código de Memória Danificada em Apresentações - CVE-2011-1269
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código de Sobrecarga de Memória Intermédia em Apresentações - CVE-2011-1270
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1269](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código de Memória Danificada em Apresentações - CVE-2011-1269
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código de Memória Danificada em Apresentações - CVE-2011-1269
...
- **Configurar a Validação de Ficheiros do Office para desactivar a abertura de ficheiros que falham na validação no PowerPoint 2003 e PowerPoint 2007**
...
- **Utilize a política do File Block do Microsoft Office para bloquear a abertura de documentos do Office 2003 e de versões anteriores que provenham de fontes ou localizações desconhecidas ou não fidedignas**
  ...
  **Para o Microsoft Office 2003 e o Microsoft Office 2007**
  ...
  Os seguintes scripts de registo podem ser guardados em ficheiros de entrada de registo (.reg) e utilizados para definir a política de Bloqueio de Ficheiros. Para obter mais informações sobre como utilizar scripts de registo, consulte o [Artigo 310516 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/310516). Utilize o script de registo apropriado para o seu software Office.
  ...
  **Nota** Para utilizar a subchave "FileOpenBlock" com o Microsoft Office 2003, é necessário aplicar todas as actualizações de segurança para o Microsoft Office 2003 mais recentes. Para utilizar a subchave "FileOpenBlock" com o Microsoft Office 2007, é necessário aplicar todas as actualizações de segurança mais recentes para o Office 2007.
  ...
  Em alternativa para o Microsoft Office 2007, o bloqueio de ficheiros pode ser aplicado através da Política de Grupo. Para obter mais informações, consulte o artigo TechNet sobre como [Configurar definições de bloqueio de formatos de ficheiros no Office 2007](http://technet.microsoft.com/en-us/library/cc179186(office.12).aspx).
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código de Memória Danificada em Apresentações - CVE-2011-1269
...
A vulnerabilidade existe quando o Microsoft PowerPoint não processa memória de forma adequada durante chamadas de funções ao analisar um ficheiro PowerPoint especialmente concebido para o efeito.
...
A actualização resolve a vulnerabilidade corrigindo a forma como o PowerPoint processa memória durante chamadas de funções ao analisar ficheiros PowerPoint especialmente concebidos para o efeito.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1270](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código de Sobrecarga de Memória Intermédia em Apresentações - CVE-2011-1270
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código de Sobrecarga de Memória Intermédia em Apresentações - CVE-2011-1270

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e indica se a solução alternativa reduz a funcionalidade:

- **Configurar a Validação de Ficheiros do Office para desactivar a abertura de ficheiros que falham na validação no PowerPoint 2003**
  ...
  **Nota** A modificação incorrecta do registo pode provocar problemas graves que podem vir a obrigar à reinstalação do sistema operativo. A Microsoft não pode garantir que os problemas resultantes da modificação incorrecta do registo possam ser resolvidos. A modificação do registo é da sua responsabilidade.
  ...
  Utilize o seguinte script de registo. 
  ...
  **Como anular esta solução alternativa.**
  ...
  Utilize o seguinte script de registo para anular as definições configuradas por esta solução alternativa.
...
- **Utilize a política do File Block do Microsoft Office para bloquear a abertura de documentos do Office 2003 e de versões anteriores que provenham de fontes ou localizações desconhecidas ou não fidedignas**
  ...
  **Para o Microsoft Office 2003**
  ...
  O seguinte script de registo pode ser guardado em ficheiros de entrada de registo (.reg) e utilizado para definir a política de Bloqueio de Ficheiros. Para obter mais informações sobre como utilizar scripts de registo, consulte o [Artigo 310516 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/310516).
  ...
  **Como anular esta solução alternativa.**
  ...
  Para o Microsoft Office 2003, utilize o seguinte script de registo para anular as definições utilizadas para configurar a política de Bloqueio de Ficheiros:
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código de Sobrecarga de Memória Intermédia em Apresentações - CVE-2011-1270

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade existe quando o Microsoft PowerPoint encontra um erro de processamento de memória ao analisar um ficheiro PowerPoint especialmente concebido para o efeito.
...
**O que faz a actualização?**  
A actualização resolve a vulnerabilidade corrigindo a forma como o PowerPoint analisa ficheiros PowerPoint especialmente concebidos para o efeito.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2535802">Artigo 2535802 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2535812">Artigo 2535812 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
#### PowerPoint 2007 (todas as edições) e Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 (todas as versões)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para o PowerPoint 2007, consulte o <a href="http://support.microsoft.com/kb/2535818">Artigo 2535818 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 Service Pack 2, consulte o <a href="http://support.microsoft.com/kb/2540162">Artigo 2540162 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
-   Will Dormann, da [CERT/CC](http://www.cert.org/), por trabalhar connosco na Vulnerabilidade de Execução Remota de Código de Memória Danificada em Apresentações (CVE-2011-1269)  
-   Will Dormann, da [CERT/CC](http://www.cert.org/), por trabalhar connosco na Vulnerabilidade de Execução Remota de Código de Sobrecarga de Memória Intermédia em Apresentações (CVE-2011-1270)
...
-   V1.1 (17 de Maio de 2011): Removida uma nota errada da tabela de Software Afectado pertencente às actualizações de segurança KB2535818 e KB2540162 para o Microsoft PowerPoint 2007 Service Pack 2.  
-   V1.2 (14 de Junho de 2011): Anunciado que as actualizações para Microsoft Office para Mac, que não estavam disponíveis quando o boletim foi publicado originalmente, estão agora disponíveis no boletim MS11-045. Além disso, para ambas as vulnerabilidades abordadas neste boletim, foram corrigidas entradas de scripts de registo incorrectas nas soluções alternativas para configurar a Validação de Ficheiros do Office para desactivar a abertura de ficheiros que falham na validação.
