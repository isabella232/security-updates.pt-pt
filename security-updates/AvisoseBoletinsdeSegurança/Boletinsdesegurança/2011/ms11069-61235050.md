...
ms:assetid: 'ms11-069'
ms:contentKeyID: 61235050
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-069(v=Security.10)'
---
...
Vulnerabilidade no .NET Framework Poderia Permitir Divulgação de Informações (2567951)
--------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Moderada para o Microsoft .NET Framework 2.0 Service Pack 2, Microsoft .NET Framework 3.5.1 e Microsoft .NET Framework 4 em todas as edições suportadas do Microsoft Windows. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o .NET Framework valida o nível de confiança no espaço de nomes System.Net.Sockets. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Questões conhecidas.** O [Artigo 2567951 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2567951) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
<span></span>
**Por que razão foi** **revisto este boletim a 23 de Agosto de 2011?**
A Microsoft reviu este boletim de segurança para anunciar uma alteração da detecção nos metadados do pacote para o KB2539636 para corrigir um problema com os códigos de retorno da instalação. Esta é apenas uma alteração de detecção. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.
...
**Esta actualização de segurança está relacionada com o boletim MS11-066?**
...
<th style="border:1px solid black;" >
Vulnerabilidade ao Ignorar Restrições Socket - CVE-2011-1978
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4 quando instalado no Windows Server 2008 R2 para sistemas baseados em x641\]
</td>
<td style="border:1px solid black;">
**Moderada**  
Divulgação de Informações
...
<span></span>
Existe uma vulnerabilidade de divulgação de informações na forma como o .NET Framework valida inadequadamente o nível de confiança no espaço de nomes System.Net.Sockets. Um intruso que explorasse esta vulnerabilidade com êxito poderia aceder a informações que não era suposto estarem expostas. Além disso, esta vulnerabilidade poderia ser utilizada por um intruso para dirigir tráfego de rede de um sistema da vítima para outros recursos de rede a que a vítima pode aceder. Isto poderia permitir um ataque de negação de serviço a qualquer sistema a que o sistema da vítima pudesse aceder ou o sistema da vítima poderia ser utilizado para executar uma análise dos recursos de rede disponíveis para a vítima. Tenha em atenção que a vulnerabilidade não permitiria que um intruso executasse código ou elevasse directamente os seus privilégios de utilizador, mas poderia ser utilizada para produzir informações que poderiam ser usadas para comprometer ainda mais o sistema afectado.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1978](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1978).

#### Factores Atenuantes para a Vulnerabilidade ao Ignorar Restrições Socket - CVE-2011-1978
...
-   Os clientes que instalaram a actualização [KB2562394](http://support.microsoft.com/kb/2562394) não podem ser explorados sem interacção do utilizador. Esta actualização, disponibilizada através do boletim [MS11-044](http://go.microsoft.com/fwlink/?linkid=216436), impede que as aplicações ClickOnce na zona de Internet sejam executadas sem a permissão do utilizador. Aos clientes que não instalaram a actualização [KB2562394](http://support.microsoft.com/kb/2562394) não será apresentada uma caixa de diálogo se a aplicação não utilizar mais do que apenas permissões de Internet. Consulte [KB2562394](http://support.microsoft.com/kb/2562394) para mais informações sobre esta funcionalidade.

#### Soluções Alternativas para a Vulnerabilidade ao Ignorar Restrições Socket - CVE-2011-1978
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade ao Ignorar Restrições Socket - CVE-2011-1978
...
Esta vulnerabilidade é provocada quando o .NET Framework valida inadequadamente o nível de confiança no espaço de nomes System.Net.Sockets.

**O que é o espaço de nomes System.Net.Sockets?**
O espaço de nomes System.Net.Sockets no .NET Framework fornece uma implementação gerida da interface Windows Sockets (Winsock) para programadores que necessitem de controlar de forma restrita o acesso à rede. Para obter mais informações, consulte o artigo MSDN sobre [Espaço de nomes System.Net.Sockets](http://msdn.microsoft.com/en-us/library/sb27wehh.aspx).
...
A actualização resolve a vulnerabilidade corrigindo a forma como o .NET Framework valida o nível de confiança no espaço de nomes System.Net.Sockets.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Instalação sem intervenção do utilizador</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Instalação sem reiniciar</strong></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 2.0 Service Pack 2 no Windows XP Service Pack 3:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Ficheiro de registo da actualização</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações adicionais</strong></td>
<td style="border:1px solid black;">Consultar a subsecção, Orientações e ferramentas de detecção e implementação</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Reinício necessário?</strong></td>
...
<td style="border:1px solid black;">Para todas as versões suportadas do Microsoft .NET Framework, utilize a ferramenta Adicionar ou Remover Programas do Painel de Controlo.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2567951">Artigo 2567951 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong></strong></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 2.0 Service Pack 2 no Windows XP Professional x64 Edition Service Pack 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 2.0 Service Pack 2\SP2\KB2539631<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong></strong></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 4 em sistemas baseados em x64:<br />
...
Esta actualização de segurança suporta os seguintes parâmetros de configuração para o Microsoft .NET Framework 3.5.
...
Esta actualização de segurança suporta os seguintes parâmetros de configuração para remover o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 4.
...
Esta actualização de segurança suporta os seguintes parâmetros de configuração para remover o Microsoft .NET Framework 3.5.
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 4 em sistemas de 32 bits:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\ Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2539636<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 4 em sistemas baseados em x64 e sistemas baseados em Itanium:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2539636<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
</tbody>
...
As actualizações de segurança para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 suportam os seguintes parâmetros de configuração:
...
A actualização de segurança para Microsoft .NET Framework 4 suporta os seguintes parâmetros de configuração:
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 4 quando instalado no Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1:<br />
NDP40-KB2539636-ia64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Instalação sem reiniciar</td>
...
-   Michael J. Liu, por fornecer informações sobre a Vulnerabilidade ao Ignorar Restrições Socket (CVE-2011-1978)
...
-   V1.1 (23 de Agosto de 2011): Adicionada uma Pergunta Frequente para anunciar uma alteração de detecção para o KB2539636 que corrige um problema de instalação. Esta é apenas uma alteração de detecção. Não foram efectuadas alterações aos ficheiros de actualização de segurança. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.  
