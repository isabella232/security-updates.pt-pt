...
ms:assetid: 'ms11-022'
ms:contentKeyID: 61235003
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-022(v=Security.10)'
---
...
**Questões Conhecidas.** O [Artigo 2489283 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2489283) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
**Quais são as vantagens de aplicar a solução de correcção da Microsoft para desactivar a edição na vista protegida?**    
Ao definir a Validação de Ficheiros do Office para não permitir a edição de ficheiros suspeitos no PowerPoint 2010, a solução de **correcção da Microsoft** "Desactivar a Edição na Vista Protegida no PowerPoint 2010" bloqueia os vectores de ataque para explorar as vulnerabilidades descritas em CVE-2011-0655 e CVE-2011-0656. Os clientes podem optar por aplicar a solução de correcção como uma solução alternativa se optarem por não instalar a actualização de segurança para o PowerPoint 2010 posteriormente.  
Consulte o [Artigo 2501584 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2501584) para obter instruções sobre a aplicação da solução de correcção automática, "Desactivar a Edição na Vista Protegida no PowerPoint 2010", ou consulte as secções de Soluções Alternativas para CVE-2011-0655 e CVE-2011-0656 na secção de Informações sobre as vulnerabilidades deste boletim para obter instruções sobre a aplicação manual da solução.
  
**Os boletins MS11-021 e MS11-023 também descrevem vulnerabilidades no Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac e Conversor de Formato de Ficheiros Open XML para Mac. O MS11-021 também descreve vulnerabilidades no Microsoft Office para Mac 2011. Como é que os boletins MS11-021 e MS11-023 estão relacionados com este boletim (MS11-022)?**  
Os pacotes da actualização de segurança para Microsoft Office 2004 para Mac (KB2505924), Microsoft Office 2008 para Mac (KB2505927) e Conversor de Formato de Ficheiros Open XML para Mac (KB2505935) oferecidos neste boletim também resolvem as vulnerabilidades descritas nos boletins de segurança [MS11-021](http://go.microsoft.com/fwlink/?linkid=210121) e [MS11-023](http://go.microsoft.com/fwlink/?linkid=210206). O pacote de actualização de segurança para Microsoft Office para Mac 2011 (KB2525412) oferecido neste boletim também resolve as vulnerabilidades descritas no boletim [MS11-021](http://go.microsoft.com/fwlink/?linkid=210121). Os utilizadores com o Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac, Conversor de Formato de Ficheiros Open XML para Mac ou Microsoft Office para Mac 2011 instalado apenas terão de instalar estes pacotes de actualização de segurança uma vez.
...
O Microsoft PowerPoint Viewer, que é baseado na tecnologia do Microsoft Office 2010, é uma substituição para o Microsoft PowerPoint Viewer 2007 Service Pack 2. O Microsoft PowerPoint Viewer permite-lhe visualizar apresentações com funcionalidades completas criadas no Microsoft PowerPoint 97 e em versões posteriores.
...
As apresentações Microsoft PowerPoint 2010 criadas com a funcionalidade "Compactar Apresentação para CD" não incluem o PowerPoint Viewer.
...
**Como são afectados por estas vulnerabilidades os programas autónomos do Microsoft Office?**    
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0655](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0655).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código em Vírgula Flutuante no Techno-Color Time Bandit - CVE-2011-0655
...
-   No Microsoft PowerPoint 2010, a possibilidade de um intruso ser bem sucedido ao explorar esta vulnerabilidade é reduzida devido às protecções proporcionadas pela funcionalidade de Validação de Ficheiros do Office activadas por predefinição no Microsoft Office 2010. Os ficheiros especialmente concebidos para o efeito utilizados para explorar a vulnerabilidade abrem na Vista Protegida e o utilizador é informado que o ficheiro é perigoso e potencialmente nocivo por ter falhado a validação. Um utilizador teria de clicar em vários avisos e abrir o ficheiro para editar ou guardar antes de a vulnerabilidade poder ser explorada. Para obter mais informações sobre a Vista Protegida e a Validação de Ficheiros do Office, consulte o artigo TechNet sobre [Visão Geral de Segurança para o Office 2010](http://technet.microsoft.com/en-us/library/cc179050.aspx).
    **Nota**  Desactivar a Validação de Ficheiros do Office no Microsoft PowerPoint 2010 eliminaria as protecções fornecidas pela Validação de Ficheiros do Office como um factor atenuante. Para esta razão, a Microsoft não recomenda a desactivação da funcionalidade de Validação de Ficheiros do Office no Microsoft PowerPoint 2010.

#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código em Vírgula Flutuante no Techno-Color Time Bandit - CVE-2011-0655

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Definir a Validação de Ficheiros do Office para desactivar a edição na vista protegida no PowerPoint 2010**

    **Nota**  Consulte o [Artigo 2501584 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2501584) para utilizar a solução automática de **correcção da Microsoft**, "Desactivar a Edição na Vista Protegida no PowerPoint 2010", para activar ou desactivar esta solução alternativa.
    ...
    **Aviso**  A utilização incorrecta do Editor de Registo pode provocar problemas graves que podem vir a obrigar à reinstalação do sistema operativo. A Microsoft não pode garantir que os problemas resultantes da utilização incorrecta do Editor de Registo possam ser resolvidos. A utilização do Editor de Registo é da sua responsabilidade. Para obter informações sobre como editar o registo, deve consultar o tópico de Ajuda "Alterar Chaves e Valores" do Editor de Registo (Regedit.exe) ou os tópicos de Ajuda "Adicionar e Eliminar Informações do Registo" e "Editar Dados do Registo" do Regedt32.exe.
    ...
    Aplicar manualmente esta solução alternativa:

    1.  Abra o Editor de Registo e navegue para a seguinte chave de registo:
        HKEY\_CURRENT\_USER\\Software\\Microsoft\\Office\\14.0\\PowerPoint\\Security\\FileValidation
    2.  Defina o valor de **DisableEditFromPV** para "00000001"
    3.  Saia do Editor de Registo

    **Impacto da solução alternativa.**  A Validação de Ficheiros do Office deixará de permitir a edição de ficheiros suspeitos no PowerPoint 2010.

    **Como anular esta solução alternativa.**

    1.  Abra o Editor de Registo e navegue para a seguinte chave de registo:
        HKEY\_CURRENT\_USER\\Software\\Microsoft\\Office\\14.0\\PowerPoint\\Security\\FileValidation
    2.  Defina o valor de **DisableEditFromPV** para "00000000"
    3.  Saia do Editor de Registo
...
-   **Não abra documentos PowerPoint de fontes não fidedignas**

    Não abra ficheiros PowerPoint que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código em Vírgula Flutuante no Techno-Color Time Bandit - CVE-2011-0655
...
O Microsoft PowerPoint é o componente afectado por esta vulnerabilidade.
...
Os sistemas em que é utilizada uma versão afectada do Microsoft PowerPoint, como estações de trabalho ou servidores de terminais, estão mais susceptíveis. Os servidores podem estar mais sujeitos a risco se os administradores permitirem que os utilizadores iniciem sessão nos servidores e executem programas. Contudo, os procedimentos recomendados desencorajam essa acção.

**O que faz a actualização?**  
A actualização modifica a forma como o PowerPoint valida registosTimeColorBehaviorContainer Floating Point ao abrir ficheiros PowerPoint.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0656](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0656).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código no Persist Directory - CVE-2011-0656
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código no Persist Directory - CVE-2011-0656
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código no Persist Directory - CVE-2011-0656
...
**O que faz a actualização?**  
A actualização modifica a forma como o PowerPoint valida registos PersistDirectoryEntry ao abrir ficheiros PowerPoint.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0976](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0976).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código no OfficeArt Atom - CVE-2011-0976
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código no OfficeArt Atom - CVE-2011-0976
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código no OfficeArt Atom - CVE-2011-0976
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2464617">Artigo 2464617 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2464588">Artigo 2464588 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
#### PowerPoint 2007 (todas as edições), Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 (todas as versões) e PowerPoint Viewer 2007 (todas as versões)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para o PowerPoint 2007, consulte o <a href="http://support.microsoft.com/kb/2464594">Artigo 2464594 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 Service Pack 2, consulte o <a href="http://support.microsoft.com/kb/2464635">Artigo 2464635 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para PowerPoint Viewer 2007 Service Pack 2, consulte o <a href="http://support.microsoft.com/kb/2464623">Artigo 2464623 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para PowerPoint 2010, consulte o <a href="http://support.microsoft.com/kb/2519975">Artigo 2519975 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para PowerPoint Viewer, consulte o <a href="http://support.microsoft.com/kb/2519984">Artigo 2519984 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para PowerPoint Web App, consulte o <a href="http://support.microsoft.com/kb/2520047">Artigo 2520047 da Base de Dados de Conhecimento da Microsoft.</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
Transfira e instale a versão do idioma adequado para a Actualização do Microsoft Office 2008 para Mac 12.2.9, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=84dfe3f4-a2a1-47b9-8da1-29ae67230918).
...
-   Investigador anónimo, a trabalhar com a* *[Zero Day Initiative da](http://www.zerodayinitiative.com/)[TippingPoint](http://www.tippingpoint.com/)</a>, por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código em Vírgula Flutuante no Techno-Color Time Bandit (CVE-2011-0655)  
-   Um investigador anónimo, a trabalhar com a* *[Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código no Persist Directory (CVE-2011-0656)  
-   Um investigador anónimo, a trabalhar com a* *[Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código no OfficeArt Atom (CVE-2011-0976)
