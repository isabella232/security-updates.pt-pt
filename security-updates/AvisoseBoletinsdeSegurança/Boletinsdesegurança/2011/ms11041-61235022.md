---
TOCTitle: 'MS11-041'
Title: 'Microsoft Security Bulletin MS11-041 - Crítica'
ms:assetid: 'ms11-041'
ms:contentKeyID: 61235022
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-041(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-041 - Crítica
==============================================

Vulnerabilidades nos Controladores de Modo de Kernel do Windows Poderiam Permitir Execução Remota de Código (2525694)
---------------------------------------------------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=035d5115-54b6-41d3-b9f0-890041ead178)                                                                                 | Elevação de Privilégios     | Importante                          | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4aa8c003-0353-4a5b-8aea-c01a103af393)                                                                                     | Elevação de Privilégios     | Importante                          | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2e07b5fa-c9fa-495b-9352-c07ce46a7e8b)                                                                      | Elevação de Privilégios     | Importante                          | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a519a5d7-bfe3-4e53-99e9-d85f7e34237f)                                                | Execução Remota de Código   | Crítica                             | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd8f3713-b408-4db6-aecd-7eed2176a715)\*             | Execução Remota de Código   | Crítica                             | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a61f888-c81e-4b8a-8932-2fe67df4b2ad)       | Execução Remota de Código   | Crítica                             | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=e7f52b13-5b3d-438c-ae14-86da50c8b67a)                                   | Execução Remota de Código   | Crítica                             | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b77e5be6-d3eb-4e3a-9be2-831578f0447c)\*       | Execução Remota de Código   | Crítica                             | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c00a33bc-c874-4693-b0f7-5034c5df9424) | Execução Remota de Código   | Crítica                             | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Validação OTF Win32k - CVE-2011-1873</th>
...
Vulnerabilidade de Validação OTF Win32k - CVE-2011-1873  
-------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código devido à forma como o controlador de modo de kernel do Windows analisa tipos de letra OpenType especialmente concebidos para o efeito em sistemas baseados em x64 e em Itanium. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1873](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1873).
  
#### Factores Atenuantes para a Vulnerabilidade de Validação OTF Win32k - CVE-2011-1873
...
#### Soluções Alternativas para a Vulnerabilidade de Validação OTF Win32k - CVE-2011-1873
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação OTF Win32k - CVE-2011-1873
...
A vulnerabilidade é provocada quando o controlado de modo de kernel do Windows valida indevidamente apontadores ao analisar tipos de letra OTF.
...
**O que é o formato de Tipos de Letra OpenType (OTF)?**  
...
Num cenário de ataque baseado na Web, um intruso teria de alojar um Web site que apontasse para um tipo de letra OpenType especialmente concebido para o efeito numa partilha de rede. Então, quando o utilizador navega para o Web site, o caminho de controlo afectado é accionado através dos painéis de Detalhes e de Pré-visualização no Explorador do Windows. O tipo de letra OpenType especialmente concebido poderia explorar a vulnerabilidade e assumir o controlo de um sistema afectado. Um intruso não conseguiria obrigar um utilizador a visitar um Web site especialmente concebido para o efeito. Em vez disso, um intruso teria de os convencer a visitar o Web site, levando-os normalmente a clicar numa hiperligação que os levasse ao site do intruso e, em seguida, convencê-los a abrir um ficheiro especialmente concebido para o efeito.
  
Num cenário de ataque baseado numa partilha de rede, um intruso poderia alojar um tipo de letra OpenType especialmente concebido para o efeito numa partilha de rede. Quando o utilizador navega para a partilha no Windows Explorer, o caminho de controlo afectado é accionado através dos painéis de Detalhes e de Pré-visualização. O tipo de letra OpenType especialmente concebido poderia explorar a vulnerabilidade e assumir o controlo de um sistema afectado.
...
**Que tipos de sistemas são afectados por esta vulnerabilidade?**  
Esta vulnerabilidade afecta apenas as versões baseadas em x64 e em Itanium dos sistemas operativos Windows. As versões de 32 bits dos sistemas operativos Windows não são afectadas.
  
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade corrigindo a forma como o controlador de modo de kernel do Windows valida apontadores ao analisar tipos de letra OpenType.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2525694$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2525694">Artigo 2525694 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
Windows6.1-KB2525694-x64.msu /quiet Para todas as edições suportadas</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalação sem reiniciar</td>
<td style="border:1px solid black;">Para todas as edições baseadas em x64 do Windows 7:<br />
...
-   Koro, [www.korosoft.net](http://www.korosoft.net/), por fornecer informações sobre a Vulnerabilidade de Validação OTF Win32k (CVE-2011-1873)
