...
ms:assetid: 'ms11-047'
ms:contentKeyID: 61235028
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-047(v=Security.10)'
---
...
Vulnerabilidade no Hyper-V Poderia Permitir Negação de Serviço (2525835)
------------------------------------------------------------------------
...
| [Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                                  | Negação de Serviço          | Importante                          | Nenhum                                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de Negação de Serviço Persistente no VMBus - CVE-2011-1872</th>
...
Vulnerabilidade de Negação de Serviço Persistente no VMBus - CVE-2011-1872  
--------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço no Hyper-V no Windows Server 2008 e Windows Server 2008 R2. A vulnerabilidade deve-se a uma validação insuficiente de sequências específicas de instruções da máquina por parte dos servidores Hyper-V. Um intruso que explorasse esta vulnerabilidade com sucesso poderia fazer com que o sistema Hyper-V afectado deixasse de responder. Isto afectaria todas as máquinas virtuais alojadas por esse sistema.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1872](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1872).
  
#### Factores Atenuantes para a Vulnerabilidade de Negação de Serviço Persistente no VMBus - CVE-2011-1872
...
#### Soluções Alternativas para a Vulnerabilidade de Negação de Serviço Persistente no VMBus - CVE-2011-1872
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Negação de Serviço Persistente no VMBus - CVE-2011-1872
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de negação de serviço. Um intruso que explorasse esta vulnerabilidade poderia fazer com que o servidor Hyper-V afectado deixasse de responder, requerendo um reinício. Tenha em atenção que a vulnerabilidade de negação de serviço não permitiria que um intruso executasse o código ou elevasse os seus direitos de utilizador no servidor Hyper-V, mas poderia fazer com que o sistema afectado deixasse de aceitar pedidos.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade deve-se a uma validação insuficiente de pacotes específicos enviados do convidado ao anfitrião. Devido a esta falta de validação, o processamento destas instruções provoca um consumo excessivo de recursos na aplicação do servidor Hyper-V.
  
**O que é o Hyper-V?**    
O Hyper-V é uma tecnologia baseada em hipervisor, uma funcionalidade essencial do Windows Server 2008 e do Windows Server 2008 R2. Fornece uma plataforma de virtualização escalável, fiável e altamente disponível. Este tipo de ambiente é útil porque permite criar e gerir máquinas virtuais, permitindo executar múltiplos sistemas operativos num computador físico e isolar os sistemas operativos entre si.
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que explorasse esta vulnerabilidade com sucesso poderia fazer com que o sistema de um utilizador deixasse de responder e tivesse de ser reiniciado. Tenha em conta que esta vulnerabilidade pode resultar num consumo completo dos recursos do servidor Hyper-V, incluindo todas as máquinas virtuais convidadas que são alojadas por esse servidor.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Um intruso teria que ser um administrador autenticado numa das máquinas virtuais convidadas que estão alojadas pelo servidor Hyper-V. O intruso teria de ter a capacidade de executar código arbitrário nesse sistema, por exemplo, executando um executável não fidedigno. Este executável poderia então invocar uma sequência mal formada de instruções de máquinas, o que resultaria num consumo dos recursos, provocando um ciclo infinito no servidor Hyper-V que impediria o processamento de pedidos de outras máquinas virtuais.
  
**Que permissões são necessárias para que um intruso execute este Ataque de Negação de Serviço?**    
Para executar este ataque de negação de serviço contra o servidor Hyper-V e todas máquinas virtuais em execução no servidor Hyper-V, o intruso teria de ter privilégios de administrador numa das máquinas virtuais alojadas no servidor Hyper-V. O intruso não necessita de ter acesso de Administrador no próprio servidor Hyper-V.
...
Esta actualização corrige a forma como o Hyper-V Server processa pedidos mal formados de máquinas virtuais. A correcção permite que a aplicação do servidor Hyper-V valide adequadamente os pacotes VMBus enviados do convidado ao anfitrião.
...
<td style="border:1px solid black;">Para Hyper-V Server instalado em todas as edições suportadas baseadas em x64 do Windows Server 2008:<br />
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2525835">Artigo 2525835 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para Hyper-V Server instalado em todas as edições suportadas baseadas em x64 do Windows Server 2008 R2:<br />
...
-   Nicolas Economou, da [Core Security Technologies](http://www.coresecurity.com/), por fornecer informações sobre a Vulnerabilidade de Negação de Serviço Persistente no VMBus (CVE-2011-1872)
