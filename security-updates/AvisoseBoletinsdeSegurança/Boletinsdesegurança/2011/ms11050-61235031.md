---
TOCTitle: 'MS11-050'
Title: 'Microsoft Security Bulletin MS11-050 - Crítica'
ms:assetid: 'ms11-050'
ms:contentKeyID: 61235031
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-050(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-050 - Crítica
==============================================

Actualização de Segurança Cumulativa para o Internet Explorer (2530548)
-----------------------------------------------------------------------

Data de publicação: 14 de junho de 2011 | Updated: 9 de agosto de 2011
...
Esta actualização de segurança está classificada como Crítica para Internet Explorer 6 em clientes Windows, Internet Explorer 7, Internet Explorer 8 e Internet Explorer 9 e como Moderada para Internet Explorer 6 em servidores Windows. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades modificando a forma como o Internet Explorer aplica as definições de conteúdo fornecidas pelo servidor Web, processa a sanitização de HTML utilizando a toStaticHTML, processa objectos em memória e processa scripts durante determinados processos. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as Vulnerabilidades**.
...
Sim. Para além das alterações indicadas na secção de **Informações sobre as Vulnerabilidades** deste boletim, esta actualização inclui actualizações de medidas de defesa profunda para ajudar a melhorar a protecção da memória no Internet Explorer. Uma destas actualizações de medidas de defesa profunda resolve uma questão de fuga de endereços da memória, publicamente conhecida como [CVE-2011-1346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1346).
...
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações em Intercepção MIME - CVE-2011-1246
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória em Processamento de Propriedades de Ligação - CVE-2011-1250
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória em Manipulação de DOM - CVE-2011-1251
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações na toStaticHTML - CVE-2011-1252
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória ao Arrastar e Largar - CVE-2011-1254
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória em Elemento de Hora - CVE-2011-1255
</th>
</tr>
<tr>
<th colspan="7">
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória em Modificação de DOM - CVE-2011-1256
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações ao Arrastar e Largar - CVE-2011-1258
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória em Esquema - CVE-2011-1260
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória em Objecto de Selecção - CVE-2011-1261
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória em Redireccionamento de HTTP - CVE-2011-1262
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1246](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1246).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações em Intercepção MIME - CVE-2011-1246
...
#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações em Intercepção MIME - CVE-2011-1246
...
Para que ocorra qualquer acção nociva, esta vulnerabilidade requer que um utilizador tenha sessão iniciada, visite um Web site e tente transferir conteúdos especificamente concebidos para o efeito. Deste modo, qualquer sistema onde o Internet Explorer seja frequentemente utilizado, como as estações de trabalho ou servidores de terminal dos utilizadores, está mais susceptível a esta vulnerabilidade.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1250).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória em Processamento de Propriedades de Ligação - CVE-2011-1250
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória em Processamento de Propriedades de Ligação - CVE-2011-1250
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória em Processamento de Propriedades de Ligação - CVE-2011-1250
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1251).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória em Manipulação de DOM - CVE-2011-1251
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória em Manipulação de DOM - CVE-2011-1251
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória em Manipulação de DOM - CVE-2011-1251
...
#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações na toStaticHTML - CVE-2011-1252
...
-   Por predefinição, todas as versões suportadas do Microsoft Outlook, Microsoft Outlook Express e Windows Mail abrem mensagens de correio electrónico em HTML na zona de sites Restritos, que desactiva scripts e controlos ActiveX, ajudando a reduzir o risco de um intruso poder utilizar esta vulnerabilidade para executar código malicioso. Se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx). Este modo atenua esta vulnerabilidade. Consulte a secção de Perguntas Mais Frequentes desta vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Internet Explorer 6 e o Internet Explorer 9 não são afectados por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações na toStaticHTML - CVE-2011-1252
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações na toStaticHTML - CVE-2011-1252

**Qual é a abrangência desta vulnerabilidade?**  
Trata-se de uma vulnerabilidade ao nível da divulgação de informações. Um intruso que explorasse a vulnerabilidade quando um utilizador visualizasse uma página Web que utilizasse a API toStaticHTML poderia executar scripts no contexto de segurança do utilizador contra esse site.
...
**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso que explorasse esta vulnerabilidade com êxito poderia executar scripts no contexto de segurança do utilizador contra um Web site quando o utilizador visualizasse HTML no Web site e a sanitização de dados do utilizador executada pela API toStaticHTML fosse ignorada.
...
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
Para que ocorra qualquer acção nociva, esta vulnerabilidade requer que um utilizador tenha sessão iniciada e visite um Web site que utilize a API toStaticHTML para proceder à sanitização de dados do utilizador. Deste modo, qualquer sistema onde o Internet Explorer seja frequentemente utilizado, como as estações de trabalho ou servidores de terminal dos utilizadores, está mais susceptível a esta vulnerabilidade.

**Tenho o Internet Explorer para o Windows Server 2003, Windows Server 2008 ou Windows Server 2008 R2. Isso atenua esta vulnerabilidade?**  
Sim. Por predefinição, o Internet Explorer no Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx). A Configuração de Segurança Avançada do Internet Explorer é um grupo de definições pré-configuradas do Internet Explorer que reduz a probabilidade de um utilizador ou de um administrador transferir e executar num servidor conteúdos da Web especialmente concebidos para o efeito. Este é um factor atenuante para Web sites que não adicionou à Zona de sites fidedignos do Internet Explorer.

**O que faz a actualização?**  
A actualização resolve a vulnerabilidade modificando a forma como o Internet Explorer processa a sanitização de HTML utilizando a toStaticHTML.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1254).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória ao Arrastar e Largar - CVE-2011-1254

O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   Num cenário de ataque baseado na Web, um intruso poderia alojar um Web site especialmente concebido para o efeito, destinado a explorar esta vulnerabilidade através do Internet Explorer, persuadindo depois um utilizador a ver o Web site em questão e a arrastar e largar conteúdos para o mesmo. Um intruso poderia também incorporar um controlo ActiveX marcado como "seguro para inicialização" numa aplicação ou num documento do Microsoft Office que alojasse o motor de processamento de gráficos do IE. O intruso também poderia tirar partido de Web sites corrompidos ou Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos pelo utilizador. Estes Web sites podem conter conteúdos especialmente concebidos para o efeito, que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visualizar o conteúdo controlado pelo intruso. Em vez disso, um intruso teria de convencer os utilizadores a executarem determinadas acções, normalmente conseguindo que clicassem numa hiperligação numa mensagem de correio electrónico ou numa mensagem de um programa de mensagens instantâneas que leve os utilizadores ao Web site do intruso, ou abrindo um anexo enviado através de correio electrónico. Além disso, o intruso teria de convencer os utilizadores a executar uma operação de arrastar e largar.
-   Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
-   Por predefinição, todas as versões suportadas do Microsoft Outlook, Microsoft Outlook Express e Windows Mail abrem mensagens de correio electrónico em HTML na zona de sites Restritos, que desactiva scripts e controlos ActiveX, ajudando a reduzir o risco de um intruso poder utilizar esta vulnerabilidade para executar código malicioso. Se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx). Este modo atenua esta vulnerabilidade. Consulte a secção de Perguntas Mais Frequentes desta vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Internet Explorer 9 não é afectado por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória ao Arrastar e Largar - CVE-2011-1254
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória ao Arrastar e Largar - CVE-2011-1254
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1255).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória em Elemento de Hora - CVE-2011-1255
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória em Elemento de Hora - CVE-2011-1255
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória em Elemento de Hora - CVE-2011-1255
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1256).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória em Modificação de DOM - CVE-2011-1256

O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   Num cenário de ataque baseado na Web, um intruso poderia alojar um Web site especialmente concebido para o efeito, destinado a explorar esta vulnerabilidade através do Internet Explorer, persuadindo depois um utilizador a realizar operações de copiar/colar enquanto estivesse no Web site do intruso. Um intruso poderia também incorporar um controlo ActiveX marcado como "seguro para inicialização" numa aplicação ou num documento do Microsoft Office que alojasse o motor de processamento de gráficos do IE. O intruso também poderia tirar partido de Web sites corrompidos ou Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos pelo utilizador. Estes Web sites podem conter conteúdos especialmente concebidos para o efeito, que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visualizar o conteúdo controlado pelo intruso. Em vez disso, um intruso teria de convencer os utilizadores a executarem determinadas acções, normalmente conseguindo que clicassem numa hiperligação numa mensagem de correio electrónico ou numa mensagem de um programa de mensagens instantâneas que leva os utilizadores ao Web site do intruso, ou abrindo um anexo enviado através de correio electrónico.
-   É necessária uma interacção significativa por parte do utilizador para activar a vulnerabilidade.
-   Por predefinição, todas as versões suportadas do Microsoft Outlook, Microsoft Outlook Express e Windows Mail abrem mensagens de correio electrónico em HTML na zona de sites Restritos, que desactiva scripts e controlos ActiveX, ajudando a reduzir o risco de um intruso poder utilizar esta vulnerabilidade para executar código malicioso. Se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx). Este modo atenua esta vulnerabilidade. Consulte a secção de Perguntas Mais Frequentes desta vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Internet Explorer 9 não é afectado por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória em Modificação de DOM - CVE-2011-1256
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória em Modificação de DOM - CVE-2011-1256
...
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
Para que ocorra qualquer acção nociva, esta vulnerabilidade requer que um utilizador tenha sessão iniciada, visite um Web site e execute operações de copiar/colar. Deste modo, qualquer sistema onde o Internet Explorer seja frequentemente utilizado, como as estações de trabalho ou servidores de terminal dos utilizadores, está mais susceptível a esta vulnerabilidade.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1258).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações ao Arrastar e Largar - CVE-2011-1258
...
#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações ao Arrastar e Largar - CVE-2011-1258
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações ao Arrastar e Largar - CVE-2011-1258

**Qual é a abrangência desta vulnerabilidade?**  
Trata-se de uma vulnerabilidade ao nível da divulgação de informações. Um intruso que explorasse a vulnerabilidade quando um utilizador visualizasse uma página Web e executasse uma operação de arrastar e largar poderia visualizar conteúdo de um domínio ou zona do Internet Explorer diferente do domínio ou zona da página Web do intruso.

**O que provoca a vulnerabilidade?**  
Em determinados processos, o Internet Explorer permite inadequadamente que os scripts acedam e leiam conteúdo de diferentes domínios.
...
**Como poderia um intruso explorar a vulnerabilidade?**  
Um intruso poderia alojar um Web site especialmente concebido para o efeito, destinado a explorar esta vulnerabilidade através do Internet Explorer, persuadindo depois um utilizador a ver o Web site em questão e a executar uma operação de arrastar e largar. O intruso também poderia tirar partido de Web sites corrompidos ou Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos pelo utilizador. Estes Web sites podem conter conteúdos especialmente concebidos para o efeito, que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Um intruso teria de convencer os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico, ou numa mensagem de um programa de mensagens instantâneas, que levasse os utilizadores para o Web site do intruso e, em seguida, convencendo-os a executar uma operação de arrastar e largar. Também poderia ser possível exibir conteúdos Web nocivos concebidos especialmente para o efeito, usando espaços de publicidade como banners, ou usando outros métodos para entregar conteúdos Web a sistemas afectados.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1260).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória em Esquema - CVE-2011-1260
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória em Esquema - CVE-2011-1260
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória em Esquema - CVE-2011-1260
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1261).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória em Objecto de Selecção - CVE-2011-1261
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória em Objecto de Selecção - CVE-2011-1261
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória em Objecto de Selecção - CVE-2011-1261
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1262](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1262).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória em Redireccionamento de HTTP - CVE-2011-1262
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória em Redireccionamento de HTTP - CVE-2011-1262
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória em Redireccionamento de HTTP - CVE-2011-1262
...
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2530548$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB2530548-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie8updates\KB2530548-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2530548">Artigo 2530548 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Robert Swiecki, da [Google Inc.](http://www.google.com/), por fornecer informações sobre a Vulnerabilidade de Divulgação de Informações em Intercepção MIME (CVE-2011-1246)  
-   [NSFOCUS Security Team](http://www.nsfocus.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória em Processamento de Propriedades de Ligação (CVE-2011-1250)  
-   Investigador anónimo, a trabalhar com o programa [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória em Manipulação de DOM (CVE-2011-1251)  
-   Adi Cohen, da [IBM Rational Application Security](http://blog.watchfire.com/), por fornecer informações sobre a Vulnerabilidade de Divulgação de Informações na toStaticHTML (CVE-2011-1252)  
-   [Trend Micro](http://www.trendmicro.com/), por trabalhar connosco na Vulnerabilidade de Divulgação de Informações na toStaticHTML (CVE-2011-1252)  
-   Nirmal Singh Bhary, da [Norman](http://www.norman.com), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória ao Arrastar e Largar (CVE-2011-1254)  
-   Investigador anónimo, a trabalhar com a [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória em Elemento de Hora (CVE-2011-1255)  
-   Damian Put, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória em Modificação de DOM (CVE-2011-1256)  
-   Yoel Gluck, Yogesh Badwe e Varun Badhwar, da equipa para a segurança de produtos da [salesforce.com](http://www.salesforce.com/), por fornecerem informações sobre a Vulnerabilidade de Divulgação de Informações ao Arrastar e Largar (CVE-2011-1258)  
-   Jose Antonio Vazquez Gonzalez, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória em Esquema (CVE-2011-1260)  
-   Investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória em Objecto de Selecção (CVE-2011-1261)  
-   Peter Winter-Smith, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória em Redireccionamento de HTTP (CVE-2011-1262)  
-   Stephen Fewer, da [Harmony Security](http://www.harmonysecurity.com/), a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por trabalhar connosco nas alterações a nível de medidas de defesa profunda neste boletim
...
-   V1.1 (9 de Agosto de 2011): Esclarecimento de que uma das alterações a nível de medidas de defesa profunda incluídas nesta actualização de segurança resolve uma questão de fuga de endereços da memória, publicamente conhecida como CVE-2011-1346. Trata-se apenas de uma alteração informativa.
