---
TOCTitle: 'MS11-021'
Title: 'Microsoft Security Bulletin MS11-021 - Importante'
ms:assetid: 'ms11-021'
ms:contentKeyID: 61235002
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-021(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-021 - Importante
=================================================
...
A actualização resolve as vulnerabilidades corrigindo a forma como o Microsoft Excel gere estruturas de dados, valida informação de registo, inicializa variáveis utilizadas em operações de memória e atribui espaço de memória intermédia ao analisar um ficheiro especialmente concebido para o efeito. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Questões Conhecidas.** O [Artigo 2489279 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2489279) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
Sim. As actualizações para o Microsoft Excel 2003 Service Pack 3 (KB2502786) e Microsoft Excel 2007 Service Pack 2 (KB2464583), em conjunto com a actualização oferecida no boletim [MS11-023](http://go.microsoft.com/fwlink/?linkid=210206), fornecem suporte para a funcionalidade de Validação de Ficheiros do Office. Para obter mais informações sobre a funcionalidade de Validação de Ficheiros do Office, consulte o [Aviso de Segurança da Microsoft 2501584](http://technet.microsoft.com/security/advisory/2501584).

**Como é que esta actualização de segurança está relacionada com os boletins MS10-087 e MS10-088?**  
A actualização para o Microsoft Office 2004 para Mac (KB2505924) oferecida neste boletim também resolve as vulnerabilidades descritas nos boletins de segurança [MS10-087](http://go.microsoft.com/fwlink/?linkid=203241) e [MS10-088](http://go.microsoft.com/fwlink/?linkid=198186).

**Os boletins MS11-022 e MS11-023 também descrevem vulnerabilidades no Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac e Conversor de Formato de Ficheiros Open XML para Mac. O MS11-022 também descreve vulnerabilidades no Microsoft Office para Mac 2011. Como é que os boletins MS11-022 e MS11-023 estão relacionados com este boletim, MS11-021?**  
Os pacotes da actualização de segurança para Microsoft Office 2004 para Mac (KB2505924), Microsoft Office 2008 para Mac (KB2505927) e Conversor de Formato de Ficheiros Open XML para Mac (KB2505935) oferecidos neste boletim também resolvem as vulnerabilidades descritas nos boletins de segurança [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727) e [MS11-023](http://go.microsoft.com/fwlink/?linkid=210206). O pacote de actualização de segurança para Microsoft Office para Mac 2011 (KB2525412) oferecido neste boletim também resolve as vulnerabilidades descritas no boletim [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727). Os utilizadores com o Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac, Conversor de Formato de Ficheiros Open XML para Mac ou Microsoft Office para Mac 2011 instalado apenas terão de instalar estes pacotes de actualização de segurança uma vez.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga de Número Inteiro no Excel - CVE-2011-0097
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados no Excel - CVE-2011-0098
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de WriteAV na Análise de Registos no Excel - CVE-2011-0101
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no Excel - CVE-2011-0103
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Substituição de Memória Intermédia no Excel - CVE-2011-0104
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Inicialização de Dados no Excel - CVE-2011-0105
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Indexação de Matriz no Excel - CVE-2011-0978
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Lista com Ligações no Excel - CVE-2011-0979
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Apontador Pendente no Excel - CVE-2011-0980
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft Excel (edições de 64 bits)
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0097](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097).

#### Factores Atenuantes para Vulnerabilidade de Sobrecarga de Número Inteiro no Excel - CVE-2011-0097
...
#### Soluções Alternativas para Vulnerabilidade de Sobrecarga de Número Inteiro no Excel - CVE-2011-0097
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga de Número Inteiro no Excel - CVE-2011-0097
...
A vulnerabilidade existe quando o Microsoft Excel não atribui correctamente espaço de memória intermédia ao analisar informações de registo num ficheiro Excel especialmente criado para o efeito.
...
A actualização resolve a vulnerabilidade corrigindo a forma como o Microsoft Excel atribui espaço de memória intermédia ao analisar um ficheiro especialmente concebido para o efeito.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0098](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098).

#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Excel - CVE-2011-0098
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Excel - CVE-2011-0098
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Excel - CVE-2011-0098
...
**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o Microsoft Excel encontra um erro de processamento da memória durante a validação de informações de registo ao analisar um ficheiro Excel especialmente concebido para o efeito, danificando a memória do sistema de tal forma que um intruso poderia executar código arbitrário.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0101](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101).

#### Factores Atenuantes para a Vulnerabilidade de WriteAV na Análise de Registos no Excel - CVE-2011-0101
...
#### Soluções Alternativas para a Vulnerabilidade de WriteAV na Análise de Registos no Excel - CVE-2011-0101
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de WriteAV na Análise de Registos no Excel - CVE-2011-0101
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0103](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2011-0103
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2011-0103
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2011-0103
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0104](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104).

#### Factores Atenuantes para a Vulnerabilidade de Substituição de Memória Intermédia no Excel - CVE-2011-0104
...
#### Soluções Alternativas para a Vulnerabilidade de Substituição de Memória Intermédia no Excel - CVE-2011-0104
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Substituição de Memória Intermédia no Excel - CVE-2011-0104
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0105](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105).

#### Factores Atenuantes para a Vulnerabilidade de Inicialização de Dados no Excel - CVE-2011-0105
...
#### Soluções Alternativas para a Vulnerabilidade de Inicialização de Dados no Excel - CVE-2011-0105
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Inicialização de Dados no Excel - CVE-2011-0105

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é provocada quando o Microsoft Excel não inicializa devidamente uma variável que é utilizada como a duração de uma operação de memcpy ao analisar um ficheiro Excel especialmente concebido para o efeito. Esta condição pode ser explorada para causar uma sobrecarga de memória intermédia, que leva a execução de código no contexto de segurança do utilizador com sessão iniciada.
...
**O que faz a actualização?**  
A actualização resolve a vulnerabilidade corrigindo a forma como o Microsoft Excel inicializa variáveis utilizadas em operações de memória.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0978](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978).

#### Factores Atenuantes para a Vulnerabilidade de Indexação de Matriz no Excel - CVE-2011-0978
...
#### Soluções Alternativas para a Vulnerabilidade de Indexação de Matriz no Excel - CVE-2011-0978
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Indexação de Matriz no Excel - CVE-2011-0978
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0979](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Lista com Ligações no Excel - CVE-2011-0979
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Lista com Ligações no Excel - CVE-2011-0979
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Lista com Ligações no Excel - CVE-2011-0979

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é provocada quando o Microsoft Excel não gere adequadamente os membros de uma estrutura de dados ao analisar um ficheiro Excel especialmente concebido para o efeito.
...
**O que faz a actualização?**  
A actualização resolve a vulnerabilidade corrigindo a forma como o Microsoft Excel gere estruturas de dados.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0980](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980).

#### Factores Atenuantes para a Vulnerabilidade de Apontador Pendente no Excel - CVE-2011-0980
...
#### Soluções Alternativas para a Vulnerabilidade de Apontador Pendente no Excel - CVE-2011-0980
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Apontador Pendente no Excel - CVE-2011-0980

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é provocada quando o Microsoft Excel não gere adequadamente estruturas de dados ao analisar um ficheiro Excel especialmente concebido para o efeito.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2466169">Artigo 2466169 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2502786">Artigo 2502786 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para o Microsoft Excel 2007, consulte o <a href="http://support.microsoft.com/kb/2464583">Artigo 2464583 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft Excel Viewer, consulte o <a href="http://support.microsoft.com/kb/2466158">Artigo 2466158 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007, consulte o <a href="http://support.microsoft.com/kb/2466156">Artigo 2466156 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2466146">Artigo 2466146 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
Transfira e instale a versão do idioma adequado para a Actualização do Microsoft Office 2004 para Mac 11.6.3, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=f756d836-6ab2-4adb-9dee-6cb523d7c1f5).
...
-   Abra o volume da Actualização Microsoft Office 2004 para Mac 11.6.3 no seu ambiente de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume de Actualização Microsoft Office 2004 para Mac 11.6.3, faça duplo clique na aplicação da Actualização Microsoft Office 2004 para Mac 11.6.3 e siga as instruções no ecrã.  
-   Se a instalação foi concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: "Verificação da Instalação da Actualização". Para remover o programa de instalação, primeiro arraste o volume da Actualização Microsoft Office 2004 para Mac 11.6.3 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da versão for **11.6.3**, a actualização foi instalada com sucesso.
...
Transfira e instale a versão do idioma adequado para a Actualização do Microsoft Office 2008 para Mac 12.2.4, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=84dfe3f4-a2a1-47b9-8da1-29ae67230918).
  
-   Feche todas as aplicações que esteja a executar, incluindo aplicações de protecção contra vírus, todas as aplicações Microsoft Office, Microsoft Messenger para Mac e Notificações do Office, porque podem interferir com a instalação.  
-   Abra o volume da Actualização Microsoft Office 2008 para Mac 12.2.9 na sua área de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume de Actualização Microsoft Office 2008 para Mac 12.2.9, faça duplo clique na aplicação da Actualização Microsoft Office 2008 para Mac 12.2.9 e siga as instruções no ecrã.  
-   Se a instalação foi concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: "Verificação da Instalação da Actualização". Para remover o programa de instalação, primeiro arraste o volume da Actualização Microsoft Office 2008 para Mac 12.2.9 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da versão for **12.2.9**, a actualização foi instalada com sucesso.
...
Transfira e instale a versão de idioma adequada para a Actualização 14.1 do Microsoft Office para Mac 2011, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=ef1e612f-d8e3-4628-9fe4-ad136f0debd3).
...
-   Abra o volume da Actualização 14.1 do Microsoft Office para Mac 2011 na sua área de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
...
-   Quando a instalação tiver sido concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: "Verificação da Instalação da Actualização". Para remover o programa de instalação, primeiro arraste o volume da Actualização 14.1 do Microsoft Office para Mac 2011 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da Versão Instalada de Actualização Mais Recente for **14.1**, a actualização foi instalada com sucesso.
...
Transfira e instale a versão do idioma adequado para a Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.9, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=0c323a12-6385-4666-ad39-a9516a8eda14).
  
-   Feche todas as aplicações que esteja a executar, incluindo aplicações de protecção contra vírus, todas as aplicações Microsoft Office, Microsoft Messenger para Mac e Notificações do Office, porque podem interferir com a instalação.  
-   Abra o volume da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.9 no seu ambiente de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.9, faça duplo clique na aplicação da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.9 e siga as instruções no ecrã.  
-   Se a instalação foi concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: "Verificação da Instalação da Actualização". Para remover o programa de instalação, primeiro arraste o volume da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.9 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da versão for **1.1.9**, a actualização foi instalada com sucesso.
...
-   Alin Rad Pop, da [Secunia Research](http://secunia.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga de Número Inteiro no Excel (CVE-2011-0097)  
-   Alin Rad Pop, da [Secunia Research](http://secunia.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Excel (CVE-2011-0098)  
-   Muhammad Junaid Bohio, da [Telus Security Labs](http://www.telussecuritylabs.com), por fornecer informações sobre a Vulnerabilidade de WriteAV na Análise de Registos no Excel (CVE-2011-0101)  
-   Aniway, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de WriteAV na Análise de Registos no Excel (CVE-2011-0101)  
-   Investigador anónimo, a trabalhar com a [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Excel (CVE-2011-0103)  
-   Rodrigo Rubira Branco, da [Check Point Vulnerability Discovery Team](http://www.checkpoint.com/) (VDT), por fornecer informações sobre a Vulnerabilidade de Substituição de Memória Intermédia no Excel (CVE-2011-0104)  
-   Aniway, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Inicialização de Dados no Excel (CVE-2011-0105)  
-   Aniway, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Indexação de Matriz no Excel (CVE-2011-0978)  
-   Investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Lista com Ligações no Excel (CVE-2011-0979)  
-   Um investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Apontador Pendente no Excel (CVE-2011-0980)
