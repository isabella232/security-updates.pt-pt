...
ms:assetid: 'ms11-005'
ms:contentKeyID: 61234986
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-005(v=Security.10)'
---
...
Vulnerabilidade no Active Directory Poderia Permitir Negação de Serviço (2478953)
---------------------------------------------------------------------------------
...
Esta actualização de segurança resolve uma vulnerabilidade no Active Directory, divulgada publicamente. A vulnerabilidade poderia permitir negação de serviço se um intruso enviasse um pacote especialmente concebido para o efeito a um servidor Active Directory afectado. O intruso tem de ter privilégios de administrador local válidos no computador que faz parte do domínio para poder explorar esta vulnerabilidade.

Esta actualização de segurança está classificada como Importante para o Active Directory em todas as edições suportadas do Windows Server 2003. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o servidor Active Directory processa pedidos de actualização do nome do principal do serviço (SPN). Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
<td style="border:1px solid black;">Modo de Aplicações do Active Directory (ADAM)</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Serviços LDS do Active Directory (AD LDS)</td>
</tr>
<tr class="even">
...
Serviços LDS do Active Directory (AD LDS)</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">(ADAM, AD LDS e Active Directory não são componentes deste lançamento do Microsoft Windows)</td>
</tr>
<tr class="even">
...
<th style="border:1px solid black;" >Vulnerabilidade de Validação SPN no Active Directory - CVE-2011-0040</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Validação SPN no Active Directory - CVE-2011-0040  
--------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço em implementações do Active Directory no Microsoft Windows devido a validação incorrecta de nomes do principal do serviço (SPN), o que poderia resultar em colisões SPN. Quando isto se verifica, os serviços que utilizam o SPN são revertidos para NT LAN Manager (NTLM) se estiverem configurados para negociar. Os serviços que não estão configurados para negociar ficarão indisponíveis, resultando numa condição de negação de serviço. Um intruso que explorasse esta vulnerabilidade com sucesso poderia fazer com que o sistema afectado deixasse de responder.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040).
  
#### Factores Atenuantes para a Vulnerabilidade de Validação SPN no Active Directory - CVE-2011-0040
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Para explorar esta vulnerabilidade de negação de serviço, o intruso deve ser administrador de um computador que faça parte de um domínio.
  
#### Soluções Alternativas para a Vulnerabilidade de Validação SPN no Active Directory - CVE-2011-0040
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação SPN no Active Directory - CVE-2011-0040
  
**Qual é a abrangência desta vulnerabilidade?**    
Trata-se de uma reversão de autenticação, bem como de uma vulnerabilidade de negação de serviço. Um intruso que explorasse esta vulnerabilidade poderia fazer com que o sistema afectado fosse revertido de Kerberos para NT LAN Manager (NTLM) e, no pior dos casos, fazer com que o serviço deixasse de responder. Tenha em atenção que esta vulnerabilidade não permitiria que um intruso executasse o código ou elevasse os seus direitos de utilizador.
  
**O que provoca a vulnerabilidade?**    
O Active Directory processa incorrectamente pedidos especialmente concebidos para o efeito para actualizar o nome do principal do serviço (SPN) e pode resultar em colisões de nome no domínio.
...
**O que é o SPN?**    
Um nome do principal do serviço (SPN) é o nome pelo qual um cliente identifica exclusivamente uma instância de um serviço. Para mais informações sobre a utilização dos nomes dos principais dos serviços, consulte o artigo MSDN, [Nomes dos Principais dos Serviços](http://msdn.microsoft.com/en-us/library/ms677949(vs.85).aspx).
...
Um intruso que explorasse esta vulnerabilidade com sucesso poderia causar colisões de nome no domínio, fazendo com que a autenticação dos serviços que utilizam o SPN fossem revertidos para NTLM. Em configurações específicas nas quais o serviço não está configurado para negociar, o serviço ficará indisponível.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Um intruso poderia tentar explorar esta vulnerabilidade enviando pacotes especialmente concebidos para o efeito ao servidor Active Directory. O intruso tem de ter privilégios de administrador local válidos no computador que faz parte do domínio para poder explorar esta vulnerabilidade.
  
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**    
Esta vulnerabilidade afecta ambientes que executam o Active Directory no Windows Server 2003.
  
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade corrigindo a forma como o servidor Active Directory processa pedidos de actualização do nome do principal do serviço (SPN).
  
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2011-0040](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0040).
...
<td style="border:1px solid black;">Para o Active Directory em todas as edições suportadas de 32 bits do Windows Server 2003:<br />
WindowsServer2003-KB2478953-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory em todas as edições suportadas baseadas em x64 do Windows Server 2003:<br />
WindowsServer2003.WindowsXP-KB2478953-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory em todas as edições suportadas baseadas em Itanium do Windows Server 2003:<br />
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2478953$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2478953">Artigo 2478953 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
