...
ms:assetid: 'ms11-076'
ms:contentKeyID: 61235057
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-076(v=Security.10)'
---
...
Vulnerabilidade no Windows Media Center Poderia Permitir Execução Remota de Código (2604926)
--------------------------------------------------------------------------------------------
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=78c099b7-4bcb-4da7-8967-512c6541c541">Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1</a><br />
(KB2579686)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=60e50f72-4001-423c-831c-8ff1f1b8f090">Windows Media Center TV Pack para Windows Vista (edições de 32 bits</a>)[2]<br />
(KB2579692)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
...
O Windows Media Center TV Pack para Windows Vista só está disponível em instalações do fabricante de equipamento original (OEM) das edições Home Premium e Ultimate do Windows Vista como componente opcional. Os clientes que têm este componente opcional instalado em sistemas baseados em x64 devem instalar ambas as actualizações disponíveis. Para manter as melhores práticas, a Microsoft recomenda a instalação da actualização de sistema operativo (KB2579686) antes da instalação da actualização do Windows Media Center TV Pack (KB2579692). Os clientes que têm o Windows Media Center TV Pack instalado em sistemas de 32 bits apenas necessitam de instalar o KB2579692.
...
<span></span>
As seguintes classificações de gravidade presumem o potencial impacto máximo da vulnerabilidade. Para obter informações sobre a probabilidade de, no prazo 30 dias após a publicação deste boletim de segurança, ocorrer uma exploração da vulnerabilidade em relação à sua classificação de gravidade e impacto de segurança, consulte o Índice de Possibilidade de Exploração no [resumo dos boletins de Outubro](http://technet.microsoft.com/en-us/security/bulletin/ms11-oct). Para mais informações, consulte o [Índice de Possibilidade de Exploração da Microsoft](http://technet.microsoft.com/en-us/security/cc998259.aspx).
...
<th style="border:1px solid black;" >Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Media Center - CVE-2011-2009</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Media Center - CVE-2011-2009  
-------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Windows Media Center processa o carregamento de ficheiros DLL. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-2009](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2009).
  
#### Factores Atenuantes para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Media Center - CVE-2011-2009
...
#### Soluções Alternativas para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Media Center - CVE-2011-2009
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Media Center - CVE-2011-2009
...
A vulnerabilidade resulta do facto de o Windows Media Player restringir incorrectamente o caminho utilizado ao carregar bibliotecas externas.
...
Um intruso poderia convencer um utilizador a abrir um ficheiro legítimo localizado no mesmo directório de rede que um ficheiro de biblioteca de hiperligação dinâmica (DLL) especialmente concebido. Nessa altura, ao abrir o ficheiro legítimo, o Windows Media Center poderia tentar carregar o ficheiro DLL e executar qualquer código aí contido.
  
Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade ao enviar um ficheiro legítimo para um utilizador e convencer o mesmo a colocar o anexo num directório que contenha um ficheiro DLL especialmente concebido, para depois a abrir o ficheiro legítimo. Nessa altura, ao abrir o ficheiro legítimo, o Windows Media Center poderia tentar carregar o ficheiro DLL e executar qualquer código aí contido.
...
A actualização resolve esta vulnerabilidade corrigindo a forma como o Windows Media Center carrega bibliotecas externas.
...
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2011-2009](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2009).
...
Faça a gestão do software e actualizações de segurança de que necessita para implementação em servidores, ambientes de trabalho e sistemas portáteis na sua organização. Para mais informações, visite o [TechNet Update Management Center](http://go.microsoft.com/fwlink/?linkid=69903). O [Web site Microsoft TechNet Security](http://go.microsoft.com/fwlink/?linkid=21132) fornece informações adicionais sobre segurança em produtos Microsoft.
...
**Nota** Para clientes que utilizam software antigo não suportado pela versão mais recente do MBSA, Microsoft Update e Windows Server Update Services, visite [Microsoft Baseline Security Analyzer](http://www.microsoft.com/technet/security/tools/mbsahome.mspx) e consulte a secção Legacy Product Support (Suporte para Produtos Antigos) sobre como criar uma detecção de actualizações de segurança abrangentes com ferramentas antigas.
  
**Windows Server Update Services**
  
O Windows Server Update Services (WSUS) permite que os administradores de tecnologia de informação implementem as actualizações mais recentes de produtos da Microsoft em computadores que estejam a executar o sistema operativo Windows. Para mais informações sobre como implementar actualizações de segurança utilizando o Windows Server Update Services, consulte o artigo TechNet sobre os [Windows Server Update Services](http://technet.microsoft.com/en-us/wsus/default.aspx).
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2579686">Artigo 2579686 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2579692">Artigo 2579692 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;"><strong>Nota</strong> Não existe uma chave de registo para validar a presença desta actualização.</td>
