...
ms:assetid: 'ms09-017'
ms:contentKeyID: 61234736
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-017(v=Security.10)'
---
...
Vulnerabilidades no Microsoft Office PowerPoint poderiam permitir Execução Remota de Código (967340)
----------------------------------------------------------------------------------------------------

Data de publicação: 12 de maio de 2009 | Updated: 9 de junho de 2009
...
Esta actualização de segurança corrige uma vulnerabilidade divulgada publicamente e várias vulnerabilidades no Microsoft Office PowerPoint, comunicadas de forma privada, que poderiam permitir execução remota de código se um utilizador abrisse um ficheiro PowerPoint especialmente concebido para o efeito. Um intruso que conseguisse tirar partido de qualquer uma destas vulnerabilidades poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Esta actualização de segurança está classificada como Crítica para edições suportadas do Microsoft Office PowerPoint 2000. Para edições suportadas do Microsoft Office PowerPoint 2002, Microsoft Office PowerPoint 2003, Microsoft Office PowerPoint 2007, Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac, Conversor de Formato de Ficheiros Open XML para Mac, todas as versões suportadas do PowerPoint Viewer, Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007, Microsoft Works 8.5 e Microsoft Works 9, esta actualização de segurança está classificada como Importante. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades modificando a forma como o PowerPoint processa condições que poderiam causar corrupção de memória ao abrir ficheiros PowerPoint especialmente concebidos para o efeito. Esta actualização também resolve as vulnerabilidades impedindo que o Microsoft Office PowerPoint 2000 e o Microsoft Office PowerPoint 2002 abram formatos de ficheiros nativos do PowerPoint 4.0. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.

Esta actualização de segurança também resolve a vulnerabilidade descrita previamente no [Aviso de Segurança da Microsoft 969136](http://technet.microsoft.com/security/advisory/969136).

**Recomendação.** A Microsoft recomenda que os clientes apliquem de imediato a actualização.

**Questões conhecidas.** O [Artigo 967340 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/967340) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
<tr>
<td style="border:1px solid black;">
[Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=e1d3a4c3-538a-4f98-8d60-250803a80e2a)  
(KB969618)
</td>
<td style="border:1px solid black;">
Não aplicável
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e1d3a4c3-538a-4f98-8d60-250803a80e2a)  
(KB969618)
</td>
<td style="border:1px solid black;">
Não aplicável
...
<span></span>
**Por que razão foi relançado este boletim a 9 de Junho de 2009? **
A Microsoft relançou este boletim de segurança para fornecer pacotes de actualizações de segurança para o Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac, Conversor de Formato de Ficheiros Open XML para Mac, Microsoft Works 8.5 e Microsoft Works 9. Os clientes que já tenham actualmente este software instalado necessitam de aplicar esta actualização imediatamente.
Quando este boletim foi originalmente publicado, estes pacotes de actualizações de segurança ainda estavam a ser desenvolvidos. Na altura, a Microsoft publicou este boletim porque tinha pacotes de actualizações prontos no ciclo regular de publicação de boletins para uma linha completa de produtos, de forma a proteger a grande maioria dos clientes em risco. A publicação actual completa agora a gama de actualizações do software afectado pelas vulnerabilidades discutidas neste boletim.

**Os boletins MS09-021 e MS09-027 também descrevem vulnerabilidades no Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac e Conversor de Formato de Ficheiros Open XML para Mac. Como é que o MS09-021 e o MS09-027 se relacionam com este boletim (MS09-017)?**  
Os pacotes de actualização de segurança para o Microsoft Office 2004 para Mac (KB969661), Microsoft Office 2008 para Mac (KB971822) e Conversor de Formato de Ficheiros Open XML para Mac (KB971824) neste boletim, MS09-017, também resolvem as vulnerabilidades descritas nos boletins [MS09-021](http://go.microsoft.com/fwlink/?linkid=147294) e [MS09-027](http://go.microsoft.com/fwlink/?linkid=147416). Os utilizadores com o Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac ou Conversor de Formato de Ficheiro Open XML para Mac instalado apenas necessitarão de instalar os pacotes de actualização uma vez.

**O MS09-024 também descreve vulnerabilidades no Microsoft Works 8.5 e Microsoft Works 9. Como é que o MS09-024 se relaciona com este boletim (MS09-017)?**  
Os pacotes de actualização de segurança para o Microsoft Works 8.5 (KB967043) e Microsoft Works 9 (KB967044) neste boletim, MS09-017, também resolvem as vulnerabilidades descritas no boletim [MS09-024](http://go.microsoft.com/fwlink/?linkid=128104). Os utilizadores com o Microsoft Works 8.5 ou Microsoft Works 9 instalado apenas necessitarão de instalar os pacotes de actualização uma vez.

**Onde estão os pormenores sobre as informações do ficheiro?**  
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 967340 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/967340).

**Os utilizadores têm de agir de forma especial em relação aos formatos de ficheiros do PowerPoint 4.0?**  
Com esta actualização, a possibilidade de abrir formatos de ficheiros do PowerPoint 4.0 estará desactivada por predefinição no Microsoft Office PowerPoint 2000 e no Microsoft Office PowerPoint 2002. Esta funcionalidade já foi desactivada por predefinição no Microsoft Office PowerPoint 2003 Service Pack 3. Esta funcionalidade deixou de existir no Microsoft Office PowerPoint 2007. Para obter mais informações sobre esta alteração, consulte o [Artigo 970980 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/970980).
...
**Por que razão esta actualização é Crítica para o PowerPoint 2000, mas apenas Importante para todas as outras versões do PowerPoint afectadas?**  
...
<th style="border:1px solid black;" >
Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0220
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Excesso de Número Inteiro - CVE-2009-0221
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0222
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0223
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória - CVE-2009-0224
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-0225
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0226
</th>
</tr>
<tr>
<th colspan="8">
...
<th style="border:1px solid black;" >
Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0227
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória - CVE-2009-0556
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-1128
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-1129
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção na Área Dinâmica para Dados - CVE-2009-1130
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Dados Fora dos Limites - CVE-2009-1131
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-1137
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada (incluindo a Parte 1)
</th>
</tr>
<tr>
<th colspan="9">
...
**Nota** A Classificação de Gravidade Agregada é a classificação de gravidade mais elevada da Parte 1 e da Parte 2 da tabela.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0220](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0220).

#### Factores Atenuantes para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0220

A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   O Microsoft Office 2003 Service Pack 3 bloqueia a abertura e a gravação de determinados ficheiros por predefinição na instalação. Para o Microsoft Office PowerPoint 2003 Service Pack 3, estes são os ficheiros anteriores ao PowerPoint 97 e que têm tipos de ficheiro como .ppt, .pot, .pps e .ppa. Note que esta funcionalidade não se aplica a ficheiros do Microsoft Office PowerPoint 97. Para obter mais informações, consulte o [Artigo 938810 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/938810).
...
-   Esta vulnerabilidade não afecta o PowerPoint 2007, PowerPoint Viewer 2003 e PowerPoint Viewer 2007.

#### Soluções Alternativas para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0220

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Restringir o acesso ao pp4x322.dll no Microsoft Office PowerPoint 2000 ou Microsoft Office PowerPoint 2002**

    **Nota** Terá de ter privilégios de administrador para configurar estas restrições de ficheiros.

    -   Em edições de 32 bits do Microsoft Windows 2000, Windows XP e Windows Server 2003, execute o seguinte comando a partir de uma linha de comandos:

        for /F "tokens=\*" %G IN ('dir /b /s ^"%programfiles%\\Microsoft Office\\pp4x322.dll^"') DO cacls "%G" /E /P everyone:N

    -   Em edições de 64 bits do Windows XP e Windows Server 2003, execute o seguinte comando a partir de uma linha de comandos:

        for /F "tokens=\*" %G IN ('dir /b /s ^"%programfiles(x86)%\\Microsoft Office\\pp4x322.dll^"') DO cacls "%G" /E /P everyone:N

    -   Em edições de 32 bits do Windows Vista e Windows Server 2008, execute o seguinte comando a partir de uma linha de comandos com privilégios elevados:

        for /F "tokens=\*" %G IN ('dir /b /s ^"%programfiles%\\Microsoft Office\\pp4x322.dll^"') DO cacls "%G" /E /P everyone:N

    -   Em edições de 64 bits do Windows Vista e Windows Server 2008, execute o seguinte comando a partir de uma linha de comandos com privilégios elevados:

        for /F "tokens=\*" %G IN ('dir /b /s ^"%programfiles(x86)%\\Microsoft Office\\pp4x322.dll^"') DO cacls "%G" /E /P everyone:N

    **Impacto da Solução Alternativa.** Não será possível abrir ficheiros do PowerPoint 4.0.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0220
...
Quando o PowerPoint lê dados de formatação de parágrafos de ficheiros PowerPoint 4.0 especialmente concebidos para o efeito, um erro pode corromper a memória de tal modo que um intruso poderia executar código arbitrário.
...
Esta vulnerabilidade requer que um utilizador abra um ficheiro PowerPoint 4.0 especialmente concebido para o efeito usando uma versão afectada do Microsoft Office PowerPoint.
...
Os sistemas em que é utilizada uma versão afectada do Microsoft Office PowerPoint, como estações de trabalho ou servidores de terminais, estão mais susceptíveis. Os servidores podem estar mais sujeitos a risco se os administradores permitirem que os utilizadores iniciem sessão nos servidores e executem programas. Contudo, os procedimentos recomendados desencorajam essa acção.

**O que faz a actualização?**  
Esta actualização impede o Microsoft Office PowerPoint 2000 e o Microsoft Office PowerPoint 2002 de abrir formatos de ficheiros nativos do PowerPoint 4.0.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0221](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0221).

#### Factores Atenuantes para a Vulnerabilidade de Excesso de Número Inteiro - CVE-2009-0221
...
#### Soluções Alternativas para a Vulnerabilidade de Excesso de Número Inteiro - CVE-2009-0221
...
-   **Utilize a política do File Block do Microsoft Office para bloquear a abertura de documentos do Office 2003 e de versões anteriores que provenham de fontes ou localizações desconhecidas ou não fidedignas**
    ...
    **Impacto da solução alternativa:** Os utilizadores que tiverem configurado a política de Bloqueio de Ficheiros e não tiverem configurado um “directório de isenção” especial, tal como discutido no [Artigo 970980 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/970980), não poderão abrir ficheiros do Office 2003 ou de versões anteriores no Office 2003 ou no Microsoft Office System 2007.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Excesso de Número Inteiro - CVE-2009-0221

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
Quando o PowerPoint lê um tipo de registo inválido num ficheiro PowerPoint especialmente concebido para o efeito, um erro pode corromper a memória de tal modo que um intruso poderia executar código arbitrário.
...
**O que faz a actualização?**  
A actualização modifica a forma como o PowerPoint valida os tipos de registos ao abrir ficheiros PowerPoint.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0222).

#### Factores Atenuantes para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0222
...
#### Soluções Alternativas para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0222
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0222

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
Quando o PowerPoint lê dados de som de ficheiros PowerPoint 4.0 especialmente concebidos para o efeito, um erro pode corromper a memória de tal modo que um intruso poderia executar código arbitrário.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0223](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0223).

#### Factores Atenuantes para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0223
...
#### Soluções Alternativas para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0223
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0223
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0224](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0224).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória – CVE-2009-0224
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória – CVE-2009-0224
...
**O que faz a actualização?**  
A actualização modifica a forma como o PowerPoint valida registos de listas ao abrir ficheiros PowerPoint.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0225](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0225).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-0225
...
-   No cenário de um ataque baseado na Web, um intruso poderia alojar um Web site contendo uma página Web que fosse utilizada para explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Em vez disso, um intruso teria de convencer os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico, ou num programa de mensagens instantâneas, que levasse o utilizador para o Web site do intruso.
-   Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
-   Esta vulnerabilidade não afecta o PowerPoint 2000, PowerPoint 2003, PowerPoint 2007, PowerPoint Viewer 2003 e PowerPoint Viewer 2007.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-0225

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Restringir o acesso ao pp7x32.dll no Microsoft Office PowerPoint 2002**
    ...
    **Impacto da Solução Alternativa.** Não será possível abrir ficheiros do PowerPoint 95.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-0225

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
Quando o PowerPoint lê dados de som de ficheiros PowerPoint 95 especialmente concebidos para o efeito, um erro pode corromper a memória de tal modo que um intruso poderia executar código arbitrário.

**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado no contexto do utilizador com sessão iniciada no momento. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**Como poderia um intruso explorar a vulnerabilidade?**  
Esta vulnerabilidade requer que um utilizador abra um ficheiro PowerPoint 95 especialmente concebido para o efeito usando uma versão afectada do Microsoft Office PowerPoint.
...
**O que faz a actualização?**  
Esta actualização modifica a forma como o Microsoft Office PowerPoint 2002 abre formatos de ficheiros nativos do PowerPoint 95.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0226](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0226).

#### Factores Atenuantes para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0226
...
#### Soluções Alternativas para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0226
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0226
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0227](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0227).

#### Factores Atenuantes para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0227
...
#### Soluções Alternativas para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0227
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-0227
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0556).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória – CVE-2009-0556
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória – CVE-2009-0556

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada por uma corrupção de memória quando o PowerPoint lê um valor de indexação inválido num ficheiro PowerPoint especialmente concebido para o efeito. O erro resultante pode corromper a memória de tal modo que um intruso poderia executar código arbitrário.
...
**O que faz a actualização?**  
A actualização remove a vulnerabilidade modificando a forma como o PowerPoint valida atribuições de memória ao abrir ficheiros PowerPoint.

**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2009-0556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0556). Esta vulnerabilidade foi previamente descrita no [Aviso de Segurança da Microsoft 969136](http://technet.microsoft.com/security/advisory/969136).
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1128](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1128).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-1128
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-1128

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Restringir o acesso ao pp7x32.dll no Microsoft Office PowerPoint 2000 ou Microsoft Office PowerPoint 2002**
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-1128

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
Esta vulnerabilidade provoca corrupção de memória durante a leitura de dados de som de ficheiros de formatos PowerPoint 95 anteriores especialmente concebidos para o efeito.
...
**O que faz a actualização?**  
Esta actualização modifica a forma como o Microsoft Office PowerPoint 2000, Microsoft Office PowerPoint 2002 e Microsoft Office PowerPoint 2003 abrem formatos de ficheiros nativos do PowerPoint 95.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1129](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1129).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-1129
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-1129
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no PP7 - CVE-2009-1129
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1130](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1130).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção na Área Dinâmica para Dados – CVE-2009-1130
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção na Área Dinâmica para Dados – CVE-2009-1130
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção na Área Dinâmica para Dados – CVE-2009-1130

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é provocada por uma corrupção de memória quando o PowerPoint lê um valor de estrutura mal formado num ficheiro PowerPoint especialmente concebido para o efeito. O erro resultante pode corromper a memória de tal modo que um intruso poderia executar código arbitrário.
...
**O que faz a actualização?**  
Esta actualização resolve a vulnerabilidade modificando a forma como o Microsoft Office PowerPoint valida a estrutura de memória vulnerável ao abrir ficheiros PowerPoint.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1131](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1131).

#### Factores Atenuantes para a Vulnerabilidade de Dados Fora dos Limites - CVE-2009-1131
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Dados Fora dos Limites - CVE-2009-1131

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
Quando o Microsoft Office PowerPoint lê dados demasiado grandes num ficheiro PowerPoint especialmente concebido para o efeito, um erro pode corromper a memória de tal modo que um intruso poderia executar código arbitrário.
...
**O que faz a actualização?**  
Esta actualização remove a vulnerabilidade modificando a forma como o Microsoft Office PowerPoint valida atribuições de memória ao abrir ficheiros PowerPoint.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1137](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1137).

#### Factores Atenuantes para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-1137
...
#### Soluções Alternativas para a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-1137
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores - CVE-2009-1137
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/967340">Artigo 967340 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
#### PowerPoint 2007 (todas as edições), PowerPoint Viewer 2003, PowerPoint Viewer 2007 (todas as edições) e Pack de Compatibilidade do Office para formatos de ficheiros Word, Excel e PowerPoint 2007 (todas as versões)
...
<br />
Para Pack de Compatibilidade do Office:<br />
...
-   Investigador anónimo, a trabalhar com a [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores (CVE-2009-0220)  
-   Sean Larsson, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Excesso de Número Inteiro (CVE-2009-0221)  
-   Nicolas Joly, da [VUPEN Security](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores (CVE-2009-0222)  
-   Marsu Pilami, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores (CVE-2009-0223)  
-   Sean Larsson, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória (CVE-2009-0224)  
-   Nicolas Joly, da [VUPEN Security](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no PP7 (CVE-2009-0225)  
-   Marsu Pilami, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores (CVE-2009-0226)  
-   Marsu Pilami, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores (CVE-2009-0227)  
-   Marsu Pilami, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória (CVE-2009-0556)  
-   Marsu Pilami, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no PP7 (CVE-2009-1128)  
-   Marsu Pilami, da [VeriSign iDefense Labs](http://labs.idefense.com/), for fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no PP7 (CVE-2009-1129)  
-   Ling e Wushi, da [team509](http://www.team509.com/), a trabalhar com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), e Sean Larsson, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecerem informações sobre a Vulnerabilidade de Corrupção na Área Dinâmica para Dados (CVE-2009-1130)  
-   Carsten H. Eiram, da [Secunia](http://secunia.com/), por fornecer informações sobre a Vulnerabilidade de Dados Fora dos Limites (CVE-2009-1131)  
-   Investigador anónimo, a trabalhar com a [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Formatos de Ficheiros de Versões Anteriores (CVE-2009-1137)
...
-   V1.1 (13 de Maio de 2009): Entrada na tabela de Software Afectado para os "Boletins substituídos por esta actualização" e informações relativas à detecção e implementação do SMS para a actualização do PowerPoint Viewer 2003 (KB969615) corrigidas. Foi também removida uma nota de rodapé errada da tabela de Software Afectado referente às actualizações de segurança KB969618 e KB957789 para versões suportadas do Microsoft Office PowerPoint 2007. Trata-se de uma alteração informativa apenas. Não foram efectuadas alterações à detecção ou aos ficheiros incluídos nesta actualização.  
-   V2.0 (9 de Junho de 2009): Boletim relançado para fornecer pacotes de actualizações de segurança para o Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac, Conversor de Formato de Ficheiros Open XML para Mac, Microsoft Works 8.5 e Microsoft Works 9. Os clientes que já tenham actualmente este software instalado necessitam de aplicar esta actualização imediatamente.
