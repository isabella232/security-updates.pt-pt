...
ms:assetid: 'ms09-067'
ms:contentKeyID: 61234786
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-067(v=Security.10)'
---
...
Vulnerabilidades no Microsoft Office Excel poderiam permitir Execução Remota de Código (972652)
-----------------------------------------------------------------------------------------------
...
\*Para o Microsoft Office Excel 2007 Service Pack 1 e o Microsoft Office Excel 2007 Service Pack 2, para além do pacote de actualização de segurança KB973593, os clientes têm também de instalar a actualização de segurança para o [Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 Service Pack 1 e o Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa) (KB973704) para estarem protegidos contra as vulnerabilidades descritas neste boletim.
...
O [Artigo 972652 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/972652) documenta as questões actualmente conhecidas que os clientes poderão verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.

**Esta actualização contém alterações não relacionadas com segurança em termos de funcionalidade?**  
Sim. Depois de esta actualização de segurança ter sido instalada, se um utilizador abrir um ficheiro Excel especialmente concebido para o efeito, o Excel pode fechar inesperadamente, mas as vulnerabilidades corrigidas nesta actualização não poderão ser exploradas.
...
**O boletim MS09-068 também descreve vulnerabilidades no Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac e Conversor de Formato de Ficheiros Open XML para Mac. Como é que o MS09-068 se relaciona com este boletim (MS09-067)?**  
Os pacotes de actualização de segurança neste boletim, MS09-067, para o Microsoft Office 2004 para Mac (KB976830), Microsoft Office 2008 para Mac (KB976828) e Conversor de Formato de Ficheiros Open XML para Mac (KB976831) também resolvem as vulnerabilidades descritas no boletim MS09-068. Os utilizadores com o Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac ou Conversor de Formato de Ficheiros Open XML para Mac instalado apenas necessitarão de instalar estes pacotes de actualização de segurança uma vez.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória na Cache do Excel - CVE-2009-3127
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no SxView do Excel - CVE-2009-3128
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no Registo Featheader do Excel - CVE-2009-3129
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados na Análise de Documentos Excel - CVE-2009-3130
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória na Análise de Fórmulas Excel - CVE-2009-3131
</th>
<th style="border:1px solid black;" >
Vulnerabilidade na Análise de Índice no Excel - CVE-2009-3132
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória na Análise de Documentos Excel - CVE-2009-3133
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Sanitização de Campo no Excel - CVE-2009-3134
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-3127](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória na Cache do Excel - CVE-2009-3127
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória na Cache do Excel - CVE-2009-3127
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória na Cache do Excel - CVE-2009-3127
...
Existe uma vulnerabilidade na forma como o Microsoft Office Excel analisa o formato de ficheiro da folha de cálculo Excel ao abrir uma folha de cálculo Excel especialmente concebida para o efeito.
...
A exploração desta vulnerabilidade requer que um utilizador abra uma folha de cálculo Excel especialmente concebida para o efeito usando uma versão afectada do Microsoft Office Excel.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Office Excel processa ficheiros Excel especialmente concebidos para o efeito que incluem um objecto de registo mal formado. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-3128](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no SxView do Excel - CVE-2009-3128
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no SxView do Excel - CVE-2009-3128
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no SxView do Excel - CVE-2009-3128
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-3129](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Registo Featheader do Excel - CVE-2009-3129
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Registo Featheader do Excel - CVE-2009-3129
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Registo Featheader do Excel - CVE-2009-3129
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Office Excel processa ficheiros Excel especialmente concebidos para o efeito com registos BIFF mal formados. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-3130](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130).

#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados na Análise de Documentos Excel - CVE-2009-3130
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados na Análise de Documentos Excel - CVE-2009-3130

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados na Análise de Documentos Excel - CVE-2009-3130

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado remotamente. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade existe porque o Excel processa incorrectamente ficheiros Excel com registos BIFF (Binary File Format) mal formados, o que poderia resultar na corrupção da memória de tal modo que permitiria que um intruso executasse código arbitrário.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Office Excel analisa documentos que contêm uma fórmula incorporada especialmente concebida para o efeito dentro de um célula. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou criar novas contas com todos os privilégios no contexto do utilizador com sessão iniciada no momento.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-3131](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória na Análise de Fórmulas Excel - CVE-2009-3131
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória na Análise de Fórmulas Excel - CVE-2009-3131

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória na Análise de Fórmulas Excel - CVE-2009-3131

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado remotamente. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
Existe uma vulnerabilidade na forma como o Microsoft Office Excel analisa a folha de cálculo Excel que contém uma fórmula especialmente concebida para o efeito.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-3132](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132).

#### Factores Atenuantes para a Vulnerabilidade na Análise de Índice no Excel - CVE-2009-3132
...
#### Soluções Alternativas para a Vulnerabilidade na Análise de Índice no Excel - CVE-2009-3132

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade na Análise de Índice no Excel - CVE-2009-3132
...
**O que faz a actualização?**  
Esta actualização resolve a vulnerabilidade alterando a forma como o Microsoft Office Excel processa a abertura de ficheiros Excel especialmente concebidos para o efeito.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-3133](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória na Análise de Documentos Excel - CVE-2009-3133
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória na Análise de Documentos Excel - CVE-2009-3133

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória na Análise de Documentos Excel - CVE-2009-3133
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-3134](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134).

#### Factores Atenuantes para a Vulnerabilidade de Sanitização de Campo no Excel - CVE-2009-3134
...
#### Soluções Alternativas para a Vulnerabilidade de Sanitização de Campo no Excel - CVE-2009-3134
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sanitização de Campo no Excel - CVE-2009-3134
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/973471">Artigo 973471 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para Excel 2003:<br />
Consulte o <a href="http://support.microsoft.com/kb/973475">Artigo 973475 da Base de Dados de Conhecimento da Microsoft</a><br />
<br />
Para Excel Viewer 2003:<br />
Consulte o <a href="http://support.microsoft.com/kb/973484">Artigo 973484 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para Excel 2007:<br />
Consulte o <a href="http://support.microsoft.com/kb/973593">Artigo 973593 da Base de Dados de Conhecimento da Microsoft</a><br />
<br />
Para Excel Viewer:<br />
Consulte o <a href="http://support.microsoft.com/kb/973707">Artigo 973707 da Base de Dados de Conhecimento da Microsoft</a><br />
<br />
Para Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007:<br />
Consulte o <a href="http://support.microsoft.com/kb/973704">Artigo 973704 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
-   Bing Liu, da [FortiGuard Labs da Fortinet](http://www.fortiguard.com), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória na Cache do Excel (CVE-2009-3127)  
-   [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecerem informações sobre a Vulnerabilidade de Corrupção de Memória na Cache do Excel (CVE-2009-3127)  
-   Bing Liu, da [FortiGuard Labs da Fortinet](http://www.fortiguard.com), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no SxView do Excel (CVE-2009-3128)  
-   Sean Larsson, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Registo Featheader do Excel (CVE-2009-3129)  
-   Nicolas Joly, da [VUPEN Security](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados na Análise de Documentos Excel (CVE-2009-3130)  
-   Nicolas Joly, da [VUPEN Security](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória na Análise de Fórmulas Excel (CVE-2009-3131)  
-   Nicolas Joly, da [VUPEN Security](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade na Análise de Índice no Excel (CVE-2009-3132)  
-   Nicolas Joly, da [VUPEN Security](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória na Análise de Documentos Excel (CVE-2009-3133)  
-   Bing Liu, da [FortiGuard Labs da Fortinet](http://www.fortiguard.com), por fornecer informações sobre a Vulnerabilidade de Sanitização de Campo no Excel (CVE-2009-3134)
