...
ms:assetid: 'ms09-019'
ms:contentKeyID: 61234738
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-019(v=Security.10)'
---
...
Actualização de Segurança Cumulativa para o Internet Explorer (969897)
----------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Crítica para o Internet Explorer 5.01 e como Importante para o Internet Explorer 6 Service Pack 1, executado em edições suportadas do Microsoft Windows 2000; Crítica para o Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 executados em edições suportadas do Windows XP e Windows Vista; e Moderada para o Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 executados em edições suportadas do Windows Server 2003 e Windows Server 2008. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve estas vulnerabilidades modificando a forma como o Internet Explorer processa scripts e conteúdo na cache, para além da forma como é inicializada a memória. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes na secção seguinte, **Informações sobre as vulnerabilidades**.
...
<td style="border:1px solid black;">
[Nenhum](http://go.microsoft.com/fwlink/?linkid=146659)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 969897 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/969897).
...
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações Entre Domínios com Condição Race - CVE-2007-3091
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2009-1140
</th>
<th style="border:1px solid black;" >
Corrupção de Memória de Objecto DHTML - CVE-2009-1141
</th>
<th style="border:1px solid black;" >
Corrupção de Memória de Objecto HTML - CVE-2009-1528
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-1529
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2009-1530
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2009-1531
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2009-1532
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<span></span>
Existe uma vulnerabilidade de divulgação de informações no Internet Explorer que poderia permitir que um script obtivesse acesso ao conteúdo noutra janela do browser noutro domínio ou zona do Internet Explorer. Um intruso poderia explorar a vulnerabilidade construindo uma página Web especialmente concebida para o efeito que pudesse permitir a divulgação de informações se um utilizador visualizasse essa página. Um intruso que explorasse esta vulnerabilidade poderia visualizar dados de uma página Web noutro domínio do Internet Explorer.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2007-3091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações Entre Domínios com Condição Race - CVE-2007-3091
...
#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações Entre Domínios com Condição Race - CVE-2007-3091
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações Entre Domínios com Condição Race - CVE-2007-3091

**Qual é a abrangência desta vulnerabilidade?**  
Trata-se de uma vulnerabilidade ao nível da divulgação de informações. Um intruso que explorasse esta vulnerabilidade com sucesso quando um utilizador visualizasse uma página Web poderia visualizar o conteúdo noutra janela do browser noutro domínio ou zona do Internet Explorer distinta do domínio ou zona do intruso.

**O que provoca a vulnerabilidade?**  
O script pode criar uma condição race capaz de quebrar a política de mesma origem do Internet Explorer e ler conteúdo de diferentes domínios.

**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso poderia visualizar o conteúdo noutra janela do browser num domínio ou zona do Internet Explorer diferente da zona ou domínio do intruso.
...
A actualização modifica a forma como o Internet Explorer identifica o domínio de um script executado, restringindo a sua execução ao contexto do respectivo domínio original.

**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2007-3091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091).
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1140](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1140).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2009-1140
...
-   Utilizar o Windows Internet Explorer 7 no Windows Vista ou Windows Server 2008 atenua os efeitos desta vulnerabilidade.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2009-1140
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1141](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1141).

#### Factores Atenuantes para a Corrupção de Memória de Objecto DHTML - CVE-2009-1141
...
-   Como pré-definição, todas as versões suportadas do Microsoft Outlook e do Microsoft Outlook Express abrem mensagens de correio electrónico em HTML na zona de Sites restritos. A zona de Sites restritos ajuda a atenuar ataques que tentem explorar esta vulnerabilidade, ao impedir a utilização de Scripts Activos e controlos ActiveX durante a leitura de mensagens de correio electrónico em HTML. Contudo, se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003 e no Windows Server 2008 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://go.microsoft.com/fwlink/?linkid=92039). Este modo define o nível de segurança para a zona da Internet como Alto. Este é um factor atenuante para Web sites que não adicionou à Zona de sites fidedignos do Internet Explorer. Consulte a subsecção de Perguntas Mais Frequentes desta secção da vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Microsoft Internet Explorer 5.01 Service Pack 4 e o Microsoft Internet Explorer 6 Service Pack 1 executados no Microsoft Windows 2000, o Windows Internet Explorer 7 e Windows Internet Explorer 8 não são afectados por esta vulnerabilidade.

#### Soluções Alternativas para a Corrupção de Memória de Objecto DHTML - CVE-2009-1141
...
#### Perguntas Mais Frequentes sobre a Corrupção de Memória de Objecto DHTML - CVE-2009-1141
...
**O que provoca a vulnerabilidade?**  
Quando o Internet Explorer apresenta uma página Web com chamadas inesperadas de método para objectos HTML, a memória do sistema pode ser danificada de tal modo que um intruso poderia executar código arbitrário.
...
**O que é o DHTML?**
O HTML Dinâmico (DHTML) é um conjunto de funções originalmente introduzido pela Microsoft no Internet Explorer 4.0 que permite a autores alterarem dinamicamente o processamento e conteúdo de páginas Web à medida que os utilizados interagem com elas. Para mais informações, consulte o artigo MSDN sobre [Objectos DHTML](http://msdn.microsoft.com/en-us/library/ms533054(vs.85).aspx).
...
**O que faz a actualização?**  
A actualização modifica a forma como o Internet Explorer processa objectos DHTML.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1528](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1528).

#### Factores Atenuantes para a Corrupção de Memória de Objecto HTML - CVE-2009-1528
...
-   Como pré-definição, todas as versões suportadas do Microsoft Outlook e do Microsoft Outlook Express abrem mensagens de correio electrónico em HTML na zona de Sites restritos. A zona de Sites restritos ajuda a atenuar ataques que tentem explorar esta vulnerabilidade, ao impedir a utilização de Scripts Activos e controlos ActiveX durante a leitura de mensagens de correio electrónico em HTML. Contudo, se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003 e no Windows Server 2008 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://go.microsoft.com/fwlink/?linkid=92039). Este modo define o nível de segurança para a zona da Internet como Alto. Este é um factor atenuante para Web sites que não adicionou à Zona de sites fidedignos do Internet Explorer. Consulte a subsecção de Perguntas Mais Frequentes desta secção da vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Microsoft Internet Explorer 5.01 Service Pack 4 e o Microsoft Internet Explorer 6.0 Service Pack 1 executados no Microsoft Windows 2000 e Windows Internet Explorer 8 não são afectados por esta vulnerabilidade.

#### Soluções Alternativas para a Corrupção de Memória de Objecto HTML - CVE-2009-1528
...
#### Perguntas Mais Frequentes sobre a Corrupção de Memória de Objecto HTML - CVE-2009-1528
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1529).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-1529
...
-   Como pré-definição, todas as versões suportadas do Microsoft Outlook e do Microsoft Outlook Express abrem mensagens de correio electrónico em HTML na zona de Sites restritos. A zona de Sites restritos ajuda a atenuar ataques que tentem explorar esta vulnerabilidade, ao impedir a utilização de Scripts Activos e controlos ActiveX durante a leitura de mensagens de correio electrónico em HTML. Contudo, se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003 e no Windows Server 2008 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://go.microsoft.com/fwlink/?linkid=92039). Este modo define o nível de segurança para a zona da Internet como Alto. Este é um factor atenuante para Web sites que não adicionou à Zona de sites fidedignos do Internet Explorer. Consulte a subsecção de Perguntas Mais Frequentes desta secção da vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Microsoft Internet Explorer 5.01 Service Pack 4 e o Microsoft Internet Explorer 6.0 Service Pack 1 executados no Microsoft Windows 2000, Microsoft Internet Explorer 6.0 e Windows Internet Explorer 8 não são afectados por esta vulnerabilidade.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-1529
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1530).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2009-1530
...
-   Como pré-definição, todas as versões suportadas do Microsoft Outlook e do Microsoft Outlook Express abrem mensagens de correio electrónico em HTML na zona de Sites restritos. A zona de Sites restritos ajuda a atenuar ataques que tentem explorar esta vulnerabilidade, ao impedir a utilização de Scripts Activos e controlos ActiveX durante a leitura de mensagens de correio electrónico em HTML. Contudo, se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003 e no Windows Server 2008 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://go.microsoft.com/fwlink/?linkid=92039). Este modo define o nível de segurança para a zona da Internet como Alto. Este é um factor atenuante para Web sites que não adicionou à Zona de sites fidedignos do Internet Explorer. Consulte a subsecção de Perguntas Mais Frequentes desta secção da vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Microsoft Internet Explorer 5.01 Service Pack 4, o Microsoft Internet Explorer 6.0,o Microsoft Internet Explorer 6.0 Service Pack 1 e o Windows Internet Explorer 8 não são afectados por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2009-1530
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2009-1530

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**O que provoca a vulnerabilidade?**  
Quando o Internet Explorer tenta aceder a memória não inicializada pode, em determinadas condições, corromper a memória de tal modo que um intruso poderia executar código arbitrário.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1531](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1531).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2009-1531
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2009-1531
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2009-1531
...
Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2009-1532
-----------------------------------------------------------------------

<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acede a um objecto que não tenha sido inicializado correctamente ou que tenha sido eliminado. Um intruso poderia explorar a vulnerabilidade criando uma página web especialmente concebida para o efeito. Quando um utilizador visualizasse a página Web, a vulnerabilidade poderia permitir a execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Se um utilizador tiver sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1532](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1532).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2009-1532
...
-   Como pré-definição, todas as versões suportadas do Microsoft Outlook e do Microsoft Outlook Express abrem mensagens de correio electrónico em HTML na zona de Sites restritos. A zona de Sites restritos ajuda a atenuar ataques que tentem explorar esta vulnerabilidade, ao impedir a utilização de Scripts Activos e controlos ActiveX durante a leitura de mensagens de correio electrónico em HTML. Contudo, se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003 e no Windows Server 2008 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://go.microsoft.com/fwlink/?linkid=92039). Este modo define o nível de segurança para a zona da Internet como Alto. Este é um factor atenuante para Web sites que não adicionou à Zona de sites fidedignos do Internet Explorer. Consulte a subsecção de Perguntas Mais Frequentes desta secção da vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Microsoft Internet Explorer 5.01 Service Pack 4, o Microsoft Internet Explorer 6.0,o Microsoft Internet Explorer 6.0 Service Pack 1 e o Windows Internet Explorer 7 não são afectados por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2009-1532
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2009-1532
...
\*O SMS 2.0 e o SMS 2003 com SUSFP suportam todas as versões afectadas do Internet Explorer, excepto o Internet Explorer 7 e o Internet Explorer 8. Para mais informações, consulte o [Artigo 924178 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/924178).
...
<td style="border:1px solid black;">Para o Internet Explorer 5.01 Service Pack 4 em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB969897-IE501SP4- 20090522.120000$\Spuninst<br />
<br />
Para o Internet Explorer 6 Service Pack 1 quando instalado em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB969897-IE6SP1-20090501.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/969897">Artigo 969897 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 for all supported editions of Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está na pasta %Windir%\$NTUninstallKB969897$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está na pasta %Windir%\ie7updates\KB969897-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está na pasta %Windir%\ie8updates\KB969897-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/969897">Artigo 969897 da Base de Dados de Conhecimento da Microsoft</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas de 32 bits e edições baseadas em x64 do Windows Server 2003:
KB969897-IE8.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Informações adicionais</td>
...
-   David Bloom, da [Google Inc.](http://www.google.com/), por trabalhar connosco na Vulnerabilidade de Divulgação de Informações Entre Domínios com Condição Race (CVE-2007-3091)  
-   Jorge Luis Alvarez Medina, da [Core Security Technologies](http://www.coresecurity.com/), por fornecer informações sobre a Vulnerabilidade de Divulgação de Informações Entre Domínios (CVE-2009-1140)  
-   Haifei Li, da [Fortinet](http://www.fortinet.com), por fornecer informações sobre a Corrupção de Memória de Objecto DHTML (CVE-2009-1141)  
-   [Tippingpoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecerem informações sobre a Corrupção de Memória de Objecto HTML (CVE-2009-1528)  
-   Peter Vreugdenhil, a trabalhar com a [Tippingpoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2009-1529)  
-   Wushi, em colaboração com a [Tippingpoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objectos HTML (CVE-2009-1530)  
-   Wushi, em colaboração com a [Tippingpoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML (CVE-2009-1531)  
-   Nils, em colaboração com a [Tippingpoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objectos HTML (CVE-2009-1532)
...
-   V1.1 (10 de Junho de 2009): Remoção de notas sobre questões conhecidas no Resumo Executivo. Não existem questões conhecidas para esta actualização de segurança.
