---
TOCTitle: 'MS09-002'
Title: 'Microsoft Security Bulletin MS09-002 - Crítica'
ms:assetid: 'ms09-002'
ms:contentKeyID: 61234721
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-002(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-002 - Crítica
==============================================

Actualização de Segurança Cumulativa para o Internet Explorer (961260)
----------------------------------------------------------------------

Data de publicação: 10 de fevereiro de 2009 | Updated: 16 de fevereiro de 2009
...
Esta actualização de segurança está classificada como Crítica para o Internet Explorer 7 executado em edições suportadas do Windows XP e Windows Vista. Para o Internet Explorer 7 executado em edições suportadas do Windows Server 2003 e Windows Server 2008, esta actualização de segurança está classificada como Moderada. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.
...
**Questões conhecidas.** O [Artigo 961260 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/961260) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
| Windows Server 2003 com SP1 para sistemas baseados em Itanium e Windows Server 2003 com SP2 para sistemas baseados em Itanium | Microsoft Internet Explorer 6                   |
...
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 961260 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/961260).
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0075
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção da Memória CSS - CVE-2009-0076
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2009-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0075
...
-   Esta vulnerabilidade afecta apenas o Windows Internet Explorer 7. Não são afectadas versões suportadas do Microsoft Internet Explorer 5 e Microsoft Internet Explorer 6.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0075
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0075
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer processa Folhas de Estilo em Cascata (CSS). Um intruso poderia explorar a vulnerabilidade criando uma página web especialmente concebida para o efeito. Quando um utilizador visualizasse a página Web, a vulnerabilidade poderia permitir a execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2009-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória CSS - CVE-2009-0076
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória CSS - CVE-2009-0076
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória CSS - CVE-2009-0076
...
**O que provoca a vulnerabilidade? **
Quando o Internet Explorer apresenta uma página Web que contém determinados estilos CSS, a memória pode ser corrompida de tal forma que um intruso poderia executar código arbitrário no contexto do utilizador com sessão iniciada.
...
**O que é o CSS?**  
CSS, ou folhas de estilo em cascata, é um método de formatação para páginas Web que utilizam HTML. Para mais informações sobre o CSS, visite o [Web site Microsoft TechNet](http://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/iisbook/c06_cascading_style_sheets.mspx?mfr=true).

**O que faz a actualização? **
A actualização modifica a forma como o Internet Explorer processa Folhas de Estilo em Cascata.
...
| Windows Server 2003 Service Pack 1 e Microsoft Windows Server 2003 Service Pack 2                                             | Não     | Não                | Sim                                                                      | Sim                        |
...
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB961260-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/961260">Artigo 961260 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecerem informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2009-0075)  
-   Sam Thomas (<http://eshu.co.uk/>), a trabalhar com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória CSS (CVE-2009-0076)
...
-   V1.1 (16 de Fevereiro de 2009): Ligação adicionada para o Artigo 961260 da Base de Dados de Conhecimento da Microsoft, na secção Questões Conhecidas, no **Resumo Executivo**.
