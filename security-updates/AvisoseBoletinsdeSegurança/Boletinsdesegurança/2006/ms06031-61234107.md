---
TOCTitle: 'MS06-031'
Title: 'Microsoft Security Bulletin MS06-031 - Crítica'
ms:assetid: 'ms06-031'
ms:contentKeyID: 61234107
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms06-031(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS06-031 - Crítica
==============================================

Vulnerabilidade na Autenticação Mútua RPC poderia permitir Ocultação de Conteúdos (917736)
------------------------------------------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 — [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=5089d956-7d8d-4241-9ca2-107ce4f8c093)
...
Esta actualização resolve uma vulnerabilidade recentemente descoberta e comunicada de forma privada. Existe uma vulnerabilidade de ocultação no serviço RPC que poderia permitir que um intruso ocultasse conteúdos nocivos em recursos de rede fidedignos. A vulnerabilidade está documentada na secção "Detalhes sobre a Vulnerabilidade" deste boletim.

**Classificações da Gravidade e Identificadores da Vulnerabilidade:**

| Identificadores da Vulnerabilidade                                                                                           | Impacto da Vulnerabilidade | Windows 2000 |
|------------------------------------------------------------------------------------------------------------------------------|----------------------------|--------------|
| Vulnerabilidade na Autenticação Mútua RPC - [CVE-2006-2380](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2380) | Ocultação                  | Moderada     |
...
<span></span>
**O suporte alargado a actualizações de segurança para o Microsoft Windows 2000 Service Pack 3 terminou a 30 de Junho de 2005. Ainda utilizo um destes sistemas operativos, o que devo fazer?**
O Windows 2000 Service Pack 3 chegou ao final do seu ciclo de vida. Os utilizadores que tenham esta versão do sistema operativo deviam considerar a migração para versões suportadas como uma prioridade, de modo a poderem estar protegidos contra a potencial exposição a vulnerabilidades. Para mais informações sobre o Ciclo de Vida dos Produtos Windows, visite o [Web site do Ciclo de Vida do Suporte da Microsoft](http://go.microsoft.com/fwlink/?linkid=21742). Para mais informações sobre o período de suporte prolongado da actualização de segurança para este sistema operativo, visite o [Web site de Suporte Técnico da Microsoft](http://go.microsoft.com/fwlink/?linkid=33328).
...
<span></span>
#### Vulnerabilidade na Autenticação Mútua RPC - CVE-2006-2380:

Existe uma vulnerabilidade de ocultação na forma como o RPC processa autenticações mútuas. Esta vulnerabilidade poderia permitir que um intruso persuadisse um utilizador a ligar-se a um servidor RPC malicioso que pareça ser válido.

#### Factores atenuantes para a Vulnerabilidade na Autenticação Mútua RPC - CVE-2006-2380:

-   Um intruso não conseguiria obrigar os utilizadores a ligar-se a um servidor RPC malicioso.

#### Soluções alternativas para a Vulnerabilidade na Autenticação Mútua RPC - CVE-2006-2380:
...
-   **Para ajudar a proteger contra tentativas de explorar esta vulnerabilidade com base na rede, o IPSec pode ser usado para assegurar a identidade de um sistema.**
...
#### Perguntas mais frequentes sobre a Vulnerabilidade na Autenticação Mútua RPC - CVE-2006-2380:

**Qual é a abrangência desta vulnerabilidade?**
Esta é uma vulnerabilidade de ocultação que afecta aplicações RPC personalizadas que actuam como clientes RPC usando o SSL com opção de autenticação mútua. Um intruso que explorasse esta vulnerabilidade com sucesso poderia fazer-se passar por um servidor RPC válido.

**O que provoca a vulnerabilidade?**
O produto afectado não valida correctamente a identidade do servidor RPC quando utiliza autenticação mútua através de Secure Socket Layer (SSL).

**O que é a Autenticação Mútua?**
Tanto as máquinas de cliente como de servidor irão trocar credenciais para verificar identidades antes da troca de dados.

**Como poderia um intruso utilizar a vulnerabilidade?**
Um intruso que explorasse esta vulnerabilidade com sucesso poderia fazer-se passar por um servidor válido.

**Quem poderia explorar a vulnerabilidade?**
Um intruso teria primeiro de convencer um utilizador a ligar-se a um recurso que necessite de autenticação mútua utilizando o protocolo Secure Sockets Layer (SSL). Então, o intruso poderia fazer-se passar por um servidor RPC válido. Um intruso não conseguiria obrigar os utilizadores a visitarem o servidor RPC.

**Como poderia um intruso explorar a vulnerabilidade?**
Um intruso poderia tentar explorar a vulnerabilidade convencendo um utilizador a ligar-se a um serviço RPC que tenha sido configurado de modo a fazer-se passar por um servidor válido.
...
A actualização remove a vulnerabilidade modificando a forma como o RPC processa a autenticação mútua.
...
Os administradores de sistema podem também utilizar o utilitário Spuninst.exe para remover esta actualização de segurança. O utilitário Spuninst.exe está localizado na pasta %Windir%\\$NTUninstallKB917736$\\Spuninst.
...
|------------------|---------------|-------------|-------|---------|
| Rpcrt4.dll       | 5.0.2195.7085 | 13-Abr-2006 | 17:47 | 437,008 |
...
-   **Verificação da Chave de Registo**
    ...
    **Nota** Esta chave de registo poderá não conter uma lista completa dos ficheiros instalados. Além disso, esta chave de registo poderá não ser criada correctamente quando um administrador ou um OEM integrar ou associar a actualização de segurança 917736 aos ficheiros de origem de instalação do Windows.
...
-   Michael Colson da [BindView](http://www.bindview.com/) por fornecer informações sobre a Vulnerabilidade na Autenticação Mútua RPC (CVE-2006-2380).
