...
ms:assetid: 'ms10-038'
ms:contentKeyID: 61234913
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-038(v=Security.10)'
---
...
Vulnerabilidades no Microsoft Office Excel Poderiam Permitir Execução Remota de Código (2027452)
------------------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para todas as edições suportadas do Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office Excel 2007, Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac, Conversor de Formato de Ficheiros Open XML para Mac e todas as versões suportadas do Microsoft Office Excel Viewer e Pack de Compatibilidade do Microsoft Office. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização resolve as vulnerabilidades alterando a forma como o Microsoft Office Excel analisa ficheiros Excel especialmente concebidos para o efeito e corrigindo a forma como o Conversor de Formato de Ficheiros Open XML para Mac é instalado. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.

**Recomendação.** A Microsoft recomenda que os clientes instalem esta actualização na primeira oportunidade.

**Questões conhecidas.** O [Artigo 2027452 da Base de Conhecimentos da Microsoft](http://support.microsoft.com/kb/2027452) salienta a situação que os clientes podem notar após esta actualização de segurança. O artigo também recomenda soluções para esta situação.
...
<sup>[1]</sup>Para o Microsoft Office Excel 2007 Service Pack 1 e o Microsoft Office Excel 2007 Service Pack 2, para além do pacote de actualização de segurança KB982308, os clientes têm também de instalar a actualização de segurança para o Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 Service Pack 1 e o Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 Service Pack 2 (KB982331) para estarem protegidos contra as vulnerabilidades descritas neste boletim.
...
**O MS10-036 também descreve uma vulnerabilidade no Microsoft Office Excel. Como é que o MS10-036 se relaciona com este boletim (MS10-038)?**  
Os pacotes de actualizações de segurança no [MS10-036](http://go.microsoft.com/fwlink/?linkid=190554) para Microsoft Office Excel 2003 (KB982133) e Microsoft Office Excel 2007 (KB982308) também resolvem as vulnerabilidades descritas neste boletim, MS10-038. Os utilizadores com Microsoft Office Excel 2003 ou Microsoft Office Excel 2007 instalado apenas necessitarão de instalar estes pacotes de actualizações de segurança uma vez. Além disso, o [MS10-036](http://go.microsoft.com/fwlink/?linkid=190554) oferece actualizações associadas ao Microsoft Office (KB982311 ou KB982312) que os utilizadores também devem instalar para resolver a vulnerabilidade descrita no [MS10-036](http://go.microsoft.com/fwlink/?linkid=190554).
...
Sim, o pacote de actualização para o Microsoft Office Excel 2007 Service Pack 1 e Microsoft Office Excel 2007 Service Pack 2 (KB982308) inclui as alterações ao Excel 2007 descritas no [Artigo 981046 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/981046).
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória na Análise de Registo no Excel - CVE-2010-0821
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga de Pilha em Objectos Excel - CVE-2010-0822
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-0823
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Registo no Excel - CVE-2010-0824
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Registo no Excel - CVE-2010-1245
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de RTD no Excel - CVE-2010-1246
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-1247
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de HFPicture no Excel - CVE-2010-1248
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-1249
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de EDG no Excel - CVE-2010-1250
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Pilha de Registo no Excel - CVE-2010-1251
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Variável de Cadeia no Excel - CVE-2010-1252
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Objecto ADO no Excel - CVE-2010-1253
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Permissões Open XML no Mac Office - CVE-2010-1254
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0821](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0821).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória na Análise de Registo no Excel - CVE-2010-0821
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória na Análise de Registo no Excel - CVE-2010-0821
...
-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória na Análise de Registo no Excel - CVE-2010-0821
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0822](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0822).

#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga de Pilha em Objectos Excel - CVE-2010-0822
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga de Pilha em Objectos Excel - CVE-2010-0822

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga de Pilha em Objectos Excel - CVE-2010-0822
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0823](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0823).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-0823
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-0823
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-0823

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado remotamente. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade existe devido à forma como o Microsoft Office Excel analisa subsequências de folhas de gráficos mal formadas no formato de ficheiro Excel ao abrir um ficheiro Excel especialmente concebido para o efeito.
...
**O que faz a actualização?**  
Esta actualização resolve a vulnerabilidade alterando a forma como o Microsoft Office Excel analisa subsequências de folhas de gráficos mal formadas em ficheiros Excel especialmente concebidos para o efeito.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0824](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0824).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Registo no Excel - CVE-2010-0824
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Registo no Excel - CVE-2010-0824

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Registo no Excel - CVE-2010-0824
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1245](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1245).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Registo no Excel - CVE-2010-1245
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Registo no Excel - CVE-2010-1245

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Registo no Excel - CVE-2010-1245
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1246](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1246).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de RTD no Excel - CVE-2010-1246
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de RTD no Excel - CVE-2010-1246

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de RTD no Excel - CVE-2010-1246
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1247](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1247).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-1247
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-1247

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-1247
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1248](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1248).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de HFPicture no Excel - CVE-2010-1248
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de HFPicture no Excel - CVE-2010-1248

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de HFPicture no Excel - CVE-2010-1248
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1249).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-1249
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-1249

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Excel - CVE-2010-1249
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1250).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de EDG no Excel - CVE-2010-1250
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de EDG no Excel - CVE-2010-1250

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de EDG no Excel - CVE-2010-1250
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1251).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Pilha de Registo no Excel - CVE-2010-1251
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Pilha de Registo no Excel - CVE-2010-1251

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Pilha de Registo no Excel - CVE-2010-1251
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1252](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1252).

#### Factores Atenuantes para a Vulnerabilidade de Variável de Cadeia no Excel - CVE-2010-1252
...
#### Soluções Alternativas para a Vulnerabilidade de Variável de Cadeia no Excel - CVE-2010-1252

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Excel que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Variável de Cadeia no Excel - CVE-2010-1252
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1253).

#### Factores Atenuantes para a Vulnerabilidade de Objecto ADO no Excel - CVE-2010-1253
...
#### Soluções Alternativas para a Vulnerabilidade de Objecto ADO no Excel - CVE-2010-1253
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Objecto ADO no Excel - CVE-2010-1253
...
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na forma como o Conversor de Formato de Ficheiros Open XML para Mac é instalado. Durante a instalação, o Conversor de Formato de Ficheiros Open XML para Mac altera as ACLs do sistema de ficheiros na pasta /Aplicações de uma forma que reduz as definições de segurança na pasta /Aplicações e permite acesso total aos ficheiros nesta pasta. Para explorar esta vulnerabilidade, um intruso teria de iniciar primeiro sessão no sistema. Um intruso poderia substituir o Conversor de Formato de Ficheiros Open XML para Mac por um ficheiro executável malicioso. Posteriormente, quando um administrador iniciar sessão e executar o Conversor de Formato de Ficheiros Open XML para Mac, o código fornecido pelo intruso pode ser executado, permitindo que o intruso assuma o controlo total de um sistema afectado.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1254).

#### Factores Atenuantes para a Vulnerabilidade de Permissões Open XML no Mac Office - CVE-2010-1254
...
-   O Conversor de Formato de Ficheiros Open XML para Mac não é instalado com nenhuma versão do Office para Mac. Apenas está disponível como uma transferência em separado.
-   O intruso apenas poderia obter elevação de privilégios no computador Mac afectado se um Administrador executasse o Conversor de Formato de Ficheiros Open XML para Mac depois de o intruso ter modificado a instalação. Não se trata de uma elevação de privilégios directa, mas antes de um ataque indirecto.

#### Soluções Alternativas para a Vulnerabilidade de Permissões Open XML no Mac Office - CVE-2010-1254

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Alterar o proprietário e o grupo da pasta /Aplicações e do Conversor de Formato de Ficheiros Open XML para Mac para utilizadores privilegiados**

    Execute os seguintes comandos na aplicação Terminal para definir permissões:

    `sudo chown root:admin /Applicationssudo chown -R root:admin /Applications/Open\ XML\ Converter.app`

    **Como anular esta solução alternativa.**

    Para repor as permissões para o estado vulnerável definido pela instalação do Conversor de Formato de Ficheiros Open XML para Mac:

    `sudo chown 99:99/Applicationssudo chown -R 99:99/Applications/Open\ XML\ Converter.app`

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Permissões Open XML no Mac Office - CVE-2010-1254

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado remotamente. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
Durante a instalação, a aplicação do conversor de Office XML para Mac altera as ACLs do sistema de ficheiros na pasta /Aplicações de uma forma que reduz as definições de segurança na pasta /Aplicações.

**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso poderia substituir a aplicação do Conversor de Office XML para Mac por um ficheiro executável malicioso. Posteriormente, quando um administrador iniciasse sessão e executasse a aplicação do Conversor de Office XML para Mac, o código fornecido pelo intruso poderia ser executado, permitindo que o intruso assumisse o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**Como poderia um intruso explorar a vulnerabilidade?**  
Para explorar esta vulnerabilidade, um intruso teria de iniciar primeiro sessão no sistema e substituir o Conversor de Formato de Ficheiros Open XML para Mac por um ficheiro executável malicioso. Posteriormente, quando um administrador iniciasse sessão e executasse a aplicação do Conversor de Office XML para Mac, o código fornecido pelo intruso poderia ser executado.
...
**O que faz a actualização?**  
A actualização resolve a vulnerabilidade corrigindo a forma como o Conversor de Formato de Ficheiros Open XML para Mac é instalado para que as definições de segurança predefinidas da pasta /Aplicações não sejam alteradas.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/982299">Artigo 982299 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/982133">Artigo 982133 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
#### Excel 2007 (todas as edições), Excel Viewer e Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007 (todas as versões)
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Excel Viewer:<br />
Consulte o <a href="http://support.microsoft.com/kb/982333">Artigo 982333 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007:<br />
Consulte o <a href="http://support.microsoft.com/kb/982331">Artigo 982331 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
Transfira e instale a versão do idioma adequado para a Actualização do Microsoft Office 2004 para Mac 11.5.9, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=16c71ab8-9284-407a-856a-93c67995f125).
...
-   Abra o volume da Actualização Microsoft Office 2004 para Mac 11.5.9 no seu ambiente de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume de Actualização Microsoft Office 2004 para Mac 11.5.9, faça duplo clique na aplicação da Actualização Microsoft Office 2004 para Mac 11.5.9 e siga as instruções no ecrã.  
-   Se a instalação foi concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: “Verificação da Instalação da Actualização”. Para remover o programa de instalação, primeiro arraste o volume da Actualização Microsoft Office 2004 para Mac 11.5.9 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da versão for **11.5.9**, a actualização foi instalada com sucesso.
...
Transfira e instale a versão do idioma adequado para a Actualização do Microsoft Office 2008 para Mac 12.2.5, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=d46255bd-6470-4106-9fe2-ea67acd3f1bd).
  
-   Feche todas as aplicações que esteja a executar, incluindo aplicações de protecção contra vírus, todas as aplicações Microsoft Office, Microsoft Messenger para Mac e Notificações do Office, porque podem interferir com a instalação.  
-   Abra o volume da Actualização Microsoft Office 2008 para Mac 12.2.5 na sua área de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume de Actualização Microsoft Office 2008 para Mac 12.2.5, faça duplo clique na aplicação da Actualização Microsoft Office 2008 para Mac 12.2.5 e siga as instruções no ecrã.  
-   Se a instalação foi concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: “Verificação da Instalação da Actualização”. Para remover o programa de instalação, primeiro arraste o volume da Actualização Microsoft Office 2008 para Mac 12.2.5 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da versão for **12.2.5**, a actualização foi instalada com sucesso.
...
Transfira e instale a versão do idioma adequado para a Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.5, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=b6ca7b05-cf97-43a2-95eb-7b5caf7c1528).
  
-   Feche todas as aplicações que esteja a executar, incluindo aplicações de protecção contra vírus, todas as aplicações Microsoft Office, Microsoft Messenger para Mac e Notificações do Office, porque podem interferir com a instalação.  
-   Abra o volume da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.5 no seu ambiente de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.5, faça duplo clique na aplicação da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.5 e siga as instruções no ecrã.  
-   Se a instalação foi concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: "Verificação da Instalação da Actualização". Para remover o programa de instalação, primeiro arraste o volume da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.5 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da versão for **1.1.5**, a actualização foi instalada com sucesso.
...
-   Investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória na Análise de Registo no Excel (CVE-2010-0821)  
-   Nicolas Joly, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga de Pilha em Objectos Excel (CVE-2010-0822)  
-   Bing Liu, da [FortiGuard Labs da Fortinet](http://www.fortiguard.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Excel (CVE-2010-0823)  
-   Nicolas Joly, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Registo no Excel (CVE-2010-0824)  
-   Nicolas Joly, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Registo no Excel (CVE-2010-1245)  
-   Nicolas Joly, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de RTD no Excel (CVE-2010-1246)  
-   Nicolas Joly, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Excel (CVE-2010-1247)  
-   Nicolas Joly, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de HFPicture no Excel (CVE-2010-1248)  
-   Nicolas Joly, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Excel (CVE-2010-1249)  
-   Nicolas Joly, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de EDG no Excel (CVE-2010-1250)  
-   Carsten Eiram, da [Secunia](http://secunia.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Pilha de Registo no Excel (CVE-2010-1251)  
-   Carsten Eiram, da [Secunia](http://secunia.com/), por fornecer informações sobre a Vulnerabilidade de Variável de Cadeia no Excel (CVE-2010-1252)  
-   Um investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Objecto ADO no Excel (CVE-2010-1253)  
-   Rick Glaspie, da Gilbert Public Schools em Gilbert, AZ, por fornecer informações sobre a Vulnerabilidade de Permissões Open XML no Mac Office (CVE-2010-1254)
...
-   V1.1 (9 de Junho de 2010): Remoção da notação de questões conhecidas, no Resumo Executivo. Actualmente, não existem questões conhecidas para esta actualização de segurança.  
-   V1.2 (30 de Junho de 2010): Foi adicionado um link para o Artigo 2027452 da Base de Conhecimentos da Microsoft nas questões conhecidas, no Resumo Executivo.
