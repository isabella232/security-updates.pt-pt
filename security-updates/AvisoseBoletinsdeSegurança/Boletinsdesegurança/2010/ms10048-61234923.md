...
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2543191a-09cb-4417-bbb2-aac4d9a2a756)                                                                     | Elevação de Privilégios     | Importante                          | [MS10-032](http://go.microsoft.com/fwlink/?linkid=184917) |
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga do Conjunto no Win32k - CVE-2010-1895
...
-   Tavis Ormandy, da [Google, Inc.](http://www.google.com/), por fornece informações sobre a Vulnerabilidade de Verificação de Limites no Win32k (CVE-2010-1887)  
-   Matthieu Suiche, da [MoonSols](http://moonsols.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga do Conjunto no Win32k (CVE-2010-1895)  
-   Matthieu Suiche, da [MoonSols](http://moonsols.com/), por fornecer informações sobre a Vulnerabilidade de Intervenção do Utilizador no Win32k (CVE-2010-1896)  
-   Matthieu Suiche, da [MoonSols](http://moonsols.com/), por trabalhar connosco nas alterações a nível da protecção defensiva profunda resolvidas neste boletim  
-   Nicolas Economou, da [Core Security Technologies](http://www.coresecurity.com/), por fornecer informações sobre a Vulnerabilidade na Criação de Janelas no Win32k (CVE-2010-1897)
