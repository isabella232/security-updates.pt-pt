---
TOCTitle: 'MS10-096'
Title: 'Microsoft Security Bulletin MS10-096 - Importante'
ms:assetid: 'ms10-096'
ms:contentKeyID: 61234971
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-096(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-096 - Importante
=================================================

Vulnerabilidade no Livro de Endereços do Windows Poderia Permitir Execução Remota de Código (2423089)
-----------------------------------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=46baa431-126c-4fa5-9a7b-525008e2817d)                                                                                                    | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b9ce9d62-2eaa-48d8-bb6d-ea137e63d077)                                                                           | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e0b2837c-019b-419b-954d-5bdc71a3a332)                                                                                           | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c5cb600-9a39-40a0-be42-1593b1e0b97d)                                                                               | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=9abc8270-f3ac-474d-9ebc-410aaa6262cc)                                                                | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a1c7f1b5-e054-4cd6-857d-2ab0a2fe9f62)                                                                  | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=73624b68-a69d-4517-b971-f0b7d2ccc9d6)                                          | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=118f528f-bd05-49c2-a4a4-78314cd00992)\*\*               | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=77e288fb-b51f-4f57-baac-1443d8fbd37b)\*\*     | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82f71194-6f1f-4f43-8752-4bf5e5f94a93) | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=4e8ad5cd-af27-4f00-9378-ad778b8ee7b3)                                                                                           | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=35a3e821-b463-411c-858b-d01eb5aed42b)                                                                                      | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=9e2c95f6-9381-4484-b11b-814ab9138118)\*\*                                                                     | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cb4211f3-1082-4245-8f03-7cbac90e9a31)                                                                     | Execução Remota de Código   | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >Vulnerabilidade de Carregamento de Biblioteca sem Segurança - CVE-2010-3147</th>
...
Vulnerabilidade de Carregamento de Biblioteca sem Segurança - CVE-2010-3147  
---------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Livro de Endereços do Windows processa o carregamento de ficheiros DLL. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3147](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147).
  
#### Factores Atenuantes para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança - CVE-2010-3147
...
#### Soluções Alternativas para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança - CVE-2010-3147
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança - CVE-2010-3147
...
Esta vulnerabilidade deve-se ao Livro de Endereços do Windows que restringe incorrectamente o caminho utilizado para o carregamento de bibliotecas externas.
  
**O que é um Livro de Endereços do Windows?**    
O Windows fornece um livro de endereços para guardar dados de contacto. O Livro de Endereços do Windows (WAB) é uma aplicação e um serviço que permite aos utilizadores guardar informações sobre pessoas. O WAB tem uma base de dados local e uma interface de utilizador para encontrar e editar informações sobre pessoas, podendo consultar servidores de serviços informativos em rede utilizando o Lightweight Directory Access Protocol (LDAP). O WAB pode ser utilizado por outras aplicações. Por exemplo, o Microsoft Outlook utiliza o WAB como o seu livro de endereços.
...
Um intruso poderia convencer um utilizador a abrir um ficheiro do Livro de Endereços do Windows (WAB) legítimo localizado no mesmo directório de rede que um ficheiro de biblioteca de hiperligação dinâmica (DLL) especialmente concebido. Nessa altura, ao abrir o ficheiro WAB, o Livro de Endereços do Windows poderia tentar carregar o ficheiro DLL e executar qualquer código aí contido.
  
Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade ao enviar um ficheiro WAB legítimo em anexo a um utilizador e convencer o utilizador a colocar o ficheiro WAB num directório que contenha um ficheiro DLL especialmente concebido e depois a abrir o ficheiro WAB. Nessa altura, ao abrir o ficheiro WAB, o Livro de Endereços do Windows poderia tentar carregar o ficheiro DLL e executar qualquer código aí contido.
  
Num cenário de rede, um intruso poderia colocar um ficheiro WAB legítimo e um ficheiro DLL especialmente concebido numa localização UNC ou WebDAV e convencer o utilizador a abrir o ficheiro WAB.
...
A actualização resolve esta vulnerabilidade corrigindo a forma como o Livro de Endereços do Windows carrega bibliotecas externas.
  
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3147](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147).
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou remover programas</strong> no Painel de controlo ou o utilitário Spuninst.exe localizado na pasta %Windir%\$NTUninstallKB2423089$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2423089">Artigo 2423089 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
#### Windows Server 2003 (todas as edições de 32 bits)
...
-   Simon Raner, da [ACROS Security](http://www.acrossecurity.com/), por fornecer informações sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança (CVE-2010-3147)  
-   HD Moore da, [Rapid7](http://www.rapid7.com/), por fornecer informações sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança (CVE-2010-3147)  
-   Muhaimin Dzulfakar, da [NGS Software](http://www.ngssoftware.com/), por fornecer informações sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança (CVE-2010-3147)
