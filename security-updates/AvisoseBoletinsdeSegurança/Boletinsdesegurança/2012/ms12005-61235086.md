---
TOCTitle: 'MS12-005'
Title: 'Microsoft Security Bulletin MS12-005 - Importante'
ms:assetid: 'ms12-005'
ms:contentKeyID: 61235086
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms12-005(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-005 - Importante
=================================================

Vulnerabilidade no Microsoft Windows Poderia Permitir Execução Remota de Código (2584146)
-----------------------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=1bcb1d1e-9261-4a36-9256-90d3df9bd4fb)                                                                                                          | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c687796-4c41-4d17-b738-511d2fbfc126)                                                                                 | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c39be84-1eab-4794-b3ed-e529643aca21)                                                                                                 | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3cf29dfd-239e-4707-92e6-952133c1c1c2)                                                                                     | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=623c1c7d-6902-4876-9614-1b6e1ef80831)                                                                      | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=038970b6-aeec-4e18-8dfe-887b260a7c87)                                                                                                       | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=23abeb12-f2fe-43fd-9c4a-4d3d244832f8)                                                                                           | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d089d9cb-382c-4e64-94c5-69b9864010b1)\*\*                                                                    | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ac8a368-4298-4c1d-9cfd-924d6df563af)\*\*                                                               | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3e08b242-2516-4cf6-b38e-35ec2b8b788d)                                                               | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7422605b-7a02-4161-b7f8-92b3ccffef64)                                             | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ba46bc7-af7a-445a-84f2-b0c13674409b)                                   | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=db3a4814-a409-4def-944d-4eaa540b83b0)\*\*     | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2101663a-ed3d-4850-b79a-16960ab56b45) | Execução Remota de Código   | Importante                          | Nenhum                                      |
...
**Esta actualização de segurança está relacionada com o boletimMS12-002?**
Não. Embora ambas as actualizações de segurança afectem o Gestor de Objectos do Windows, as actualizações afectam componentes diferentes e não estão relacionadas. Estas actualizações podem ser aplicadas por qualquer ordem.

**Esta actualização contém outras alterações de segurança em termos de funcionalidade?**
Sim, esta actualização altera a forma como o Gestor de Objectos do Windows identifica ficheiros inseguros.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Execução de Assemblagem - CVE-2012-0013
</th>
<th colspan="2">
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Gestor de Objectos do Windows carrega aplicações ClickOnce incorporadas em ficheiros do Microsoft Office.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0013).

#### Factores Atenuantes para Vulnerabilidade de Execução de Assemblagem - CVE-2012-0013
...
-   Para ser implementado através de uma rede, o manifesto de implementação e o manifesto de aplicação de uma implementação ClickOnce devem ser assinados com um certificado digital.

#### Soluções Alternativas para Vulnerabilidade de Execução de Assemblagem - CVE-2012-0013
...
-   **Remover a associação a ficheiros** **.application**
    ...
    **Nota** Se utilizar o Editor de Registo incorrectamente, pode causar problemas sérios que podem vir a obrigar à reinstalação do seu sistema operativo. A Microsoft não pode garantir que consiga resolver problemas que resultam da utilização incorrecta do Editor de Registo. A utilização do Editor de Registo é da sua responsabilidade. Para obter informações sobre como editar o registo, deve consultar o tópico de Ajuda "Alterar Chaves e Valores" do Editor de Registo (Regedit.exe) ou os tópicos de Ajuda "Adicionar e Eliminar Informações do Registo" e "Editar Dados do Registo" do Regedt32.exe.
    ...
    Para remover a associação ao ficheiro .application, execute os passos seguintes:

    **Utilizar o método interactivo**

    1.  Clique em **Iniciar**, em seguida em **Executar**, escreva **regedit** e, depois, clique em **OK.**
    2.  Expanda **HKEY\_CLASSES\_ROOT** e clique em **.application** e, a seguir, clique no menu **Ficheiro** e seleccione **Exportar.**
    3.  Na caixa de diálogo **Exportar ficheiro de registo**, escreva **Cópia de segurança de registo com associação ao ficheiro application HKCR** e clique em **Guardar**.
    ...
    5.  Expanda **HKEY\_CURRENT\_USER**, depois **Software**, **Microsoft**, **Windows**, **CurrentVersion**, **Explorer** e, finalmente, **FileExts**.
    6.  Clique em **.application** e, a seguir, clique no menu **Ficheiro** e seleccione **Exportar.**
    7.  Na caixa de diálogo **Exportar ficheiro de registo**, escreva **Cópia de segurança de registo com associação ao ficheiro application HKCU** e clique em **Guardar**.
        **Nota** Isto criará uma cópia de segurança desta chave de registo, que, por predefinição, ficará na pasta Os meus documentos**.**
    8.  Prima a tecla **Delete** no teclado para apagar a chave de registo. Quando lhe for solicitado para eliminar o valor de registo, clique em **Sim.**
    ...
    **Utilizar a gestão de scripts de implementação**
    ...
    2.  Guarde o que se segue num ficheiro com a extensão .REG (por exemplo: Delete\_Application\_File\_Association.reg):

        `Editor de registo do Windows versão 5.00[-HKEY_CLASSES_ROOT\.application][-HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.application]`
    ...
    **Impacto da solução alternativa.** Esta solução alternativa remove a associação ao ficheiro .application. O duplo clique num ficheiro de aplicação deixará de a iniciar.
    ...
    **Como anular esta solução alternativa.**
    ...
    3.  Na caixa de diálogo Importar ficheiro de registo, seleccione **Cópia de segurança de registo com associação ao ficheiro application HKCR** e clique em **Abrir**.
    4.  Clique no menu **Ficheiro** e seleccione **Importar**.
    5.  Na caixa de diálogo Importar ficheiro de registo, seleccione **Cópia de segurança de registo com associação ao ficheiro application HK**C**U** e clique em **Abrir**.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução de Assemblagem - CVE-2012-0013
...
Esta vulnerabilidade é causada pelo facto de tipos de ficheiros de aplicação ClickOnce não fazerem parte da lista de ficheiros inseguros do Gestor de Objectos do Windows, permitindo que as aplicações ClickOnce sejam incorporadas em documentos do Microsoft Office.

**O que é o ClickOnce?**
O ClickOnce é uma tecnologia de implementação que permite que os programadores criem aplicações baseadas em Windows com actualização automática que podem ser instaladas e executadas com interacção mínima do utilizador. Uma aplicação ClickOnce é qualquer ficheiro do Windows Presentation Foundation (.xbap), Windows Forms (.exe), aplicação de consola (.exe) ou solução Office (.dll) publicado utilizando a tecnologia ClickOnce. As aplicações ClickOnce podem ser publicadas de três formas diferentes: a partir de uma página da Web, de uma partilha de ficheiro de rede ou de conteúdos multimédia como CD-ROM. Para mais informações, consulte o artigo MSDN sobre [Implementação e Segurança ClickOnce](http://msdn.microsoft.com/en-us/library/t71a733d.aspx).

**Como poderia um intruso utilizar a vulnerabilidade?**
Esta vulnerabilidade permite que os intrusos incorporem programas de instalação de aplicação ClickOnce em documentos do Microsoft Office e executem código sem interacção do utilizador.

**Como poderia um intruso explorar a** **vulnerabilidade?**
A exploração desta vulnerabilidade requer que um utilizador abra um ficheiro do Microsoft Office especialmente concebido para o efeito.

Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade enviando um ficheiro do Microsoft Office especialmente concebido para o efeito com uma aplicação ClickOnce ao utilizador e convencendo-o a abrir o ficheiro.

Num cenário de ataque com base na Web, um intruso teria de alojar um Web site contendo um ficheiro do Office que fosse utilizado para tentar explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Um intruso não conseguiria obrigar os utilizadores a visitarem um Web site especialmente concebido para o efeito. Em vez disso, um intruso teria de os convencer a visitar o Web site, levando-os normalmente a clicar numa hiperligação que os levasse ao site do intruso e, em seguida, convencê-los a abrir um ficheiro especialmente concebido para o efeito.
...
A actualização altera a forma como o Gestor de Objectos do Windows verifica ficheiros inseguros.
...
<td style="border:1px solid black;">Utilize o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2584146$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2584146">Artigo 2584146 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilize o item **Adicionar ou Remover Programas** no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\\$NTUninstallKB2584146$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consulte o [Artigo 2584146 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2584146)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Yorick Koster, a trabalhar com o programa [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html), por fornecer informações sobre a Vulnerabilidade de Execução de Assemblagem - (CVE-2012-0013)
