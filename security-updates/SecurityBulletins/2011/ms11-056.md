---
TOCTitle: 'MS11-056'
Title: 'Microsoft Security Bulletin MS11-056 - Importante'
ms:assetid: 'ms11-056'
ms:contentKeyID: 61235037
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-056(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS11-056 - Importante
=================================================

Vulnerabilidades no Windows Client/Server Run-time Subsystem Poderiam Permitir Elevação de Privilégios (2507938)
----------------------------------------------------------------------------------------------------------------

Data de publicação: 12 de julho de 2011 | Updated: 21 de julho de 2011
...
A actualização de segurança resolve as vulnerabilidades ao não permitir que múltiplos objectos de consola sejam associados a um processo, modificando a forma como o CSRSS inicializa memória, validando entradas do utilizador antes da utilização como índice para uma matriz e modificando a verificação de limites para impedir a corrupção da memória. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Questões Conhecidas.** O [Artigo 2507938 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2507938) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a81c011d-eeea-4383-9efb-df70515ab357">Windows Server 2003 com SP2 para sistemas baseados em Itanium</a></td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>,</em><br />
<a href="http://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=36e3dbaf-36f5-4c74-8f11-ecbef46f58e1">Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2</a>*</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b43d2ab5-e281-4c6b-bb37-1f1b5d86ac82">Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2</a>*</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b70209f2-1c51-45af-b3c4-3473aebcdb35">Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2</a></td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac3b435c-8caf-40cc-8f13-b52261b3b9e6">Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1</a></td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=64e5f889-fa46-4884-9b22-3ba4e2fba1b9">Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1</a></td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b99a40cf-8a31-43d9-bd0b-a458a533068b">Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1</a>*</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=784efc20-3a41-42ab-b48d-51fd59d71523">Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1</a></td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
</tr>
...
<th style="border:1px solid black;" >Vulnerabilidade de Elevação Local de Privilégios no CSRSS AllocConsole - CVE-2011-1281</th>
<th style="border:1px solid black;" >Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleLocalEUDC - CVE-2011-1282</th>
<th style="border:1px solid black;" >Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleNumberOfCommand - CVE-2011-1283</th>
<th style="border:1px solid black;" >Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutput - CVE-2011-1284</th>
<th style="border:1px solid black;" >Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutputString - CVE-2011-1870</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Elevação Local de Privilégios no CSRSS AllocConsole - CVE-2011-1281  
--------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no Windows CSRSS devido à forma como o subsistema CSRSS atribui memória para transacções específicas de utilizador. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1281).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação Local de Privilégios no CSRSS AllocConsole - CVE-2011-1281
...
#### Soluções Alternativas para a Vulnerabilidade de Elevação Local de Privilégios no CSRSS AllocConsole - CVE-2011-1281
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS AllocConsole - CVE-2011-1281
...
Esta vulnerabilidade é causada por uma condição de corrupção de memória que ocorre quando múltiplos objectos de consola são associados a um processo. Quando o processo termina, os objectos extra de consola ficam órfãos e este processo de objecto pode então ser obtido por outro processo com um privilégio superior ao pretendido.
  
**O que é o Windows Client/Server Runtime Subsystem (CSRSS)?**    
O CSRSS (Client/Server Run-time Subsystem) é a parte de modo de utilizador do subsistema Win32 (com o Win32.sys sendo a parte do modo de kernel). O CSRSS é um subsistema essencial que deve estar sempre a ser executado. O CSRSS é responsável por janelas de consola, criando e/ou apagando threads.
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia executar código arbitrário no contexto de um sistema. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
...
A actualização resolve esta vulnerabilidade ao não permitir que múltiplos objectos de consola sejam associados a um processo.
...
Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleLocalEUDC - CVE-2011-1282  
------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no Windows CSRSS devido à forma como o subsistema CSRSS atribui memória para transacções específicas de utilizador. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1282](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1282).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleLocalEUDC - CVE-2011-1282
  
O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade.
  
#### Soluções Alternativas para a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleLocalEUDC - CVE-2011-1282
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleLocalEUDC - CVE-2011-1282
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Para tentar explorar a vulnerabilidade, um intruso teria que conseguir iniciar sessão no sistema e executar um programa.
  
**O que provoca a vulnerabilidade?**    
Esta é uma vulnerabilidade de corrupção de memória que pode permitir execução de código no contexto de sistema. É transmitido um ponteiro NULL sem validação a uma função no CSRSS. Isto permite que o CSRSS escreva numa página NULL no seu espaço de processo. Em sistemas Windows XP, sob determinadas condições, um intruso pode tirar partido desta página para executar código com permissões aumentadas.
...
**O que faz a actualização?**    
A actualização resolve esta vulnerabilidade modificando a forma como o CSRSS inicializa memória para impedir a execução de código arbitrário no contexto de sistema.
...
Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleNumberOfCommand - CVE-2011-1283  
------------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no Windows CSRSS devido à forma como o subsistema CSRSS atribui memória para transacções específicas de utilizador. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1283](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1283).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleNumberOfCommand - CVE-2011-1283
  
O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade.
  
#### Soluções Alternativas para a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleNumberOfCommand - CVE-2011-1283
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleNumberOfCommand - CVE-2011-1283
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Para tentar explorar a vulnerabilidade, um intruso teria que conseguir iniciar sessão no sistema e executar um programa.
  
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é causada quando a entrada do utilizador é utilizada como índice para uma matriz sem que seja verificada primeiro a existência de um valor negativo. Isto poderia permitir que um intruso lesse dados de áreas na memória ou de memória corrompida, de tal forma que poderia permitir execução de código.
...
**O que faz a actualização?**    
A actualização resolve esta vulnerabilidade validando a entrada do utilizador antes da utilização como índice para uma matriz.
...
Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutput - CVE-2011-1284  
-----------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no Windows CSRSS devido à forma como o subsistema CSRSS atribui memória para transacções específicas de utilizador. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1284](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1284).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutput - CVE-2011-1284
  
O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade.
  
#### Soluções Alternativas para a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutput - CVE-2011-1284
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutput - CVE-2011-1284
...
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é causada por uma condição de sobrecarga de números inteiros que poderia permitir que um intruso executasse código no contexto da conta de sistema.
...
**O que faz a actualização?**    
A actualização resolve esta vulnerabilidade modificando a verificação de limites para impedir corrupção de memória e execução de código.
...
Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutputString - CVE-2011-1870  
-----------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no Windows CSRSS devido à forma como o subsistema CSRSS atribui memória para transacções específicas de utilizador. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1870).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação Local Privilégios no CSRSS SrvWriteConsoleOutputString - CVE-2011-1870
  
O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade.
  
#### Soluções Alternativas para a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutputString - CVE-2011-1870
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutputString - CVE-2011-1870
...
**O que faz a actualização?**    
A actualização resolve esta vulnerabilidade modificando a verificação de limites para impedir corrupção de memória.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2507938$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2507938">Artigo 2507938 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Matthew 'j00ru' Jurczyk, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por fornecer informações sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS AllocConsole (CVE-2011-1281)  
-   Matthew 'j00ru' Jurczyk, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por fornecer informações sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleLocalEUDC (CVE-2011-1282)  
-   Matthew 'j00ru' Jurczyk, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por fornecer informações sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvSetConsoleNumberOfCommand (CVE-2011-1283)  
-   Matthew 'j00ru' Jurczyk, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por fornecer informações sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutput (CVE-2011-1284)  
-   Matthew 'j00ru' Jurczyk, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por fornecer informações sobre a Vulnerabilidade de Elevação Local de Privilégios no CSRSS SrvWriteConsoleOutputString (CVE-2011-1870)
...
-   V1.1 (21 de Julho de 2011): Ligação adicionada para o Artigo 2507938 da Base de Dados de Conhecimento da Microsoft, na secção Questões Conhecidas, no Resumo Executivo.
