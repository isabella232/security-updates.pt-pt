---
TOCTitle: 'MS11-023'
Title: 'Microsoft Security Bulletin MS11-023 - Importante'
ms:assetid: 'ms11-023'
ms:contentKeyID: 61235004
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-023(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-023 - Importante
=================================================
...
Esta actualização de segurança está classificada como Importante para todas as edições suportadas do Microsoft Office XP, Microsoft Office 2003, Microsoft Office 2007, Microsoft Office 2004 para Mac e Microsoft Office 2008 para Mac; e Conversor de Formato de Ficheiros Open XML para Mac. Para mais informações, consulte a subsecção, **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o Microsoft Office processa objectos de gráfico em ficheiros Office especialmente concebido para o efeito e corrigindo a forma como o Microsoft Office carrega bibliotecas externas. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Questões Conhecidas.** O [Artigo 2489293 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2489293) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
Sim, a Vulnerabilidade de Carregamento de Biblioteca sem Segurança em Componentes Office (CVE-2011-0107) resolvida por esta actualização está relacionada com a classe de vulnerabilidades, descrita no [Aviso de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afecta a forma como as aplicações carregam bibliotecas externas. Esta actualização de segurança resolve uma instância particular deste tipo de vulnerabilidade.

**Esta actualização contém outras alterações de segurança em termos de funcionalidade?**  
Sim. As actualizações para o Microsoft Office 2003 Service Pack 3 (KB2509503) e Microsoft Office 2007 Service Pack 2 (KB2509488), juntamente com as actualizações para o Microsoft Word, Microsoft Excel e Microsoft PowerPoint, fornecem suporte para a funcionalidade de Validação de Ficheiros do Office. Para obter mais informações sobre a funcionalidade de Validação de Ficheiros do Office, consulte o [Aviso de Segurança da Microsoft 2501584](http://technet.microsoft.com/security/advisory/2501584).

**Como é que esta actualização de segurança está relacionada com o boletim MS11-029?**  
O pacote da actualização de segurança para o Microsoft Office XP (KB2509461) oferecido neste boletim também resolve a vulnerabilidade descrita no boletim de segurança [MS11-029](http://go.microsoft.com/fwlink/?linkid=208524). Os utilizadores com o Microsoft Office XP instalado apenas necessitam de instalar um dos pacotes da actualização de segurança.
...
**Os boletins MS11-022 e MS11-021 também descrevem vulnerabilidades no Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac e Conversor de Formato de Ficheiros Open XML para Mac. Como é que os boletins MS11-022 e MS11-021 estão relacionados com este boletim, MS11-023?**  
Os pacotes da actualização de segurança para Microsoft Office 2004 para Mac (KB2505924), Microsoft Office 2008 para Mac (KB2505927) e Conversor de Formato de Ficheiros Open XML para Mac (KB2505935) oferecidos neste boletim também resolvem as vulnerabilidades descritas nos boletins de segurança [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727) e [MS11-021](http://go.microsoft.com/fwlink/?linkid=210121). Os utilizadores com Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac ou Conversor de Formato de Ficheiros Open XML para Mac instalado apenas deverão instalar estes pacotes da actualização de segurança uma vez.
...
Um programa autónomo do Microsoft Office é afectado com a mesma classificação de gravidade que o conjunto de aplicações correspondente do Microsoft Office. Por exemplo, uma instalação autónoma do Microsoft Excel é afectada com a mesma classificação de gravidade que uma instalação do conjunto de aplicações do Microsoft Office afectado.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Carregamento de Biblioteca sem Segurança em Componentes Office - CVE-2011-0107
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Não Referência de Objectos de Gráficos no Microsoft Office - CVE-2011-0977
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).

#### Factores Atenuantes para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança em Componentes Office - CVE-2011-0107

A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   Para um ataque ser bem sucedido, um utilizador terá de visitar uma localização não fidedigna do sistema de ficheiro remoto ou partilha WebDAV e abrir um ficheiro relacionado com Office (por exemplo, um ficheiro .docx).
...
#### Soluções Alternativas para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança em Componentes Office - CVE-2011-0107
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança em Componentes Office - CVE-2011-0107
...
Um intruso poderia convencer um utilizador a abrir um ficheiro legítimo relacionado com Office (por exemplo, um ficheiro .docx) localizado no mesmo directório de rede que um ficheiro de biblioteca de hiperligação dinâmica (DLL) especialmente concebido. Nessa altura, ao abrir o ficheiro legítimo, o Microsoft Office poderia tentar carregar o ficheiro DLL e executar qualquer código aí contido.

Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade enviando um anexo de ficheiro legítimo relacionado com Office (por exemplo, um ficheiro .docx) a um utilizador e convencer o utilizador a colocar o anexo num directório que contenha um ficheiro DLL especialmente concebido e depois a abrir o ficheiro legítimo. Nessa altura, ao abrir o ficheiro legítimo, o Microsoft Office poderia tentar carregar o ficheiro DLL e executar qualquer código aí contido.
...
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).
...
Sim. Esta actualização de segurança resolve a vulnerabilidade que poderia ser potencialmente explorada usando o código de prova de conceito publicado. À vulnerabilidade que foi corrigida foi atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).

Vulnerabilidade de Não Referência de Objectos de Gráficos no Microsoft Office - CVE-2011-0977
---------------------------------------------------------------------------------------------


Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Office processa objectos de gráficos ao analisar um ficheiro Office especialmente concebido para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0977](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0977).

#### Factores Atenuantes para a Vulnerabilidade de Não Referência de Objectos de Gráficos no Microsoft Office - CVE-2011-0977
...
-   Num cenário de ataque com base na Web, um intruso teria de alojar um Web site contendo um ficheiro Office especialmente concebido para o efeito que fosse utilizado para tentar explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Um intruso não teria como obrigar os utilizadores a visitar estes Web sites. Em vez disso, um intruso teria de convencer os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação que levasse os utilizadores para o Web site do intruso e, em seguida, convencendo-os a abrir um ficheiro Office especialmente concebido para o efeito.

#### Soluções Alternativas para a Vulnerabilidade de Não Referência de Objectos de Gráficos no Microsoft Office - CVE-2011-0977
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Não Referência de Objectos de Gráficos no Microsoft Office - CVE-2011-0977

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o Microsoft Office não processa correctamente estruturas de dados de não referência ao analisar um ficheiro Office especialmente concebido para o efeito que contém objectos de gráficos.
...
**Como poderia um intruso explorar a vulnerabilidade?**  
Embora o código vulnerável exista num componente partilhado do Microsoft Office, o vector de ataque conhecido é através do Microsoft Excel. A exploração desta vulnerabilidade requer que um utilizador abra um ficheiro Excel especialmente concebido para o efeito usando uma versão afectada do Microsoft Excel.
...
**O vector de ataque para a vulnerabilidade é através do Microsoft Excel. Por que razão este é um boletim do Microsoft Office?**  
Embora o vector de ataque conhecido para explorar a vulnerabilidade seja através do Microsoft Excel, o código vulnerável existe num componente partilhado do Microsoft Office. A lógica de detecção utilizada para procurar sistemas afectados é concebida para verificar o componente partilhado afectado do Microsoft Office e oferecer as actualizações a um sistema, independentemente de o Microsoft Excel estar ou não instalado.
...
**O que faz a actualização?**  
A actualização resolve a vulnerabilidade corrigindo a forma como o Microsoft Office processa objectos de gráficos em ficheiros Office especialmente concebidos para o efeito.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2509503">Artigo 2509503 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2509488">Artigo 2509488 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
-   Haifei Li, da [FortiGuard Labs da Fortinet](http://www.fortiguard.com/), por fornecer informações sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança em Componentes Office (CVE-2011-0107)  
-   Investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Não Referência de Objectos de Gráficos no Microsoft Office (CVE-2011-0977)
