---
TOCTitle: 'MS11-038'
Title: 'Microsoft Security Bulletin MS11-038 - Crítica'
ms:assetid: 'ms11-038'
ms:contentKeyID: 61235019
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-038(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-038 - Crítica
==============================================

Vulnerabilidade na Automação OLE Poderia Permitir Execução Remota de Código (2476490)
-------------------------------------------------------------------------------------
...
Esta actualização de segurança resolve uma vulnerabilidade comunicada de forma privada na automação de ligação e incorporação de objectos (OLE - Object Linking and Embedding) do Microsoft Windows. A vulnerabilidade poderia permitir a execução remota de código se um utilizador visitasse um Web site que contenha uma imagem de metaficheiro Windows (WMF) especialmente concebida para o efeito. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar esse Web site. Em vez disso, o intruso teria de convencer os utilizadores a visitar um Web site malicioso, levando-os normalmente a clicar numa hiperligação numa mensagem de correio electrónico, ou num pedido de mensagem instantânea.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2371079f-fb20-4fd5-999e-e73f3701818c)                                                                                                          | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b53d6631-4ded-48f5-a503-925b89b322b2)                                                                                 | Execução Remota de Código   | Crítica                             | [MS08-008](http://go.microsoft.com/fwlink/?linkid=108277) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7e6ff410-4552-4687-81ab-83d9c91f8af5)                                                                                                 | Execução Remota de Código   | Crítica                             | [MS08-008](http://go.microsoft.com/fwlink/?linkid=108277) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9c1a539f-1472-4394-8354-bd549d8332e0)                                                                                     | Execução Remota de Código   | Crítica                             | [MS08-008](http://go.microsoft.com/fwlink/?linkid=108277) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c194dd35-b9db-44a5-a252-38f9f803802f)                                                                      | Execução Remota de Código   | Crítica                             | [MS08-008](http://go.microsoft.com/fwlink/?linkid=108277) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f33c9e54-c2e5-498d-a798-5bbfe9e4249c)                                                                        | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4566528f-62ee-4d78-b3af-131a7cc15e1f)                                                | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c9614d9-6f61-463d-b1fa-bd5eb2c1a5c5)\*\*                     | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=36698775-0e4e-4980-ae4c-43542de424ca)\*\*           | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3edb613f-5bf0-4e28-9835-4afbb6ef0e01)       | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=50ae36ff-2406-48a4-97cc-12782b6d30ac)                                             | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1241f0f8-a5c7-420a-a5b7-b6c3caa9e5e2)                                   | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8181c359-cd79-438a-87be-093b363d0b04)\*\*     | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6b63a1eb-445a-4cd3-b357-9a1dd82d7a35) | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de Fluxo Insuficiente de Automação OLE - CVE-2011-0658</th>
...
Vulnerabilidade de Fluxo Insuficiente de Automação OLE - CVE-2011-0658  
----------------------------------------------------------------------
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0658](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0658).
  
#### Factores Atenuantes para a Vulnerabilidade de Fluxo Insuficiente de Automação OLE - CVE-2011-0658
...
#### Soluções Alternativas para a Vulnerabilidade de Fluxo Insuficiente de Automação OLE - CVE-2011-0658
  
Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:
  
-   **Restringir o acesso ao VBScript.dll**
  
    Para restringir acesso ao VBScript.dll, execute o seguinte comando a partir de uma linha de comandos:
  
    Para o Windows XP (sistemas de 32 bits):
  
    `cacls %windir%\system32\vbscript.dll /E /P everyone:N`
  
    Para o Windows XP (sistemas de 64 bits):
  
    `cacls %windir%\syswow64\vbscript.dll /E /P everyone:N`
  
    Para o Windows Vista e posteriores (sistemas de 32 bits):
  
    `takeown /f %windir%\system32\vbscript.dllcacls %windir%\system32\vbscript.dll /E /P everyone:N`
  
    Para o Windows Vista e posteriores (sistemas de 64 bits):
  
    `takeown /f %windir%\syswow64\vbscript.dllcacls %windir%\syswow64\vbscript.dll /E /P everyone:N`
  
    **Impacto da solução alternativa.** As páginas Web e outras aplicações que requerem o VBScript podem não ser apresentadas adequadamente.
  
    **Como anular esta solução alternativa.**
  
    Para anular a solução alternativa, execute o seguinte comando a partir de uma linha de comandos:
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Fluxo Insuficiente de Automação OLE - CVE-2011-0658
...
A vulnerabilidade é provocada pela forma como a Automação OLE analisa um ficheiro WMF especialmente concebido para o efeito.
  
**O que é a Automação OLE?**    
A Automação de ligação e incorporação de objectos (OLE - Object Linking and Embedding) é um protocolo Windows que permite que uma aplicação partilhe dados ou controle outra aplicação. A Automação OLE é uma norma industrial que as aplicações usam para expor os seus objectos OLE a ferramentas de desenvolvimento, linguagens de macro e outros contentores que suportam a Automação OLE.
  
**O que é o formato de imagem Metaficheiro do Windows (WMF)?**    
O formato de imagem WMF (Metaficheiro do Windows) é um formato de metaficheiro de 16 bits que pode incluir informações sobre vectores e mapas de bits. Este formato foi optimizado para o sistema operativo Windows.
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Se um utilizador tiver sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre o sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Esta vulnerabilidade requer que um utilizador visualize um ficheiro de imagem WMF especialmente concebido para o efeito. Um intruso poderia alojar um Web site especialmente concebido para o efeito, destinado a tirar partido desta vulnerabilidade através do Internet Explorer, persuadindo depois um utilizador a ver o Web site em questão. Isto também poderia incluir Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos por utilizadores, ou Web sites afectados. Estes Web sites podem conter conteúdos especialmente concebidos para o efeito, que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar esses Web sites. Em vez disso, o intruso teria de persuadir os utilizadores a visitar um Web site, levando-os normalmente a clicar numa hiperligação numa mensagem de correio electrónico, ou num pedido de mensagem instantânea que levasse o utilizador para o Web site do intruso. Também poderia ser possível exibir conteúdos Web nocivos concebidos especialmente para o efeito, usando espaços de publicidade como banners, ou usando outros métodos para entregar conteúdos Web a sistemas afectados.
...
Esta actualização de segurança resolve a vulnerabilidade corrigindo a forma como a Automação OLE analisa ficheiros WMF.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2476490$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2476490">Artigo 2476490 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Yamata Li, da [Palo Alto Networks](http://www.paloaltonetworks.com/), por fornecer informações sobre a Vulnerabilidade de Fluxo Insuficiente de Automação OLE (CVE-2011-0658)
