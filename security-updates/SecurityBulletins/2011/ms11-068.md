...
ms:assetid: 'ms11-068'
ms:contentKeyID: 61235049
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-068(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Kernel do Windows Poderia Permitir Negação de Serviço (2556532)
----------------------------------------------------------------------------------
...
| [Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=560efa6f-c956-47cb-a2f4-a1f45278b7cd)      | Negação de Serviço          | Moderada                            | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
...
| [Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6c8dd72b-abf8-4e1f-aafc-777c1a3ef3db)                         | Negação de Serviço          | Moderada                            | Nenhum                                                    |
...
| [Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d90c07c1-3c07-4989-825c-fb8453541a0e)                    | Negação de Serviço          | Moderada                            | Nenhum                                                    |
...
| [Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=67cccd09-5b82-4546-884a-d2a9e2400820)\*\*\* | Negação de Serviço          | Moderada                            | Nenhum                                                    |
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a1edf843-9a2a-4334-a95f-78e75a9b3ef1)                  | Negação de Serviço          | Moderada                            | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a1edf843-9a2a-4334-a95f-78e75a9b3ef1)   | Negação de Serviço          | Moderada                            | Nenhum                                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de Negação de Serviço na Análise de Metadados no Kernel do Windows - CVE-2011-1971</th>
...
Vulnerabilidade de Negação de Serviço na Análise de Metadados no Kernel do Windows - CVE-2011-1971  
--------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço no Windows devido à forma como o kernel analisa metadados de ficheiros ao navegar para uma pasta. Um intruso que explorasse esta vulnerabilidade com êxito poderia fazer com que o sistema afectado se desligasse.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1971](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1971).
  
#### Factores Atenuantes para a Vulnerabilidade de Negação de Serviço na Análise de Metadados no Kernel do Windows - CVE-2011-1971
...
-   No cenário de um ataque baseado na Web, um intruso poderia alojar um Web site contendo uma página Web que fosse utilizada para explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Num cenário de ataque baseado numa partilha de rede, um intruso poderia alojar um ficheiro especialmente concebido para o efeito numa partilha de rede que fosse utilizada para explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar esse Web site ou partilha de rede. Em vez disso, um intruso teria de persuadir os utilizadores a fazê-lo, levando-os normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico ou numa mensagem de um programa de mensagens instantâneas.
  
#### Soluções Alternativas para a Vulnerabilidade de Negação de Serviço na Análise de Metadados no Kernel do Windows - CVE-2011-1971
...
-   **Desactive o Painel de Pré-visualização e Painel de Detalhes no Windows Explorer**
    ...
    A desactivação dos painéis de Pré-visualização e de Detalhes no Explorador do Windows impede a apresentação automática de tipos de letra OTF no Explorador do Windows. Enquanto isto impede ficheiros nocivos de serem vistos no Explorador do Windows, não impede um utilizador local e autenticado de executar um programa especialmente concebido para explorar esta vulnerabilidade. Para desactivar estes painéis no Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2, execute os passos que se seguem:
  
    1.  Abra o Explorador do Windows, clique em **Organizar** e depois em **Esquema**.  
    ...
    6.  Feche todas as instâncias abertas do Explorador do Windows para a alteração ter efeito.
...
-   **Bloqueio das portas TCP 139 e 445 na firewall**
    ...
    **Como anular esta solução alternativa.** Desbloqueio das portas TCP 139 e 445 na firewall. Para mais informações sobre portas, consulte o artigo Technet sobre [Atribuição de portas TCP e UDP](http://go.microsoft.com/fwlink/?linkid=21312).
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Negação de Serviço na Análise de Metadados no Kernel do Windows - CVE-2011-1971
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de negação de serviço. Um intruso que explorou esta vulnerabilidade pode provocar o reinício do sistema afectado. Tenha em atenção que esta vulnerabilidade não permitiria que um intruso executasse o código ou elevasse os direitos de utilizador.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é provocada quando o kernel do Windows analisa inadequadamente informações de metadados em ficheiros.
  
**O que é o kernel do Windows?**    
O kernel do Windows é o núcleo do sistema operativo. O kernel proporciona serviços a nível do sistema, tais como a gestão de dispositivos e gestão de memória, atribui tempo de processador aos processos e gere o processamento de erros.
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que explorasse esta vulnerabilidade com êxito poderia fazer com que o sistema afectado fosse reiniciado.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Num cenário de ataque baseado na Web, um intruso teria de alojar um Web site que apontasse para um ficheiro especialmente concebido para o efeito numa partilha de rede. Então, quando o utilizador navegasse para o Web site, o caminho de controlo afectado seria accionado através dos painéis de Detalhes e de Pré-visualização no Explorador do Windows. O ficheiro especialmente concebido para o efeito poderia então explorar a vulnerabilidade e fazer com que o sistema afectado fosse reiniciado. Um intruso não conseguiria obrigar os utilizadores a visitarem um Web site especialmente concebido para o efeito. Em vez disso, um intruso teria de persuadi-los a visitar o Web site, normalmente conseguindo que clicassem numa ligação que os levasse ao site do intruso.
  
Num cenário de ataque baseado numa partilha de rede, um intruso poderia alojar um ficheiro especialmente concebido para o efeito numa partilha de rede. Quando o utilizador navega para a partilha no Explorador do Windows, o caminho de controlo afectado é accionado através dos painéis de Detalhes e de Pré-visualização. O ficheiro especialmente concebido para o efeito poderia então explorar a vulnerabilidade e fazer com que o sistema afectado fosse reiniciado.
...
A actualização resolve a vulnerabilidade corrigindo a forma como o kernel do Windows analisa informações de metadados em ficheiros.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2556532">Artigo 2556532 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
-   Zheng Wenbin, da [Qihoo 360 Security Center](http://www.360.cn/), por fornecer informações sobre a Vulnerabilidade de Negação de Serviço na Análise de Metadados no Kernel do Windows (CVE-2011-1971)
...
-   V1.1 (10 de Agosto de 2011): Revisão da notação de **instalação Server Core não afectada** para Windows Server 2008 e Windows Server 2008 R2 para clarificar que os sistemas instalados utilizando a opção de instalação Server Core continuarão a receber a actualização.
