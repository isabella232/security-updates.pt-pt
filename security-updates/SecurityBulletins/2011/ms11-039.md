...
ms:assetid: 'ms11-039'
ms:contentKeyID: 61235020
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-039(v=Security.10)'
---
...
**Questões conhecidas.** O [Artigo 2514842 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2514842) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
**Esta actualização de segurança está relacionada com o boletim MS11-044, Vulnerabilidade no .NET Framework Poderia Permitir** **Execução Remota de Código?**
...
O Microsoft Silverlight compilação 4.0.60531.0, que é a compilação actual do Microsoft Silverlight na data da primeira publicação deste boletim, resolve as vulnerabilidades e não é afectado. As compilações do Microsoft Silverlight anteriores a 4.0.60531.0 são afectadas.
...
A versão instalada com esta actualização de segurança é a 4.0.60531.0. Se o número da sua versão for igual ou superior a este número de versão, o seu sistema não está vulnerável.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0664](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0664).

#### Factores Atenuantes para a Vulnerabilidade de Offset de Matriz no .NET Framework - CVE-2011-0664
...
#### Soluções Alternativas para a Vulnerabilidade de Offset de Matriz no .NET Framework - CVE-2011-0664
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Offset de Matriz no .NET Framework - CVE-2011-0664
...
A vulnerabilidade é provocada quando o .NET Framework e o Microsoft Silverlight validam incorrectamente argumentos transmitidos para funções de rede integradas.
...
A actualização resolve a vulnerabilidade corrigindo a forma como o .NET Framework valida valores transmitidos a APIs fidedignas.
...
| Microsoft Silverlight 3 quando instalado em Mac                                                                                    | Sim  |
| Microsoft Silverlight 3 quando instalado em todas as edições de clientes Microsoft Windows                                         | Sim  |
| Microsoft Silverlight 3 quando instalado em todas as edições de servidores Microsoft Windows                                       | Sim  |
| Microsoft Silverlight 4 quando instalado em Mac                                                                                    | Sim  |
...
| Microsoft Silverlight 3 quando instalado em Mac                                                                                    | Sim               | Sim                        |
| Microsoft Silverlight 3 quando instalado em todas as edições de clientes Microsoft Windows                                         | Sim               | Sim                        |
| Microsoft Silverlight 3 quando instalado em todas as edições de servidores Microsoft Windows                                       | Sim               | Sim                        |
| Microsoft Silverlight 4 quando instalado em Mac                                                                                    | Sim               | Sim                        |
...
A tabela seguinte contém a informação sobre a actualização de segurança para este software. Pode encontrar informações adicionais na subsecção, **Informações de** **Implementação**, neste secção.
...
<td style="border:1px solid black;">Consultar a subsecção, <strong>Orientações e</strong> <strong>ferramentas de detecção e implementação</strong></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2514842">Artigo 2514842 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 4.0 quando instalado no Windows Server 2003 em sistemas de 32 bits:<br />
NDP40-KB2478663-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 4.0 quando instalado no Windows Server 2003 em sistemas baseados em x64:<br />
NDP40-KB2478663-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 3.5 no Windows Server 2003 em sistemas baseados em Itanium:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 4.0 quando instalado no Windows Server 2003 em sistemas baseados em Itanium:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Para desinstalar uma actualização instalada pelo WUSA, utilize o parâmetro de configuração /Uninstall ou clique em <strong>Painel de Controlol</strong>, em <strong>Sistema e</strong> <strong>Segurança</strong> e, adepois, em Windows Update, em <strong>Ver actualizações instaladas</strong> e seleccione-a a partir da lista de actualizações.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2514842">Artigo 2514842 da Base de Dados de Conhecimento da Microsoft</a></td>
