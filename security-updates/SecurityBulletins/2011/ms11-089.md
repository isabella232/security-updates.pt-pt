...
ms:assetid: 'ms11-089'
ms:contentKeyID: 61235070
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-089(v=Security.10)'
---
...
Vulnerabilidade no Microsoft Office Poderia Permitir Execução Remota de Código (2590602)
----------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para todas as edições suportadas do Microsoft Office 2007, Microsoft Office 2010 e Microsoft Office para Mac 2011. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o Microsoft Word analisa ficheiros Word especialmente concebidos para o efeito. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as Vulnerabilidades**.
...
**Por que razão esta actualização é classificada apenas como Importante para as versões afectadas do** **Office?**
...
**O vector de ataque para a vulnerabilidade é através do Microsoft Word. Por que razão esta é** **uma** **actualização do Microsoft Office?**
Embora o vector de ataque para CVE-2011-1983 seja apenas através de versões afectadas do Microsoft Word, o código vulnerável encontra-se num componente partilhado do Microsoft Office. Outro software Microsoft Office, incluindo algumas versões suportadas do Microsoft Visio (consulte [KB2553374 (x86)](http://www.microsoft.com/downloads/details.aspx?familyid=20a9e33e-079d-4522-8cff-6a284d842979) e [KB2553374 (x64)](http://www.microsoft.com/downloads/details.aspx?familyid=866f0a93-01a9-4e0a-8bf8-aa4dffce6c15)), Microsoft Visio Viewer (consulte [KB2553353 (x86)](http://www.microsoft.com/downloads/details.aspx?familyid=d8db143f-bc08-466e-81bb-2efef1d8a68d) e [KB2553353 (x64)](http://www.microsoft.com/downloads/details.aspx?familyid=dee2c20c-0afd-4ebe-aabb-66593c76adf3)), Microsoft Office Web Application Companions (WAC) (consulte [KB2553153](http://www.microsoft.com/downloads/details.aspx?familyid=f7e2fb4c-a883-4517-8c6d-740a69845fe8)) e Microsoft SharePoint Server 2010 (consulte [KB2553132](http://www.microsoft.com/downloads/details.aspx?familyid=e03b4a55-810e-4503-8236-2e1a33ec3e7d)), contém o componente partilhado vulnerável do Microsoft Office, mas por não aceder ao código vulnerável, não é afectado por esta vulnerabilidade. Contudo, como o código vulnerável está presente, esta actualização será oferecida.

**Tenho software Microsoft Office instalado. Por que razão não me está a ser oferecida esta actualização?**
A actualização apenas será oferecida a sistemas que executam software Microsoft Office que contém o componente partilhado vulnerável do Microsoft Office.

Note que o vector de ataque para o CVE-2011-1983 é apenas através das versões afectadas do Microsoft Word. Outro Software Microsoft Office pode receber esta actualização porque o componente do Microsoft Office partilhado vulnerável está presente, mas uma vez que não acede ao código vulnerável, não é afectado por esta vulnerabilidade.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Utilização Após Libertação Word - CVE-2011-1983
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Word processa ficheiros Word especialmente concebidos para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1983](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1983).

#### Factores Atenuantes para a Vulnerabilidade de Utilização Após Libertação Word - CVE-2011-1983
...
#### Soluções Alternativas para a Vulnerabilidade de Utilização Após Libertação Word - CVE-2011-1983
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Utilização Após Libertação Word - CVE-2011-1983
...
A vulnerabilidade é causada quando o Microsoft Word processa incorrectamente objectos na memória.
...
A exploração desta vulnerabilidade requer que um utilizador abra um ficheiro Word especialmente concebido para o efeito usando uma versão afectada do Microsoft Word.
...
Os sistemas em que o Microsoft Word é utilizado, como estações de trabalho, estão mais susceptíveis. Os servidores podem estar mais sujeitos a risco se os administradores permitirem que os utilizadores iniciem sessão nos servidores e executem programas. Contudo, os procedimentos recomendados desencorajam essa acção.

**O que faz a actualização?**
A actualização resolve a vulnerabilidade modificando a forma como o Microsoft Word analisa ficheiros Word especialmente concebidos para o efeito.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2596785">Artigo 2596785 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2589320">Artigo 2589320 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
Transfira e instale a versão de idioma adequada para a Actualização 14.1.4 do Microsoft Office para Mac 2011, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=3c8017d6-232c-42a6-a133-96efe3ad3385).
...
-   Abra o volume da Actualização 14.1.4 do Microsoft Office para Mac 2011 na sua área de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume de Actualização 14.1.4 do Microsoft Office para Mac 2011, faça duplo clique na aplicação da Actualização 14.1.4 do Microsoft Office para Mac 2011 e siga as instruções no ecrã.  
-   Quando a instalação tiver sido concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: "Verificação da Instalação da Actualização". Para remover o programa de instalação, primeiro arraste o volume da Actualização 14.1.4 do Microsoft Office para Mac 2011 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da Versão Instalada de Actualização Mais Recente for **14.1.4**, a actualização foi instalada com sucesso.
...
-   Nikita Tarakanov (CISS Research Team) e Alexey Sintsov (Digital Security Research Group), a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecerem informações sobre a Vulnerabilidade de Utilização Após Libertação Word (CVE-2011-1983)
...
-   V1.1 (16 de Dezembro de 2011): Amentada a lista de software não afectado e revistas as perguntas frequentes sobre a actualização para ajudar a clarificar que esta actualização pode ser oferecida a software não afectado quando o componente do Microsoft Office partilhado vulnerável está presente.  
-   V1.2 (22 de Fevereiro de 2012): Boletim revisto para identificar os números KB do pacote de actualização para o seguinte software não afectado a que esta actualização se aplica: Microsoft Visio (KB2553374), Microsoft Visio Viewer (KB2553353), Microsoft Office Web Application Companions (WAC) (KB2553153) e Microsoft SharePoint Server 2010 (KB2553132). Para obter mais informações, consulte as perguntas frequentes sobre a actualização.
