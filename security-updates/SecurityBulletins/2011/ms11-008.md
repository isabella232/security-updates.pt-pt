...
ms:assetid: 'ms11-008'
ms:contentKeyID: 61234989
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-008(v=Security.10)'
---
...
Vulnerabilidades no Microsoft Visio Poderiam Permitir Execução Remota de Código (2451879)
-----------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para o Microsoft Visio 2002 Service Pack 2, Microsoft Visio 2003 Service Pack 3 e Microsoft Visio 2007 Service Pack 2. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades corrigindo a forma como o Microsoft Visio processa estruturas e objectos corrompidos em memória ao analisar ficheiros Visio especialmente concebidos para o efeito. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória de Objecto Visio - CVE-2011-0092</th>
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória de Tipo de Dados Visio - CVE-2011-0093</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Corrupção de Memória de Objecto Visio - CVE-2011-0092  
------------------------------------------------------------------------
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0092](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0092).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objecto Visio - CVE-2011-0092
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objecto Visio - CVE-2011-0092
  
Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:
  
-   **Restringir o acesso ao ORMELEMS.DLL**
    ...
    **Nota** Para &lt;office version&gt;, introduza a versão do componente do Microsoft Office apropriado existente no seu sistema como, por exemplo, "Office10" para Microsoft Visio 2002, "Office11" para Microsoft Visio 2003 e "Office12" para Microsoft Visio 2007. Para verificar a versão, abra este componente do Microsoft Office e clique em **Ajuda**.
    ...
    **Impacto da solução alternativa.** Os utilizadores não poderão utilizar a funcionalidade de Modelação de Bases de Dados no Visio.
...
-   **Desactivar Suplementos no Microsoft Visio 2007**
  
    Abra o Visio 2007 e siga os passos apresentados abaixo:
  
    1.  Clique em **Ferramentas**.  
    2.  Clique em **Centro de Fidedignidade**.  
    3.  Clique em **Suplementos**.  
    4.  Certifique-se de que a caixa de verificação **Desactivar todos os Suplementos da Aplicação** está seleccionada.  
    5.  Clique em **OK** para aplicar as Definições.
  
    **Impacto da solução alternativa.** A funcionalidade que depende dos suplementos Visio não funcionará.
    ...
    **Como anular esta solução alternativa.**
    ...
    2.  Clique em **Centro de Fidedignidade**.  
    3.  Clique em **Suplementos**.  
    4.  Certifique-se de que a caixa de verificação **Desactivar todos os Suplementos da Aplicação** não está seleccionada.  
    5.  Clique em **OK** para aplicar as Definições.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objecto Visio - CVE-2011-0092
...
Vulnerabilidade de Corrupção de Memória de Tipo de Dados Visio - CVE-2011-0093  
------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Visio analisa algumas estruturas ao processar ficheiros Visio especialmente concebidos para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com direitos de utilização reduzidos no sistema podem ser menos afectados do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0093](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0093).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Tipo de Dados Visio - CVE-2011-0093
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Tipo de Dados Visio - CVE-2011-0093
  
Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:
  
-   **Restringir o acesso ao ELEMENTS.DLL**
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Tipo de Dados Visio - CVE-2011-0093
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**O que provoca a vulnerabilidade?**    
O Microsoft Visio não processa correctamente estruturas corrompidas ao abrir ficheiros Visio especialmente concebidos para o efeito.
...
**O que faz a actualização?**    
Esta actualização resolve a vulnerabilidade corrigindo a forma como o Microsoft Visio analisa estruturas corrompidas ao abrir ficheiros Visio especialmente concebidos para o efeito.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2434711">Artigo 2434711 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2434733">Artigo 2434733 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2434737">Artigo 2434737 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
-   Procyun, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [Tipping Point](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objecto Visio (CVE-2011-0092)  
-   Xin Ouyang, da [Palo Alto Networks](http://www.paloaltonetworks.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objecto Visio (CVE-2011-0092)  
-   Xin Ouyang, da [Palo Alto Networks](http://www.paloaltonetworks.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Tipo de Dados Visio (CVE-2011-0093)
