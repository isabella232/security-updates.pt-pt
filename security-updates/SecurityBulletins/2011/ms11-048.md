---
TOCTitle: 'MS11-048'
Title: 'Microsoft Security Bulletin MS11-048 - Importante'
ms:assetid: 'ms11-048'
ms:contentKeyID: 61235029
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-048(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS11-048 - Importante
=================================================

Vulnerabilidade no Servidor SMB Poderia Permitir Negação de Serviço (2536275)
-----------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5f0007c3-8d11-4940-8766-1112e3777aae)                                                                        | Negação de Serviço          | Importante                          | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fadf6f12-1f09-4d49-93b1-8fce01400b4f)                                                | Negação de Serviço          | Importante                          | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8960dd62-7cf7-41cb-97b2-b082bd1750aa)\*                       | Negação de Serviço          | Importante                          | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0abc6908-ac6a-4da3-843a-af6841ccc1db)\*             | Negação de Serviço          | Importante                          | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=057f1356-9c70-4457-a1df-69334fdab467)       | Negação de Serviço          | Importante                          | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=cf9e5ecd-68f7-4982-b4ed-be80859b757c)                                             | Negação de Serviço          | Importante                          | [MS11-020](http://go.microsoft.com/fwlink/?linkid=212236) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2707650a-604c-4044-acc4-07a30b5640d8)                                   | Negação de Serviço          | Importante                          | [MS11-020](http://go.microsoft.com/fwlink/?linkid=212236) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f9824310-772d-4e1e-980e-11e2db3ac53e)\*       | Negação de Serviço          | Importante                          | [MS11-020](http://go.microsoft.com/fwlink/?linkid=212236) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0533d293-e186-4d39-a925-ab3d9ed46290) | Negação de Serviço          | Importante                          | [MS11-020](http://go.microsoft.com/fwlink/?linkid=212236) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Análise de Pedido SMB - CVE-2011-1267</th>
...
Vulnerabilidade de Análise de Pedido SMB - CVE-2011-1267  
--------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço na forma como o software do protocolo SMB (Bloco de Mensagem de Servidor) da Microsoft processa pedidos SMB especialmente concebidos para o efeito. Não seria necessária autenticação para uma tentativa de exploração da vulnerabilidade, o que permitiria a um intruso explorar a vulnerabilidade enviando uma mensagem de rede especialmente concebida para um computador que execute o serviço de Servidor.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1267](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1267).
  
#### Factores Atenuantes para a Vulnerabilidade de Análise de Pedido SMB - CVE-2011-1267
...
#### Soluções Alternativas para a Vulnerabilidade de Análise de Pedido SMB - CVE-2011-1267
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Análise de Pedido SMB - CVE-2011-1267
...
A vulnerabilidade é causada quando o software do protocolo SMB (Bloco de Mensagem de Servidor) da Microsoft processa de forma inadequada pedidos SMB especialmente concebidos para o efeito.
...
**Esta questão afecta o SMBv1 ou o SMBv2?**    
Esta questão afecta tanto o protocolo SMBv1 como o SMBv2.
...
A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o software do protocolo SMB processa pedidos SMB especialmente concebidos para o efeito.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2536275">Artigo 2536275 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
