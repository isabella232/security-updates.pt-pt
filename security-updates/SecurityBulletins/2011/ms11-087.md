...
ms:assetid: 'ms11-087'
ms:contentKeyID: 61235068
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-087(v=Security.10)'
author: SharonSears
...
Vulnerabilidade nos Controladores de Modo de Kernel do Windows Poderiam Permitir Execução Remota de Código (2639417)
--------------------------------------------------------------------------------------------------------------------
...
A actualização de segurança resolve a vulnerabilidade modificando a forma como um controlador do modo de kernel do Windows processa ficheiros de tipos de letra TrueType. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.

Esta actualização de segurança também resolve a vulnerabilidade descrita previamente no [Aviso de Segurança da Microsoft 2639658](http://technet.microsoft.com/security/advisory/2639658).
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b01bb041-005c-48c4-a606-66aa264ba0fa)                                                                                                          | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0a872cd2-5f4d-400c-a1c4-a2d194746fb6)                                                                                 | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e84e6964-1580-41ef-9d3e-4d0c3ad4cb69)                                                                                                 | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9d9f3667-3fd6-4948-83db-282783599f41)                                                                                     | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1ecf72cd-6732-4cf3-aa22-8caf15ea633e)                                                                      | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7f69ec9d-43ad-4106-90ef-c191e7ec43af)                                                                                                       | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ae1f1f86-6f13-4e1e-9f93-4f70b6c9927e)                                                                                           | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c4ba344d-dd0d-4cfb-81d9-d364d7f37e25)\*\*\*\*                                                                | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=058963f6-9654-41d0-86d2-f25a0c2ad416)\*\*\*\*                                                           | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=42cd1c33-11a7-4a29-ae85-f7272a626f91)                                                               | Execução Remota de Código   | Crítica                             | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0526727a-f2fb-4846-9b04-f1899f52f1f6)                                             | Execução Remota de Código   | Crítica                             | [MS11-084](http://go.microsoft.com/fwlink/?linkid=229245) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=cfd42c42-1595-419a-bf04-b23b64663629)                                   | Execução Remota de Código   | Crítica                             | [MS11-084](http://go.microsoft.com/fwlink/?linkid=229245) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d64a31ca-cccd-488a-98fd-c059b9e9e1ea)\*\*\*\* | Execução Remota de Código   | Crítica                             | [MS11-084](http://go.microsoft.com/fwlink/?linkid=229245) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b46f6da7-6d24-4262-8e55-3b657db39813) | Execução Remota de Código   | Crítica                             | [MS11-084](http://go.microsoft.com/fwlink/?linkid=229245) |
...
<span></span>
**Se apliquei as soluções alternativas** **fornecidas no Aviso de Segurança da Microsoft 2639658, tenho de as anular** **antes de aplicar esta actualização?**
Não. Não necessita de anular a solução alternativa, "Negar acesso ao T2EMBED.DLL", em sistemas em que a tenha aplicado anteriormente, antes de instalar esta actualização de segurança.

No entanto, depois de aplicar esta actualização de segurança, deve anular a solução alternativa, "Negar acesso ao T2EMBED.DLL", em sistemas onde a tenha aplicado anteriormente a fim de restaurar funcionalidades desactivadas pela solução alternativa. Consulte o [Artigo 2639417 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2639417) para utilizar a solução automática de correcção da Microsoft para desactivar esta solução alternativa.
...
Sim, a actualização KB2639417 está disponível para o Windows Developer Preview. Aconselha-se os clientes que utilizam o Windows Developer Preview a aplicarem a actualização nos seus sistemas. A actualização está disponível no [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
O Windows Server 2008 e o Windows Server 2008 R2, quando instalados utilizando a opção de instalação Server Core, apenas são vulneráveis a um cenário de ataque local de elevação de privilégios para CVE-2011-3402. Os cenários de ataque baseado na Web e de partilha de ficheiros não se aplicam.
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 para sistemas de 32 bits Service Pack 2, quando instalado utilizando a opção de instalação Server Core
</td>
<td style="border:1px solid black;">
**Importante**  
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 para sistemas baseados em x64 Service Pack 2, quando instalado utilizando a opção de instalação Server Core
</td>
<td style="border:1px solid black;">
**Importante**  
Elevação de Privilégios
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1, quando instalados utilizando a opção de instalação Server Core
</td>
<td style="border:1px solid black;">
**Importante**  
Elevação de Privilégios
...
-   **Negar acesso ao T2EMBED.DLL**
    ...
    **Nota** Esta solução alternativa apenas atenua os cenários de ataque baseado na Web e de partilha de ficheiros. O cenário de ataque local não será atenuado por esta solução alternativa.
...
A actualização resolve a vulnerabilidade modificando a forma como um controlador do modo de kernel do Windows processa ficheiros de tipos de letra TrueType.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2639417$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2639417">Artigo 2639417 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilize a ferramenta **Adicionar ou Remover Programas** no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\\$NTUninstallKB2639417$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consulte o [Artigo 2639417 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2639417)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Symantec e Laboratório de Criptografia e Segurança de Sistemas (CrySyS), por trabalharem connosco na Vulnerabilidade na Análise de Tipos de Letra TrueType (CVE-2011-3402)
