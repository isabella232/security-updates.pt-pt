---
TOCTitle: 'MS11-001'
Title: 'Microsoft Security Bulletin MS11-001 - Importante'
ms:assetid: 'ms11-001'
ms:contentKeyID: 61234982
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-001(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS11-001 - Importante
=================================================

Vulnerabilidade no Gestor de Cópias de Segurança do Windows Poderia Permitir Execução Remota de Código (2478935)
----------------------------------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para todas as edições suportadas do Windows Vista. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o Gestor de Cópias de Segurança do Windows carrega bibliotecas externas. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4eeaad20-729c-4594-8853-e4ae55e9d491)                         | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b2839cd0-1958-4a22-9aac-0e0aa8f2b52c) | Execução Remota de Código   | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Gestor de Cópias de Segurança - CVE-2010-3145</th>
...
Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Gestor de Cópias de Segurança - CVE-2010-3145  
------------------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Gestor de Cópias de Segurança do Microsoft Windows processa o carregamento de ficheiros DLL. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3145](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3145).
  
#### Factores Atenuantes para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Gestor de Cópias de Segurança - CVE-2010-3145
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Para um ataque poder ser bem sucedido, um utilizador terá de visitar uma localização não fidedigna do sistema de ficheiro remoto ou partilha WebDAV e abrir um ficheiro de Catálogo de Cópia de Segurança do Windows (.wbcat).  
...
#### Soluções Alternativas para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Gestor de Cópias de Segurança - CVE-2010-3145
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Gestor de Cópias de Segurança - CVE-2010-3145
...
A vulnerabilidade é provocada quando o Gestor de Cópias de Segurança do Windows restringe incorrectamente o caminho utilizado para carregar bibliotecas externas.
  
**O que é o Gestor de Cópias de Segurança do Windows?**    
O Gestor de Cópias de Segurança do Windows (sdclt.exe) permite que os utilizadores restaurem os ficheiros do sistema de um computador para um ponto anterior no tempo. O Restauro do Sistema utiliza uma funcionalidade chamada Protecção do Sistema para criar e guardar regularmente pontos de restauro no computador. Estes pontos de restauro contêm informações sobre definições de registo e outras informações do sistema que o Windows utiliza. Estes pontos de restauro também podem ser criados manualmente.
...
Para explorar esta vulnerabilidade, é necessário que um utilizador abra um ficheiro .wbcat legítimo localizado no mesmo directório que um ficheiro de biblioteca de ligação dinâmica (DLL) especialmente concebido para o efeito. Ao abrir o ficheiro .wbcat, a aplicação do Gestor de Cópias de Segurança do Windows poderia tentar carregar o ficheiro DLL especialmente concebido para o efeito e executar qualquer código aí contido.
  
Num cenário de ataque através da rede, um intruso poderia colocar um ficheiro .wbcat legítimo e um DLL especialmente concebido para o efeito numa partilha de rede, tal como numa localização UNC ou WebDAV, e convencer o utilizador a abrir o ficheiro .wbcat. Quando o utilizador abrir o ficheiro .wbcat, poderá ser carregado o ficheiro DLL especialmente concebido para o efeito e que está contido no mesmo directório que o ficheiro .wbcat. Um intruso não teria qualquer forma de obrigar os utilizadores a abrir um ficheiro .wbcat a partir de uma partilha de rede. Em vez disso, um intruso teria de convencer os utilizadores a abrir o ficheiro, levando-os a clicar numa hiperligação presente numa mensagem de correio electrónico, ou numa mensagem de um programa de mensagens instantâneas, que levasse os utilizadores para a partilha de rede e, em seguida, convencê-los a abrir o ficheiro .wbcat.
  
Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade enviando um anexo .wbcat legítimo a um utilizador, convencendo-o a colocar o anexo num directório que contivesse um ficheiro DLL especialmente concebido para o efeito e, depois, convencendo-o a abrir o ficheiro .wbcat. Quando o utilizador abrir o ficheiro .wbcat, poderá ser carregado o ficheiro DLL especialmente concebido para o efeito e que está contido no mesmo directório que o ficheiro .wbcat. Se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá estar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na rede.
...
A actualização resolve esta vulnerabilidade corrigindo a forma como o Gestor de Cópias de Segurança do Windows carrega bibliotecas externas.
  
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3145](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3145).
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2478935">Artigo 2478935 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
