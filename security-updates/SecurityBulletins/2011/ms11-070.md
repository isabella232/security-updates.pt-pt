...
ms:assetid: 'ms11-070'
ms:contentKeyID: 61235051
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-070(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no WINS Poderia Permitir Elevação de Privilégios (2571621)
--------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1e6ac3b2-752e-49a0-84e5-5a8dfe955299)                                                                                           | Elevação de Privilégios     | Importante                          | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f9378339-c58e-4e84-9427-85aeb35b0d99)                                                                               | Elevação de Privilégios     | Importante                          | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c35c71a8-13b4-47a6-9763-06f6f65327b1)                                                                | Elevação de Privilégios     | Importante                          | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a9039660-3cc2-470d-a0a5-a70f78074495)\*                                                                | Elevação de Privilégios     | Importante                          | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ea78a9b-b1f7-4e94-b69e-c984e1622ae9)\*                                                           | Elevação de Privilégios     | Importante                          | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f58cf343-946c-4e74-bd9c-40ac934a4986)\* | Elevação de Privilégios     | Importante                          | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Elevação Local de Privilégios no WINS - CVE-2011-1984</th>
...
Vulnerabilidade de Elevação Local de Privilégios no WINS - CVE-2011-1984  
------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no WINS, permitindo a execução de código arbitrário no contexto do sistema local. A vulnerabilidade é causada quando o servidor WINS processa incorrectamente uma sequência de pacotes especialmente concebidos para o efeito recebidos na interface de loopback. Um intruso local que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. O intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1984](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1984).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação Local de Privilégios no WINS - CVE-2011-1984
...
#### Soluções Alternativas para a Vulnerabilidade de Elevação Local de Privilégios no WINS - CVE-2011-1984
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação Local de Privilégios no WINS - CVE-2011-1984
  
**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de elevação local de privilégios.
  
**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o servidor WINS processa incorrectamente uma sequência de pacotes especialmente concebidos para o efeito recebidos na interface de loopback.
...
Um intruso que explorasse esta vulnerabilidade com sucesso no Windows Server 2003 poderia executar código arbitrário no contexto de um sistema local. Um intruso que explorasse esta vulnerabilidade com sucesso no Windows Server 2008 ou no Windows Server 2008 R2 poderia executar código arbitrário no contexto do serviço local. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**Como poderia um intruso explorar a vulnerabilidade?**  
Para explorar esta vulnerabilidade, um intruso teria de iniciar primeiro sessão no sistema. Um intruso poderia então executar uma aplicação especialmente concebida para o efeito que poderia explorar a vulnerabilidade enviando pacotes especialmente concebidos para o efeito à interface de loopback permitindo que o intruso obtivesse o controlo total sobre o sistema afectado.
...
A actualização resolve a vulnerabilidade corrigindo a forma como o WINS processa a comunicação interna no endereço de loopback.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2571621$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2571621">Artigo 2571621 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Nicolas Economou, da [Core Security Technologies](http://www.coresecurity.com/), por fornecer informações sobre a Vulnerabilidade de Elevação Local de Privilégios no WINS (CVE-2011-1984)
