---
TOCTitle: 'MS11-081'
Title: 'Microsoft Security Bulletin MS11-081 - Crítica'
ms:assetid: 'ms11-081'
ms:contentKeyID: 61235062
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-081(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS11-081 - Crítica
==============================================

Actualização de Segurança Cumulativa para o Internet Explorer (2586448)
-----------------------------------------------------------------------

Data de publicação: 11 de outubro de 2011 | Updated: 2 de novembro de 2011
...
Esta actualização de segurança está classificada como Crítica para o Internet Explorer em clientes Windows e como Moderada para o Internet Explorer em servidores Windows. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização resolve as vulnerabilidades modificando a forma como o Internet Explorer processa objectos na memória e a forma como o Internet Explorer atribui e acede à memória. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as Vulnerabilidades**.
...
**Questões conhecidas.** O [Artigo 2586448 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2586448) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
<span></span>
**Por que razão foi revisto este boletim a 2 de Novembro** **de** **2011?**
A Microsoft reviu este boletim para anunciar a publicação de um hotfix para resolver uma questão que afecta os clientes do Internet Explorer 7, onde algumas pesquisas na lista suspensa e caixas de combinação não aparecem no Internet Explorer 7 depois de instalar a actualização de segurança KB2586448. Para obter mais informações acerca desta questão e para obter instruções sobre como aplicar o hotfix resolver a questão, consulte o [Artigo 2586448 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2586448).
...
Sim. Para além das alterações indicadas na secção de Informações sobre as Vulnerabilidades deste boletim, esta actualização inclui actualizações de medidas de defesa profunda para ajudar a melhorar a protecção de memória, estruturas e gestão de cookies, a API Bing e o Filtro XSS no Internet Explorer.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código em Evento de Navegação - CVE-2011-1993
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código em OLEAuto32.dll - CVE-2011-1995
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código em Elemento de Opção - CVE-2011-1996
</th>
<th colspan="2">
Vulnerabilidade de Execução Remota de Código em Evento OnLoad - CVE-2011-1997
</th>
</tr>
<tr>
<th colspan="6">
...
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código em Jscript9.dll - CVE-2011-1998
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código em Elemento de Selecção - CVE-2011-1999
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código em Elemento de Corpo - CVE-2011-2000
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código de Corrupção em Tabela de Função Virtual - CVE-2011-2001
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acede a um objecto que foi eliminado. A vulnerabilidade pode corromper a memória de tal forma que um intruso poderia executar código arbitrário no contexto do utilizador com sessão iniciada.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1993](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1993).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código em Evento de Navegação - CVE-2011-1993
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código em Evento de Navegação - CVE-2011-1993
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código em Evento de Navegação - CVE-2011-1993
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acede a um objecto que não tenha sido inicializado correctamente. A vulnerabilidade pode corromper a memória de tal forma que um intruso poderia executar código arbitrário no contexto do utilizador com sessão iniciada.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1995](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1995).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código em OLEAuto32.dll - CVE-2011-1995
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código em OLEAuto32.dll - CVE-2011-1995
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código em OLEAuto32.dll - CVE-2011-1995

**Qual é a abrangência desta vulnerabilidade?**
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**O que provoca a vulnerabilidade?**
Quando o Internet Explorer tenta aceder a um objecto que não foi inicializado, pode corromper a memória de tal forma que um intruso poderia executar código arbitrário no contexto do utilizador com sessão iniciada.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1996](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1996).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código em Elemento de Opção - CVE-2011-1996
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código em Elemento de Opção - CVE-2011-1996
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código em Elemento de Opção - CVE-2011-1996
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1997](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1997).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código em Evento OnLoad - CVE-2011-1997
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código em Evento OnLoad - CVE-2011-1997
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código em Evento OnLoad - CVE-2011-1997
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1998](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1998).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código em Jscript9.dll - CVE-2011-1998
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código em Jscript9.dll - CVE-2011-1998
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código em Jscript9.dll - CVE-2011-1998
...
**Como poderia um intruso explorar a vulnerabilidade?**
Um intruso poderia alojar um Web site especialmente concebido para o efeito, destinado a explorar esta vulnerabilidade através do Internet Explorer, convencendo depois um utilizador a ver o Web site em questão e a executar acções no mesmo. O intruso também poderia tirar partido de Web sites corrompidos ou Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos pelo utilizador. Estes Web sites podem conter conteúdos especialmente concebidos para o efeito, que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visualizar o conteúdo controlado pelo intruso. Em vez disso, um intruso teria de convencer os utilizadores a executarem determinadas acções, normalmente conseguindo que clicassem numa hiperligação numa mensagem de correio electrónico ou numa mensagem de um programa de mensagens instantâneas que leva os utilizadores ao Web site do intruso, ou abrindo um anexo enviado através de correio electrónico.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acede a um endereço da memória sem referência. A vulnerabilidade pode corromper a memória de tal forma que um intruso poderia executar código arbitrário no contexto do utilizador com sessão iniciada.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1999](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1999).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código em Elemento de Selecção - CVE-2011-1999
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código em Elemento de Selecção - CVE-2011-1999
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código em Elemento de Selecção - CVE-2011-1999

**Qual é a abrangência desta vulnerabilidade?**
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**O que provoca a vulnerabilidade?**
Quando o Internet Explorer tenta aceder a um endereço de memória sem referência, pode corromper a memória de tal modo que um intruso poderia executar código arbitrário no contexto do utilizador com sessão iniciada.
...
**O que faz a actualização?**
A actualização resolve a vulnerabilidade modificando a forma como o Internet Explorer atribui e acede à memória.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-2000](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2000).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código em Elemento de Corpo - CVE-2011-2000
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código em Elemento de Corpo - CVE-2011-2000
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código em Elemento de Corpo - CVE-2011-2000
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acede a uma tabela de função virtual depois de ter sido corrompida. A vulnerabilidade pode corromper a memória de tal forma que um intruso poderia executar código arbitrário no contexto do utilizador com sessão iniciada.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-2001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2001).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código de Corrupção em Tabela de Função Virtual - CVE-2011-2001
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código de Corrupção em Tabela de Função Virtual - CVE-2011-2001
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código de Corrupção em Tabela de Função Virtual - CVE-2011-2001

**Qual é a abrangência desta vulnerabilidade?**
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**O que provoca a vulnerabilidade?**
Quando o Internet Explorer tenta aceder a uma tabela de função virtual corrompida, pode permitir que um intruso execute código arbitrário no contexto do utilizador com sessão iniciada.
...
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2586448$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB2586448-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie8updates\KB2586448-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2586448">Artigo 2586448 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Vishwas Sharma, da McAfee Labs, por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código em Evento de Navegação (CVE-2011-1993)  
-   David Bloom, da [Greplin](https://www.greplin.com), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código em OLEAuto32.dll (CVE-2011-1995)  
-   Ivan Fratric, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com) da [TippingPoint](http://www.tippingpoint.com), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código em Elemento de Opção (CVE-2011-1996)  
-   [GWSlabs](http://www.gwslabs.com), a trabalhar com a [VeriSign iDefense Labs](http://labs.idefense.com), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código em Evento OnLoad (CVE-2011-1997)  
-   David Bloom, da [Greplin](https://www.greplin.com), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código em Jscript9.dll (CVE-2011-1998)  
-   Ivan Fratric, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com) da [TippingPoint](http://www.tippingpoint.com), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código em Elemento de Selecção (CVE-2011-1999)  
-   Sebastian Apelt, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com) da [TippingPoint](http://www.tippingpoint.com), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código em Elemento de Corpo (CVE-2011-2000)  
-   Investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com) da [TippingPoint](http://www.tippingpoint.com), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código de Corrupção em Tabela de Função Virtual (CVE-2011-2001)  
-   Eduardo Vela Nava, da [Google Inc.](http://www.google.com), e David Bloom, da [Greplin](https://www.greplin.com), por trabalharem connosco nas alterações a nível de medidas de defesa profunda incluídas neste boletim  
-   [Soroush Dalili](http://www.secproject.com), por trabalhar connosco nas alterações a nível de medidas de defesa profunda incluídas neste boletim  
-   Billy Rios, da [Google Inc.](http://www.google.com), por trabalhar connosco nas alterações a nível de medidas de defesa profunda incluídas neste boletim
...
-   V1.1 (12 de Outubro de 2011): Ligação adicionada para o Artigo 2586448 da Base de Dados de Conhecimento da Microsoft, na secção Questões Conhecidas, no Resumo Executivo.  
-   V1.2 (2 de Novembro de 2011): Anunciada a publicação de um hotfix para resolver uma questão conhecida que afecta os clientes do Internet Explorer 7 depois de instalar a actualização de segurança KB2586448. Para obter mais informações, consulte as perguntas frequentes sobre a actualização.
