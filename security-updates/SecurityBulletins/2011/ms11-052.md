...
ms:assetid: 'ms11-052'
ms:contentKeyID: 61235033
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-052(v=Security.10)'
author: SharonSears
...
Data de publicação: 14 de junho de 2011 | Updated: 12 de julho de 2011
...
<span></span>
**Por que razão foi revisto este boletim a 12 de Julho de 2011?**  
A Microsoft reviu este boletim para anunciar uma alteração da lógica de detecção e para corrigir as informações relativas à substituição do boletim para algumas configurações afectadas.

Para clientes que executam o Internet Explorer 6 para todas edições baseadas em x64 suportadas do Windows XP e para todas as edições suportadas do Windows Server 2003, esta é uma alteração da lógica de detecção e uma correcção das informações relativas à substituição do boletim. Não foram efectuadas alterações aos ficheiros de actualização de segurança. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.

Para clientes que executam o Internet Explorer 7 para todas as edições suportadas do Windows XP e Windows Server 2003, esta é apenas uma correcção das informações relativas à substituição do boletim. Não foram efectuadas alterações à lógica de detecção nem aos ficheiros de actualização de segurança. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.
...
Sim. Os clientes que instalaram a actualização de segurança do VML em sistemas com o Internet Explorer 6 e posteriormente instalam o Internet Explorer 7 receberão esta actualização para o Internet Explorer 7. A versão do vgx.dll instalada com o Windows Internet Explorer 7 é uma versão expandida do vgx.dll incluído no Windows XP ou Windows Server 2003. Quando o Internet Explorer 7 é instalado, substituirá o vgx.dll actualizado pelo Internet Explorer 6 fornecido por esta actualização de segurança.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1266](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1266).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória em VML - CVE-2011-1266
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória em VML - CVE-2011-1266
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória em VML - CVE-2011-1266
...
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2544521$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB2544521-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie8updates\KB2544521-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2544521">Artigo 2544521 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória em VML - (CVE-2011-1266)
