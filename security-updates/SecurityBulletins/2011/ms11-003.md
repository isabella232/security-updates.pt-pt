...
ms:assetid: 'ms11-003'
ms:contentKeyID: 61234984
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-003(v=Security.10)'
---
...
Actualização de Segurança Cumulativa para o Internet Explorer (2482017)
-----------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Crítica para o Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 em clientes Windows e como Moderada para o Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 em servidores Windows. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades ao modificar a forma como o Internet Explorer processa objectos em memória, processa Folhas de Estilos em Cascata e carrega bibliotecas externas. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.

Esta actualização de segurança também resolve a vulnerabilidade descrita previamente no [Aviso de Segurança da Microsoft 2488013](http://technet.microsoft.com/security/advisory/2488013).
...
**Se apliquei as soluções alternativas fornecidas no Aviso de Segurança da Microsoft 2488013, tenho de as anular antes de aplicar esta actualização?**  
Antes de instalar esta actualização de segurança, a Microsoft recomenda que anule a solução alternativa "Impedir o carregamento recursivo de Folhas de Estilos em Cascata (CSS) no Internet Explorer" dos sistemas onde a aplicou anteriormente. Consulte o [Artigo 2482017 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2482017) para utilizar a solução automática de **correcção da Microsoft** para desactivar esta solução alternativa.

**Esta actualização está relacionada com o Aviso de Segurança da Microsoft 2269637?**  
Sim, a vulnerabilidade resolvida por esta actualização, [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038), está relacionada com a classe de vulnerabilidades descrita no [Aviso de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afecta o modo como as aplicações carregam bibliotecas externas. Esta actualização de segurança resolve uma instância particular deste tipo de vulnerabilidade.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória CSS - CVE-2010-3971
</th>
<th style="border:1px solid black;" >
...
<th style="border:1px solid black;" >
Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Internet Explorer - CVE-2011-0038
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória CSS - CVE-2010-3971
...
-   **Impedir o carregamento recursivo de Folhas de Estilos em Cascata (CSS) no Internet Explorer**

    Esta solução alternativa ajuda a impedir a exploração da vulnerabilidade bloqueando o vector de ataque em Folhas de Estilos em Cascata (CSS) no Internet Explorer.

    Esta solução alternativa apenas está disponível como uma solução de **correcção da Microsoft**. Consulte o [Artigo 2482017 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2482017) para utilizar a solução automática de **correcção da Microsoft** para activar ou desactivar esta solução alternativa.

    **Nota** Os clientes do Internet Explorer que ainda não aplicaram a actualização [MS10-090](http://go.microsoft.com/fwlink/?linkid=206495) devem também aplicar a actualização MS10-090 antes de activar esta solução alternativa.

    **Impacto da solução alternativa.** Há efeitos secundários ao bloquear o carregamento recursivo de uma Folha de Estilos em Cascata (CSS). Os utilizadores podem deparar-se com algumas pequenas questões de desempenho devido à verificação aumentada que é necessária para bloquear o carregamento dos ficheiros CSS.

    **Nota** Antes de aplicar esta actualização de segurança, a Microsoft recomenda que a solução alternativa seja desactivada em sistemas onde a mesma está activada.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória CSS - CVE-2010-3971
...
O Internet Explorer não processa correctamente memória ao analisar uma Folha de Estilos em Cascata especialmente concebida para o efeito que se refira a si recursivamente.
...
A actualização resolve a vulnerabilidade modificando a forma como o Internet Explorer processa Folhas de Estilos em Cascata.

**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3971](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971). Esta vulnerabilidade foi previamente descrita no [Aviso de Segurança da Microsoft 2488013](http://technet.microsoft.com/security/advisory/2488013).
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0035](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0035).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2011-0035
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2011-0035

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**O que provoca a vulnerabilidade?**  
O Internet Explorer não processa correctamente objectos em memória ao analisar conteúdo Web especialmente concebido para o efeito.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0036](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0036).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2011-0036
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2011-0036
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038).

#### Factores Atenuantes para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Internet Explorer - CVE-2011-0038
...
#### Soluções Alternativas para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Internet Explorer - CVE-2011-0038
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Internet Explorer - CVE-2011-0038
...
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038).
...
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2482017$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB2482017-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie8updates\KB2482017-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2482017">Artigo 2482017 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Yuki Chen, da [Trend Micro](http://www.trendmicro.com), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2011-0035)  
-   SkyLined, da [Google Inc.](http://www.google.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2011-0036)  
-   Haifei Li, da [FortiGuard Labs da Fortinet](http://www.fortiguard.com/), por fornecer informações sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Internet Explorer (CVE-2011-0038)
