...
ms:assetid: 'ms11-013'
ms:contentKeyID: 61234994
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-013(v=Security.10)'
author: SharonSears
...
Vulnerabilidades no Kerberos Poderiam Permitir Elevação de Privilégios (2496930)
--------------------------------------------------------------------------------

Data de publicação: 8 de fevereiro de 2011 | Updated: 16 de março de 2011
...
Esta actualização de segurança resolve uma vulnerabilidade comunicada de forma privada e uma vulnerabilidade divulgada publicamente no Microsoft Windows. A vulnerabilidade mais grave poderia permitir elevação de privilégios se um intruso local autenticado instalasse um serviço malicioso num computador que faça parte de um domínio.

Esta actualização de segurança está classificada como Importante para todas as edições suportadas do Windows XP, Windows Server 2003, Windows 7 e Windows Server 2008 R2. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

Esta actualização resolve as vulnerabilidades impedindo a utilização de algoritmos hash pouco seguros no Windows Kerberos e no Windows KDC e impedindo que o cliente reverta a norma de encriptação para DES para comunicação Kerberos entre cliente e servidor. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=856fbcc2-ead9-4ec1-92dd-988e6d22dae9">Windows Server 2003 com SP2 para sistemas baseados em Itanium</a><br />
(KB2478971)</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=181196">MS10-014</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c26cebcf-683f-4a51-be75-76535fb979a7">Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1</a><br />
(KB2425227)</td>
<td style="border:1px solid black;">Spoofing</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=46bb3ef1-24c3-41cb-8141-0fdbd85093f7">Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1</a>*<br />
(KB2425227)</td>
<td style="border:1px solid black;">Spoofing</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=01737933-e7de-451b-b02f-b7ca24693965">Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1</a><br />
(KB2425227)</td>
<td style="border:1px solid black;">Spoofing</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
...
<span></span>
**Por que razão foi revisto este boletim a 16 de Março de 2011?**   
...
<th style="border:1px solid black;" >Vulnerabilidade de Soma de Verificação Sem Chave no Kerberos - CVE-2011-0043</th>
<th style="border:1px solid black;" >Vulnerabilidade de Spoofing no Kerberos - CVE-2011-0091</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Soma de Verificação Sem Chave no Kerberos - CVE-2011-0043  
----------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios em implementações do Kerberos. A vulnerabilidade existe porque a implementação do Microsoft Kerberos suporta um mecanismo hash pouco seguro que pode permitir que alguns aspectos de uma permissão de serviço Kerberos seja falsificada. Um utilizador malicioso ou um intruso que explorasse esta vulnerabilidade com sucesso poderia obter um token com privilégios elevados no sistema afectado.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0043](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043).
  
#### Factores Atenuantes para a Vulnerabilidade de Soma de Verificação Sem Chave no Kerberos - CVE-2011-0043
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Se os controladores de domínio estiverem a ser executados no Windows Server 2008 ou no Windows Server 2008 R2, não é possível explorar esta vulnerabilidade.  
...
#### Soluções Alternativas para a Vulnerabilidade de Soma de Verificação Sem Chave no Kerberos - CVE-2011-0043
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Soma de Verificação Sem Chave no Kerberos - CVE-2011-0043
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso local autenticado poderia executar um serviço malicioso num sistema e este poderia enviar uma permissão de serviço especialmente concebida para o efeito a fim de obter um token que atribui ao intruso um nível mais elevado de privilégios nesse sistema.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando a implementação do Microsoft Kerberos no Microsoft Windows suporta mecanismos hash pouco seguros, como CRC32.
  
**O que é o Kerberos?**    
O Kerberos é um protocolo utilizado para autenticar mutuamente utilizadores e serviços numa rede aberta e não segura. Permite que os serviços identifiquem correctamente o utilizador de uma permissão Kerberos, sem ser necessário autenticar o utilizador no serviço. Isto faz-se utilizando chaves secretas partilhadas.
  
O protocolo Kerberos utiliza chaves secretas partilhadas para encriptar e assinar as credenciais dos utilizadores. Um cliente é autenticado por um Centro de Distribuição de Chaves (KDC) do Kerberos. Depois dessa autenticação, o utilizador pode solicitar uma permissão de serviço para aceder a um serviço específico na rede. Esta permissão inclui a identidade do utilizador autenticada com encriptação.
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que explorasse esta vulnerabilidade com sucesso poderia executar código arbitrário no contexto de segurança do sistema local. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com privilégios elevados.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Um intruso local autenticado com privilégios para instalar uma aplicação Kerberos maliciosa com privilégios limitados poderia explorar esta vulnerabilidade instalando esse serviço malicioso num computador que faça parte de um domínio. Este serviço poderia gerar uma permissão de serviço Kerberos especialmente concebida para o efeito que permite que o intruso obtenha privilégios ao nível do sistema na máquina local.
...
Esta actualização resolve a vulnerabilidade impedindo a utilização de algoritmos hash pouco seguros no Windows Kerberos e no Windows KDC.
  
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2011-0043](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043).
  
**Quando este boletim de segurança foi publicado, a Microsoft já tinha recebido informações sobre a exploração desta vulnerabilidade?**    
Não. A Microsoft não tinha recebido quaisquer informações que indicassem que esta vulnerabilidade tivesse sido utilizada publicamente para atacar clientes e não tinha conhecimento de exemplos publicados de código para prova de conceito quando este boletim de segurança foi criado pela primeira vez.
  
Vulnerabilidade de Spoofing no Kerberos - CVE-2011-0091  
-------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de spoofing em implementações do Kerberos no Windows 7 e no Windows Server 2008 R2. A vulnerabilidade existe porque é possível reverter a autenticação Kerberos para utilizar DES em vez das normas de encriptação predefinidas incluídas no Windows 7 e no Windows Server 2008 R2.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0091).
  
#### Factores Atenuantes para a Vulnerabilidade de Spoofing no Kerberos - CVE-2011-0091
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   A vulnerabilidade afecta apenas a autenticação Kerberos.
  
#### Soluções Alternativas para a Vulnerabilidade de Spoofing no Kerberos - CVE-2011-0091
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Spoofing no Kerberos - CVE-2011-0091
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de ocultação (spoofing). Esta vulnerabilidade poderia fazer com que um intruso personificasse as credenciais de um utilizador legítimo ou falsificasse todo o tráfego Kerberos numa sessão comprometida.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando o Windows não reforça correctamente as normas de encriptação predefinidas mais robustas incluídas no Windows 7 e no Windows Server 2008 R2, permitindo que um intruso man-in-the-middle force uma reversão na comunicação Kerberos entre um cliente e um servidor para uma norma de encriptação menos segura do que a inicialmente negociada.
...
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso poderia diminuir a norma de encriptação predefinida para DES. Poderia então ler e falsificar todo o tráfego Kerberos nessa sessão. Um intruso poderia utilizar esta capacidade para se fazer passar pelo utilizador autenticado durante essa sessão Kerberos.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Num cenário de ataque man-in-the-middle, um intruso teria de estar situado entre o cliente alvo e o servidor para interceptar as comunicações e diminuir a norma de encriptação predefinida para DES.
  
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**    
Os sistemas Windows 7 e Windows Server 2008 R2 que utilizam autenticação Kerberos estão vulneráveis a este ataque de reversão.
  
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade impedindo que um intruso man-in-the-middle reverta a norma de encriptação para DES para comunicação Kerberos entre o cliente e o servidor.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2478971$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2478971">Artigo 2478971 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2425227">Artigo 2425227 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
...
-   Equipa Kerberos do [MIT](http://web.mit.edu/kerberos), por fornecer informações sobre a Vulnerabilidade de Soma de Verificação Sem Chave no Kerberos (CVE-2011-0043)  
-   Scott Stender, da [iSEC Partners](http://www.isecpartners.com/), por fornecer informações sobre a Vulnerabilidade de Spoofing no Kerberos (CVE-2011-0091)
...
-   V2.0 (16 de Março de 2011): Clarificação de Software Afectado para incluir o Windows 7 para sistemas de 32 bits Service Pack 1, Windows 7 para sistemas baseados em x64 Service Pack 1, Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1 e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1. Consulte a entrada da secção de **Perguntas Mais Frequentes relativas a esta Actualização de Segurança** que explica esta revisão.
