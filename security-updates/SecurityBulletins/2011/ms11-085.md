...
ms:assetid: 'ms11-085'
ms:contentKeyID: 61235066
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-085(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Windows Mail e no Windows Meeting Space Poderia Permitir Execução Remota de Código (2620704)
---------------------------------------------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e08266d8-fffa-40bf-b8f6-10a65ee27524)                                                                                                       | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38)                                                                                           | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f82dc413-668c-4ca8-a8c8-db74f05346bc)\*\*                                                                    | Execução Remota de Código   | Moderada                            | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=06ad5637-56a1-4478-aaa0-063e877503c9)\*\*                                                               | Execução Remota de Código   | Moderada                            | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2de5de74-e643-4045-9c22-ff95b0dbcafc)                                                               | Execução Remota de Código   | Moderada                            | Nenhum                                      |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2307fa93-8e45-4841-a5a9-7e89960712f9)                                             | Execução Remota de Código   | Baixa                               | Nenhum                                      |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=62603d18-1b21-400c-8eba-202193182960)                                   | Execução Remota de Código   | Baixa                               | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9cf6a22-f9ab-427a-9b16-33c60baaabb5)\*\*     | Execução Remota de Código   | Baixa                               | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=012777f5-51f2-4944-91af-a9c79b8081a1) | Execução Remota de Código   | Baixa                               | Nenhum                                      |
...
**O que é o Desktop Experience no Windows Server 2008?**
Há várias funcionalidades do ambiente de trabalho, como o Windows Mail, que não estão instaladas por predefinição no Windows Server 2008. Em vez disso, poderá instalá-las a todas instalando o Desktop Experience no Windows Server 2008. Para mais informações, consulte o artigo TechNet, [Windows Mail, Windows Media Player e outras funcionalidades no Desktop Experience no Windows Server 2008](http://technet.microsoft.com/en-us/library/cc771519(ws.10).aspx).

**Por que razão** **esta actualização é oferecida a sistemas** **Windows Server 2008, independentemente de o** **Desktop Experience** **estar ou não** **instalado?**
O código vulnerável existe em instalações do Windows Server 2008, independentemente de o Desktop Experience estar ou não instalado Como o código vulnerável está presente, a actualização será oferecida.

Por outro lado, o vector de ataque para explorar a vulnerabilidade é através do Windows Mail e do Windows Meeting Space. Por predefinição, o Windows Meeting Space e o Windows Mail não estão instalados no Windows Server 2008. Em sistemas em que o Windows Meeting Space e o Windows Mail não estejam instalados, não há acesso ao código vulnerável.

O Windows Mail pode ser instalado instalando o Desktop Experience no Windows Server 2008. A Microsoft recomenda que os utilizadores do Windows Server 2008 apliquem a actualização para resolver o possível vector de ataque.

**Por que razão a** **classificação de gravidade** **é mais baixa para os sistemas Windows 7 e Windows Server 2008 R2?** **
**Embora o código vulnerável exista no Windows 7 e no Windows Server 2008 R2, a Microsoft não tem conhecimento de quaisquer vectores de ataque que permitissem a exploração da vulnerabilidade nestes sistemas operativos. Ainda assim, recomenda-se que os utilizadores destes sistemas operativos apliquem a actualização como uma medida de defesa profunda.
...
**Há outros clientes de correio, como o Windows Live Mail ou o Outlook Express, afectados por esta questão?** **
**Não. Esta vulnerabilidade afecta apenas os clientes do Windows Mail nos sistemas operativos listados na tabela de Software Afectado. Não há outros clientes de correio electrónico afectados.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Windows Mail - CVE-2011-2016
</th>
<th colspan="2">
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Windows Mail e o Windows Meeting Space processam o carregamento de ficheiros DLL. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-2016](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2016).

#### Factores Atenuantes para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Windows Mail - CVE-2011-2016
...
-   Para um ataque poder ser bem sucedido, um utilizador teria de visitar uma localização não fidedigna do sistema de ficheiros remoto ou partilha WebDAV e abrir um ficheiro legítimo (como um ficheiro .eml ou .wcinv) desta localização que é então carregado por uma aplicação vulnerável.
...
-   No Windows Server 2008, o Windows Mail e o Windows Meeting Space não estão instalados por predefinição. O Windows Mail apenas é instalado quando o Desktop Experience também é instalado.
-   Embora o código vulnerável exista no Windows 7 e no Windows Server 2008 R2, a Microsoft não tem conhecimento de quaisquer vectores de ataque que permitissem a exploração da vulnerabilidade nestes sistemas operativos.

#### Soluções Alternativas para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Windows Mail - CVE-2011-2016
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Windows Mail - CVE-2011-2016
...
A vulnerabilidade resulta do facto de o Windows Mail e de o Windows Meeting Space restringirem incorrectamente o caminho utilizado ao carregar bibliotecas externas.
...
O Windows Meeting Space permite partilhar documentos, programas ou o seu ambiente de trabalho com outras pessoas com computadores que executam Windows Vista. O Windows Meeting Space utiliza tecnologia peer-to-peer e configura automaticamente uma rede ad-hoc para o caso de não conseguir encontrar uma rede existente. Para mais informações, consulte a secção de [Perguntas Mais Frequentes sobre o Windows Meeting Space](http://windows.microsoft.com/en-us/windows-vista/windows-meeting-space-frequently-asked-questions).
...
Um intruso poderia convencer um utilizador a abrir um ficheiro legítimo ( como um ficheiro .eml ou .wcinv) localizado no mesmo directório de rede que um ficheiro de biblioteca de hiperligação dinâmica (DLL) especialmente concebido. Então, ao abrir o ficheiro legítimo, o Windows Mail ou o Microsoft Meeting Space poderiam tentar carregar o ficheiro DLL e executar qualquer código nele contido.

Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade ao enviar um ficheiro legítimo (como um ficheiro .eml ou .wcinv) a um utilizador e convencer o utilizador a colocar o anexo num directório que contenha um ficheiro DLL especialmente concebido e depois a abrir o ficheiro legítimo. Então, ao abrir o ficheiro legítimo, o Windows Mail ou o Microsoft Meeting Space poderiam tentar carregar o ficheiro DLL e executar qualquer código nele contido.

Num cenário de ataque através da rede, um intruso poderia colocar um ficheiro legítimo (como um ficheiro .eml ou .wcinv) e um ficheiro DLL especialmente concebido para o efeito numa partilha de rede, UNC ou WebDAV, e convencer o utilizador a abrir o ficheiro.

**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**
Os sistemas em que o Windows Mail ou o Windows Meeting Space são utilizados, incluindo as estações de trabalho e servidores de terminais, estão mais susceptíveis. Os servidores podem estar mais sujeitos a risco se os administradores permitirem que os utilizadores iniciem sessão nos servidores e executem programas. Contudo, os procedimentos recomendados desencorajam essa acção.

**O que faz a actualização?**
A actualização resolve esta vulnerabilidade corrigindo a forma como o Windows Mail e o Windows Meeting Space carregam bibliotecas externas.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2620704">Artigo 2620704 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
-   Ivan Sanchez, da EvilCode, por fornecer informações sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Windows Mail (CVE-2011-2016)
