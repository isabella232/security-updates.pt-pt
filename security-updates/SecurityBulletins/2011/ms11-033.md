...
ms:assetid: 'ms11-033'
ms:contentKeyID: 61235014
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-033(v=Security.10)'
author: SharonSears
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6753ca98-feb4-4c7f-9969-9294038a2bbb)                                     | Execução Remota de Código   | Importante                          | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3c94bc96-99ea-44a1-9052-e69de5e21f81)            | Execução Remota de Código   | Importante                          | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9fbfc742-6c74-49a2-b3cc-e1d5d8c84b77)                            | Execução Remota de Código   | Importante                          | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=897b97b0-1bab-4b1b-b417-950fab0d4a65)                | Execução Remota de Código   | Importante                          | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ede38974-4e57-4ea1-8731-b91e96534693) | Execução Remota de Código   | Importante                          | [MS10-067](http://go.microsoft.com/fwlink/?linkid=197102) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Parsing no Conversor do WordPad - CVE-2011-0028</th>
...
Vulnerabilidade de Parsing no Conversor do WordPad - CVE-2011-0028  
------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft WordPad analisa ficheiros Word especialmente concebidos para o efeito. A vulnerabilidade poderia permitir a execução remota de código se um utilizador abrisse um ficheiro Word que incluísse uma estrutura mal formada. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0028).
  
#### Factores Atenuantes para a Vulnerabilidade de Parsing no Conversor do WordPad - CVE-2011-0028
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.  
-   A vulnerabilidade não pode ser automaticamente explorada através de correio electrónico. Para um ataque poder ser bem sucedido, é necessário que um utilizador abra um anexo recebido numa mensagem de correio electrónico. Seria solicitado ao utilizador que abrisse ou não o ficheiro, a menos que o utilizador tivesse retirado previamente a opção "Perguntar sempre antes de abrir este tipo de ficheiro".  
...
#### Soluções Alternativas para a Vulnerabilidade de Parsing no Conversor do WordPad - CVE-2011-0028
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Parsing no Conversor do WordPad - CVE-2011-0028
...
A vulnerabilidade é provocada quando o conversor de texto do WordPad analisa incorrectamente campos específicos num documento Word.
...
Num cenário de ataque com base na Web, um intruso teria de alojar um Web site contendo um documento Word que fosse utilizado para tentar explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Um intruso não conseguiria obrigar os utilizadores a visitarem um Web site especialmente concebido para o efeito. Em vez disso, um intruso teria de convencê-los a visitar o Web site, levando-os normalmente a clicar numa hiperligação que os levasse ao Web site do intruso. Depois de clicar na ligação, os utilizadores teriam de aceitar manualmente uma linha de comandos para abrir o documento.
  
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**    
Os sistemas afectados, como estações de trabalho ou servidores de terminais, em que o WordPad é utilizado para abrir documentos Word a partir de fontes não fidedignas estão mais susceptíveis. Os servidores podem estar mais sujeitos a risco se os administradores permitirem que os utilizadores iniciem sessão nos servidores e executem programas. Contudo, os procedimentos recomendados desencorajam essa acção. Por predefinição, os sistemas onde o Microsoft Word está instalado geralmente abrirão documentos Word com o Microsoft Office em vez do WordPad.
  
**O que faz a actualização?**    
Esta actualização resolve a vulnerabilidade alterando a forma como os Conversores de Texto do WordPad processam ficheiros especialmente concebidos para o efeito.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2485663$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2485663">Artigo 2485663 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Carsten Eiram, da [Secunia](http://secunia.com/), por fornecer informações sobre a Vulnerabilidade de Parsing no Conversor do WordPad (CVE-2011-0028)
