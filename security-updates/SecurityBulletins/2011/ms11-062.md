---
TOCTitle: 'MS11-062'
Title: 'Microsoft Security Bulletin MS11-062 - Importante'
ms:assetid: 'ms11-062'
ms:contentKeyID: 61235043
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-062(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-062 - Importante
=================================================

Vulnerabilidade no Controlador NDISTAPI no Serviço de Acesso Remoto Poderia Permitir Elevação de Privilégios (2566454)
----------------------------------------------------------------------------------------------------------------------
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4)                                     | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b)            | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc)                            | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667)                | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d) | Elevação de Privilégios     | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >Vulnerabilidade de Elevação de Privilégios no NDISTAPI - CVE-2011-1974</th>
...
Vulnerabilidade de Elevação de Privilégios no NDISTAPI - CVE-2011-1974  
----------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no controlador NDISTAPI no Serviço de Acesso Remoto. A vulnerabilidade é provocada quando o controlador NDISTAPI valida inadequadamente entradas fornecidas pelo utilizador ao transmitir dados do modo de utilizador para o kernel do Windows. Um intruso local que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. O intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1974](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação de Privilégios no NDISTAPI - CVE-2011-1974
...
#### Soluções Alternativas para a Vulnerabilidade de Elevação de Privilégios no NDISTAPI - CVE-2011-1974
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação de Privilégios no NDISTAPI - CVE-2011-1974
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é provocada quando o controlador NDISTAPI valida inadequadamente entradas fornecidas pelo utilizador ao transmitir dados do modo de utilizador para o kernel do Windows.
  
**Qual é o componente afectado pela vulnerabilidade?**    
O NDISTAPI.sys é o componente afectado pela vulnerabilidade.
  
**O que é Serviço de Acesso Remoto (RAS)?**    
O Serviço de Acesso Remoto (RAS) permite que os utilizadores se liguem a um computador remoto através de linhas telefónicas, da Internet ou de outra ligação de rede, para poderem trabalhar como se o seu sistema estivesse fisicamente ligado à rede remota. O RAS permite que os utilizadores executem remotamente actividades como enviar e receber mensagens de correio electrónico, enviar documentos por fax, recuperar ficheiros e imprimir documentos numa impressora de escritório. Para obter mais informações, consulte o artigo MSDN sobre uma Visão Geral da Arquitectura do [RAS](http://msdn.microsoft.com/en-us/library/ff563285(v=vs.85).aspx) (NDIS 5.1).
  
O RAS é um serviço nativo do Windows XP e do Windows Server 2003. O RAS foi substituído pelo Serviço de Encaminhamento e Acesso Remoto (RRAS) nos sistemas operativos posteriores. O RRAS permite que um computador funcione como um router de rede. O RRAS também fornece a próxima geração de funcionalidades de RAS para o Windows. A funcionalidade de servidor RRAS segue e baseia-se na funcionalidade RAS que foi incluída em sistemas operativos anteriores.
  
**O que é o controlador NDISTAPI?**    
O controlador NDISTAPI faz parte da arquitectura do RAS e é compatível com o NDISWAN para serviços TAPI. As aplicações telefónicas implementam serviços TAPI, podendo fazer pedidos de TAPI para configurar, monitorizar e eliminar linhas e chamadas. O controlador NDISTAPI transmite estes pedidos de TAPI ao NDISWAN. Para obter mais informações, consulte o artigo MSDN sobre uma [Visão Geral do NDISTAPI (NDIS 5.1)](http://msdn.microsoft.com/en-us/library/ff554813(v=vs.85).aspx).
  
**O que é o NDISWAN?**    
O NDISWAN (Network Driver Interface Standard Wide Area Network) é um controlador NDIS intermédio fornecido pelo sistema que disponibiliza funcionalidades como compressão de dados, encriptação, loopback e pacotes PPP simples, sendo a sua utilização efectuada por controladores de miniportas WAN. Assim, é necessário que os controladores de miniportas WAN implementem apenas as funcionalidades específicas ao meio (por exemplo, a sinalização Q931 é necessária para RDIS). Para mais informações, consulte o artigo MSDN sobre uma [Visão Geral do NDISWAN](http://msdn.microsoft.com/en-us/library/ff564653(v=vs.85).aspx).
  
**O que é o serviço TAPI?**    
O serviço TAPI (Telephony Application Programming Interface) é uma interface de programação que fornece serviços telefónicos a aplicações capazes de estabelecer comunicação telefónica.
  
**O que é o NDIS?**    
O NDIS (Network Driver Interface Standard) faz parte do Windows Driver Kit, consistindo num sistema de desenvolvimento de controladores completamente integrado, que contém o Windows Driver Device Kit e testes de estabilidade e fiabilidade para controladores do Windows. A biblioteca de NDIS identifica o hardware de rede a partir dos controladores de rede. O NDIS também especifica uma interface padrão entre controladores de rede por camadas, identificando assim os controladores de níveis inferiores que gerem o hardware em relação aos controladores de níveis superiores, como os transportes de rede. O NDIS também mantém parâmetros e informações de estado para controladores de rede, incluindo apontadores de funções, identificadores e blocos de parâmetros para ligação e outros valores do sistema.
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que explorasse esta vulnerabilidade com êxito poderia executar código arbitrário no contexto do sistema local. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
...
A actualização resolve a vulnerabilidade corrigindo a forma como o controlador NDISTAPI valida intervenções no modo de utilizador antes de as enviar para o kernel do Windows.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2566454$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2566454">Artigo 2566454 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Lufeng Li, da , por fornecer informações sobre a Vulnerabilidade de Elevação de Privilégios no NDISTAPI (CVE-2011-1974)
