...
ms:assetid: 'ms11-051'
ms:contentKeyID: 61235032
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-051(v=Security.10)'
---
...
Vulnerabilidade no Suporte de Inscrição Web de Serviços de Certificados do Active Directory Poderia Permitir Elevação de Privilégios (2518295)
----------------------------------------------------------------------------------------------------------------------------------------------

Data de publicação: 14 de junho de 2011 | Updated: 15 de junho de 2011
...
Esta actualização de segurança resolve uma vulnerabilidade comunicada de forma privada no Suporte de Inscrição Web de Serviços de Certificados do Active Directory. Trata-se de uma vulnerabilidade de execução de scripts entre sites (XSS) que poderia permitir elevação de privilégios, permitindo a um intruso executar comandos arbitrários no site no contexto do utilizador alvo. Um intruso que conseguisse tirar partido desta vulnerabilidade teria de enviar uma hiperligação especialmente concebida para o efeito e convencer um utilizador a clicar na mesma. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar o Web site. Em vez disso, um intruso teria de persuadir um utilizador a visitar o Web site, levando-o normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico ou numa mensagem de um programa de mensagens instantâneas, que levasse o utilizador para o Web site vulnerável.

Esta actualização de segurança está classificada como Importante para todas as edições suportadas (excepto Itanium) do Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o site de Suporte de Inscrição Web de Serviços de Certificados do Active Directory valida parâmetros de entrada. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Questões Conhecidas.** O [Artigo 2518295 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2518295) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ef90d6c1-ea7f-4c32-9c90-0303e04c7436)                                                                                             | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=62944095-33d6-4131-be32-a79d9ec4d4a9)                                                                                 | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46ade106-e0cb-4c71-8230-793a15062823)\*\*                 | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6141a1c5-ecaf-4553-9d27-dd6e5c4a13fd)\*\*       | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1da04414-6210-43ea-8e0a-cf21cf144076)\*\* | Elevação de Privilégios     | Importante                          | Nenhum                                      |
...
A actualização só será oferecida para sistemas onde o componente afectado esteja instalado e activado. Os sistemas Microsoft Windows Server não configurados na função de Suporte de Inscrição Web de Serviços de Certificados do Active Directory não são afectados e não receberão esta actualização.

**Personalizei as minhas páginas ASP de inscrição Web. Devo preocupar-me com as questões conhecidas listadas no Artigo 2518295 da Base de Dados de Conhecimento da Microsoft?**  
Sim, a Microsoft recomenda que os clientes que editaram as respectivas páginas ASP de inscrição Web consultem o [Artigo 2518295 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2518295) para obter informações importantes acerca de questões conhecidas que podem aplicar-se aos seus sistemas.
...
<th style="border:1px solid black;" >Vulnerabilidade em Serviços de Certificados do Active Directory - CVE-2011-1264</th>
...
Vulnerabilidade em Serviços de Certificados do Active Directory - CVE-2011-1264  
-------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de XSS com reflexo no Suporte de Inscrição Web de Serviços de Certificados do Active Directory que poderia permitir que um intruso injectasse um script do lado do cliente na instância do utilizador do Internet Explorer. O script poderia falsificar conteúdos (spoofing), divulgar informações, ou executar qualquer acção que o utilizador pudesse executar no site em nome do utilizador visado.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1264).
  
#### Factores Atenuantes para a Vulnerabilidade em Serviços de Certificados do Active Directory - CVE-2011-1264
...
-   O Filtro XSS no Internet Explorer 8 e no Internet Explorer 9 evita este ataque para utilizadores do Internet Explorer 8 e Internet Explorer 9 que navegam para um Web site na Zona de Internet. O Filtro XSS no Internet Explorer 8 e no Internet Explorer 9 não está activado por predefinição na Zona de Intranet.  
...
#### Soluções Alternativas para a Vulnerabilidade em Serviços de Certificados do Active Directory - CVE-2011-1264
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade em Serviços de Certificados do Active Directory - CVE-2011-1264
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de XSS reflectida que poderia permitir uma elevação de privilégios.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é provocada por uma validação inadequada de entradas de um parâmetro de pedido num site de Suporte de Inscrição Web de Serviços de Certificados do Active Directory.
...
O componente afectado é o Suporte de Inscrição Web de Serviços de Certificados do Active Directory.
...
Os servidores que executam a função de Suporte de Inscrição Web de Serviços de Certificados do Active Directory estão mais susceptíveis. Os servidores que não executam esta função específica não estão susceptíveis.
  
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade corrigindo a forma como o site de Suporte de Inscrição Web de Serviços de Certificados do Active Directory valida parâmetros de entrada.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2518295$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2518295">Artigo 2518295 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Ruggero Strabla, [Emaze Networks](http://www.emaze.net/); [Saipem Security Team](http://www.saipem.com/), por fornecer informações sobre a Vulnerabilidade em Serviços de Certificados do Active Directory (CVE-2011-1264)
...
-   V1.1 (15 de Junho de 2011): Clarificação da atenuação do Filtro XSS.
