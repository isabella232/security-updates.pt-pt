---
TOCTitle: 'MS11-028'
Title: 'Microsoft Security Bulletin MS11-028 - Crítica'
ms:assetid: 'ms11-028'
ms:contentKeyID: 61235009
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-028(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-028 - Crítica
==============================================

Vulnerabilidade no .NET Framework Poderia Permitir Execução Remota de Código(2484015)
-------------------------------------------------------------------------------------

Data de publicação: 12 de abril de 2011 | Updated: 30 de novembro de 2011
...
**Questões conhecidas.** O [Artigo 2484015 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2484015) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
<span></span>
**Por que razão foi revisto este boletim a 14 de Junho de 2011?**
A Microsoft reviu este boletim de segurança para anunciar uma alteração na detecção em pacotes Windows Update (WU) para KB2446709. Agora, o pacote WU lista correctamente o boletim substituído por esta actualização. Esta é apenas uma alteração de detecção. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.

**Por que razão foi relançado este boletim a 10 de Maio de 2011?**
A Microsoft relançou este boletim para oferecer novamente a correcção KB979744 com as actualizações de segurança KB2446709 e KB2449742 a fim de resolver uma questão conhecida com impacto em servidores SQL e Exchange. Esta questão encontra-se descrita detalhadamente no [Artigo 2540222 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2540222). Para os clientes que tenham instalado a versão original (V1) da correcção KB979744, esta actualização oferecerá e instalará automaticamente tanto a actualização de segurança como a nova versão da correcção KB979744. Os clientes que já tenham actualizado os respectivos sistemas com êxito, mas que não tenham a correcção KB979744 instalada, não necessitam de instalar novamente esta actualização.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Danos na Pilha no .NET Framework - CVE-2010-3958
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<tr>
<td style="border:1px solid black;">
Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows Server 2003 com SP2 para sistemas baseados em Itanium
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 no Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 no Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 no Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 no Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 no Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Server 2003 com SP2 para sistemas baseados em Itanium
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Server 2008 R2 para sistemas baseados em x64
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1\*
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft .NET Framework processa determinadas chamadas de funções. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958).

#### Factores Atenuantes para a Vulnerabilidade de Danos na Pilha no .NET Framework - CVE-2010-3958
...
#### Soluções Alternativas para a Vulnerabilidade de Danos na Pilha no .NET Framework - CVE-2010-3958
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Danos na Pilha no .NET Framework - CVE-2010-3958
...
Esta vulnerabilidade é provocada quando o compilador JIT x86 no .NET Framework compila incorrectamente determinados tipos de chamadas de funções.
...
Esta actualização resolve a vulnerabilidade corrigindo a forma como o compilador JIT x86 no .NET Framework processa determinados tipos de chamadas de funções.

**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958).
...
<td style="border:1px solid black;">Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows XP Service Pack 3:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2484015">Artigo 2484015 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows Server 2003 Service Pack 2:<br />
NDP20SP2-KB2446704-v2-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP20SP2-KB2446704-v2-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows Server 2003 com SP2 para sistemas baseados em Itanium:<br />
...
-   V2.0 (10 de Maio de 2011): Boletim relançado para oferecer novamente as actualizações KB2446709 e KB2449742. Isto resolve uma questão conhecida com impacto em servidores SQL e Exchange com a correcção KB979744 instalada.  
-   V2.1 (14 de Junho de 2011): Adição de uma actualização de Perguntas Frequentes para anunciar uma alteração de detecção que corrige o boletim substituído para o Microsoft .NET Framework 3.5.1 em edições suportadas do Windows 7 e Windows Server 2008 R2. Esta é apenas uma alteração de detecção. Não foram efectuadas alterações aos ficheiros de actualização de segurança. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.  
-   V2.2 (22 de Junho de 2011): Corrigidas as informações relativas à substituição do boletim. Esta é apenas uma alteração de boletim. Não foram efectuadas alterações à detecção nem aos ficheiros de actualização de segurança.  
-   V2.3 (26 de Outubro de 2011): Corrigidas as informações relativas à substituição do boletim para o .NET Framework 4 em edições de 32 bits do Microsoft Windows. Esta é apenas uma alteração de boletim. Não foram efectuadas alterações à detecção nem aos ficheiros de actualização de segurança. Foi também corrigida a aplicabilidade da instalação Server Core para o .NET Framework 4 no Windows Server 2008 R2 para sistemas baseados em x64.  
-   V2.4 (30 de Novembro, 2011): Corrigidas as informações relativas à substituição do boletim para o .NET Framework 4 no Windows 7 para sistemas baseados em x64 Service Pack 1, no Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1 e no Windows Server 2008 R2 para sistemas baseados em baseados em Itanium Service Pack 1. Trata-se apenas de uma alteração a um boletim. Não foram efectuadas alterações à detecção nem aos ficheiros de actualização de segurança.
