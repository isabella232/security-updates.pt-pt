---
TOCTitle: 'MS11-014'
Title: 'Microsoft Security Bulletin MS11-014 - Importante'
ms:assetid: 'ms11-014'
ms:contentKeyID: 61234995
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-014(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-014 - Importante
=================================================

Vulnerabilidade no Serviço de Subsistema de Autoridade de Segurança Local Poderia Permitir Elevação Local de Privilégios (2478960)
----------------------------------------------------------------------------------------------------------------------------------

Data de publicação: 8 de fevereiro de 2011 | Updated: 28 de abril de 2011
...
Esta actualização de segurança resolve uma vulnerabilidade no Serviço de Subsistema de Autoridade de Segurança Local (LSASS), comunicada de forma privada, no Windows XP e no Windows Server 2003. Esta actualização de segurança está classificada como Importante para todas as edições suportadas destes sistemas operativos. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.
...
**Questões Conhecidas.** O [Artigo 2478960 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2478960) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=541f228f-79b3-402a-8ff9-366c1e595227)                                     | Elevação de Privilégios     | Importante                          | Nenhum                                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82189bf2-3f34-4949-92da-eea98036d18e)            | Elevação de Privilégios     | Importante                          | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e31e6b1-577e-468e-9c94-67227d2273c2)                            | Elevação de Privilégios     | Importante                          | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e3c229-d812-433c-ad05-7cbd1f9c6a6d)                | Elevação de Privilégios     | Importante                          | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41) | Elevação de Privilégios     | Importante                          | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Validação de Comprimento LSASS - CVE-2011-0039</th>
...
Vulnerabilidade de Validação de Comprimento LSASS - CVE-2011-0039  
-----------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na forma como o Serviço de Subsistema de Autoridade de Segurança Local (LSASS) do Microsoft Windows processa pedidos de autenticação especialmente concebidos para o efeito. A vulnerabilidade poderia permitir que um intruso executasse código com privilégios elevados. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0039](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0039).
  
#### Factores Atenuantes para a Vulnerabilidade de Validação de Comprimento LSASS - CVE-2011-0039
...
#### Soluções Alternativas para a Vulnerabilidade de Validação de Comprimento LSASS - CVE-2011-0039
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação de Comprimento LSASS - CVE-2011-0039
...
A vulnerabilidade é causada quando o Windows LSASS processa um pedido de autenticação especialmente concebido para o efeito.
...
A actualização resolve esta vulnerabilidade corrigindo a forma como o LSASS processa valores específicos utilizados no processo de autenticação.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2478960$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2478960">Artigo 2478960 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Jorge Moura, técnico de teste de segurança da Primavera BSS, por fornecer informações sobre a Vulnerabilidade de Validação de Comprimento LSASS (CVE-2011-0039)
...
-   V1.1 (28 de Abril de 2011): Ligação adicionada para o Artigo 2478960 da Base de Dados de Conhecimento da Microsoft, na secção Questões Conhecidas, no Resumo Executivo.
