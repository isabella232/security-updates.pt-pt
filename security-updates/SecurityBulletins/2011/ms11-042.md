...
ms:assetid: 'ms11-042'
ms:contentKeyID: 61235023
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-042(v=Security.10)'
---
...
Vulnerabilidades no Sistema de Ficheiros Distribuído Poderiam Permitir Execução Remota de Código (2535512)
----------------------------------------------------------------------------------------------------------

Data de publicação: 14 de junho de 2011 | Updated: 14 de junho de 2011
...
Esta actualização de segurança está classificada como Crítica para todas as edições suportadas do Windows XP e Windows Server 2003, como Importante para todas as edições suportadas do Windows Vista e Windows Server 2008, e como Importante para o Windows 7 para sistemas de 32 bits, Windows 7 para sistemas baseados em x64, Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em Itanium. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades corrigindo a forma como o cliente DFS valida campos em respostas de referência DFS especialmente concebidas para o efeito e corrigindo a forma como o serviço DFS processa respostas de referência DFS especialmente concebidas para o efeito. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                                                    | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                                           | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                                           | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                                               | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                                | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                                                  | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                                          | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\*                 | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*       | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4) | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                                           | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                                      | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                                       | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                                     | Negação de Serviço          | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória no DFS - CVE-2011-1868</th>
<th style="border:1px solid black;" >Vulnerabilidade de Resposta de Referência no DFS - CVE-2011-1869</th>
...
Vulnerabilidade de Corrupção de Memória no DFS - CVE-2011-1868  
--------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código não autenticado na forma como o cliente do Sistema de Ficheiros Distribuído (DFS) analisa respostas DFS especialmente concebidas para o efeito. A tentativa de exploração da vulnerabilidade não necessitaria de autenticação, o que permitiria a um intruso explorar a vulnerabilidade enviando uma resposta DFS especialmente concebida para o efeito a um pedido DFS iniciado pelo cliente. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no DFS - CVE-2011-1868
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no DFS - CVE-2011-1868
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no DFS - CVE-2011-1868
...
A vulnerabilidade é provocada quando a implementação do Sistema de Ficheiros Distribuído (DFS) da Microsoft valida indevidamente todos os campos dentro de respostas DFS especialmente concebidas para o efeito.
  
**O que é o Sistema de Ficheiros Distribuído (DFS)?**    
O Sistema de Ficheiros Distribuído (DFS) permite aos administradores agrupar pastas partilhadas situadas em servidores diferentes, ligando-as de forma transparente a um ou mais espaços de nomes DFS. Um espaço de nome DFS é uma vista virtual de todas as pastas partilhadas numa organização. Utilizando as ferramentas DFS, um administrador seleccione quais as pastas partilhadas a apresentar no espaço de nome, concebe a hierarquia na qual estas pastas aparecem e determina os nomes que as pastas partilhadas apresentam no espaço de nome. Quando um utilizador visualiza o espaço de nome, as pastas aparentam residir numa única unidade de disco duro de elevada capacidade. Os utilizadores podem navegar as pastas no espaço de nome sem terem de saber quais os nomes dos servidores ou as pastas partilhas onde os dados se encontram alojados. Para mais informações, consulte a [Referência Técnica DFS](http://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx).
...
Um intruso poderia alojar um servidor especialmente concebido para o efeito, concebido para explorar esta vulnerabilidade e, depois, convencer um utilizador a iniciar uma ligação DFS com o mesmo. Além disso, um intruso na rede local poderia executar um ataque man-in-the-middle para responder a um pedido DFS legítimo com uma resposta DFS mal formada.
  
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**    
Todos as edições suportadas do Windows XP e Windows Server 2003 estão susceptíveis a esta vulnerabilidade.
  
**O que faz a actualização?**    
A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o cliente DFS valida campos em repostas DFS especialmente concebidas para o efeito.
...
Vulnerabilidade de Resposta de Referência no DFS - CVE-2011-1869  
----------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço na forma como o Sistema de Ficheiros Distribuído (DFS) da Microsoft processa respostas de referência DFS especialmente concebidas para o efeito. Não seria necessária autenticação para uma tentativa de exploração da vulnerabilidade, o que permitiria a um intruso explorar a vulnerabilidade enviando uma mensagem de rede especialmente concebida para um computador que execute o serviço de Servidor.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869).
  
#### Factores Atenuantes para a Vulnerabilidade de Resposta de Referência no DFS - CVE-2011-1869
  
O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Esta vulnerabilidade de negação de serviço não permitiria que um intruso executasse código ou elevasse direitos de utilizador, mas poderia fazer com que o sistema afectado deixasse de responder até ser reiniciado manualmente.  
-   Os procedimentos recomendados de firewall e as configurações de firewall padrão predefinidas podem ajudar a proteger as redes de ataques provenientes do exterior do perímetro da empresa. É recomendado que os sistemas ligados à Internet tenham um número mínimo de portas exposto.
  
#### Soluções Alternativas para a Vulnerabilidade de Resposta de Referência no DFS - CVE-2011-1869
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes para a Vulnerabilidade de Resposta de Referência no DFS - CVE-2011-1869
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de negação de serviço. Um intruso que explorasse esta vulnerabilidade poderia fazer com que o sistema afectado deixasse de responder até ser reiniciado manualmente. Tenha em atenção que a vulnerabilidade na negação de serviço não permitiria que um intruso executasse o código ou elevasse direitos de utilizador, mas poderia fazer com que o sistema afectado deixasse de aceitar pedidos.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é provocada quando a implementação do Sistema de Ficheiros Distribuído (DFS) processa incorrectamente respostas de referência DFS especialmente concebidas para o efeito.
...
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**    
Todas as versões suportadas do Windows estão susceptíveis a esta vulnerabilidade.
  
**O que faz a actualização?**    
A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o serviço DFS processa respostas de referência DFS especialmente concebidas para o efeito.
...
| Windows Server 2008 R2 para sistemas baseados em Itanium                                                                     | Sim               | Sim                        |
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2535512$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2535512">Artigo 2535512 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para o Windows 7 para sistemas de 32 bits:<br />
Windows6.1-KB2535512-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows 7 para sistemas baseados em x64:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todos os Windows 7 para sistemas baseados em x64:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para o Windows 2008 R2 para sistemas baseados em x64:<br />
Windows6.1-KB2535512-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows 2008 R2 para sistemas baseados em Itanium:<br />
...
-   Laurent Gaffié, da [NGS Software](http://www.ngssoftware.com/), por fornecer informações sobre a Vulnerabilidade de Resposta de Referência DFS (CVE-2011-1869)
...
-   V1.1 (14 de Junho de 2011): Transferência do Windows 7 para sistemas de 32 bits Service Pack 1, Windows 7 para sistemas baseados em x64 Service Pack 1, Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1 e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1 da tabela de software afectado para a tabela de software não afectado. Trata-se de uma alteração informativa apenas. Não foram efectuadas alterações aos ficheiros da actualização de segurança ou à lógica de detecção.
