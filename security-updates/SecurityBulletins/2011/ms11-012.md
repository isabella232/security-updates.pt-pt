---
TOCTitle: 'MS11-012'
Title: 'Microsoft Security Bulletin MS11-012 - Importante'
ms:assetid: 'ms11-012'
ms:contentKeyID: 61234993
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-012(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS11-012 - Importante
=================================================

Vulnerabilidades nos Controladores de Modo de Kernel do Windows Poderiam Permitir Elevação de Privilégios (2479628)
-------------------------------------------------------------------------------------------------------------------
...
A actualização de segurança resolve as vulnerabilidades corrigindo a forma como os controladores de modo de kernel do Windows validam entradas transmitidas a partir do modo de utilizador. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=56f4f43e-c313-49dc-a278-e3e8a83a907e)                                                                                                          | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e80db313-b470-4d71-bc34-70bfbfb6579f)                                                                                 | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54fe2669-8a63-4d96-8b82-5b10f45b293e)                                                                                                 | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4632e1ce-6ae8-431c-9104-9a8840e5ac63)                                                                                     | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a09c3e6e-c55c-492a-b7ad-3e3d35711643)                                                                      | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6fb7ebcc-2052-457b-b5bc-1bbcb17696b9)                                                                        | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88d68757-1ab0-4585-9578-52a474b10882)                                                | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=80494972-db45-475f-97cd-dac46b9486a1)\*                       | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5597d449-17e3-440f-8b0e-56a902a96569)\*             | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d10eda21-b3c3-4d8e-8596-bc45e4165f93)       | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=078fe6c0-1b2c-4896-a345-25cc1b1105e2)                                             | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b42642b3-fb78-4700-bfe8-bfa997b90c16)                                   | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d2c53f44-12eb-4293-9fa5-2a14075b636e)\*       | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8c6bf720-f544-4f58-9b1c-2399957ec43d) | Elevação de Privilégios     | Importante                          | [MS10-098](http://go.microsoft.com/fwlink/?linkid=204869) |
...
<span></span>
**Por que razão foi revisto este boletim a 18 de Março de 2011?**  
...
<th style="border:1px solid black;" >Vulnerabilidade de Validação de Entrada Incorrecta do Utilizador no Win32k - CVE-2011-0086</th>
<th style="border:1px solid black;" >Vulnerabilidade de Validação de Entrada Insuficiente do Utilizador no Win32k - CVE-2011-0087</th>
<th style="border:1px solid black;" >Vulnerabilidade de Confusão de Ponteiro de Classe de Janela no Win32k - CVE-2011-0088</th>
<th style="border:1px solid black;" >Vulnerabilidade de Validação de Ponteiro Incorrecta de Classe de Janela no Win32k - CVE-2011-0089</th>
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória no Win32k - CVE-2011-0090</th>
...
Vulnerabilidade de Validação de Entrada Incorrecta do Utilizador no Win32k - CVE-2011-0086  
------------------------------------------------------------------------------------------
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0086](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0086).
  
#### Factores Atenuantes para a Vulnerabilidade de Validação de Entrada Incorrecta do Utilizador no Win32k - CVE-2011-0086
...
#### Soluções Alternativas para a Vulnerabilidade de Validação de Entrada Incorrecta do Utilizador no Win32k - CVE-2011-0086
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação de Entrada Incorrecta do Utilizador no Win32k - CVE-2011-0086
...
Vulnerabilidade de Validação de Entrada Insuficiente do Utilizador no Win32k - CVE-2011-0087  
--------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na forma como os controladores de modo de kernel do Windows validam dados fornecidos a partir do modo de utilizador para o modo de kernel. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário no modo de kernel e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0087).
  
#### Factores Atenuantes para a Vulnerabilidade de Validação de Entrada Insuficiente do Utilizador no Win32k - CVE-2011-0087
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade de Validação de Entrada Insuficiente do Utilizador no Win32k - CVE-2011-0087
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação de Entrada Insuficiente do Utilizador no Win32k - CVE-2011-0087
...
Vulnerabilidade de Confusão de Ponteiro de Classe de Janela no Win32k - CVE-2011-0088  
-------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na forma como os controladores de modo de kernel do Windows validam dados fornecidos a partir do modo de utilizador para o modo de kernel. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário no modo de kernel e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0088).
  
#### Factores Atenuantes para a Vulnerabilidade de Confusão de Ponteiro de Classe de Janela no Win32k - CVE-2011-0088
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade de Confusão de Ponteiro de Classe de Janela no Win32k - CVE-2011-0088
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Confusão de Ponteiro de Classe de Janela no Win32k - CVE-2011-0088
...
Vulnerabilidade de Validação de Ponteiro Incorrecta de Classe de Janela no Win32k - CVE-2011-0089  
-------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na forma como os controladores de modo de kernel do Windows validam dados fornecidos a partir do modo de utilizador para o modo de kernel. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário no modo de kernel e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0089](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0089).
  
#### Factores Atenuantes para a Vulnerabilidade de Validação de Ponteiro Incorrecta de Classe de Janela no Win32k - CVE-2011-0089
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade de Validação de Ponteiro Incorrecta de Classe de Janela no Win32k - CVE-2011-0089
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação de Ponteiro Incorrecta de Classe de Janela no Win32k - CVE-2011-0089
...
Vulnerabilidade de Corrupção de Memória no Win32k - CVE-2011-0090  
-----------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na forma como os controladores de modo de kernel do Windows validam dados fornecidos a partir do modo de utilizador para o modo de kernel. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário no modo de kernel e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-0090](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0090).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Win32k - CVE-2011-0090
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Win32k - CVE-2011-0090
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Win32k - CVE-2011-0090
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2479628$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2479628">Artigo 2479628 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Tarjei Mandt, da [Norman](http://www.norman.com), por fornecer informações sobre a Vulnerabilidade de Validação de Entrada Incorrecta do Utilizador no Win32k (CVE-2011-0086)  
-   Tarjei Mandt, da [Norman](http://www.norman.com), por fornecer informações sobre a Vulnerabilidade de Validação de Entrada Insuficiente do Utilizador no Win32k (CVE-2011-0087)  
-   Tarjei Mandt, da [Norman](http://www.norman.com), por fornecer informações sobre a Vulnerabilidade de Confusão de Ponteiro de Classe de Janela no Win32k (CVE-2011-0088)  
-   Tarjei Mandt, da [Norman](http://www.norman.com), por fornecer informações sobre a Vulnerabilidade de Validação de Ponteiro Incorrecta de Classe de Janela no Win32k (CVE-2011-0089)  
-   Tarjei Mandt, da [Norman](http://www.norman.com), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Win32k (CVE-2011-0090)
...
-   V2.0 (18 de Março de 2011): Clarificação de Software Afectado para incluir o Windows 7 para sistemas de 32 bits Service Pack 1, Windows 7 para sistemas baseados em x64 Service Pack 1, Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1 e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1. Consulte a entrada da secção de **Perguntas Mais Frequentes relativas a esta Actualização de Segurança** que explica esta revisão.
