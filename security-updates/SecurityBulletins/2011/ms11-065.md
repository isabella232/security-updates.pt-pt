...
ms:assetid: 'ms11-065'
ms:contentKeyID: 61235046
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-065(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Protocolo de Ambiente de Trabalho Remoto Poderia Permitir Negação de Serviço (2570222)
---------------------------------------------------------------------------------------------------------
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=c07e1630-43ba-491e-bd59-9eb53105986c)                                     | Negação de Serviço          | Moderada                            | Nenhum                                      |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=797a01dc-39fb-4511-832a-42d2975133f5)            | Negação de Serviço          | Moderada                            | Nenhum                                      |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=694ba1a6-7512-497d-a572-646a6e07b13b)                            | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=308da543-d49d-4591-8bbc-d65c524bb0ad)                | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3b459bf0-7844-4740-895c-d149d56e781f) | Negação de Serviço          | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >Vulnerabilidade no Protocolo de Ambiente de Trabalho Remoto - CVE-2011-1968</th>
...
Vulnerabilidade no Protocolo de Ambiente de Trabalho Remoto - CVE-2011-1968  
---------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço na forma como o Protocolo de Ambiente de Trabalho Remoto acede a um objecto na memória que tenha sido inicializado incorrectamente ou que tenha sido eliminado. Um intruso que explorasse esta vulnerabilidade com êxito poderia fazer com que o sistema visado deixasse de responder e fosse reiniciado automaticamente.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2011-1968](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1968).
  
#### Factores Atenuantes para a Vulnerabilidade no Protocolo de Ambiente de Trabalho Remoto - CVE-2011-1968
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Por predefinição, o Protocolo de Ambiente de Trabalho Remoto não está activado em nenhum sistema operativo Windows. No Windows XP e no Windows Server 2003, a Assistência Remota pode activar o RDP.  
...
#### Soluções Alternativas para a Vulnerabilidade no Protocolo de Ambiente de Trabalho Remoto - CVE-2011-1968
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade no Protocolo de Ambiente de Trabalho Remoto - CVE-2011-1968
...
Não, o RDP não está activado por predefinição para administração. Os clientes que não tenham o RDP activado continuarão a receber esta actualização, de forma a garantir a protecção das suas máquinas. Para obter mais informações acerca desta configuração, consulte o artigo TechNet sobre [Como activar e configurar o Ambiente de Trabalho Remoto para Administração no Windows Server 2003](http://support.microsoft.com/kb/814590).
...
A actualização resolve a forma como o Protocolo do Ambiente de Trabalho Remoto processa pacotes na memória.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2570222$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2570222">Artigo 2570222 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
