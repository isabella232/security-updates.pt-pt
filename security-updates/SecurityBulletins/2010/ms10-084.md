---
TOCTitle: 'MS10-084'
Title: 'Microsoft Security Bulletin MS10-084 - Importante'
ms:assetid: 'ms10-084'
ms:contentKeyID: 61234959
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-084(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-084 - Importante
=================================================

Vulnerabilidade na Chamada de Procedimento Local do Windows Poderia Permitir Elevação de Privilégios (2360937)
--------------------------------------------------------------------------------------------------------------
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6049c879-b81a-4d10-b96b-b2837cb24834)                                     | Elevação de Privilégios     | Importante                          | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d690846c-5e0b-4216-84cd-d17e366dd16d)            | Elevação de Privilégios     | Importante                          | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b31e18b0-da9f-4b3b-82c6-603e08b3b241)                            | Elevação de Privilégios     | Importante                          | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d73f0f1-6ec8-4304-a20e-345d8b6c225a)                | Elevação de Privilégios     | Importante                          | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8fad4f77-7c89-4684-b957-9c00ced248d3) | Elevação de Privilégios     | Importante                          | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Sobrecarga de Memória Intermédia em Mensagens LPC - CVE-2010-3222</th>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=?...?">Windows Server 2003 com SP2 para sistemas baseados em Itanium</a></td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Elevação de Privilégios</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
...
Vulnerabilidade de Sobrecarga de Memória Intermédia em Mensagens LPC - CVE-2010-3222  
------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no Subsistema da Chamada de Procedimento Remoto (RPCSS) com execução no contexto da conta NetworkService, em que uma aplicação local pode utilizar o LPC para pedir que o servidor LPC volte a ligar-se ao cliente utilizando o LRPC. Este pedido poderia conter dados especialmente concebidos para o efeito, destinados a provocar uma sobrecarga de memória intermédia baseada em pilha, permitindo que um utilizador autenticado acedesse a recursos com execução no contexto da conta NetworkService.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222).
  
#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga de Memória Intermédia em Mensagens LPC - CVE-2010-3222
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga de Memória Intermédia em Mensagens LPC - CVE-2010-3222
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga de Memória Intermédia em Mensagens LPC - CVE-2010-3222
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso com credenciais de utilizador que explorasse esta vulnerabilidade com sucesso poderia executar código no contexto da conta NetworkService.
  
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é provocada por uma sobrecarga de memória intermédia baseada em pilha na troca de mensagens de portas entre os servidores LPC e LRPC (Mapeador de Pontos Finais RPC) contidos no RPCSS.
  
**Qual é o componente afectado pela vulnerabilidade?**    
O componente afectado pela vulnerabilidade é a Chamada de Procedimento Local (LPC) da Microsoft, um componente da Chamada de Procedimento Remoto (RPC).
  
**O que é o LPC?**  
A Chamada de Procedimento Local (LPC) é um serviço de passagem de mensagens incluído no Windows. Este serviço permite que threads e processos comuniquem entre si. Quando um processo cliente tem de requerer um serviço de um processo de servidor, tem de haver uma maneira de os dois processos comunicarem um com o outro. Tem de haver uma maneira de o processo cliente fazer requisições ao servidor, de o servidor enviar respostas ao cliente e de cada um deles determinar o seu estado. Quando o processo cliente e o processo de servidor estão localizados em sistemas diferentes, é usada uma Chamada de Procedimento Remoto (Remote Procedure Call - RPC). Quando estão localizados no mesmo sistema, pode usar-se o LPC.
...
**O que é o LRPC?**  
O RPC local (LRPC) denota a comunicação RPC que ocorre num sistema local.
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que explorasse esta vulnerabilidade com sucesso poderia executar código especialmente concebido para o efeito no contexto da conta NetworkService, permitindo-lhe obter acesso a recursos com execução como NetworkService. Alguns destes processos poderão ser capazes de elevar os seus privilégios para LocalSystem, permitindo também que quaisquer processos NetworkService elevem os seus privilégios para LocalSystem. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Um intruso que tivesse sessão iniciada localmente e credenciais válidas poderia explorar a vulnerabilidade executando código especialmente concebido para o efeito que enviasse uma mensagem LPC para o servidor LRPC local. A mensagem poderia então permitir que um utilizador autenticado executasse código no contexto da conta NetworkService.
...
A actualização resolve a vulnerabilidade modificando a forma como as mensagens das portas LPC são processadas dentro do RPCSS.
  
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222).
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2360937$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2360937">Artigo 2360937 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
