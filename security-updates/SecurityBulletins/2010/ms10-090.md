...
ms:assetid: 'ms10-090'
ms:contentKeyID: 61234965
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-090(v=Security.10)'
author: SharonSears
...
Actualização de Segurança Cumulativa para o Internet Explorer (2416400)
-----------------------------------------------------------------------

Data de publicação: 14 de dezembro de 2010 | Updated: 4 de janeiro de 2011
...
A actualização de segurança resolve as vulnerabilidades, ao modificar a forma como o Internet Explorer processa objectos em memória e script durante determinados processos. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.

Esta actualização de segurança também resolve a vulnerabilidade descrita previamente no [Aviso de Segurança da Microsoft 2458511](http://technet.microsoft.com/security/advisory/2458511).
...
**Questões Conhecidas.** O [Artigo 2416400 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2416400) documenta as questões actualmente conhecidas que os clientes poderão experimentar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
<span></span>
**Por que razão foi revisto este boletim de segurança a 4 de Janeiro de 2011?**  
A Microsoft reviu este boletim para anunciar uma alteração de detecção que ajuda a assegurar que as actualizações de segurança cumulativas do Internet Explorer previamente lançadas foram correctamente oferecidas pela ordem em que foram lançadas. Esta é apenas uma alteração de detecção. Não foram efectuadas alterações aos ficheiros de actualização de segurança. Os clientes que já tenham instalado a actualização com sucesso não têm de voltar a instalá-la.
...
As versões Windows 7 Service Pack 1 Beta e Windows Server 2008 R2 Service Pack 1 Beta são afectadas pelas vulnerabilidades descritas neste boletim. Aconselha-se os clientes que utilizem estas versões beta a transferirem e a aplicarem a actualização nos seus sistemas. As actualizações de segurança estão disponíveis no [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) e no [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130). A actualização de segurança também está disponível para transferência no [Centro de Transferências da Microsoft](http://go.microsoft.com/fwlink/?linkid=21129).

**O Internet Explorer 9 Beta é afectado por estas vulnerabilidades?**  
Não. O Internet Explorer que 9 Beta não é afectado pelas vulnerabilidades descritas neste boletim.

**Esta actualização contém outras alterações de segurança em termos de funcionalidade?**  
Esta actualização inclui uma actualização defensiva em profundidade para ajudar a melhorar a segurança entre domínios no Internet Explorer.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-3340
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2010-3342
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-3343
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Elemento HTML - CVE-2010-3345
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Elemento HTML - CVE-2010-3346
</th>
<th style="border:1px solid black;" >
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3340](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3340).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-3340
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-3340
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-3340
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3342](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2010-3342
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2010-3342
...
**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso que explorasse com sucesso esta vulnerabilidade poderia visualizar conteúdo do computador local ou uma janela do browser noutro domínio ou zona do Internet Explorer.
...
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3342](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342).
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3343](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3343).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-3343
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-3343

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Desactivar LMClassFactory**

    Remova a chave Liquid Motion Class do registo.
    ...
    **Aviso** Se utilizar o Editor de Registo incorrectamente, pode causar problemas sérios que podem vir a obrigar à reinstalação do seu sistema operativo. A Microsoft não pode garantir que consiga resolver problemas que resultam da utilização incorrecta do Editor de Registo. A utilização do Editor de Registo é da sua responsabilidade.
    ...
    1.  Crie uma cópia de segurança das chaves de registo, executando o seguinte comando a partir de uma linha de comandos com direitos de administrador elevados:
        `Regedit.exe /e Disable_LM_Factory_backup.reg HKEY_CLASSES_ROOT\CLSID\{B1549E58-3894-11D2-BB7F-00A0C999C4C1}`
    2.  Cole o texto seguinte num editor de texto como o Notepad. Depois, guarde o ficheiro com a extensão de nome de ficheiro .reg., como Disable\_LM\_Factory.reg:
        `Editor de registo do Windows versão 5.00`
        `[-HKEY_CLASSES_ROOT\CLSID\{B1549E58-3894-11D2-BB7F-00A0C999C4C1}]`
    3.  Execute o ficheiro Disable\_LM\_Factory.reg através do comando seguinte numa linha de comandos elevada:
        `Regedit.exe /s Disable_LM_Factory.reg `

    **Impacto da Solução Alternativa**. As funcionalidades que utilizem Liquid Motion são desactivadas. Para mais informações sobre Liquid Motion, consulte o [Artigo 257557 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/257557).
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-3343
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3345](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3345).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Elemento HTML - CVE-2010-3345
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Elemento HTML - CVE-2010-3345
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Corrupção de Memória de Elemento HTML - CVE-2010-3345
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3346).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Elemento HTML - CVE-2010-3346
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Elemento HTML - CVE-2010-3346
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Corrupção de Memória de Elemento HTML - CVE-2010-3346
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3348](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2010-3348
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2010-3348
...
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3348](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348).
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-3962

A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   A Prevenção de Execução de Dados (DEP) ajuda a proteger contra ataques que resultam em execução de código e está activada por predefinição no Internet Explorer 8 nos seguintes sistemas operativos Windows: Windows XP Service Pack 3, Windows Vista Service Pack 1, Windows Vista Service Pack 2 e Windows 7.
-   No cenário de um ataque baseado na Web, um intruso poderia alojar um Web site contendo uma página Web que fosse utilizada para explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Em vez disso, um intruso teria de convencer os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico, ou num programa de mensagens instantâneas, que levasse o utilizador para o Web site do intruso.
-   Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
...
-   **Substituir o CSS do Web site por uma folha de estilo definida pelo utilizador**

    Para aplicar uma folha de estilos CSS personalizada para formatar documentos carregados no Internet Explorer, guarde o texto que segue num ficheiro com a extensão .CSS, tal como KB2458511.CSS:
    TABLE
    {
        POSI\\TION: relative !important;
    }

    **Nota** O literal "\\" que, acima, aparece entre "POSI" e "TION" é intencional.

    **Impacto da solução alternativa.** A aplicação de um CSS definido pelo utilizador pode fazer com que as folhas de estilo do Web site não funcionem correctamente. Se tiver aplicado anteriormente esta solução alternativa, a mesma tem de ser anulada antes de aplicar esta actualização de segurança. Utilize a solução **Fix it da Microsoft** do [Artigo 2458511 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2458511) para desactivar esta solução alternativa.

    **Para aplicar a alteração interactivamente**

    1.  No Internet Explorer, clique em **Ferramentas** e, depois, em **Opções da Internet**.
    2.  No separador **Geral**, clique no botão **Acessibilidade**.
    3.  Seleccione **Formatar documentos com a minha folha de estilos**, clique em **Procurar**, navegue até à localização do ficheiro acima e seleccione o ficheiro.
    4.  Clique em **Abrir**, clique duas vezes em **OK** e reinicie o Internet Explorer.

    **Como anular esta solução alternativa.** Repita os passos acima, excepto o passo 3, e desmarque a caixa **Formatar documentos com a minha folha de estilos**.

    **Para aplicar a alteração utilizando o Editor de registo**

    **Aviso** Se utilizar o Editor de Registo incorrectamente, pode causar problemas sérios que podem vir a obrigar à reinstalação do seu sistema operativo. A Microsoft não pode garantir que consiga resolver problemas que resultam da utilização incorrecta do Editor de Registo. A utilização do Editor de Registo é da sua responsabilidade.

    1.  Crie uma cópia de segurança das chaves de registo, executando o seguinte comando a partir de uma linha de comandos com direitos de administrador elevados:
        regedit /e CSS-backup.reg "HKEY\_CURRENT\_USER\\Software\\Microsoft\\Internet Explorer\\Styles"
        Se não tiver sido criada uma cópia CSS-backup.reg, isso significa que não existe uma CSS definida pelo utilizador.
    2.  Depois, guarde o que se segue num ficheiro com a extensão .REG, tal como Apply\_user\_CSS.reg:
        Editor de registo do Windows versão 5.00
        ...
        **Nota** \[directory location\] deve corresponder à localização de KB2458511.css no sistema local.
    3.  Depois execute Apply\_user\_CSS.reg para aplicar a definição.

    **Como anular esta solução alternativa.** No caso de haver uma CSS definida pelo utilizador anterior, utilize o ficheiro CSS-backup.reg para restaurar a definição anterior. Caso contrário, guarde o que se segue num ficheiro com a extensão .REG, tal como Remove\_user\_CSS.reg:
    Editor de registo do Windows versão 5.00
    \[-HKEY\_CURRENT\_USER\\Software\\Microsoft\\Internet Explorer\\Styles\]

    Depois, execute Remove\_user\_CSS.reg usando o seguinte comando numa linha de comandos com privilégios elevados:
    Regedit.exe /s Remove\_user\_CSS.reg

    **Para aplicar a alteração utilizando a solução automática Fix it da Microsoft**

    Consulte o [Artigo 2458511 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2458511) para utilizar a solução automática de **correcção da Microsoft** para activar ou desactivar esta solução alternativa.

-   **Activar a Prevenção de Execução de Dados (DEP) para o Internet Explorer 7**

    Os **Administradores** locais podem controlar a DEP/NX executando o Internet Explorer como Administrador. Para activar a DEP, utilize um dos seguintes métodos:

    **Activar a DEP para o Internet Explorer 7 interactivamente**
    ...
    **Impacto da solução alternativa.** Algumas extensões do browser poderão não ser compatíveis com a DEP, podendo fechar-se inesperadamente.

    **Como anular esta solução alternativa.** Se for esse o caso, pode desactivar o suplemento ou repor a definição da DEP utilizando o Painel de Controlo da Internet. Também pode ter acesso através do Painel de Controlo do Sistema.

    **Active a DEP para o Internet Explorer 7 utilizando a solução automática Fix it da Microsoft**

    Consulte o [Artigo 2458511 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2458511) para utilizar a solução automática de correcção da Microsoft para activar ou desactivar esta solução alternativa.

    **Impacto da solução alternativa.** Algumas extensões do browser poderão não ser compatíveis com a DEP, podendo fechar-se inesperadamente.

    **Como anular esta solução alternativa.** Se for esse o caso, pode desactivar o suplemento ou repor a definição da DEP utilizando a solução automática de correcção da Microsoft para desactivar a solução alternativa.
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-3962
...
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962). Esta vulnerabilidade foi previamente descrita no [Aviso de Segurança da Microsoft 2458511](http://technet.microsoft.com/security/advisory/2458511).

**Quando este boletim de segurança foi publicado, a Microsoft já tinha recebido informações sobre a exploração desta vulnerabilidade?**  
Sim. A Microsoft tem conhecimento de ataques activos que tentam explorar a vulnerabilidade.
...
Sim. Esta actualização de segurança corrige a vulnerabilidade actualmente explorada. À vulnerabilidade que foi resolvida foi atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962).

**Se apliquei as soluções alternativas fornecidas no** [**Aviso de Segurança da Microsoft 2458511**](http://technet.microsoft.com/security/advisory/2458511)**, tenho de as anular antes de aplicar esta actualização?**  
A Microsoft recomenda que anule a solução alternativa "Substituir o CSS do Web site" dos sistemas onde a aplicou anteriormente, antes que de instalar esta actualização de segurança. No entanto, pode deixar implementadas as soluções alternativas "Implementar o Enhanced Mitigation Experience Toolkit" (EMET) e "Activar Prevenção de Execução de Dados (DEP) para o Internet Explorer 7" como medida defensiva em profundidade.
...
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2416400$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB2416400-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie8updates\KB2416400-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2416400">Artigo 2416400 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Aniway da [iDefense Labs da VeriSign](http://labs.idefense.com/) por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML (CVE-2010-3340)  
-   Nicolas Joly, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML (CVE-2010-3343)  
-   Stephen Fewer, trabalhar com a [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Elemento HTML (CVE-2010-3345)  
-   [Peter Vreugdenhil](http://vreugdenhilresearch.nl/), a trabalhar com a [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Elemento HTML (CVE-2010-3346)  
-   Masatoshi Sato, da [AZIA CO., LTD.](http://www.azia.jp), por fornecer informações sobre a Vulnerabilidade de Divulgação de Informações entre Domínios (CVE-2010-3348)  
-   [Yosuke Hasegawa](http://utf-8.jp), por trabalhar connosco na Vulnerabilidade de Divulgação de Informações Entre Domínios (CVE-2010-3348)  
-   Jose Antonio Vazquez Gonzalez da [iDefense Labs da VeriSign](http://labs.idefense.com/) por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2010-3962)
...
-   V1.1 (4 de Janeiro de 2011): Adição de uma actualização de Perguntas Frequentes para anunciar uma alteração de detecção que ajuda a assegurar que as actualizações de segurança cumulativas do Internet Explorer previamente lançadas foram correctamente oferecidas pela ordem em que foram lançadas. Esta é apenas uma alteração de detecção. Não foram efectuadas alterações aos ficheiros de actualização de segurança.
