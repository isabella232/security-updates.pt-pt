---
TOCTitle: 'MS10-081'
Title: 'Microsoft Security Bulletin MS10-081 - Importante'
ms:assetid: 'ms10-081'
ms:contentKeyID: 61234956
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-081(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-081 - Importante
=================================================

Vulnerabilidade na Biblioteca de Controlo Comum do Windows Poderia Permitir Execução Remota de Código (2296011)
---------------------------------------------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=912a7c20-8177-4f65-b986-43fca6375ec1)                                                                                                    | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c651bca-adb1-4172-9714-cd5a6e5d2c2a)                                                                           | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b2eb449-ad55-4dfb-a3c5-aac767de6f45)                                                                                           | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54fc4bc6-f46c-447c-8307-afd8338e7ffb)                                                                               | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=64f5c311-d74a-4665-9775-ac91c6885ed3)                                                                | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=95ceafc6-e37a-4c77-b16e-c9c94a7d89bd)                                                                  | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dfe7cd18-53a3-433e-9a33-bd96b04b4deb)                                          | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5f079b0-d8e1-47fe-b9dd-41eeb463a93c)\*\*               | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e88d9c5-eb57-4d39-a880-a478c5f286da)\*\*     | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e46d08-22d9-4a0c-82cd-d2753d07efe6) | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=bdff9057-381a-44e8-b093-84f07d8d7e3c)                                                                                           | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=35a2b1a9-6dd6-4a7e-bc0a-b4fcffa06b28)                                                                                      | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=25fff010-3abc-45e6-979e-21d2bae49418)\*\*                                                                     | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d0742526-b5ec-4658-82f1-c3680f33a790)                                                                     | Execução Remota de Código   | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Comctl32 - CVE-2010-2746</th>
...
Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Comctl32 - CVE-2010-2746  
-------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como a biblioteca de controlos comuns do Windows processa Web sites especialmente concebidos para o efeito ao utilizar um visualizador de gráficos de vector dimensionáveis (SVG) de outras empresas. Esta vulnerabilidade poderia permitir a execução de código se um utilizador visitasse uma página Web especialmente concebida para o efeito. Se um utilizador tiver sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-2746](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2746).
  
#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Comctl32 - CVE-2010-2746
...
-   Esta vulnerabilidade não pode ser explorada na configuração predefinida do Windows. Para ser vulnerável à questão, uma aplicação de outra empresa que processa gráficos de vector dimensionáveis (SVG) tem de estar instalada no sistema.
  
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Comctl32 - CVE-2010-2746
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Comctl32 - CVE-2010-2746
...
A biblioteca de controlos comuns do Windows não processa correctamente determinadas mensagens ao processar gráficos de vector dimensionáveis transmitidos de um visualizador de gráficos de vector dimensionáveis (SVG) de outras empresas.
  
**O que são as Bibliotecas de Controlos Comuns do Windows?**    
Os controlos comuns são um conjunto de janelas que são implementadas pela biblioteca de controlo comum, Comctl32.dll, que é um DLL incluído com o sistema operativo Windows. Tal como outras janelas de controlo, um controlo comum é uma janela subordinada que uma aplicação utiliza juntamente com outra janela para permitir a interacção com o utilizador. Para mais informações sobre estas bibliotecas, consulte o artigo MSDN [Acerca de Controlos Comuns](http://msdn.microsoft.com/en-us/library/bb775493(vs.85).aspx).
  
**Esta questão pode ser explorada na configuração predefinida do Windows?**    
Não. Para ser vulnerável à questão, uma aplicação de outra empresa que processa gráficos de vector dimensionáveis (SVG) tem de estar instalada no sistema. A Microsoft não determinou qualquer vector de ataque sem este visualizador de outras empresas estar instalado no sistema. Para obter uma lista de implementações SVG, consulte a lista do World Wide Web Consortium (W3C) relativa a [Implementações SVG](http://www.w3.org/graphics/svg/wg/wiki/implementations).
  
**O que são Gráficos de Vector Dimensionáveis?**    
Os Gráficos de Vector Dimensionáveis (SVG) são um padrão para escrever e implementar gráficos de vector bidimensionais utilizando documentos XML. É uma recomendação da World Wide Web Consortium (W3C) que foi adoptada e aplicada por várias organizações da indústria. Um SVG é, essencialmente, um documento XML em conformidade com o esquema definido como parte do processo de ratificação SVG. Definida na especificação está uma variedade de formas geométricas básicas, tais como rectângulos, círculos, elipses, linhas, linhas múltiplas, polígonos e elementos de glifos, como texto. Podem ser criadas formas mais complexas utilizando o elemento de caminho, permitindo-lhe definir formas como uma sequência de linhas, arcos e curvas complexas de Bezier. Através da utilização destas formas básicas, juntamente com um pouco de ingenuidade, podem ser criadas as mais complexas construções geométricas.
...
A actualização resolve esta vulnerabilidade corrigindo a forma como a biblioteca de controlos comuns do Windows processa determinadas mensagens transmitidas de um visualizador de gráficos de vector dimensionáveis (SVG) de outras empresas.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2296011$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2296011">Artigo 2296011 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Krystian Kloskowski (h07), a trabalhar com a [Secunia](http://secunia.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Comctl32 (CVE-2010-2746)
