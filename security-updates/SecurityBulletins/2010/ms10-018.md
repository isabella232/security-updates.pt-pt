...
ms:assetid: 'ms10-018'
ms:contentKeyID: 61234893
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-018(v=Security.10)'
author: SharonSears
...
Actualização de Segurança Cumulativa para o Internet Explorer (980182)
----------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Crítica para todas as versões suportadas do Internet Explorer: Internet Explorer 5.01, Internet Explorer 6 Service Pack 1, Internet Explorer 6 em clientes Windows, Internet Explorer 7 e Internet Explorer 8 em clientes Windows. Para Internet o Explorer 6 em servidores Windows, esta actualização está classificada como Importante. Para o Internet Explorer 8 em servidores Windows, esta actualização está classificada como Moderada. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve estas vulnerabilidades modificando a forma como o Internet Explorer verifica a origem de scripts e processa objectos em memória, conteúdo que utiliza cadeias de codificação e URL longo. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes na secção seguinte, **Informações sobre as vulnerabilidades**.

Esta actualização de segurança também resolve a vulnerabilidade previamente descrita no [Aviso de Segurança da Microsoft 981374](http://technet.microsoft.com/security/advisory/981374). A vulnerabilidade, [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806), não afecta o Windows 7, o Windows Server 2008 R2 ou o Internet Explorer 8.
...
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 980182 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/980182).
...
Esta actualização inclui uma actualização de protecção defensiva profunda para o Cabeçalho HTTP X-XSS-Protection. Especificamente, uma nova sintaxe "mode = block" faz com que o Filtro XSS desactive totalmente o conteúdo da página caso seja detectada execução de scripts entre sites. Por exemplo: X-XSS-Protection: 1; mode=block.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações Após Codificação - CVE-2010-0488
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Condição Race - CVE-2010-0489
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-0490
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-0491
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-0492
</th>
<th style="border:1px solid black;" >
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no Processamento de HTML - CVE-2010-0807
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0267](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0267).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-0267
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-0267
...
<span></span>
Existe uma vulnerabilidade de divulgação de informações na forma como o Internet Explorer processa conteúdo que utiliza cadeias de codificação específicas durante o envio de dados. Um intruso poderia explorar a vulnerabilidade construindo uma página Web especialmente concebida para o efeito que pudesse permitir a divulgação de informações se um utilizador visualizasse essa página. Um intruso que explorasse com sucesso esta vulnerabilidade poderia visualizar conteúdo do computador local ou de outra janela do browser noutro domínio ou zona do Internet Explorer.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0488](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0488).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações Após Codificação - CVE-2010-0488
...
#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações Após Codificação - CVE-2010-0488
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações Após Codificação - CVE-2010-0488

**Qual é a abrangência desta vulnerabilidade?**  
Trata-se de uma vulnerabilidade ao nível da divulgação de informações. Um intruso que explorasse a vulnerabilidade quando um utilizador visualiza uma página Web poderia visualizar dados importantes guardados na memória do sistema.

**O que provoca a vulnerabilidade?**  
Existe uma vulnerabilidade de divulgação de informações na forma como o Internet Explorer processa conteúdo que utiliza cadeias de codificação específicas durante o envio de dados.

**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso que conseguisse tirar partido desta vulnerabilidade quando um utilizador está a visualizar uma página Web poderia visualizar dados importantes guardados na memória do sistema.
...
**O que faz a actualização?**  
A actualização modifica a forma como o Internet Explorer processa conteúdo que utiliza cadeias de codificação específicas.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0489](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0489).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Condição Race - CVE-2010-0489
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Condição Race - CVE-2010-0489
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Condição Race - CVE-2010-0489
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0490](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0490).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-0490
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-0490
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0491](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0491).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-0491
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-0491
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-0491
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0492](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0492).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-0492
...
-   Por predefinição, todas as versões suportadas do Microsoft Outlook, Microsoft Outlook Express e Windows Mail abrem mensagens de correio electrónico em HTML na Zona de sites restritos, que desactiva scripts e controlos ActiveX, eliminando o risco de um intruso poder utilizar esta vulnerabilidade para executar código malicioso. Se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003 e no Windows Server 2008 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://go.microsoft.com/fwlink/?linkid=92039). Este modo define o nível de segurança para a zona da Internet como Alto. Este é um factor atenuante para Web sites que não adicionou à Zona de sites fidedignos do Internet Explorer. Consulte a subsecção de Perguntas Mais Frequentes desta secção da vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Internet Explorer 6 e o Internet Explorer 7 não são afectados por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-0492
...
-   **Modificar a Lista de Controlo de Acesso (ACL) no ficheiro mstime.dll**

    Modificar a ACL para desactivar o mstime.dll.

    No Windows XP e no Windows Server 2003, execute o seguinte comando a partir de uma linha de comandos com direitos administrativos:

    `Echo y| cacls %WINDIR%\SYSTEM32\mstime.DLL /E /P everyone:N`

    No Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2, execute os seguintes comandos a partir de uma linha de comandos com privilégios elevados:
    ...
    **Impacto da solução alternativa.** Funcionalidades como HTML e TIME são desactivadas.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML - CVE-2010-0492
...
<span></span>
Existe uma vulnerabilidade de divulgação de informações no Internet Explorer que poderia permitir que um script obtivesse acesso a uma janela do browser noutro domínio ou zona do Internet Explorer. Um intruso poderia explorar a vulnerabilidade construindo uma página da Web especialmente concebida para o efeito que poderia permitir a divulgação de informações se um utilizador visualizasse a página da Web e arrastasse a janela do browser para uma segunda janela do browser.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0494](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0494).

#### Factores Atenuantes para a Vulnerabilidade entre Domínios de Elementos HTML - CVE-2010-0494
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade entre Domínios de Elementos HTML - CVE-2010-0494
...
**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar um script no contexto do utilizador noutro domínio do Internet Explorer.
...
**O que faz a actualização?**  
A actualização reforça as verificações de segurança ao verificar a origem do script.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer gere um URL longo em determinadas situações. Um intruso poderia explorar a vulnerabilidade criando uma página web especialmente concebida para o efeito. Quando um utilizador visualizasse a página Web, a vulnerabilidade poderia permitir a execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Se um utilizador tiver sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0805](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0805).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória - CVE-2010-0805
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória - CVE-2010-0805

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**O que provoca a vulnerabilidade?**  
Um controlo ActiveX no Internet Explorer gere incorrectamente um URL longo em determinadas situações. Como resultado desta operação, a memória pode ficar corrompida de uma forma que pode permitir que um intruso execute código arbitrário no contexto do utilizador com sessão iniciada.
...
**O que faz a actualização?**  
A actualização modifica a forma como o Controlo ActiveX no Internet Explorer gere um URL longo.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-0806
...
-   **Desactivar a classe de peer definida de fábrica editando as chaves de registo para o ficheiro iepeers.dll**

    Primeiro, crie uma cópia de segurança das chaves de registo, executando o seguinte comando a partir de uma linha de comandos com direitos de administrador elevados:

    `Regedit.exe /e Disable_Peer_Factory_backup.reg HKEY_CLASSES_ROOT\CLSID\{3050F4CF-98B5-11CF-BB82-00AA00BDCE0B}`

    Apenas para o Windows Vista e o Windows Server 2008, deve primeiro obter acesso de proprietário a \[HKEY\_CLASSES\_ROOT\\CLSID\\{3050F4CF-98B5-11CF-BB82-00AA00BDCE0B}\], seguindo os seguintes passos:
    ...
    2.  Aceda a \[HKEY\_CLASSES\_ROOT\\CLSID\\{3050F4CF-98B5-11CF-BB82-00AA00BDCE0B}\]
    ...
    6.  Repita os passos 3 a 5 para todas as subchaves

    Depois, guarde o que se segue num ficheiro com a extensão .REG, como por exemplo, Disable\_Peer\_Factory.reg:

    `Editor de Registo do Windows Versão 5.00[-HKEY_CLASSES_ROOT\CLSID\{3050F4CF-98B5-11CF-BB82-00AA00BDCE0B}]`

    Depois, execute Disable\_Peer\_Factory.reg usando o seguinte comando numa linha de comandos com privilégios elevados:

    `Regedit.exe /s Disable_Peer_Factory.reg`

    **Impacto da solução alternativa.** As funcionalidades que dependem das definições de peer de fábrica, tais como impressão e pastas na Web, podem ser afectadas.
...
-   **Modificar a Lista de Controlo de Acesso (ACL) no ficheiro iepeers.dll**

    Para modificar a ACL no ficheiro iepeers.dll de modo a que seja mais restritivo, execute os comandos que se seguem a partir de uma linha de comandos com privilégios de administrador:
    ...
    **Impacto da solução alternativa.** As funcionalidades alargadas de MSHTML, tais como impressão e pastas na Web, podem ser afectadas.

    **Como anular esta solução alternativa.**

    Execute os comandos que se seguem a partir de uma linha de comandos com privilégios de administrador:
...
-   **Activar a Prevenção de Execução de Dados (DEP) para o Internet Explorer 7**
    ...
    **Como anular esta solução alternativa.**
    ...
    Utilize o Painel de Controlo da Internet ou o Painel de Controlo do Sistema.

-   **Active a DEP para o Internet Explorer 7 utilizando a correcção automática da Microsoft**

    Consulte o [Artigo 980182 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/980182) para utilizar a solução automática de correcção da Microsoft para activar ou desactivar esta solução alternativa.

    **Impacto da solução alternativa.** Algumas extensões do browser poderão não ser compatíveis com a DEP, podendo fechar-se inesperadamente. Se for esse o caso, pode desactivar o suplemento ou repor a definição da DEP utilizando a solução automática de correcção da Microsoft para desactivar a solução alternativa.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-0806
...
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806). Foi também descrita no [Aviso de Segurança da Microsoft 981374](http://technet.microsoft.com/security/advisory/981374).

**Quando este boletim de segurança foi publicado, a Microsoft já tinha recebido relatórios indicando que esta vulnerabilidade estava a ser explorada?**  
Sim. A Microsoft tem conhecimento de ataques que tentam explorar a vulnerabilidade.

**Se apliquei as soluções alternativas fornecidas no Aviso 981374, tenho de as anular antes de aplicar esta actualização?**  
Se aplicou as soluções alternativas fornecidas no [Aviso de Segurança da Microsoft 981374](http://technet.microsoft.com/security/advisory/981374), terá de as anular seguindo as respectivas instruções fornecidas na subsecção Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2010-0806. Se as soluções alternativas para iepeers.dll ou DEP tiverem sido aplicadas utilizando a funcionalidade de activação de correcção fornecida no [Aviso de Segurança da Microsoft 981374](http://technet.microsoft.com/security/advisory/981374), pode anular a solução alternativa seleccionando a opção "Desactivar esta correcção" para estas soluções alternativas no [Artigo 980182 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/980182).
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0807](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0807).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Processamento de HTML - CVE-2010-0807

A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   No cenário de um ataque baseado na Web, um intruso poderia alojar um Web site contendo uma página Web que fosse utilizada para explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Em vez disso, um intruso teria de convencer os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico, ou num programa de mensagens instantâneas, que levasse o utilizador para o Web site do intruso.
-   Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
-   O Internet Explorer 5.01 Service Pack 4, o Internet Explorer 6, o Internet Explorer 6 Service Pack 1 e o Internet Explorer 8 não são afectados por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Processamento de HTML - CVE-2010-0807
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Processamento de HTML - CVE-2010-0807
...
<td style="border:1px solid black;">Para o Internet Explorer 5.01 Service Pack 4 em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB980182-IE5SP4-20100305.120000$\Spuninst<br />
<br />
Para o Internet Explorer 6 Service Pack 1 quando instalado em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB980182-IE6SP1-20100305.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/980182">Artigo 980182 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 for all supported editions of Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB980182$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB980182-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie8updates\KB980182-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/980182">Artigo 980182 da Base de Dados de Conhecimento da Microsoft</a></td>
...
-   [Secunia](http://secunia.com), por trabalhar connosco na Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2010-0267)  
-   Daiki Fukumori, da [Cyber Defense Institute Inc.](http://www.cyberdefense.jp/), por fornecer informações sobre a Vulnerabilidade de Divulgação de Informações Após Codificação (CVE-2010-0488)  
-   Alexander Kornbrust, da [Red Database Security](http://www.red-database-security.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2010-0490)  
-   Ivan Fratric, da [iSIGHT Partners](http://www.isightpartners.com/) Global Vulnerability Partnership, por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2010-0490)  
-   Wushi, da [team509](http://www.team509.com/), a trabalhar com a [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML (CVE-2010-0491)  
-   Simon Zuckerbraun, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objecto HTML (CVE-2010-0492)  
-   Paul Stone, da [Context Information Security](http://www.contextis.co.uk/), por fornecer informações sobre a Vulnerabilidade entre Domínios de Elementos HTML (CVE-2010-0494)  
-   Investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória (CVE-2010-0805)  
-   ADLab, da [VenusTech](http://www.venustech.com.cn/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2010-0806)  
-   ADLab, da [VenusTech](http://www.venustech.com.cn/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Processamento de HTML (CVE-2010-0807)
