...
ms:assetid: 'ms10-068'
ms:contentKeyID: 61234943
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-068(v=Security.10)'
---
...
Vulnerabilidade no Serviço de Subsistema de Autoridade de Segurança Local Poderia Permitir Elevação de Privilégios (983539)
---------------------------------------------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para o Active Directory, ADAM e AD LDS quando instalados em edições suportadas do Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o Serviço de Subsistema de Autoridade de Segurança Local (LSASS) processa determinadas mensagens LDAP. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6554f98f-4dc5-4784-b92c-b0aae1fa22ca">Modo de Aplicações do Active Directory (ADAM)</a><br />
(KB982000)</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5bc00f9a-3028-4c9d-be06-f2b78fa444c4">Modo de Aplicações do Active Directory (ADAM)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
(KB981550)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=c42731f1-6393-42ed-b59f-5310c832fdc4">Modo de Aplicações do Active Directory (ADAM)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
(KB981550)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=79fb639d-2cc1-4bea-9df6-c67ed95890e3">Modo de Aplicações do Active Directory (ADAM)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=853a71f3-fb0d-43af-a2b8-45bf8ca1a588">Serviços LDS do Active Directory (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=566f468b-22b6-400a-a656-ae64cfcb52df">Serviços LDS do Active Directory (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=454fc025-bfa2-4552-9522-3585f523ecb2">Serviços LDS do Active Directory (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b15ad533-3cf1-4dcf-847c-05ebffb84e26">Serviços LDS do Active Directory (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">Elevação de Privilégios</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhum</td>
...
| Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2<sup>[1]</sup> |  
| Windows Server 2008 R2 para sistemas baseados em Itanium<sup>[1]</sup>                                                                   |
...
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no LSASS - CVE-2010-0820  
</th>
<th style="border:1px solid black;" >
...
<span></span>
Existe uma vulnerabilidade de elevação de privilégios autenticados no Microsoft Windows devido à forma como o Serviço de Subsistema de Autoridade de Segurança Local (LSASS) processa incorrectamente determinadas mensagens de protocolo LDAP (Lightweight Directory Access Protocol). A vulnerabilidade existe em implementações do Active Directory, Modo de Aplicações do Active Directory (ADAM) e Serviços LDS do Active Directory (AD LDS). Um intruso teria de se autenticar previamente no servidor LSASS antes de explorar esta questão. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0820](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0820).

#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no LSASS - CVE-2010-0820
...
-   Para explorar com êxito esta vulnerabilidade, um intruso teria de ter uma conta de membro no domínio visado do Windows. Contudo, o intruso não necessitaria de ter uma estação de trabalho ligada ao domínio do Windows.

#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no LSASS - CVE-2010-0820

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Bloquear a porta TCP 389 na firewall**

    Bloquear a porta TCP 389 na firewall. Esta porta é usada para iniciar uma ligação com o componente afectado.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no LSASS - CVE-2010-0820
...
A vulnerabilidade é provocada quando a implementação LSASS do Windows não processa correctamente pacotes mal formados específicos em mensagens LDAP.
...
**O que é o protocolo LDAP (Lightweight Directory Access Protocol)?**  
...
**O que são os Serviços LDS do Active Directory?**  
Os Serviços LDS do Active Directory (AD LDS) são um modo independente do Active Directory que fornece serviços de directório dedicados para aplicações. O AD LDS está disponível para o Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2. O AD LDS substitui o Modo de Aplicações do Active Directory (ADAM), que está disponível para o Windows XP e Windows Server 2003.

**Como posso confirmar se meu servidor está a executar o serviço LDAP se estiver a utilizar o Active Directory?**  
Para confirmar se um servidor atende a pedidos de LDAP ou LDAPS, execute o seguinte comando a partir de uma linha de comandos com direitos de administrador e verifique se o sistema está a processar pedidos na porta do LDAP (389) ou na porta do LDAPS (636) ou numa das portas do serviço de Catálogo Global (3268 ou 3269):
netstat –a
...
Um intruso poderia explorar esta vulnerabilidade enviando mensagens LDAP especialmente concebidas para o efeito para um servidor LSASS em escuta. Um intruso teria de se autenticar previamente no servidor LSASS antes de explorar esta questão.

**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
São afectados por esta vulnerabilidade todos os sistemas que executem um sistema operativo afectado com serviços do Active Directory instalados. Esta vulnerabilidade não afecta directamente os sistemas apenas do cliente.

**O que faz a actualização?**  
A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o LSASS processa determinadas mensagens LDAP.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe, que está localizado na pasta %Windir%\$NTUninstallKB982000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/982000">Artigo 982000 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para o Active Directory no Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB981550-x86-ENU.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Modo de Aplicações do Active Directory (ADAM) no Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB982000-x86-ENU.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory no Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB981550-x64-ENU.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Modo de Aplicações do Active Directory (ADAM) no Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB982000-x64-ENU.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory no Windows Server 2003 com SP2 para sistemas baseados em Itanium:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Para o Active Directory, utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe, que está localizado na pasta %Windir%\$NTUninstallKB981550$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Modo de Aplicações do Active Directory (ADAM), utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe, que está localizado na pasta %Windir%\$NTUninstallKB982000$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para o Active Directory no Windows Server 2003, consulte o <a href="http://support.microsoft.com/kb/981550">Artigo 981550 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Modo de Aplicações do Active Directory (ADAM) no Windows Server 2003, consulte o <a href="http://support.microsoft.com/kb/982000">Artigo 982000 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Para o Active Directory no Windows Server 2003:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB981550\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Modo de Aplicações do Active Directory (ADAM) no Windows Server 2003:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/981550">Artigo 981550 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
