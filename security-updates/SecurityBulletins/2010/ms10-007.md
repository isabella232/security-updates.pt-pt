---
TOCTitle: 'MS10-007'
Title: 'Microsoft Security Bulletin MS10-007 - Crítica'
ms:assetid: 'ms10-007'
ms:contentKeyID: 61234882
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-007(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS10-007 - Crítica
==============================================

Vulnerabilidade no Processador da Shell do Windows Poderia Permitir Execução Remota de Código (975713)
------------------------------------------------------------------------------------------------------
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=92234237-a8eb-4ce4-bc5e-cd86feb7dbd3)                         | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b8e7bf17-a037-4200-9ae2-2280b19766a4)         | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b8d83f30-9cd7-4d6b-b2b9-65d0a483cb9c)            | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cb2e203-18fb-4887-a1c9-289d86b8ba11)                            | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=90360537-9311-45e2-8047-9a971f90c3c3)                | Execução Remota de Código   | Crítica                             | Nenhum                                      |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d695ca9f-a1db-4c0f-94b6-7112861c28da) | Execução Remota de Código   | Crítica                             | Nenhum                                      |
...
**Como é que esta actualização de segurança está relacionada com CVE-2010-0027 conforme descrito no boletim MS10-002?**  
A Vulnerabilidade de Validação de URL (CVE-2010-0027) é resolvida por esta actualização (MS10-007) e pela [Actualização de Segurança Cumulativa para o Internet Explorer (MS10-002)](http://go.microsoft.com/fwlink/?linkid=179104), dependendo da versão do Microsoft Windows e da versão do Internet Explorer instalada no sistema do utilizador.
...
<th style="border:1px solid black;" >Vulnerabilidade de Validação de URL - CVE-2010-0027</th>
...
Esta é uma vulnerabilidade de execução remota de código. Um intruso que explorasse esta vulnerabilidade com sucesso poderia então executar acções com os mesmos direitos do utilizador com sessão iniciada no momento.
  
**O que provoca a vulnerabilidade?**    
Quando uma aplicação, tal como um browser da Web, utiliza a função da API ShellExecute para processar dados especialmente concebidos para o efeito, a ShellExecute pode validar incorrectamente o fluxo de dados e executar um binário a partir do sistema de cliente local.
...
**O que é a ShellExecute?**    
A ShellExecute faz parte das funções da interface de programação da aplicação (API) Shell do Windows. Executa uma operação num ficheiro especificado. Tal poderia significar, por exemplo, a invocação do processador correcto para um determinado tipo de ficheiro específico. Encontram-se mais informações acerca da função ShellExecute no artigo MSDN sobre a [Função ShellExecute](http://msdn.microsoft.com/en-us/library/bb762153(vs.85).aspx).
  
**O que é uma Interface de Programação da Aplicação (API)?**    
Uma API é um conjunto de funções que pode ser utilizado para trabalhar com um componente, aplicação ou sistema operativo. Tipicamente, uma API consiste em um ou mais DLLs que fornecem alguma funcionalidade específica.
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia executar código arbitrário em nome do utilizador com sessão iniciada. Se um utilizador tiver sessão iniciada com direitos de utilizador administrativos, um intruso poderia obter controlo total sobre o sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Um intruso poderia fornecer conteúdos, tais como uma página Web especialmente concebida para o efeito, que fizessem com que uma aplicação analisasse uma cadeia mal formada. Quando este conteúdo é enviado para o pedido da API ShellExecute, por exemplo, como uma hiperligação, tal poderia permitir que um intruso executasse um binário a partir do sistema cliente sem o conhecimento do utilizador com sessão iniciada.
  
**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**    
Os sistemas cliente que navegam em conteúdos de Internet não fidedignos estão mais susceptíveis a esta vulnerabilidade, o que poderia permitir a exploração no contexto do utilizador com sessão iniciada.
  
**O que faz a actualização?**    
Esta actualização resolve a vulnerabilidade corrigindo a forma como a API ShellExecute valida parâmetros de entrada em edições suportadas do Microsoft Windows 2000, Windows XP e Windows Server 2003.
...
| **Implementação**                        |                                                                                                                                                                                   |  
| Instalação sem intervenção do utilizador | Windows2000-KB975713-x86-ENU /quiet                                                                                                                                               |  
| Instalação sem reiniciar                 | Windows2000-KB975713-x86-ENU /norestart                                                                                                                                           |  
| Ficheiro log da actualização             | kb975713.log                                                                                                                                                                      |  
...
| **Informações de Remoção**               | Utilize a ferramenta **Adicionar ou Remover Programas** no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\\$NTUninstallKB975713$\\Spuninst |  
| **Informações de Ficheiros**             | Consulte o [Artigo 975713 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/975713)                                                                  |  
| **Verificação da Chave de Registo**      | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB975713\\Filelist                                                                                         |
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB975713$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/975713">Artigo 975713 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
