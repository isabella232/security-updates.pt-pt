...
ms:assetid: 'ms10-017'
ms:contentKeyID: 61234892
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-017(v=Security.10)'
author: SharonSears
...
Vulnerabilidades no Microsoft Office Excel Poderiam Permitir Execução Remota de Código (980150)
-----------------------------------------------------------------------------------------------

Data de publicação: 9 de março de 2010 | Updated: 10 de março de 2010
...
Esta actualização de segurança está classificada como Importante para todas as edições suportadas do Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office Excel 2007, Microsoft Office SharePoint Server 2007, Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac, Conversor de Formato de Ficheiros Open XML para Mac e todas as versões suportadas do Microsoft Office Excel Viewer e Pack de Compatibilidade do Microsoft Office. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.
...
**Questões conhecidas.** O [Artigo 980150 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/980150) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
O [Artigo 980150 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/980150) documenta as questões actualmente conhecidas que os clientes poderão verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
O Excel Services no Microsoft Office SharePoint Server utiliza um código baseado no cliente Excel, que é afectado por vulnerabilidades, tal como indicado na secção de Informações sobre as Vulnerabilidades deste boletim.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Registo no Microsoft Office Excel - CVE-2010-0257
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Confusão de Tipo de Objecto em Folhas de Cálculo no Microsoft Office Excel - CVE-2010-0258
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXTUPLE no Microsoft Office Excel - CVE-2010-0260
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXSET no Microsoft Office Excel - CVE-2010-0261
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Memória Não Inicializada no Registo FNGROUPNAME no Microsoft Office Excel - CVE-2010-0262
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Execução de Código na Análise de Ficheiros XLSX no Microsoft Office Excel - CVE-2010-0263
</th>
<th style="border:1px solid black;" >
Vulnerabilidade na Análise de Registo DbOrParamQry no Microsoft Office Excel - CVE-2010-0264
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0257).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Registo no Microsoft Office Excel - CVE-2010-0257
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Registo no Microsoft Office Excel - CVE-2010-0257
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Registo no Microsoft Office Excel - CVE-2010-0257
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0258).

#### Factores Atenuantes para a Vulnerabilidade de Confusão de Tipo de Objecto em Folhas de Cálculo no Microsoft Office Excel - CVE-2010-0258
...
#### Soluções Alternativas para a Vulnerabilidade de Confusão de Tipo de Objecto em Folhas de Cálculo no Microsoft Office Excel - CVE-2010-0258
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Confusão de Tipo de Objecto em Folhas de Cálculo no Microsoft Office Excel - CVE-2010-0258
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0260).

#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXTUPLE no Microsoft Office Excel - CVE-2010-0260
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXTUPLE no Microsoft Office Excel - CVE-2010-0260
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXTUPLE no Microsoft Office Excel - CVE-2010-0260
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0261).

#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXSET no Microsoft Office Excel - CVE-2010-0261
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXSET no Microsoft Office Excel - CVE-2010-0261
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXSET no Microsoft Office Excel - CVE-2010-0261
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0262](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0262).

#### Factores Atenuantes para a Vulnerabilidade de Memória Não Inicializada no Registo FNGROUPNAME no Microsoft Office Excel - CVE-2010-0262
...
#### Soluções Alternativas para a Vulnerabilidade de Memória Não Inicializada no Registo FNGROUPNAME no Microsoft Office Excel - CVE-2010-0262
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Memória Não Inicializada no Registo FNGROUPNAME no Microsoft Office Excel - CVE-2010-0262
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0263](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0263).

#### Factores Atenuantes para a Vulnerabilidade de Execução de Código na Análise de Ficheiros XLSX no Microsoft Office Excel - CVE-2010-0263
...
#### Soluções Alternativas para a Vulnerabilidade de Execução de Código na Análise de Ficheiros XLSX no Microsoft Office Excel - CVE-2010-0263

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Utilize a política de Bloqueio de Ficheiros do Microsoft Office para bloquear a abertura de documentos do Office 2007 que provenham de fontes ou localizações desconhecidas ou não fidedignas**
    ...
    **Impacto da solução alternativa.** Os utilizadores que tiverem configurado a política de Bloqueio de Ficheiros e não tiverem configurado um “directório de isenção” especial, tal como discutido no [Artigo 922848 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/922848), não poderão abrir ficheiros do Office 2007 no Office 2003 ou no Microsoft Office System 2007.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução de Código na Análise de Ficheiros XLSX no Microsoft Office Excel - CVE-2010-0263
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0264).

#### Factores Atenuantes para a Vulnerabilidade na Análise de Registo DbOrParamQry no Microsoft Office Excel - CVE-2010-0264
...
#### Soluções Alternativas para a Vulnerabilidade na Análise de Registo DbOrParamQry no Microsoft Office Excel - CVE-2010-0264

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade na Análise de Registo DbOrParamQry no Microsoft Office Excel - CVE-2010-0264
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/978471">Artigo 978471 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/978474">Artigo 978474 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para Excel 2007, consulte:<br />
<a href="http://support.microsoft.com/kb/978382">Artigo 978382 da Base de Dados de Conhecimento da Microsoft</a><br />
<br />
Para Excel Viewer, consulte:<br />
<a href="http://support.microsoft.com/kb/978383">Artigo 978383 da Base de Dados de Conhecimento da Microsoft</a><br />
<br />
Para Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007, consulte:<br />
<a href="http://support.microsoft.com/kb/978380">Artigo 978380 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
Transfira e instale a versão do idioma adequado para a Actualização do Microsoft Office 2004 para Mac 11.5.8, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=ae5936f8-fe3f-4d23-a37c-d80f228e475e).
...
-   Abra o volume da Actualização Microsoft Office 2004 para Mac 11.5.8 no seu ambiente de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume de Actualização Microsoft Office 2004 para Mac 11.5.8, faça duplo clique na aplicação da Actualização Microsoft Office 2004 para Mac 11.5.8 e siga as instruções no ecrã.  
-   Se a instalação foi concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: “Verificação da Instalação da Actualização”. Para remover o programa de instalação, primeiro arraste o volume da Actualização Microsoft Office 2004 para Mac 11.5.8 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da versão for **11.5.8**, a actualização foi instalada com sucesso.
...
Transfira e instale a versão do idioma adequado para a Actualização do Microsoft Office 2008 para Mac 12.2.4, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=e0ed1569-ab2f-407c-b728-4eddc463c385).
  
-   Feche todas as aplicações que esteja a executar, incluindo aplicações de protecção contra vírus, todas as aplicações Microsoft Office, Microsoft Messenger para Mac e Notificações do Office, porque podem interferir com a instalação.  
-   Abra o volume da Actualização Microsoft Office 2008 para Mac 12.2.4 na sua área de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume de Actualização Microsoft Office 2008 para Mac 12.2.4, faça duplo clique na aplicação da Actualização Microsoft Office 2008 para Mac 12.2.4 e siga as instruções no ecrã.  
-   Se a instalação foi concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: “Verificação da Instalação da Actualização”. Para remover o programa de instalação, primeiro arraste o volume da Actualização Microsoft Office 2008 para Mac 12.2.4 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da versão for **12.2.4**, a actualização foi instalada com sucesso.
...
Transfira e instale a versão do idioma adequado para a Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.4, a partir do [Centro de Transferências da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=4c5487d5-c912-4087-8c83-769e3fb78ea9).
  
-   Feche todas as aplicações que esteja a executar, incluindo aplicações de protecção contra vírus, todas as aplicações Microsoft Office, Microsoft Messenger para Mac e Notificações do Office, porque podem interferir com a instalação.  
-   Abra o volume da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.4 no seu ambiente de trabalho. Este passo pode ter sido executado pelo administrador de sistema.  
-   Para iniciar o processo de actualização, na janela do volume da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.4, faça duplo clique na aplicação da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.4 e siga as instruções no ecrã.  
-   Se a instalação foi concluída com sucesso, pode remover o programa de instalação da actualização do seu disco rígido. Para verificar se a instalação foi concluída com sucesso, consulte a seguinte secção: “Verificação da Instalação da Actualização”. Para remover o programa de instalação, primeiro arraste o volume da Actualização do Conversor de Formato de Ficheiros Open XML para Mac 1.1.4 para o caixote do lixo e, em seguida, faça o mesmo para o ficheiro que transferiu.
...
Se o número da versão for **1.1.4**, a actualização foi instalada com sucesso.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/979439">Artigo 979439 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
-   Nicolas Joly, da [equipa de investigação de vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Registo no Microsoft Office Excel (CVE-2010-0257)  
-   Sean Larsson, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Confusão de Tipo de Objecto em Folhas de Cálculo no Microsoft Office Excel (CVE-2010-0258)  
-   Sean Larsson, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXTUPLE no Microsoft Office Excel (CVE-2010-0260)  
-   Sean Larsson, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga na Área Dinâmica para Dados no Registo MDXSET no Microsoft Office Excel (CVE-2010-0261)  
-   Sean Larsson, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Memória Não Inicializada no Registo FNGROUPNAME no Microsoft Office Excel (CVE-2010-0262)  
-   Um investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Execução de Código na Análise de Ficheiros XLSX no Microsoft Office Excel (CVE-2010-0263)  
-   Damián Frizza, da [Core Security Technologies](http://www.coresecurity.com/), por fornecer informações sobre a Vulnerabilidade na Análise de Registo DbOrParamQry no Microsoft Office Excel (CVE-2010-0264)
...
-   V1.1 (10 de Março de 2010) : Correcção da tabela de gravidade para listar o Microsoft Office Excel 2003 como afectado por CVE-2010-0262. Correcção do nome de ficheiro do pacote para Excel 2007. Correcção também da lista de software afectado no Resumo Executivo. Estas são apenas alterações informativas. Os clientes que tenham aplicado esta actualização com sucesso não necessitam de efectuar mais acções.
