---
TOCTitle: 'MS10-066'
Title: 'Microsoft Security Bulletin MS10-066 - Importante'
ms:assetid: 'ms10-066'
ms:contentKeyID: 61234941
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-066(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS10-066 - Importante
=================================================

Vulnerabilidade na Chamada de Procedimento Remoto Poderia Permitir Execução Remota de Código (982802)
-----------------------------------------------------------------------------------------------------
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7ad0f2cf-03dc-49a0-a16e-17fed0c01cc6)                                     | Execução Remota de Código   | Importante                          | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3349b12b-621e-48bc-9c57-489c7a56920d)            | Execução Remota de Código   | Importante                          | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8b3004b-07db-4638-a9b7-224ff829081c)                            | Execução Remota de Código   | Importante                          | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=612b2096-bd82-47ca-8b99-454c2f158d39)                | Execução Remota de Código   | Importante                          | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1f04f151-330a-4b6c-826e-76def35daa73) | Execução Remota de Código   | Importante                          | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória em RPC - CVE-2010-2567</th>
...
Vulnerabilidade de Corrupção de Memória em RPC - CVE-2010-2567  
--------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código não autenticada na forma como a implementação do cliente RPC (Chamada de Procedimento Remoto) da Microsoft atribui memória ao analisar respostas RPC especialmente concebidas para o efeito. A tentativa de exploração da vulnerabilidade não necessitaria de autenticação, o que permitiria a um intruso explorar a vulnerabilidade enviando uma resposta RPC especialmente concebida para o efeito a um pedido RPC iniciado pelo cliente. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-2567](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2567).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória em RPC - CVE-2010-2567
...
-   O intruso deve convencer o utilizador a iniciar uma ligação RPC a um servidor malicioso sob controlo do intruso. Um intruso não poderia explorar remotamente esta vulnerabilidade sem interacção do utilizador.  
-   Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória em RPC - CVE-2010-2567
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória em RPC - CVE-2010-2567
...
A vulnerabilidade é causada quando a implementação do cliente de Chamada de Procedimento Remoto (RPC) da Microsoft atribui inadequadamente memória ao analisar respostas RPC especialmente concebidas para o efeito.
  
**O que é a Chamada de Procedimento Remoto (RPC)?**  
A Chamada de Procedimento Remoto (RPC) da Microsoft é uma norma de programação de rede originalmente desenvolvida no início da década de 1980. Uma funcionalidade RPC é uma funcionalidade que permite que um programador crie uma aplicação que consiste em qualquer número de procedimentos, alguns executados localmente e outros executados em computadores remotos através de uma rede.
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que explorasse esta vulnerabilidade com sucesso poderia executar código no contexto de segurança da aplicação de cliente RPC. Se a aplicação de cliente RPC estiver a ser executada numa conta LocalSystem ou numa conta com privilégios de administração, um intruso poderia assumir o controlo total de um sistema afectado.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Um intruso poderia alojar um servidor RPC especialmente concebido para o efeito, concebido para explorar esta vulnerabilidade e, depois, convencer um utilizador a iniciar uma chamada RPC com o mesmo. Além disso, um intruso na rede local poderia executar um ataque man-in-the-middle para responder a um pedido RPC legítimo com uma resposta RPC mal formada.
  
**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**    
Todos os sistemas que executam edições suportadas do Windows XP e Windows Server 2003 estão susceptíveis.
  
**O que faz a actualização?**    
A actualização resolve esta vulnerabilidade corrigindo a forma como o cliente RPC atribui memória antes de carregar respostas RPC transmitidas por um servidor remoto.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB982802$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/982802">Artigo 982802 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Yamata Li, da [Palo Alto Networks](http://www.paloaltonetworks.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória em RPC (CVE-2010-2567)
