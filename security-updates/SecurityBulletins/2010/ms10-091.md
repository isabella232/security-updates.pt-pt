---
TOCTitle: 'MS10-091'
Title: 'Microsoft Security Bulletin MS10-091 - Crítica'
ms:assetid: 'ms10-091'
ms:contentKeyID: 61234966
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-091(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-091 - Crítica
==============================================

Vulnerabilidades no Controlador OpenType Font (OTF) Podem Permitir Execução Remota de Código (2296199)
------------------------------------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cdef3358-ad3e-40a6-9ba5-3be220a56a65)                                                                                                    | Elevação de Privilégios     | Importante                          | [MS10-078](http://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=070fef8e-ba09-40f4-abaa-9cebf08983c3)                                                                           | Elevação de Privilégios     | Importante                          | [MS10-078](http://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9b70334c-490d-446c-988a-a88a75595fd4)                                                                                           | Elevação de Privilégios     | Importante                          | [MS10-078](http://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=08328e82-b012-4ea5-bf89-becb4881084f)                                                                               | Elevação de Privilégios     | Importante                          | [MS10-078](http://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=15588d6a-f576-4e3d-95e8-d422af8a94de)                                                                | Elevação de Privilégios     | Importante                          | [MS10-078](http://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2ddb8a06-c9cc-4d33-b6d1-22dbda2d871f)                                                                  | Execução Remota de Código   | Crítica                             | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9a245f3c-ffb6-4ccd-956c-e7d1231fca30)                                          | Execução Remota de Código   | Crítica                             | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=87149ec2-74a8-4dea-b7e3-873558e0103e)\*                 | Execução Remota de Código   | Crítica                             | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=523a47d3-771d-471a-889b-16311c276a00)\*       | Execução Remota de Código   | Crítica                             | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=959146ee-0e70-4e56-9012-72ed59aeb24b) | Execução Remota de Código   | Crítica                             | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=ff590db8-4264-42ba-9e07-88d100e1c4f5)                                                                                           | Execução Remota de Código   | Crítica                             | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=4ea4e339-9db2-4b99-b567-80ee55ecdf92)                                                                                      | Execução Remota de Código   | Crítica                             | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=e52f7869-474a-44c8-a102-e766c576fc01)\*                                                                       | Execução Remota de Código   | Crítica                             | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a21d061a-794a-4012-b3cd-c67445c074f5)                                                                     | Execução Remota de Código   | Crítica                             | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
...
<th style="border:1px solid black;" >Vulnerabilidade do índice do Tipo de Letra OpenType - CVE-2010-3956</th>
<th style="border:1px solid black;" >Vulnerabilidade &quot;livre e dupla&quot; do tipo de letra OpenType - CVE-2010-3957</th>
<th style="border:1px solid black;" >Vulnerabilidade da Tabela de CMAP de OpenType - CVE-2010-3959</th>
...
Vulnerabilidade do índice do Tipo de Letra OpenType - CVE-2010-3956  
-------------------------------------------------------------------
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3956](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3956).
  
#### Factores Atenuantes para a Vulnerabilidade do índice do Tipo de Letra OpenType - CVE-2010-3956
...
#### Soluções alternativas para a Vulnerabilidade do índice do Tipo de Letra OpenType - CVE-2010-3956
...
-   **Desactive o Painel de Pré-visualização e Painel de Detalhes no Windows Explorer**
    ...
    A desactivação dos painéis de Pré-visualização e de Detalhes no Windows Explorer impede os tipos de letra OTF de serem visto no Windows Explorer. Enquanto isto impede ficheiros nocivos de serem vistos no Windows Explorer, não impede um utilizador local e autenticado de executar um programa especialmente concebido para explorar esta vulnerabilidade. Para desactivar estes painéis no Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2, execute os passos que se seguem:
    ...
    3.  Feche todas as instâncias abertas do Windows Explorer para a alteração ter efeito.
  
    **Impacto da solução alternativa.**  O Windows Explorer não apresentará tipos de letra OTF.
  
    **Como anular esta solução alternativa.**
  
    Para reactivar os painéis de Pré-visualização e de Detalhes no Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2:
  
    1.  Abra o Windows Explorer, clique em **Organizar** e depois em **Esquema**.  
    2.  Seleccione as opções de menu **Painel de detalhes** e **Painel de pré-visualização**.  
    3.  Feche todas as instâncias abertas do Windows Explorer para a alteração ter efeito.
  
#### Perguntas mais frequentes sobre a Vulnerabilidade do índice do Tipo de Letra OpenType - CVE-2010-3956
...
A vulnerabilidade é provocada quando o controlador OpenType Font (OTF) não organiza adequadamente um conjunto durante a interpretação dos tipos de letra OpenType.
...
A actualização resolve a vulnerabilidade, corrigindo o modo como o controlador OpenType Font (OTF) organiza um conjunto durante a interpretação dos tipos de letra OpenType.
...
Vulnerabilidade "livre e dupla" do tipo de letra OpenType - CVE-2010-3957  
-------------------------------------------------------------------------
  
<span></span>
Há uma vulnerabilidade de execução remota de códigos na forma como o controlador OpenType Font (OTF) analisa incorrectamente os tipos de letra OpenType especialmente concebidos. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3957](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3957).
  
#### Factores atenuantes para a Vulnerabilidade "livre e dupla" do tipo de letra OpenType - CVE-2010-3957
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   No cenário de um ataque baseado na Web, um intruso poderia alojar um Web site contendo uma página Web que fosse utilizada para explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Em vez disso, um intruso teria de convencer os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico, ou num programa de mensagens instantâneas, que levasse o utilizador para o Web site do intruso.
  
#### Soluções alternativas para a Vulnerabilidade "livre e dupla" do tipo de letra OpenType - CVE-2010-3957
...
-   **Desactive o Painel de Pré-visualização e Painel de Detalhes no Windows Explorer**
    ...
    **Como anular esta solução alternativa.**
    ...
    Para reactivar os painéis de Pré-visualização e de Detalhes do Windows Explorer no Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2:
  
    1.  Abra o Windows Explorer, clique em **Organizar** e depois em **Esquema**.  
    2.  Seleccione as opções de menu **Painel de detalhes** e **Painel de pré-visualização**.  
    3.  Feche todas as instâncias abertas do Windows Explorer para a alteração ter efeito.
  
#### Perguntas mais frequentes sobre a Vulnerabilidade "livre e dupla" do tipo de letra OpenType - CVE-2010-3957
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado remotamente. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é provocada quando o controlador OpenType Font (OTF) não reinicia adequadamente uma indicação ao libertar memória. Isto resulta numa condição "livre e dupla".
...
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade, corrigindo o modo como o controlador OpenType Font (OTF) reinicia as indicações ao libertar memória.
...
Vulnerabilidade da Tabela de CMAP de OpenType - CVE-2010-3959  
-------------------------------------------------------------
  
<span></span>
Há uma vulnerabilidade de execução remota de códigos na forma como o controlador OpenType Font (OTF) analisa incorrectamente os tipos de letra OpenType especialmente concebidos. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3959](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3959).
  
#### Factores atenuantes para a Vulnerabilidade da Tabela de CMAP de OpenType - CVE-2010-3959
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   No cenário de um ataque baseado na Web, um intruso poderia alojar um Web site contendo uma página Web que fosse utilizada para explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Em vez disso, um intruso teria de convencer os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico, ou num programa de mensagens instantâneas, que levasse o utilizador para o Web site do intruso.
  
#### Soluções alternativas para a Vulnerabilidade da Tabela de CMAP de OpenType - CVE-2010-3959
...
#### Perguntas mais frequentes sobre a Vulnerabilidade da Tabela de CMAP de OpenType - CVE-2010-3959
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado remotamente. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é provocada quando o controlador OpenType Font (OTF) não interpreta adequadamente a tabela de CMAP ao processar um tipo de letra OpenType especialmente concebido.
...
**Os browsers da Web de outros fabricantes são afectados por esta vulnerabilidade?**    
Sim. Os browsers da Web de outros fabricantes são afectados por esta vulnerabilidade caso processem tipos de letra OpenType de origem. Para estas aplicações, esta vulnerabilidade poderia permitir uma negação de serviço remota se um utilizador utilizasse um Web site com um tipo de letra OpenType incorporado especialmente concebido. Por predefinição, o Internet Explorer não é afectado por esta questão.
  
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade, corrigindo o modo como o controlador OpenType Font (OTF) interpreta a tabela de CMAP durante o processamento dos tipos de letra OpenType.
  
**O que é uma tabela de CMAP?**    
Esta tabela define o mapeamento de códigos de caracteres para os valores de índice de glifos utilizados no tipo de letra. Pode conter mais de uma subtabela para apoiar mais do que um esquema de codificação de caracteres. O cabeçalho da tabela indica as codificações de caracteres, pelas quais estão presentes as subtabelas. Cada subtabela é um de sete possíveis formatos e começa com um código de formato indicando o formato utilizado. Para obter mais informações, consulte o artigo intitulado, [Tabela de mapeamento de índice de caracteres para glifos](http://www.microsoft.com/typography/otspec/cmap.htm).
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2296199$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2296199">Artigo 2296199 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Marc Schoenefeld, da [Equipa de Resposta de Segurança Red Hat](https://www.redhat.com/security/team/), a trabalhar com a [Equipa de Segurança Opera](http://www.opera.com/security/), por fornecer informações sobre a Vulnerabilidade do índice do Tipo de Letra OpenType (CVE-2010-3956)  
-   Marc Schoenefeld da [Equipa de Resposta de Segurança Red Hat](https://www.redhat.com/security/team/) por fornecer informações sobre a Vulnerabilidade "livre e dupla" do tipo de letra OpenType (CVE-2010-3957)  
-   Paul-Kenji Cahier Furuya por fornecer informações sobre a Vulnerabilidade da Tabela de CMAP de OpenType (CVE-2010-3959)
