...
ms:assetid: 'ms10-058'
ms:contentKeyID: 61234933
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-058(v=Security.10)'
author: SharonSears
...
Vulnerabilidades no TCP/IP Poderiam Permitir Elevação de Privilégios (978886)
-----------------------------------------------------------------------------

Data de publicação: 10 de agosto de 2010 | Updated: 13 de março de 2012
...
A actualização de segurança resolve as vulnerabilidades corrigindo a forma como a pilha de TCP/IP processa pacotes IPv6 mal formados e dados copiados a partir do modo de utilizador. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as Vulnerabilidades**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4684c4df-0a5c-4dba-82e5-059378737118)                                                                  | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=18152cd4-815f-425f-8694-fbabcbe80609)                                          | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=844404be-f2e8-47bc-9650-9e2bbe383814)\*                 | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=08491c73-66b1-4c4c-8740-ea596a730fc1)\*       | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8aa12902-c234-4fd9-bba3-6767eafc38fc) | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=3a5a088e-644a-4a0e-9a09-0370bcd97688)                                                                                           | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=163fe2bd-f999-47c1-9a35-c4fc868bda51)                                                                                      | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=a1f95600-34e5-44b3-b2cb-b2b2cbf645cb)\*                                                                       | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c3cd7f2f-e198-4fbd-a65d-21a1bf51eb61)                                                                     | Elevação de Privilégios     | Importante                          | Nenhum                                      |
...
A Microsoft reviu este boletim de segurança para anunciar uma alteração de detecção que remove o MS10-029 como o boletim substituído para todas as edições suportadas do Windows Vista e Windows Server 2008; a actualização não substitui nenhum boletim para estes sistemas operativos. Esta é apenas uma alteração de detecção. Não foram efectuadas alterações aos ficheiros de actualização de segurança. Os clientes que já tenham instalado esta actualização com sucesso não têm de voltar a instalá-la, mas devem certificar-se de que a actualização KB978338 é instalada nos sistemas Windows Vista e Windows Server 2008 para ficarem protegidos contra a vulnerabilidade descrita em MS10-029.
...
**Por que razão esta actualização resolve duas vulnerabilidades de segurança divulgadas?**
Esta actualização contém suporte para duas vulnerabilidades, porque as modificações necessárias para resolver estas questões estão incluídas nos ficheiros relacionados. Assim, em vez de instalarem duas actualizações independentes quase iguais, os clientes podem instalar apenas esta actualização.
...
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória no IPv6 - CVE-2010-1892</th>
<th style="border:1px solid black;" >Vulnerabilidade de Excesso de Número Inteiro no Funcionamento em Rede do Windows – CVE-2010-1893</th>
...
Vulnerabilidade de Corrupção de Memória no IPv6 - CVE-2010-1892  
---------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço no processamento de TCP/IP no Microsoft Windows devido a um erro no processamento de pacotes IPv6 especialmente concebidos para o efeito com um cabeçalho de extensão mal formado. Um intruso poderia explorar a vulnerabilidade enviando ao sistema visado um pequeno número de pacotes especialmente concebidos para o efeito, fazendo com que o sistema afectado deixasse de responder.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1892](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1892).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no IPv6 - CVE-2010-1892
  
A Microsoft não identificou quaisquer factores atenuantes para esta vulnerabilidade.
  
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no IPv6 - CVE-2010-1892
...
-   **Desactive os componentes do Internet Protocol versão 6 (IPv6)**
  
    **Nota** Consulte o [Artigo 929852 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/929852) para utilizar a solução automática de **correcção da Microsoft** 50444 para desactivar os componentes do IPv6, com excepção da interface de loopback. Para ser eficaz, esta solução de correcção requer um reinício após a conclusão. Esta solução de correcção implementa a solução alternativa, tendo assim o mesmo impacto para o utilizador. Recomendamos que os administradores consultem detalhadamente o artigo da Base de Dados de Conhecimento antes de implementar esta solução de correcção.
    ...
    **Nota** A utilização incorrecta do Editor de Registo pode provocar problemas graves que poderão conduzir à reinstalação do sistema operativo. A Microsoft não pode garantir que os problemas resultantes da utilização incorrecta do Editor de Registo possam ser resolvidos. A utilização do Editor de Registo é da sua responsabilidade. Para obter informações sobre como editar o registo, deve consultar o tópico de Ajuda "Alterar Chaves e Valores" do Editor de Registo (Regedit.exe) ou os tópicos de Ajuda "Adicionar e Eliminar Informações do Registo" e "Editar Dados do Registo" do Regedt32.exe.
    ...
    1.  Clique em **Iniciar**, escreva **regedit** na caixa **Iniciar procura** e clique em **regedit.exe** na lista **Programas**.  
    2.  Na caixa de diálogo **Controlo de Conta de Utilizador**, clique em **Continuar**.  
    3.  No Editor de Registo, localize e clique na seguinte subchave de registo:  
        `HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip6\Parameters\`  
    4.  Clique duas vezes em **DisabledComponents** para modificar a entrada DisabledComponents.  
        **Nota** Se a entrada DisabledComponents não estiver disponível, tem de criá-la. Para isso, siga estes passos:  
        a. No menu **Editar**, escolha **Novo** e clique em **Valor DWORD (32 bits)**.  
        b. Escreva **DisabledComponents** e prima **ENTER**.  
        c. Clique duas vezes em **DisabledComponents.**  
    5.  Introduza **0xffffffff** para desactivar todos os componentes do IPv6, excepto a interface de loopback do IPv6. Este valor também configura o Windows para utilizar o Internet Protocol versão 4 (IPv4) em vez do IPv6 em políticas de prefixos.  
    6.  Clique em **OK.** Tem de reiniciar o seu computador para que estas alterações tenham efeito.
  
    **Impacto da solução alternativa.**O serviço de Encaminhamento e Acesso Remoto falhará depois de esta alteração entrar em efeito.
  
    **Como anular esta solução alternativa.**
  
    **Nota** Consulte o [Artigo 929852 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/929852) para utilizar a solução automática de **correcção da Microsoft** 50440 para activar o IPv6. Para ser eficaz, esta solução de correcção requer um reinício após a conclusão.
  
    1.  Clique em **Iniciar**, escreva **regedit** na caixa **Iniciar procura** e clique em **regedit.exe** na lista **Programas**.  
    2.  Na caixa de diálogo **Controlo de Conta de Utilizador**, clique em **Continuar**.  
    3.  No Editor de Registo, localize e clique na seguinte subchave de registo:  
        `HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip6\Parameters\`  
    4.  Elimine a entrada **DisabledComponents**.  
    5.  Tem de reiniciar o seu computador para que estas alterações tenham efeito.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no IPv6 - CVE-2010-1892
...
A vulnerabilidade é causada quando a pilha de Funcionamento em Rede do Windows não processa adequadamente pacotes mal formados específicos.
...
Um intruso poderia explorar a vulnerabilidade enviando a um sistema um pequeno número de pacotes IPv6 mal formados especialmente concebidos para o efeito.
...
A actualização resolve esta vulnerabilidade corrigindo a forma como a pilha de TCP/IP do Windows processa pacotes de IPv6 mal formados.
...
Vulnerabilidade de Excesso de Número Inteiro no Funcionamento em Rede do Windows – CVE-2010-1893  
------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no processamento de TCP/IP no Microsoft Windows devido a um erro no processamento de uma memória intermédia de entrada específica. Um intruso que explorasse esta vulnerabilidade com sucesso poderia executar código arbitrário com privilégios ao nível do sistema. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1893).
  
#### Factores Atenuantes para a Vulnerabilidade de Excesso de Número Inteiro no Funcionamento em Rede do Windows – CVE-2010-1893
...
#### Soluções Alternativas para a Vulnerabilidade de Excesso de Número Inteiro no Funcionamento em Rede do Windows – CVE-2010-1893
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Excesso de Número Inteiro no Funcionamento em Rede do Windows – CVE-2010-1893
...
**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando a pilha de TCP/IP do Windows não processa adequadamente dados copiados do modo de utilizador, resultando num excesso de número inteiro.
...
**Como poderia um intruso explorar a vulnerabilidade?**  
Para explorar esta vulnerabilidade, um intruso teria de iniciar primeiro sessão no sistema. Um intruso poderia executar uma aplicação especialmente concebida para explorar a vulnerabilidade e obter controlo total sobre o sistema afectado. Esta é uma vulnerabilidade apenas local, não podendo ser explorada remotamente.
  
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
Os sistemas, como servidores de terminais, em que os utilizadores são autorizados a executar código não fidedigno são especialmente afectados por esta vulnerabilidade.
  
**O que faz a actualização?**  
A actualização resolve esta vulnerabilidade corrigindo a forma como a pilha de TCP/IP do Windows processa dados copiados do modo de utilizador.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/978886">Artigo 978886 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
-   Darren Willis, da [Fourteenforty Research Institute, Inc.](http://www.fourteenforty.jp/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no IPv6 (CVE-2010-1892)  
-   Matthieu Suiche, da [MoonSols](http://moonsols.com/), por fornecer informações sobre a Vulnerabilidade de Excesso de Número Inteiro no Funcionamento em Rede do Windows (CVE-2010-1893)
...
-   V1.1 (18 de Agosto de 2010): Solução alternativa adicional para a Vulnerabilidade de Corrupção de Memória no IPv6 - CVE-2010-1892.  
-   V2.0 (13 de Março de 2012): Boletim revisto para anunciar uma alteração de detecção que remove o MS10-029 como o boletim substituído para todas as edições suportadas do Windows Vista e Windows Server 2008. Para mais informações, consulte a entrada relacionada nas perguntas frequentes sobre a actualização.
