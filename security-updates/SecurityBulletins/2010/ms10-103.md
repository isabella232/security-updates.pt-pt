...
ms:assetid: 'ms10-103'
ms:contentKeyID: 61234978
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-103(v=Security.10)'
---
...
Vulnerabilidades no Microsoft Publisher poderiam permitir Execução Remota de Código (2292970)
---------------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para as edições suportadas do Microsoft Publisher 2002, Microsoft Publisher 2003, Microsoft Publisher 2007 e Microsoft Publisher 2010. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização resolve as vulnerabilidades, corrigindo a forma como o Microsoft Publisher interpreta ficheiros do Publisher especialmente concebidos. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.

**Recomendação.** A Microsoft recomenda que os clientes instalem esta actualização na primeira oportunidade.

**Questões Conhecidas.** O [Artigo 2292970 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2292970) documenta os problemas actualmente conhecidos que os clientes poderão verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2010 (edições de 64 bits)</td>
...
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória Heap de Valor de Tamanho em pubconv.dll - CVE-2010-2569</th>
<th style="border:1px solid black;" >Vulnerabilidade de Sobrecarga de Memória Heap em pubconv.dll - CVE-2010-2570</th>
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória Devido a Índice Inválido na matriz em Pubconv.dll - CVE-2010-2571</th>
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória no Microsoft Publisher - CVE-2010-3954</th>
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória de Indexação de Matriz - CVE-2010-3955</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Corrupção de Memória Heap de Valor de Tamanho em pubconv.dll - CVE-2010-2569  
-----------------------------------------------------------------------------------------------
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-2569](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2569).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Heap de Valor de Tamanho em pubconv.dll - CVE-2010-2569
...
-   No cenário de um ataque baseado na Web, um intruso poderia alojar um Web site contendo uma página Web que fosse utilizada para explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Um intruso teria de convencer os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico, ou numa mensagem de um programa de mensagens instantâneas, que levasse os utilizadores para o Web site do intruso e, em seguida, convencendo-os a abrir o ficheiro Publisher especialmente concebido para o efeito.
  
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória Heap de Valor de Tamanho em pubconv.dll - CVE-2010-2569
...
-   **Desactivar o DLL de Conversão do Publisher**
    ...
    **Nota** Para &lt;office version&gt;, introduza a versão do componente do Microsoft Office apropriado existente no seu sistema como, por exemplo, "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003 e "Office12" para Microsoft Publisher 2007. Para verificar a versão, abra este componente do Microsoft Office e clique em **Ajuda**.
    ...
    **Impacto da solução alternativa.** Os utilizadores que tenham desactivado o ficheiro DLL do Conversor do Publisher não poderão abrir ficheiros do Publisher criados em versões anteriores à do Microsoft Publisher 2007.
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Corrupção de Memória Heap de Valor de Tamanho em pubconv.dll - CVE-2010-2569
...
A vulnerabilidade existe na forma como o Microsoft Publisher interpreta ficheiros do Publisher especialmente concebidos.
  
**O que é o pubconv.dll?**    
O ficheiro DLL do Conversor do Publisher é utilizado pelo Microsoft Publisher para abrir ficheiros do Publisher criados em versões anteriores à do Microsoft Publisher 2007.
...
Num cenário de ataque com base na Web, um intruso teria de alojar um Web site contendo um ficheiro Publisher que fosse utilizado para tentar explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Um intruso não conseguiria obrigar os utilizadores a visitarem um Web site especialmente concebido para o efeito. Normalmente, um intruso teria de convencer os utilizadores a visitar o Web site, levando-os a clicar numa hiperligação presente numa mensagem de correio electrónico, ou numa mensagem de um programa de mensagens instantâneas, que levasse os utilizadores para o site do intruso e, em seguida, convencê-los a abrir o ficheiro do Publisher especialmente concebido para o efeito.
...
Vulnerabilidade de Sobrecarga de Memória Heap em pubconv.dll - CVE-2010-2570  
----------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Publisher interpreta ficheiros do Publisher. Um intruso poderia explorar a vulnerabilidade criando um ficheiro Publisher especialmente concebido para o efeito, que poderia estar incluído como anexo numa mensagem de correio electrónico ou alojado num Web site corrompido ou especialmente concebido para o efeito, levando depois o utilizador a abrir o ficheiro Publisher especialmente concebido para o efeito. Se um utilizador tivesse sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com direitos de utilização reduzidos no sistema podem ser menos afectados do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-2570](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2570).
  
#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga de Memória Heap em pubconv.dll - CVE-2010-2570
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga de Memória Heap em pubconv.dll - CVE-2010-2570
...
-   **Desactivar o DLL de Conversão do Publisher**
    ...
    **Nota** Utilize a versão do software Microsoft Office apropriada para o seu sistema como, por exemplo, "Office10" para Microsoft Publisher 2002, "Office11" para Microsoft Publisher 2003, "Office12" para Microsoft Publisher 2007 e "Office14" para Microsoft Publisher 2010.
    ...
    **Para edições de 32 bits do WindowsVista, Windows Server 2008 e Windows 7:**
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Sobrecarga de Memória Heap em pubconv.dll - CVE-2010-2570
...
**Como poderia um intruso explorar a vulnerabilidade?**    
Esta vulnerabilidade requer que um utilizador abra um ficheiro Publisher especialmente concebido para o efeito usando o Microsoft Publisher.
...
Vulnerabilidade de Corrupção de Memória Devido a Índice Inválido na matriz em Pubconv.dll - CVE-2010-2571  
---------------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Publisher abre ficheiros do Publisher. Um intruso poderia explorar a vulnerabilidade criando um ficheiro Publisher especialmente concebido para o efeito, que poderia estar incluído como anexo numa mensagem de correio electrónico ou alojado num Web site corrompido ou especialmente concebido para o efeito, levando depois o utilizador a abrir o ficheiro Publisher especialmente concebido para o efeito. Se um utilizador tivesse sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com direitos de utilização reduzidos no sistema podem ser menos afectados do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-2571](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2571).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Devido a Índice Inválido na matriz em Pubconv.dll - CVE-2010-2571
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória Devido a Índice Inválido na matriz em Pubconv.dll - CVE-2010-2571
...
-   **Desactivar o DLL de Conversão do Publisher**
    ...
    **Nota** Utilize a versão do software Microsoft Office apropriada para o seu sistema como, por exemplo, "Office10" para Microsoft Publisher 2002 e "Office11" para Microsoft Publisher 2003.
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Corrupção de Memória Devido a Índice Inválido na matriz em Pubconv.dll - CVE-2010-2571
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade existe na forma como o Microsoft Publisher interpreta ficheiros do formato Publisher 97.
...
**O que faz a actualização?**    
Esta actualização resolve a vulnerabilidade corrigindo a forma como o Microsoft Publisher converte ficheiros do formato Publisher 97.
...
Vulnerabilidade de Corrupção de Memória no Microsoft Publisher - CVE-2010-3954  
------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Publisher abre ficheiros do Publisher. Um intruso poderia explorar a vulnerabilidade criando um ficheiro Publisher especialmente concebido para o efeito, que poderia estar incluído como anexo numa mensagem de correio electrónico ou alojado num Web site corrompido ou especialmente concebido para o efeito, levando depois o utilizador a abrir o ficheiro Publisher especialmente concebido para o efeito. Se um utilizador tivesse sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com direitos de utilização reduzidos no sistema podem ser menos afectados do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3954](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3954).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Microsoft Publisher - CVE-2010-3954
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Microsoft Publisher - CVE-2010-3954
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Corrupção de Memória no Microsoft Publisher - CVE-2010-3954
...
Vulnerabilidade de Corrupção de Memória de Indexação de Matriz - CVE-2010-3955  
------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Publisher abre ficheiros do Publisher. Um intruso poderia explorar a vulnerabilidade criando um ficheiro Publisher especialmente concebido para o efeito, que poderia estar incluído como anexo numa mensagem de correio electrónico ou alojado num Web site corrompido ou especialmente concebido para o efeito, levando depois o utilizador a abrir o ficheiro Publisher especialmente concebido para o efeito. Se um utilizador tivesse sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com direitos de utilização reduzidos no sistema podem ser menos afectados do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3955](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3955).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Indexação de Matriz - CVE-2010-3955
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Indexação de Matriz - CVE-2010-3955
...
-   **Desactivar o DLL de Conversão do Publisher**
    ...
    **Como anular esta solução alternativa::**
    ...
    Em edições de 32 bits do Windows Vista, Windows Server 2008 e Windows 7, execute o seguinte comando a partir de uma linha de comandos elevada:
...
#### Perguntas mais frequentes sobre a Vulnerabilidade de Corrupção de Memória de Indexação de Matriz - CVE-2010-3955
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2284692">Artigo 2284692 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2284695">Artigo 2284695 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2284697">Artigo 2284697 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para o Microsoft Publisher 2010 (edições de 32 bits):<br />
Publisher2010-kb2409055-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Microsoft Publisher 2010 (edições de 64 bits):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2409055">Artigo 2409055 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
-   Chaouki Bekrar da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Heap de Valor de Tamanho em pubconv.dll (CVE-2010-2569)  
-   Chaouki Bekrar da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga de Memória Heap em pubconv.dll (CVE-2010-2570)  
-   Chaouki Bekrar da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Devido a Índice Inválido na matriz em Pubconv.dll (CVE-2010-2571)  
-   Chaouki Bekrar, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Microsoft Publisher (CVE-2010-3954)  
-   Chaouki Bekrar, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Indexação de Matriz (CVE-2010-3955)
