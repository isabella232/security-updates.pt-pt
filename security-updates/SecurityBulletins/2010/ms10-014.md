...
ms:assetid: 'ms10-014'
ms:contentKeyID: 61234889
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-014(v=Security.10)'
---
...
Vulnerabilidade no Kerberos Poderia Permitir Negação de Serviço (977290)
------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=56a9afba-a6ee-4fb9-ba85-e51d9f94de27)                                                                           | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=738e2fda-96fc-413d-a5c7-74b1fac1d6b3)                                                                                     | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8ad539d-8191-4864-977b-ad4e31c04ba0)                                                                         | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d549c927-add7-4d83-bfc7-15dc35663dfb)                                                          | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=75327470-0f14-4cdd-bcb7-64684c61c267)\*           | Negação de Serviço          | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d0f8f81-fc10-450a-a653-06f89acba9fa)\* | Negação de Serviço          | Importante                          | Nenhum                                      |
...
A actualização só será oferecida para sistemas onde o componente afectado esteja instalado e activado. Os sistemas que não desempenham o papel de controlador de domínio contêm o componente vulnerável, mas não são afectados e não receberão esta actualização através das Actualizações Automáticas.
...
<th style="border:1px solid black;" >Vulnerabilidade de Não Referência no Apontador NULL no Kerberos - CVE-2010-0035</th>
...
Vulnerabilidade de Não Referência no Apontador NULL no Kerberos - CVE-2010-0035  
-------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço em implementações do Kerberos. A vulnerabilidade deve-se ao processamento incorrecto de pedidos para renovar permissões de concessão de autorização feitos por um cliente num realm remoto que não do Windows, numa implementação Kerberos de modo misto. Um intruso que explorasse esta vulnerabilidade com sucesso poderia fazer com que o controlador de domínio do Windows afectado deixasse de responder.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0035](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0035).
  
#### Factores Atenuantes para a Vulnerabilidade de Não Referência no Apontador NULL no Kerberos - CVE-2010-0035
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Para explorar esta vulnerabilidade, um intruso tem de ter credenciais de início de sessão válidas para um realm considerado fidedigno pelo Controlador de Domínio do Windows. A vulnerabilidade não pode ser explorada por utilizadores anónimos.  
-   Esta vulnerabilidade afecta apenas controladores de domínio. Os servidores que não efectuem o papel de controladores de domínio não são afectados.
  
#### Soluções Alternativas para a Vulnerabilidade de Não Referência no Apontador NULL no Kerberos - CVE-2010-0035
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Não Referência no Apontador NULL no Kerberos - CVE-2010-0035
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de "negação de serviço". Um intruso remoto autenticado poderia enviar um pedido especialmente concebido para o efeito para renovar permissões de concessão de autorização (TGT) existentes, o que poderia fazer com que o sistema afectado deixasse de responder e provocasse uma negação de serviço. A negação de serviço poderia persistir até que o controlador de domínio fosse reiniciado.
  
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é provocada pelo processamento incorrecto de pedidos de renovação de permissão provenientes de um domínio Kerberos que não do Windows.
...
**O que é uma permissão de concessão de autorização ou TGT?**    
No Kerberos, o KDC atribui uma chave temporária ao cliente. Esta chave temporária é válida apenas para um início de sessão específico. Quando um utilizador inicia sessão, o cliente pede uma permissão ao KDC, tal como solicitaria uma permissão para qualquer outro serviço. O KDC responde criando uma chave de início de sessão e uma permissão para um servidor especial, o serviço completo de concessão de autorização do KDC. A permissão inclui uma cópia da chave de início de sessão e dispõe ainda de encriptação com a chave mestra do KDC. Outra cópia da chave de início de sessão é encriptada com a chave mestra do utilizador derivada da sua palavra-passe de início de sessão. Tanto a permissão como a chave de sessão encriptada são enviadas ao cliente.
  
Quando o cliente recebe a resposta do KDC, desencripta a chave de início de sessão com a chave mestra do utilizador derivada da sua palavra-passe. O cliente já não necessita da chave derivada da palavra-passe do utilizador, porque o cliente utilizará agora a chave de início de sessão para desencriptar a sua cópia de qualquer chave de início de sessão que seja obtida do KDC. O cliente guarda a chave de início de sessão na respectiva cache de permissão, juntamente com a permissão para o serviço completo de concessão de autorização do KDC. A permissão para o serviço completo de atribuição de autorização chama-se permissão de concessão de autorização (TGT).
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que explorasse esta vulnerabilidade poderia fazer com que o sistema afectado deixasse de responder. O administrador teria de reiniciar o sistema manualmente para restaurar a funcionalidade. Mesmo que um controlador de domínio não estivesse disponível, isso não impediria que os utilizadores que já tivessem bilhetes Kerberos os utilizassem. Poderiam continuar a aceder a todos os recursos para os quais já tivessem recebido autorização. No entanto, a negação de serviço impediria que o controlador de domínio emitisse novas permissões para conceder acesso a outros recursos.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Um intruso autenticado num realm Kerberos que não do Windows e considerado fidedigno pelo domínio Kerberos do Windows poderia explorar esta vulnerabilidade enviando um pedido de renovação de permissão especialmente concebido para o efeito ao respectivo KDC do Kerberos.
  
**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**    
Os controladores de domínio que têm um realm de Kerberos de modo misto definido são afectados por esta vulnerabilidade. Os realms do Kerberos de modo misto são implementações em que o realm do Kerberos do Windows confia numa implementação de Kerberos de terceiros que não da Microsoft.
  
**O que faz a actualização?**    
Esta actualização resolve a vulnerabilidade corrigindo a forma como o servidor Kerberos lida com pedidos de renovação de permissão.
...
| **Implementação**                        |                                                                                                                                                                                   |  
| Instalação sem intervenção do utilizador | Windows2000-KB977290-x86-ENU /quiet                                                                                                                                               |  
| Instalação sem reiniciar                 | Windows2000-KB977290-x86-ENU /norestart                                                                                                                                           |  
| Ficheiro log da actualização             | kb977290.log                                                                                                                                                                      |  
...
| **Informações de Remoção**               | Utilize a ferramenta **Adicionar ou Remover Programas** no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\\$NTUninstallKB977290$\\Spuninst |  
| **Informações de Ficheiros**             | Consulte o [Artigo 977290 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/977290)                                                                  |  
| **Verificação da Chave de Registo**      | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB977290\\Filelist                                                                                         |
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB977290$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/977290">Artigo 977290 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
