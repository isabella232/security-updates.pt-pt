...
ms:assetid: 'ms10-056'
ms:contentKeyID: 61234931
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-056(v=Security.10)'
---
...
Vulnerabilidades no Microsoft Office Word Poderiam Permitir Execução Remota de Código (2269638)
-----------------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Crítica para todas as edições suportadas do Microsoft Office Word 2007. Esta actualização de segurança também está classificada como Importante para todas as edições suportadas do Microsoft Office Word 2002, Microsoft Office Word 2003, Microsoft Office 2004 para Mac e Microsoft Office 2008 para Mac, Conversor de Formato de Ficheiros Open XML para Mac, Works 9 e todas as versões suportadas do Microsoft Office Word Viewer e do Pack de Compatibilidade para o Microsoft Office. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização resolve as vulnerabilidades modificando a forma como o Microsoft Office Word abre ficheiros Word especialmente concebidos para o efeito e modificando a forma como o Word processa determinadas propriedades de dados de formato RTF. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.

**Recomendação.** A Microsoft recomenda que os clientes apliquem de imediato a actualização.

**Questões Conhecidas.** O [Artigo 2269638 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2269638) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
Um programa autónomo do Office é afectado com a mesma classificação de gravidade que o componente correspondente de uma Suite do Office. Por exemplo, uma instalação autónoma do Microsoft Office Word é afectada com a mesma classificação de gravidade que uma instalação do Microsoft Office Word que tenha sido fornecida com uma Suite do Office.
...
<th style="border:1px solid black;" >
Vulnerabilidade na Análise de Registo no Word - CVE-2010-1900
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no Motor de Análise de RTF no Word - CVE-2010-1901
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise de RTF no Word - CVE-2010-1902
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Objectos com Ligações a HTML no Word - CVE-2010-1903
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Office Word processa registos mal formados dentro de um ficheiro Word especialmente concebido para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1900](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1900).

#### Factores Atenuantes para Vulnerabilidade de Análise de Registo no Word - CVE-2010-1900
...
#### Soluções Alternativas para Vulnerabilidade de Análise de Registo no Word - CVE-2010-1900
...
-   **Não abra ficheiros Word que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual**

    Não abra ficheiros Word que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Análise de Registo no Word - CVE-2010-1900
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Office Word analisa dados em formato RTF. Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1901](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1901).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Motor de Análise de RTF no Word - CVE-2010-1901

A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação

-   Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Motor de Análise de RTF no Word - CVE-2010-1901
...
-   **Ler mensagens de correio electrónico em formato de texto simples**
    ...
    Os utilizadores do Microsoft Office Outlook 2002 que aplicaram o Office XP Service Pack 1 ou uma versão posterior e os utilizadores do Microsoft Office Outlook Express 6 que aplicaram o Internet Explorer 6 Service Pack 1 ou uma versão posterior podem activar esta definição e ver em texto simples apenas as mensagens de correio electrónico não assinadas digitalmente ou mensagens de correio electrónico não encriptadas.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Motor de Análise de RTF no Word - CVE-2010-1901

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado remotamente. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
O Microsoft Office Word não executa uma validação de dados suficiente ao processar dados em formato RTF. Quando o Word abre e analisa um ficheiro ou mensagem de correio electrónico em formato RTF especialmente concebida para o efeito, pode danificar a memória de tal forma que é possível a um intruso executar código arbitrário.
...
**Como poderia um intruso explorar a vulnerabilidade?**  
Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade enviando um ficheiro em formato RTF especialmente concebido para o efeito como anexo ou no conteúdo de uma de correio electrónico e convencendo o utilizador a visualizar a mensagem de correio electrónico em formato RTF especialmente concebida para o efeito num Outlook que utilize o Word como visualizador de correio electrónico.
...
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
As estações de trabalho e servidores de terminais que tenham o Microsoft Office Word instalado estão mais susceptíveis. Os servidores podem estar mais sujeitos a risco se os administradores permitirem que os utilizadores iniciem sessão nos servidores e executem programas. Contudo, os procedimentos recomendados desencorajam essa acção.

**O que faz a actualização?**  
A actualização resolve a vulnerabilidade modificando a forma como o Word processa determinadas propriedades de dados em formato RTF.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Office Word analisa determinados dados em formato RTF. Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1902](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1902).

#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise de RTF no Word - CVE-2010-1902

A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise de RTF no Word - CVE-2010-1902
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise de RTF no Word - CVE-2010-1902

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado remotamente. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**  
O Microsoft Office Word não executa uma validação de dados suficiente ao processar dados em formato RTF. Quando o Word abre e analisa um ficheiro ou mensagem de correio electrónico especialmente concebida para o efeito, pode danificar a memória de tal forma que é possível a um intruso executar código arbitrário.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1903](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1903).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objectos com Ligações a HTML no Word - CVE-2010-1903
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objectos com Ligações a HTML no Word - CVE-2010-1903
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objectos com Ligações a HTML no Word - CVE-2010-1903
...
| Microsoft Office System 2007 Service Pack 2                                                                         | Sim        |
...
| Microsoft Office System 2007 Service Pack 2                                                                         | Não     | Não               | Sim               | Sim                        |
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2251389">Artigo 2251389 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para o Word 2003, consulte o <a href="http://support.microsoft.com/kb/2251399">Artigo 2251399 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Word Viewer, consulte o <a href="http://support.microsoft.com/kb/2251437">Artigo 2251437 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para o Word 2007, consulte o <a href="http://support.microsoft.com/kb/2251419">Artigo 2251419 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Pack de Compatibilidade do Microsoft Office para formatos de ficheiros Word, Excel e PowerPoint 2007, consulte o <a href="http://support.microsoft.com/kb/2277947">Artigo 2277947 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para o Works 9:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2092914">Artigo 2092914 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
-   L.W.Z, da [team509](http://www.team509.com/), a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Análise de Registo no Word (CVE-2010-1900)  
-   Wushi, da [team509](http://www.team509.com/), a trabalhar com a [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Motor de Análise de RTF no Word (CVE-2010-1901)  
-   [team509](http://www.team509.com/), a trabalhar com a [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise de RTF no Word (CVE-2010-1902)  
-   Rodrigo Rubira Branco, da Equipa de Investigação IPS da [Check Point](http://www.checkpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objectos com Ligações a HTML no Word (CVE-2010-1903)  
-   Investigador anónimo, a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objectos com Ligações a HTML no Word (CVE-2010-1903)
...
-   V1.1 (11 de Agosto de 2010): Os nomes dos pacotes de actualização foram corrigidos para o Microsoft Office Word Viewer e o Pack de Compatibilidade para Microsoft Office nas tabelas de referência de implementação. Trata-se de uma alteração informativa apenas. Não foram efectuadas alterações aos ficheiros da actualização de segurança ou à lógica de detecção.  
-   V1.2 (25 de Agosto de 2010): Ligação adicionada para o Artigo 2269638 da Base de Dados de Conhecimento da Microsoft, na secção Questões Conhecidas, no Resumo Executivo.  
-   V1.3 (1 de Setembro de 2010): Adicionada nota à tabela de Software Afectado para informar os clientes que utilizam o Word 2007 que, para além do pacote da actualização de segurança KB2251419, têm também de instalar o pacote da actualização de segurança KB2277947 para estarem protegidos contra as vulnerabilidades descritas neste boletim.
