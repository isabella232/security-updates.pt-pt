...
ms:assetid: 'ms10-047'
ms:contentKeyID: 61234922
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-047(v=Security.10)'
author: SharonSears
...
Vulnerabilidades no Kernel do Windows Poderiam Permitir Elevação de Privilégios (981852)
----------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para o Windows XP, Windows Vista e Windows Server 2008 e como Moderada para o Windows 7 e Windows Server 2008 R2. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades corrigindo a inicialização de objectos do kernel do Windows e a validação das listas de controlo de acesso, e introduzindo a validação do runtime adicional ao mecanismo de criação de threads. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e3574047-5ce5-4461-94aa-4eb3258d5e71)                                                                                                    | Elevação de Privilégios     | Importante                          | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4486f97c-4cf8-4236-bfc3-b50e72e2a5c1)                                                                  | Elevação de Privilégios     | Importante                          | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b547898e-f8a9-49dc-b49d-cffec5a001bc)                                          | Elevação de Privilégios     | Importante                          | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=611765ab-b3f3-45db-92b2-ee040b9cfd27)\*                 | Elevação de Privilégios     | Importante                          | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=131f3512-1585-462e-a4f1-3f359aac44bd)\*       | Elevação de Privilégios     | Importante                          | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=972efd3a-ec1e-49b2-835e-76f4b21b5b79) | Elevação de Privilégios     | Importante                          | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=a7d60864-5942-47ed-a6f3-1c07b4833a14)                                                                                           | Negação de Serviço          | Moderada                            | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=b00ec47c-402e-4207-a4c9-6c1900f254f8)                                                                                      | Negação de Serviço          | Moderada                            | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=c1ad1248-07f1-42d4-baa4-8a20837ec7b4)\*                                                                       | Negação de Serviço          | Moderada                            | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f23dec0f-a33b-4d8c-a86d-0e9368ae7ff5)                                                                     | Negação de Serviço          | Moderada                            | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Inicialização de Dados no Kernel do Windows - CVE-2010-1888</th>
<th style="border:1px solid black;" >Vulnerabilidade de Condição Livre e Dupla no Kernel do Windows - CVE-2010-1889</th>
<th style="border:1px solid black;" >Vulnerabilidade de Validação Imprópria no Kernel do Windows - CVE-2010-1890</th>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2 para sistemas baseados em Itanium[1]</td>
<td style="border:1px solid black;">Não aplicável</td>
<td style="border:1px solid black;">Não aplicável</td>
<td style="border:1px solid black;"><strong>Moderada</strong> <br />
Negação de Serviço</td>
...
Vulnerabilidade de Inicialização de Dados no Kernel do Windows - CVE-2010-1888  
------------------------------------------------------------------------------
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1888](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888).
  
#### Factores Atenuantes para a Vulnerabilidade na Inicialização de Dados no Kernel do Windows - CVE-2010-1888
...
#### Soluções Alternativas para a Vulnerabilidade na Inicialização de Dados no Kernel do Windows - CVE-2010-1888
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade na Inicialização de Dados no Kernel do Windows - CVE-2010-1888
...
Esta vulnerabilidade é causada por uma condição race que pode ocorrer ao criar tipos específicos de threads.
...
Vulnerabilidade de Condição Livre e Dupla no Kernel do Windows - CVE-2010-1889  
------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no Kernel do Windows devido à forma como este inicializa objectos enquanto processa determinados erros. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1889](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889).
  
#### Factores Atenuantes para a Vulnerabilidade de Condição Livre e Dupla no Kernel do Windows - CVE-2010-1889
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade de Condição Livre e Dupla no Kernel do Windows - CVE-2010-1889
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Condição Livre e Dupla no Kernel do Windows - CVE-2010-1889
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**O que provoca a vulnerabilidade?**    
O kernel do Windows não inicializa objectos adequadamente enquanto processa de determinados erros.
...
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade assegurando que o kernel do Windows inicializa objectos adequadamente enquanto processa determinados erros.
...
Vulnerabilidade de Validação Imprópria no Kernel do Windows - CVE-2010-1890  
---------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço na forma como o kernel do Windows valida listas de controlo de acesso em objectos do kernel. Um intruso poderia explorar a vulnerabilidade executando uma aplicação especialmente concebida para o efeito, fazendo com que o sistema deixasse de responder e reiniciasse automaticamente.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890).
  
#### Factores Atenuantes para a Vulnerabilidade de Validação Imprópria no Kernel do Windows - CVE-2010-1890
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade de Validação Imprópria no Kernel do Windows - CVE-2010-1890
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação Imprópria no Kernel do Windows - CVE-2010-1890
...
**O que provoca a vulnerabilidade?**    
O kernel do Windows não valida adequadamente listas de controlo de acesso em objectos do kernel.
...
**O que faz a actualização?**    
A actualização resolve esta vulnerabilidade corrigindo a forma como o kernel do Windows valida listas de controlo de acesso aplicadas a objectos do kernel.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe, que está localizado na pasta %Windir%\$NTUninstallKB981852$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/981852">Artigo 981852 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Tavis Ormandy, da [Google, Inc.](http://www.google.com/), por fornecer informações sobre a Vulnerabilidade de Inicialização de Dados no Kernel do Windows (CVE-2010-1888)  
-   Tavis Ormandy, da [Google Inc.](http://www.google.com/), por fornecer informações sobre a Vulnerabilidade de Condição Livre e Dupla no Kernel do Windows (CVE-2010-1889)  
-   Tavis Ormandy, da [Google, Inc.](http://www.google.com/), por fornecer informações sobre a Vulnerabilidade de Validação Imprópria no Kernel do Windows (CVE-2010-1890)
