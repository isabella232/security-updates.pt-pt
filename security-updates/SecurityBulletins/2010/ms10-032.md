...
ms:assetid: 'ms10-032'
ms:contentKeyID: 61234907
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-032(v=Security.10)'
author: SharonSears
...
Vulnerabilidades nos Controladores de Modo de Kernel do Windows Poderiam Permitir Elevação de Privilégios (979559)
------------------------------------------------------------------------------------------------------------------
...
A actualização de segurança resolve as vulnerabilidades corrigindo a alteração de objectos e a validação de parâmetros de chamada de retorno e corrigindo a forma como o Windows fornece descrições de tipos de letra TrueType em aplicações do modo de utilizador. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=60c8579b-1540-40d8-80a0-956edadd63ce)                                                                                        | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=023a777a-3d83-4a4e-8029-da8b095b074b)                                                                        | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e3aac9d-7747-435f-9678-f621e314e070)                                                                           | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79a11dcd-5d88-4d83-beae-6580ef6fc2c0)                                                                                           | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f42cc5d4-1bea-4a4a-8a08-b3eb92503588)                                                                               | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=50efb1cf-9d89-4522-929d-f87fd98d6fe8)                                                                | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7cb64633-d2a0-4e38-be35-ec32ea655a04)                                                                  | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bbfc4d80-67eb-4deb-9595-cb67942a0df2)                                          | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=22d550fe-ba35-4750-a9d6-624858b67c94)\*                 | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=09025626-4116-4a31-8700-215382898ee2)\*       | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0035cfe2-d38d-41cd-b704-ec1feda307d8) | Elevação de Privilégios     | Importante                          | [MS09-065](http://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=3e0ff389-4612-4c92-bbff-bb45b5bdfc6a)                                                                                           | Elevação de Privilégios     | Importante                          | Nenhum                                                    |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=2b1e4aff-605a-4e94-88f9-135ce35f0646)                                                                                      | Elevação de Privilégios     | Importante                          | Nenhum                                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=4272277f-b2dd-4406-8bbd-bc461c9923b8)\*                                                                       | Elevação de Privilégios     | Importante                          | Nenhum                                                    |
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=7d636f82-e828-468c-ac36-808ff9d37c7f)                                                                     | Elevação de Privilégios     | Importante                          | Nenhum                                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de Validação de Dados Imprópria no Win32k - CVE-2010-0484</th>
<th style="border:1px solid black;" >Vulnerabilidade na Criação de Janelas no Win32k - CVE-2010-0485</th>
<th style="border:1px solid black;" >Vulnerabilidade de Análise de Tipos de Letra TrueType no Win32k - CVE-2010-1255</th>
...
Vulnerabilidade de Validação de Dados Imprópria no Win32k - CVE-2010-0484  
-------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios porque os controladores de modo de kernel do Windows não validam adequadamente alterações em determinados objectos kernel. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0484](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0484).
  
#### Factores Atenuantes para a Vulnerabilidade de Validação de Dados Imprópria no Win32k - CVE-2010-0484
...
#### Soluções Alternativas para a Vulnerabilidade de Validação de Dados Imprópria no Win32k - CVE-2010-0484
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação de Dados Imprópria no Win32k - CVE-2010-0484
...
Os controladores de modo de kernel do Windows não validam adequadamente alterações em determinados objectos do kernel.
...
Vulnerabilidade na Criação de Janelas no Win32k - CVE-2010-0485  
---------------------------------------------------------------
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0485](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485).
  
#### Factores Atenuantes para a Vulnerabilidade na Criação de Janelas no Win32k - CVE-2010-0485
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade na Criação de Janelas no Win32k - CVE-2010-0485
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade na Criação de Janelas no Win32k - CVE-2010-0485
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**O que provoca a vulnerabilidade?**    
Os controladores de modo de kernel do Windows não validam adequadamente todos os parâmetros de chamada de retorno quando se cria uma nova janela.
...
**O que faz a actualização?**    
A actualização resolve esta vulnerabilidade corrigindo a maneira como os controladores de modo de kernel do Windows validam os parâmetros da chamada de retorno quando se cria uma nova janela.
  
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-0485](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485).
  
**Quando este boletim de segurança foi publicado, a Microsoft já tinha recebido relatórios indicando que esta vulnerabilidade estava a ser explorada?**    
Não. A Microsoft não tinha recebido quaisquer informações que indicassem que esta vulnerabilidade tivesse sido utilizada publicamente para atacar clientes e não tinha conhecimento de exemplos publicados de código para prova de conceito quando este boletim de segurança foi criado pela primeira vez.
  
Vulnerabilidade de Análise de Tipos de Letra TrueType no Win32k - CVE-2010-1255  
-------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios devido à forma como o sistema operativo fornece informações relacionadas com o tipo de letra às aplicações. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255).
  
#### Factores Atenuantes para a Vulnerabilidade de Análise de Tipos de Letra TrueType no Win32k - CVE-2010-1255
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade de Análise de Tipos de Letra TrueType no Win32k - CVE-2010-1255
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Análise de Tipos de Letra TrueType no Win32k - CVE-2010-1255
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada pela forma como o Windows fornece informações de descrição de imagens às aplicações.
...
Não existem aplicações da Microsoft que exponham esta vulnerabilidade através de um vector remoto. No entanto, as aplicações de outros fabricantes podem analisar tipos de letra específicos de fontes não fidedignas e expor esta vulnerabilidade remotamente. Neste cenário, a exploração desta vulnerabilidade poderia fazer com que um utilizador anónimo executasse código com privilégios de administração totais.
  
**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**    
Os sistemas afectados são principalmente estações de trabalho e servidores de terminais. Os servidores podem estar mais sujeitos a risco se os administradores permitirem que os utilizadores iniciem sessão nos servidores e executem programas. Contudo, os procedimentos recomendados desencorajam essa acção.
  
**O que faz a actualização?**    
Esta actualização resolve esta vulnerabilidade corrigindo a forma como o Windows fornece descrições de tipos de letra Truetype às aplicações do modo de utilizador.
  
**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255).
...
| **Implementação**                        |                                                                                                                                                                                   |  
| Instalação sem intervenção do utilizador | Windows2000-KB979559-x86-enu /quiet                                                                                                                                               |  
| Instalação sem reiniciar                 | Windows2000-KB979559-x86-enu /norestart                                                                                                                                           |  
| Ficheiro log da actualização             | KB979559.log                                                                                                                                                                      |  
...
| **Informações de Remoção**               | Utilize a ferramenta **Adicionar ou Remover Programas** no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\\$NTUninstallKB979559$\\Spuninst |  
| **Informações de Ficheiros**             | Consulte o [Artigo 979559 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/979559)                                                                  |  
| **Verificação da Chave de Registo**      | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB979559\\Filelist                                                                                         |
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB979559$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/979559">Artigo 979559 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Sebastien Renaud, da [Equipa de Investigação de Vulnerabilidades da VUPEN](http://www.vupen.com/), por fornecer informações sobre a Vulnerabilidade de Validação de Dados Imprópria no Win32k (CVE-2010-0484)  
-   [Secunia Research](http://secunia.com/), por trabalhar connosco na Vulnerabilidade de Análise de Tipos de Letra TrueType no Win32k (CVE-2010-1255)
