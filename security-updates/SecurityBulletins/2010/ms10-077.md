...
#### Soluções Alternativas para a Vulnerabilidade no Compilador JIT do .NET Framework x64 - CVE-2010-3228
...
-   Jeroen Frijters, da [Sumatra](http://www.sumatra.nl), por fornecer informações sobre a Vulnerabilidade no Compilador JIT do .NET Framework x64 (CVE-2010-3228)
...
-   V1.1 (13 de Outubro de 2010): Alteração da classificação de gravidade do Windows Server 2008 e Windows Server 2008 R2 para Importante. Adicionada também uma ligação para o Artigo 2160841 da Base de Dados de Conhecimento da Microsoft, na secção Questões Conhecidas, no Resumo Executivo, e revisão dos factores atenuantes.
-   V1.2 (26 de Outubro de 2010): Revisão deste boletim para anunciar uma alteração de detecção para correcção de uma questão de instalação. Esta é apenas uma alteração de detecção. Não foram efectuadas alterações à actualização de segurança. Os clientes que já tenham instalado a actualização com sucesso não têm de voltar a instalá-la.
-   V2.0 (14 de Dezembro de 2010): Adição de uma Pergunta Frequente para anunciar que estão disponíveis novos pacotes de actualização para o .NET Framework 4.0 para corrigir uma questão na configuração que poderia interferir com a instalação bem sucedida de outras actualizações e/ou produtos. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.
-   V3.0 (22 de Fevereiro de 2011): Anunciada uma alteração de detecção para oferecer os pacotes de actualização do Microsoft .NET Framework 4.0 a clientes que instalaram o Microsoft .NET Framework 4.0 depois de terem instalado o Windows 7 para sistemas baseados em x64 Service Pack 1, Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1 ou Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.
-   V3.1 (26 de Outubro de 2011): Corrigida a aplicabilidade da instalação Server Core para o .NET Framework 4 no Windows Server 2008 R2 para sistemas baseados em x64.
