...
ms:assetid: 'ms10-100'
ms:contentKeyID: 61234975
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-100(v=Security.10)'
author: SharonSears
...
Vulnerabilidade na Interface de utilizador de Consentimento Poderia Permitir a Elevação de privilégios (2442962)
----------------------------------------------------------------------------------------------------------------
...
A actualização de segurança soluciona a vulnerabilidade corrigindo a forma como a IU de Consentimento processa os valores lidos a partir do registo. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=85265a23-5094-4007-8d33-f402cabd1664)                                                                  | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=63c7257a-16bf-4108-80b9-9dfe53528348)                                          | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=14e079a8-01a4-47c9-bd47-f5c9a6ca070a)\*\*               | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6baf92b7-a336-45f2-a1ba-c00c34dfb76f)\*\*     | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em Itanium e Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7a4b23d4-f68e-4d5b-8814-d9247145f164) | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=f7c7d57a-d031-46a3-9613-eae2b9cb6401)                                                                                           | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=e52c36f5-637b-4928-83d0-27514c6cc384)                                                                                      | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=b823a7aa-0eb9-42dd-bf56-8907d94b314a)\*\*                                                                     | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=66b2506d-80e0-4e32-86e6-0908ef56ae90)                                                                     | Elevação de Privilégios     | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >Vulnerabilidade de Representação da IU de Consentimento - CVE-2010-3961</th>
...
Vulnerabilidade de Representação da IU de Consentimento - CVE-2010-3961  
-----------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na forma como a Interface do Utilizador de Consentimento processa de forma incorrecta valores especiais lidos a partir do registo. A vulnerabilidade poderia permitir que um intruso executasse código com privilégios elevados. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3961](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3961).
  
#### Factores Atenuantes para a Vulnerabilidade de Representação da IU de Consentimento - CVE-2010-3961
...
-   Para explorar com êxito esta vulnerabilidade, o intruso terá de ter o SeImpersonatePrivilege. Os componentes que se seguem permitem igualmente a exploração por parte deste intruso:  
    - Serviços iniciados pelo Service Control Manager  
    - Servidores Component Object Model (Modelo de objectos de componentes) que sejam iniciados pela infra-estrutura de COM e que estejam configurados para execução numa conta específica  
    - Serviços IIS, quando configurados para execução como um utilizador regular
  
#### Soluções alternativas para a Vulnerabilidade de Representação da IU de Consentimento - CVE-2010-3961
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Representação da IU de Consentimento - CVE-2010-3961
...
A vulnerabilidade é causada quando a IU de Consentimento não processa correctamente uma chave de registo que tenha sido definida para um valor específico.
  
**O que é a Interface do Utilizador (IU) de Consentimento?**    
A IU de Consentimento faz parte do Controlo de Conta de Utilizador. Com o controlo de contas de utilizador activado, os administradores interactivos são executados normalmente com menos privilégios, mas estes podem elevar-se de forma autónoma para realizar tarefas administrativas, mediante consentimento específico através da IU de Consentimento. Estas tarefas administrativas incluem a instalação de software e controladores, a alteração de definições abrangentes a todo o sistema, a visualização ou alteração de outras contas de utilizador e a execução de ferramentas administrativas. Para mais informações, consulte o artigo MSDN sobre o [Controlo de Conta de Utilizador](http://msdn.microsoft.com/en-us/library/aa511445.aspx).
  
**O que é o SeImpersonatePrivilege?**    
O direito de utilizador SeImpersonatePrivilege, ou "Representar um cliente depois da autenticação" consiste numa definição de segurança introduzida pela primeira vez no Microsoft Windows 2000 Service Pack 4. Por predefinição, os membros do grupo de Administradores locais do dispositivo e a conta LocalService do dispositivo são atribuídos a este direito de utilizador. A definição SeImpersonatePrivilege é descrita no [Artigo 821546 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/821546).
...
Apenas as contas de utilizador às quais tenha sido atribuído o direito SeImpersonatePrivilege podem realizar este ataque. Um intruso que explorasse com êxito esta vulnerabilidade poderia executar código especialmente concebido para o efeito com privilégios LocalSystem. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
...
A actualização resolve a vulnerabilidade corrigindo a forma como a IU de Consentimento processa os valores lidos a partir do registo.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2442962">Artigo 2442962 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
-   Cesar Cerrudo da [Argeniss](http://www.argeniss.com/) por fornecer informações sobre a Vulnerabilidade de Representação da IU de Consentimento (CVE-2010-3961)
