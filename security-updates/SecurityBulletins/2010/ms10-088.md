...
ms:assetid: 'ms10-088'
ms:contentKeyID: 61234963
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-088(v=Security.10)'
author: SharonSears
...
Vulnerabilidades no Microsoft PowerPoint Poderiam Permitir Execução Remota de Código (2293386)
----------------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para edições suportadas do Microsoft PowerPoint 2002, Microsoft PowerPoint 2003 e Microsoft Office 2004 para Mac e Microsoft PowerPoint Viewer 2007 Service Pack 2. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização resolve as vulnerabilidades alterando a forma como o Microsoft PowerPoint analisa ficheiros PowerPoint especialmente concebidos para o efeito. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.

**Recomendação.** A Microsoft recomenda que os clientes instalem esta actualização na primeira oportunidade.

**Questões Conhecidas.** O [Artigo 2293386 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2293386) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
A Microsoft reviu este boletim para esclarecer que os clientes que utilizam o Microsoft PowerPoint 2002 e o Microsoft PowerPoint 2003 também devem instalar a actualização do Microsoft Office fornecido no [MS10-087](http://go.microsoft.com/fwlink/?linkid=203241), Vulnerabilidades no Microsoft Office Poderiam Permitir Execução Remota de Código (2423930), para se protegerem contra a vulnerabilidade descrita em CVE-2010-2573. Trata-se apenas de uma alteração informativa. Os clientes que já tenham aplicado as actualizações MS10-087 e MS10-088 com sucesso não necessitam de efectuar qualquer acção.
...
**Tenho o Microsoft PowerPoint 2007, que não é afectado pelas vulnerabilidades descritas neste boletim. Por que razão está a ser-me oferecida esta actualização?**  
O Microsoft PowerPoint 2007 não é afectado pelas vulnerabilidades descritas neste boletim; no entanto, o Microsoft PowerPoint Viewer 2007 vulnerável é fornecido com o Microsoft PowerPoint 2007, pelo que deverá receber esta actualização de segurança.

**O que é o Microsoft PowerPoint Viewer?**  
O Microsoft PowerPoint Viewer, que é baseado na tecnologia do Microsoft Office 2010, é uma substituição para o Microsoft PowerPoint Viewer 2007. O Microsoft PowerPoint Viewer permite-lhe visualizar apresentações com funcionalidades completas criadas no Microsoft PowerPoint 97 e em versões posteriores. O Microsoft PowerPoint Viewer não é afectado pelas vulnerabilidades descritas neste boletim.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise no PowerPoint - CVE-2010-2572
</th>
<th style="border:1px solid black;" >
...
<sup>[1]</sup>Para o Microsoft PowerPoint 2002 e para o Microsoft PowerPoint 2003, os clientes devem instalar a actualização do Microsoft Office fornecida no MS10-087, para se protegerem contra a vulnerabilidade descrita em CVE-2010-2573.

Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise no PowerPoint - CVE-2010-2572
--------------------------------------------------------------------------------------------

<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft PowerPoint processa ficheiros PowerPoint 95 especialmente concebidos para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-2572](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2572).

#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise no PowerPoint - CVE-2010-2572
...
-   Por predefinição, a abertura de ficheiros PowerPoint 95 está bloqueada no Microsoft PowerPoint 2003 Service Pack 3. Para obter mais informações acerca dos tipos de ficheiro que são bloqueados após a instalação do Microsoft Office 2003 Service Pack 3, consulte o [Artigo 938810 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/938810/).

#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise no PowerPoint - CVE-2010-2572

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Restringir o acesso ao pp7x32.dll para utilizadores do Microsoft PowerPoint 2002**
    ...
    **Windows XP e Windows XP Professional x64 Edition**
    ...
    Para o PowerPoint 2002 no Windows XP, execute os comandos seguintes a partir de uma linha de comandos como administrador:
    `cacls "C:\Program Files\Microsoft Office\Office10\Xlators\PP7X32.DLL" /E /P everyone:N`

    Para o PowerPoint 2002 no Windows XP Professional x64 Edition, execute os comandos seguintes a partir de uma linha de comandos como administrador:
    ...
    **Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2**
    ...
    Para o PowerPoint 2002 em edições de 32 bits do Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2, execute os seguintes comandos a partir de uma linha de comandos elevada:
    ...
    Para o PowerPoint 2002 em edições de 64 bits do Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2, execute os seguintes comandos a partir de uma linha de comandos elevada:
    ...
    **Impacto da solução alternativa.** Não será possível abrir ficheiros com o formato PowerPoint 95.
    ...
    **Como anular esta solução alternativa:**
    ...
    2.  Na caixa Executar, escreva:
        `C:\Program Files\Microsoft Office\Office10\Xlators`
    3.  Clique com o botão direito do rato em **PP7X32.DLL** e seleccione **Propriedades**.
    4.  Clique no separador **Segurança**.
        **Nota** Se não houver um separador "Segurança" presente na caixa de diálogo de Propriedades, siga os passos descritos no [Artigo 307874 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/307874/), na secção sobre como "Desactivar a Partilha de Ficheiros Simples", para visualizar o separador "Segurança".
    5.  Clique em **Avançadas**.
    6.  Clique no separador de **Proprietário**.
    7.  Seleccione a opção **Administradores** na lista "Mudar proprietário para". Clique em **OK** para guardar as alterações.
    8.  Execute o seguinte comando a partir de uma linha de comandos.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise no PowerPoint - CVE-2010-2572
...
A vulnerabilidade existe devido à forma como o Microsoft PowerPoint interpreta o formato de ficheiro PowerPoint ao abrir um ficheiro PowerPoint 95 especialmente concebido para o efeito.
...
A exploração desta vulnerabilidade requer que um utilizador abra um ficheiro PowerPoint 95 especialmente concebido para o efeito usando uma versão afectada do Microsoft PowerPoint.
...
**Por que razão esta vulnerabilidade é classificada como Moderada para o Microsoft PowerPoint 2003 Service Pack 3?**  
Por predefinição, a abertura de ficheiros PowerPoint 95 está bloqueada no Microsoft PowerPoint 2003 Service Pack 3. Este factor atenuante reduz a classificação de gravidade da vulnerabilidade para Moderada.
...
**Como é que o Microsoft PowerPoint 2007 é afectado por esta vulnerabilidade?**  
O Microsoft PowerPoint 2007 não é afectado pela vulnerabilidade; no entanto, o Microsoft PowerPoint Viewer 2007 vulnerável é fornecido com o Microsoft PowerPoint 2007, pelo que deverá receber esta actualização de segurança.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2413272">Artigo 2413272 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2413304">Artigo 2413304 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2413381">Artigo 2413381 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
-   Alin Rad Pop, da [Secunia Research](http://secunia.com/), por fornecer informações sobre a Vulnerabilidade de Sobrecarga de Memória Intermédia de Análise no PowerPoint (CVE-2010-2572)  
...
-   V1.1 (9 de Novembro de 2010): Correcção da versão afectada do "Microsoft PowerPoint Viewer" para "Microsoft PowerPoint Viewer 2007 Service Pack 2". Trata-se de uma alteração informativa apenas. Os clientes que já tenham actualizado os seus sistemas com sucesso, incluindo clientes com as actualizações automáticas activadas, não necessitam de efectuar qualquer acção. Os clientes que não tenham instalado previamente esta actualização podem necessitar de reavaliar se os seus sistemas necessitam desta actualização, com base no software afectado revisto.  
-   V1.2 (17 de Novembro de 2010): Clarificação de que para o Microsoft PowerPoint 2002 e para o Microsoft PowerPoint 2003, os clientes também devem instalar a actualização do Microsoft Office fornecida no boletim MS10-087, para se protegerem contra a vulnerabilidade descrita em CVE-2010-2573. Trata-se apenas de uma alteração informativa. Os clientes que já tenham aplicado as actualizações MS10-087 e MS10-088 com sucesso não necessitam de efectuar qualquer acção.  
-   V1.3 (12 de Abril de 2011): Anunciado que a actualização de segurança para o Microsoft Office 2004 para Mac (KB2505924) oferecida nos boletins MS11-021, MS11-022 e MS11-023 também resolve as vulnerabilidades descritas neste boletim de segurança.
