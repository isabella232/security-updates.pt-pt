...
ms:assetid: 'ms10-071'
ms:contentKeyID: 61234946
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms10-071(v=Security.10)'
author: SharonSears
...
Actualização de Segurança Cumulativa para o Internet Explorer (2360131)
-----------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Crítica para o Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 em clientes Windows e como Importante para o Internet Explorer 6, Internet Explorer 7 e Internet Explorer 8 em servidores Windows. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve estas vulnerabilidades modificando a forma como o Internet Explorer processa objectos na memória, caracteres especiais CSS, sanitização de HTML, a funcionalidade de Conclusão Automática, o elemento Âncora e scripts em determinados processos. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Como são afectadas por estas vulnerabilidades as versões Windows 7 Service Pack 1 Beta e Windows Server 2008 R2 Service Pack 1 Beta?**  
...
**Como é que esta actualização de segurança está relacionada com o boletim MS10-072?**  
As Vulnerabilidades de Sanitização de HTML (CVE-2010-3243 e CVE-2010-3324) descritas neste boletim também afectam o Microsoft SharePoint. No entanto, pode instalar apenas as actualizações que correspondem ao software que tem instalado nos seus sistemas. Se tem instalado o Internet Explorer, aplique as actualizações necessárias de acordo com este boletim. Se tem instalado o Microsoft SharePoint, aplique as actualizações necessárias de acordo com o boletim [MS10-072](http://go.microsoft.com/fwlink/?linkid=202016).
...
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações na Conclusão Automática - CVE-2010-0808
</th>
<th style="border:1px solid black;" >
...
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações em Caracteres Especiais CSS - CVE-2010-3325
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3326
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações no Elemento Âncora - CVE-2010-3327
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3328
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3329
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2010-3330
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3331
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<span></span>
Existe uma vulnerabilidade de divulgação de informações que poderia potencialmente permitir que fossem capturados dados de formulários no Internet Explorer através da funcionalidade de Conclusão Automática. Um intruso poderia explorar a vulnerabilidade construindo uma página Web especialmente concebida para o efeito que pudesse permitir a divulgação de informações se um utilizador visualizasse essa página. Um intruso que explorasse com sucesso esta vulnerabilidade poderia capturar informação anteriormente introduzida em campos depois de a funcionalidade de Conclusão Automática ter sido activada.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-0808](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0808).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações na Conclusão Automática - CVE-2010-0808
...
#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações na Conclusão Automática - CVE-2010-0808
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações na Conclusão Automática - CVE-2010-0808

**Qual é a abrangência desta vulnerabilidade?**  
Trata-se de uma vulnerabilidade ao nível da divulgação de informações. Um intruso que explorasse a vulnerabilidade quando um utilizador visualizasse uma página Web poderia capturar o conteúdo introduzido em campos de formulários, caso a funcionalidade de Conclusão Automática estivesse activada.

**O que provoca a vulnerabilidade?**  
O Internet Explorer permite que instruções de script automatizadas simulem acções do utilizador na funcionalidade de Conclusão Automática.

**O que é a funcionalidade de Conclusão Automática?**  
A Conclusão Automática é uma funcionalidade do Internet Explorer que ajuda os utilizadores a introduzir rapidamente informações em campos de formulários. Para obter mais informações, consulte o artigo MSDN sobre a [Utilização da Conclusão Automática em Formulários HTML](http://msdn.microsoft.com/en-us/library/ms533032.aspx).

**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso que explorasse com sucesso esta vulnerabilidade poderia potencialmente capturar dados anteriormente introduzidos em formulários no browser. A funcionalidade de Conclusão Automática está desactivada por predefinição.
...
A actualização resolve a vulnerabilidade modificando a funcionalidade de Conclusão Automática no Internet Explorer.

**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-0808](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0808).
...
<span></span>
Existe uma vulnerabilidade de divulgação de informações na forma como a API toStaticHTML sanitiza HTML, o que poderia permitir que um intruso efectuasse ataques de execução de scripts entre sites e executasse scripts no contexto de segurança do utilizador com sessão iniciada. Um intruso que explorasse com sucesso esta vulnerabilidade poderia efectuar um ataque de execução de scripts entre sites no utilizador, permitindo ao intruso executar um script no contexto de segurança do utilizador perante um site que utilize a API toStaticHTML.
...
**Qual é a abrangência desta vulnerabilidade?**  
Trata-se de uma vulnerabilidade ao nível da divulgação de informações. Um intruso que explorasse a vulnerabilidade quando um utilizador visualizasse uma página Web que utilize a API toStaticHTML poderia efectuar um ataque de execução de scripts entre sites no utilizador.
...
A API toStaticHTML pode ser usada para remover atributos de eventos e scripts de entradas de um utilizador antes de serem apresentados como HTML. Para obter mais informações, consulte o artigo do MSDN Library sobre o [Método toStaticHTML](http://msdn.microsoft.com/en-us/library/cc848922.aspx).

**Esta vulnerabilidade está relacionada com CVE-2010-3243 no boletim MS10-072, Vulnerabilidades na toStaticHTML Poderiam Permitir Divulgação de Informações?**  
Sim, a Vulnerabilidade de Sanitização de HTML, CVE-2010-4243, também afecta o Microsoft SharePoint.
...
**Esta vulnerabilidade está relacionada com CVE-2010-3324 no boletim MS10-072, Vulnerabilidades na toStaticHTML Poderiam Permitir Divulgação de Informações?**  
Sim, a Vulnerabilidade de Sanitização de HTML, CVE-2010-3324, também afecta o Microsoft SharePoint.

**É necessário instalar ambas as actualizações para estar protegido contra esta vulnerabilidade?**  
Não, cada actualização resolve uma aplicação separada. Apenas é necessário aplicar a actualização correspondente ao software executado no seu sistema.

**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso que conseguisse explorar com sucesso esta vulnerabilidade, quando um utilizador está a visualizar um HTML num Web site que não foi adequadamente sanitização pelo Internet Explorer, poderia executar scripts no contexto de segurança do utilizador contra o site.
...
<span></span>
Existe uma vulnerabilidade de divulgação de informações na forma como o Internet Explorer processa caracteres especiais CSS. Um intruso poderia explorar a vulnerabilidade construindo uma página Web especialmente concebida para o efeito que pudesse permitir a divulgação de informações se um utilizador visualizasse essa página. Um intruso que explorasse com sucesso esta vulnerabilidade poderia visualizar conteúdo de outro domínio ou zona do Internet Explorer.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3325](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3325).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações em Caracteres Especiais CSS - CVE-2010-3325
...
#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações em Caracteres Especiais CSS - CVE-2010-3325
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações em Caracteres Especiais CSS - CVE-2010-3325

**Qual é a abrangência desta vulnerabilidade?**  
Trata-se de uma vulnerabilidade ao nível da divulgação de informações. Um intruso que explorasse a vulnerabilidade quando um utilizador visualizasse uma página Web poderia visualizar conteúdo de outro domínio ou zona do Internet Explorer diferente do domínio ou zona da página Web do intruso.

**O que provoca a vulnerabilidade?**  
O Internet Explorer processa inadequadamente caracteres especiais CSS, permitindo potencialmente a divulgação de dados importantes.
...
**O que faz a actualização?**  
Esta actualização resolve a vulnerabilidade modificando a forma como o Internet Explorer processa caracteres especiais CSS.

**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3325](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3325).
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3326](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3326).

#### Factores Atenuantes para a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3326
...
#### Soluções Alternativas para a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3326
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3326
...
<span></span>
Existe uma vulnerabilidade de divulgação de informações na forma como o Internet Explorer processa inadequadamente o elemento Âncora. Isto acontece durante a operação do utilizador, quando o elemento Âncora não é removido durante a colagem ou edição de conteúdos, revelando potencialmente informações que permitem a identificação pessoal e que deveriam ser eliminadas.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3327](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3327).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações no Elemento Âncora - CVE-2010-3327

A Microsoft não identificou quaisquer factores atenuantes para esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações no Elemento Âncora - CVE-2010-3327

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações no Elemento Âncora - CVE-2010-3327

**Qual é a abrangência desta vulnerabilidade?**  
Trata-se de uma vulnerabilidade ao nível da divulgação de informações. A informação potencialmente eliminada permanecerá no conteúdo HTML.

**O que provoca a vulnerabilidade?**  
O elemento Âncora não é removido do elemento HTML editável durante operações especificas do utilizador.

**Como poderia um intruso explorar a vulnerabilidade?**  
Esta não é uma vulnerabilidade que possa ser explorada. Em vez disso, pode expor potencialmente conteúdos eliminados anteriormente durante a operação do utilizador.

**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
Esta vulnerabilidade exige que um utilizador tenha sessão iniciada e que utilize o browser para criação de conteúdos HTML. Deste modo, qualquer sistema onde o Internet Explorer seja frequentemente utilizado, como as estações de trabalho ou servidores de terminal dos utilizadores, está mais susceptível a esta vulnerabilidade.

**O que faz a actualização?**  
A actualização resolve a vulnerabilidade modificando a forma como o Internet Explorer processa o elemento Âncora.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3328](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3328).

#### Factores Atenuantes para a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3328
...
#### Soluções Alternativas para a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3328
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3328
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acede a um objecto que não tenha sido inicializado correctamente ou que tenha sido eliminado quando um documento em formato HTML é aberto no Microsoft Word. Um intruso poderia explorar a vulnerabilidade convencendo o utilizador a abrir um documento Word nocivo. Quando um utilizador fechasse o documento, a vulnerabilidade poderia permitir a execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Se um utilizador tiver sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3329](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3329).

#### Factores Atenuantes para a Vulnerabilidade Memória Danificada Não Inicializada - CVE-2010-3329
...
#### Soluções Alternativas para a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3329

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Impeça a execução de objectos COM no Internet Explorer**

    Pode desactivar tentativas de instanciar um objecto COM da Classe HtmlDlgHelper no Internet Explorer definindo o kill bit para o controlo no registo.
    ...
    **Aviso** Se utilizar o Editor de Registo incorrectamente, pode causar problemas sérios que podem vir a obrigar à reinstalação do seu sistema operativo. A Microsoft não pode garantir que consiga resolver problemas que resultam da utilização incorrecta do Editor de Registo. A utilização do Editor de Registo é da sua responsabilidade.
    ...
    Para definir o kill bit para um controlo CLSID com o valor de {3050f4e1-98b5-11cf-bb82-00aa00bdce0b}, cole o seguinte texto num editor de texto como o Bloco de notas. Depois, guarde o ficheiro com a extensão de nome de ficheiro .reg.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3329

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**O que provoca a vulnerabilidade?**  
Quando o Internet Explorer tenta aceder a um objecto que não foi inicializado ou que foi eliminado quando o Microsoft Word foi fechado, a memória pode ser danificada de tal forma que um intruso poderia executar código arbitrário no contexto do utilizador com sessão iniciada.

**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que um utilizador com sessão iniciada. Se o utilizador tiver sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**Como poderia um intruso explorar a vulnerabilidade?**  
Um intruso poderia enviar ao utilizador um documento Word especialmente concebido para o efeito e destinado a explorar esta vulnerabilidade através do Microsoft Word e convencer o utilizador a visualizar o documento Word. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visualizar o conteúdo controlado pelo intruso. Em vez disso, um intruso teria de convencer os utilizadores a executarem determinadas acções, normalmente conseguindo que clicassem numa hiperligação numa mensagem de correio electrónico ou numa mensagem de um programa de mensagens instantâneas que leva os utilizadores ao Web site do intruso, ou abrindo um anexo enviado através de correio electrónico. Esta questão não pode ser explorada directamente através do Internet Explorer.

**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
Para que ocorra alguma acção maliciosa, esta vulnerabilidade requer que um utilizador tenha sessão iniciada e que abra um documento Word nocivo. Deste modo, qualquer sistema onde o Microsoft Word seja frequentemente utilizado, como as estações de trabalho ou servidores de terminal, está mais susceptível a esta vulnerabilidade.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3330](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3330).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2010-3330
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações Entre Domínios - CVE-2010-3330
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acede a um objecto que não tenha sido inicializado correctamente ou que tenha sido eliminado. Um intruso poderia explorar a vulnerabilidade convencendo um utilizador a visualizar um documento Word especialmente concebido para o efeito. Quando um utilizador fechasse o documento Word, a vulnerabilidade poderia permitir a execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Se um utilizador tiver sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3331](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3331).

#### Factores Atenuantes para a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3331
...
#### Soluções Alternativas para a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3331

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Utilize a política de Bloqueio de Ficheiros do Microsoft Office para bloquear a abertura de documentos HTML que provenham de fontes ou localizações desconhecidas ou não fidedignas**
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Memória Danificada Não Inicializada - CVE-2010-3331
...
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
Para que seja executado um ataque, esta vulnerabilidade requer que um utilizador tenha sessão iniciada e que abra um documento Word nocivo. Deste modo, qualquer sistema onde o Microsoft Word seja frequentemente utilizado, como as estações de trabalho ou servidores de terminal, está mais susceptível a esta vulnerabilidade.
...
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2360131$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB2360131-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie8updates\KB2360131-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2360131">Artigo 2360131 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Sirdarckcat, da [Google Inc.](http://www.google.com/), por fornecer informações sobre a Vulnerabilidade de Sanitização de HTML (CVE-2010-3243)  
-   Mario Heiderich, por fornecer informações sobre a Vulnerabilidade de Sanitização de HTML (CVE-2010-3324)  
-   Takehiro Takahashi, da [IBM ISS X-Force](http://www.iss.net/), por fornecer informações sobre a Vulnerabilidade de Memória Danificada Não Inicializada (CVE-2010-3326)  
-   [Peter Vreugdenhil](http://vreugdenhilresearch.nl), a trabalhar com a [TippingPoint's](http://www.tippingpoint.com/) da [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Memória Danificada Não Inicializada (CVE-2010-3328)  
-   Damián Frizza, da [Core Security Technologies](http://www.coresecurity.com/), por fornecer informações sobre a Vulnerabilidade de Memória Danificada Não Inicializada (CVE-2010-3329)  
-   Aldwin Saugere e Radoslav Vasilev da [Cigital](http://www.cigital.com) por fornecerem informações sobre a Vulnerabilidade de Divulgação de Informações Entre Domínios (CVE-2010-3330)  
-   Rodrigo Rubira Branco, do Centro de Investigação IPS da [Check Point](http://www.checkpoint.com/), por fornecer informações sobre a Vulnerabilidade de Memória Danificada Não Inicializada (CVE-2010-3331)
...
-   V1.1 (13 de Outubro de 2010): Corrigidos os nomes dos pacotes de actualização para o Internet Explorer na tabela de referência de implementação do Windows Server 2008. Trata-se de uma alteração informativa apenas. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.
