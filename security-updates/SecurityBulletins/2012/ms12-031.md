...
ms:assetid: 'ms12-031'
ms:contentKeyID: 61235112
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms12-031(v=Security.10)'
---
...
Vulnerabilidade no Microsoft Visio Viewer 2010 Poderia Permitir Execução Remota de Código (2597981)
---------------------------------------------------------------------------------------------------
...
<td style="border:1px solid black;">KB2597170 no <a href="http://go.microsoft.com/fwlink/?linkid=238400">MS12-015</a> substituído por KB2597981</td>
</tr>
<tr class="even">
...
<th style="border:1px solid black;" >Vulnerabilidade de Corrupção de Memória no Formato de Ficheiro VSD - CVE-2012-0018</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Corrupção de Memória no Formato de Ficheiro VSD - CVE-2012-0018  
----------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Visio valida atributos ao processar ficheiros Visio especialmente concebidos para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com direitos de utilização reduzidos no sistema podem ser menos afectados do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0018](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0018).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Formato de Ficheiro VSD - CVE-2012-0018
...
-   Num cenário de ataque com base na Web, um intruso poderia alojar um Web site contendo um ficheiro Visio especialmente concebido para o efeito que fosse utilizado para tentar explorar esta vulnerabilidade. Além disso, os Web sites afectados e os Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos por utilizadores poderiam conter conteúdos especialmente concebidos que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Um intruso teria de convencer os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação presente numa mensagem de correio electrónico, ou numa mensagem de um programa de mensagens instantâneas, que levasse os utilizadores para o Web site do intruso e convencendo-os a abrir o ficheiro Visio especialmente concebido para o efeito.  
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Formato de Ficheiro VSD - CVE-2012-0018
...
-   **Configure as definições das zonas de segurança de Intranet Local e Internet para "Alto", para que sejam bloqueados os Controlos ActiveX e os Scripts Activos nestas zonas**
    ...
    3.  Em **Nível de segurança para esta zona**, mova o cursor para **Alta** e, em seguida, clique em **OK**. Isso define o nível de segurança para Alto para todos os Web sites que visita.
  
    **Nota** Se não vir nenhum cursor, clique em **Nível predefinido**, mova o cursor para **Alto** e, em seguida, clique em **OK**.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Formato de Ficheiro VSD - CVE-2012-0018
  
**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código.
  
**O que provoca a vulnerabilidade?**  
A vulnerabilidade existe quando o Microsoft Visio não processa memória de forma adequada ao analisar ficheiros Visio especialmente concebidos para o efeito.
...
Esta actualização resolve a vulnerabilidade modificando a forma como o Microsoft Visio Viewer valida dados ao analisar ficheiros Visio especialmente concebidos para o efeito.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2597981">Artigo 2597981 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Luigi Auriemma, a trabalhar com a [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Formato de Ficheiro VSD (CVE-2012-0018)
