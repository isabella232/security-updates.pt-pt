---
TOCTitle: 'MS12-009'
Title: 'Microsoft Security Bulletin MS12-009 - Importante'
ms:assetid: 'ms12-009'
ms:contentKeyID: 61235090
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms12-009(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS12-009 - Importante
=================================================

Vulnerabilidades no Controlador de Função Auxiliar Poderiam Permitir Elevação de Privilégios (2645640)
------------------------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para todas as edições suportadas do Windows XP (excepto baseadas em x86), Windows Server 2003, Windows Vista (excepto baseadas em x86), Windows Server 2008 (excepto baseadas em x86), Windows 7 (excepto baseadas em x86) e Windows Server 2008 R2. Para obter mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades corrigindo a forma como o AFD valida entradas antes de passar as entradas do modo de utilizador para o kernel do Windows. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as Vulnerabilidades**.

**Recomendação.** A maioria dos clientes tem a actualização automática activada e não necessitará de efectuar qualquer acção, porque esta actualização de segurança será transferida e instalada automaticamente. Os clientes que não tenham a actualização automática activada necessitam de verificar as actualizações e instalar esta actualização manualmente. Para obter informações sobre opções específicas de configuração de actualizações automáticas, consulte o [Artigo 294871 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/294871) A Microsoft recomenda que os clientes apliquem a actualização na primeira oportunidade, utilizando software de gestão de actualizações ou verificando as actualizações através do serviço [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747).
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82f5c503-d2ea-4fed-8f9d-f30bee2f60b3)                                                                                 | Elevação de Privilégios     | Importante                          | [MS11-080](http://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ee4bef7-b355-4aae-8bba-834a16d44744)                                                                                                 | Elevação de Privilégios     | Importante                          | [MS11-080](http://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b53cf810-0ea3-4cb0-91f9-de1406ccfc96)                                                                                     | Elevação de Privilégios     | Importante                          | [MS11-080](http://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3b18d22d-e192-498b-a105-b946a5f5bfad)                                                                      | Elevação de Privilégios     | Importante                          | [MS11-080](http://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=73e240a6-2d5e-4ceb-8500-8dacca0e4a43)                                                                                           | Elevação de Privilégios     | Importante                          | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e06e77d-7e5d-4d57-98b2-0817f68a1ebb)\*                                                                 | Elevação de Privilégios     | Importante                          | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=56cbeba9-0c39-4418-9042-7244ac9d03db)                                                               | Elevação de Privilégios     | Importante                          | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=299d107d-ab9f-42b6-8f94-a2f1d242c127)                                   | Elevação de Privilégios     | Importante                          | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=576192d3-f050-4718-a7da-c84fce6bf744)\*       | Elevação de Privilégios     | Importante                          | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d6a9b2c9-7582-4953-8ab1-a55c63fcc8dc) | Elevação de Privilégios     | Importante                          | [MS11-046](http://go.microsoft.com/fwlink/?linkid=217464) |
...
**Por que é que o Windows Server 2003 Service Pack 2 é a única edição de 32 bits do Windows afectada neste boletim?** **
**Esta actualização de segurança resolve duas vulnerabilidades, CVE-2012-0148 e CVE-2012-0149. A primeira não afecta nenhuma edição de 32 bits do Windows, enquanto que a segunda apenas afecta as edições suportadas do Windows Server 2003, incluindo as edições de 32 bits. Portanto, o Windows Server 2003 Service Pack 2 é a única edição de 32 bits do Windows incluída como software afectado neste boletim.
...
<th style="border:1px solid black;" >Vulnerabilidade de Elevação de Privilégios no AfdPoll - CVE-2012-0148</th>
<th style="border:1px solid black;" >Vulnerabilidade de Elevação de Privilégios no Controlador de Função Auxiliar - CVE-2012-0149</th>
...
Vulnerabilidade de Elevação de Privilégios no AfdPoll - CVE-2012-0148  
---------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios quando Controlador de Função Auxiliar (afd.sys) valida inadequadamente as entradas transmitidas do modo de utilizador para o kernel do Windows. A vulnerabilidade poderia permitir que um intruso executasse código com privilégios elevados. Um intruso local que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. O intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0148](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0148).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação de Privilégios no AfdPoll - CVE-2012-0148
...
-   Esta vulnerabilidade não pode ser explorada em edições de 32 bits do Microsoft Windows.
  
#### Soluções Alternativas para a Vulnerabilidade de Elevação de Privilégios no AfdPoll - CVE-2012-0148
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação de Privilégios no AfdPoll - CVE-2012-0148
...
A vulnerabilidade é causada quando o controlador afd.sys valida incorrectamente entradas ao receber dados do modo de utilizador.
  
**O que é o Controlador de Função Auxiliar (AFD)?**  
O componente AFD fornece o "controlador de função auxiliar", que suporta aplicações do Windows Sockets e encontra-se no ficheiro afd.sys. O controlador afd.sys é executado no modo de kernel e gere o protocolo de comunicações TCP/IP do Winsock. Esta Interface do Kernel do Winsock permite o acesso aos transportes TDI.
  
**O que é a Interface do Controlador de Transporte (TDI)?**  
A Interface do Controlador de Transporte (TDI) define uma interface de rede no modo de kernel que fica exposta na extremidade superior de todas as pilhas de protocolos de transporte. O nível mais elevado do controlador de protocolo em cada uma destas pilhas suporta a interface TDI para clientes de rede no modo de kernel num nível ainda mais elevado. Para mais informações sobre o Componente TDI, consulte o artigo MSDN sobre [Interface do Controlador de Transporte](http://msdn.microsoft.com/en-us/library/ff565685.aspx).
...
A actualização resolve a vulnerabilidade corrigindo a forma como o AFD valida entradas antes de passar as entradas do modo de utilizador para o kernel do Windows.
...
Vulnerabilidade de Elevação de Privilégios no Controlador de Função Auxiliar - CVE-2012-0149  
--------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios quando Controlador de Função Auxiliar (afd.sys) valida inadequadamente as entradas transmitidas do modo de utilizador para o kernel do Windows. A vulnerabilidade poderia permitir que um intruso executasse código com privilégios elevados. Um intruso local que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. O intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0149](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0149).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação de Privilégios no Controlador de Função Auxiliar - CVE-2012-0149
  
O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade.
  
#### Soluções Alternativas para a Vulnerabilidade de Elevação de Privilégios no Controlador de Função Auxiliar - CVE-2012-0149
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação de Privilégios no Controlador de Função Auxiliar - CVE-2012-0149
...
**O que faz a actualização?**  
A actualização resolve esta vulnerabilidade corrigindo a forma como o AFD valida entradas antes de passar as entradas do modo de utilizador para o kernel do Windows.
...
<td style="border:1px solid black;">Utilize o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2645640$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2645640">Artigo 2645640 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilize o item **Adicionar ou Remover Programas** no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\\$NTUninstallKB2645640$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consulte o [Artigo 2645640 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2645640)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Tarjei Mandt, da [Azimuth Security](http://www.azimuthsecurity.com/), por fornecer informações sobre a Vulnerabilidade de Elevação de Privilégios no AfdPoll (CVE-2012-0148)  
-   Tarjei Mandt, da [Azimuth Security](http://www.azimuthsecurity.com/), por fornecer informações sobre a Vulnerabilidade de Elevação de Privilégios no AfdPoll (CVE-2012-0149)
