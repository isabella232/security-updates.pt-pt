---
TOCTitle: 'MS12-010'
Title: 'Microsoft Security Bulletin MS12-010 - Crítica'
ms:assetid: 'ms12-010'
ms:contentKeyID: 61235091
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms12-010(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS12-010 - Crítica
==============================================

Actualização de Segurança Cumulativa para o Internet Explorer (2647516)
-----------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Crítica para o Internet Explorer 7, Internet Explorer 8 e Internet Explorer 9 em clientes Windows e como Moderada para o Internet Explorer 7, Internet Explorer 8 e Internet Explorer 9 em servidores Windows. Esta actualização de segurança também está classificada como Moderada para o Internet Explorer 6 em todas as edições suportadas do Windows XP. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades modificando a forma como o Internet Explorer lida com os conteúdos durante processos de copiar e colar, processa objectos em memória e cria e inicializa cadeias. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as Vulnerabilidades**.
...
Sim. A actualização KB2647516 está disponível para o Windows Developer Preview. Aconselha-se os clientes com o Windows Developer Preview a aplicarem a actualização nos seus sistemas. A actualização apenas está disponível no [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
Os clientes que necessitem de suporte personalizado para software anterior devem contactar o seu representante de equipa de contas da Microsoft, o seu Gestor Técnico de Contas ou o parceiro ou representante Microsoft adequado para mais informações sobre opções de suporte personalizado. Os clientes que não disponham de um Contrato Alliance, Premier ou Autorizado podem contactar a subsidiária local da Microsoft. Para obter informações de contacto, visite o Web site de [Informações Microsoft Worldwide](http://technet.microsoft.com/security/advisory/), seleccione o país na lista de informações de contacto e, em seguida, clique em **Go** para ver uma lista de números de telefone. Quando telefonar, peça para falar com o Gestor de Vendas de Suporte Premier local. Para obter mais informações, consulte as [Perguntas Mais Frequentes sobre o Ciclo de Vida do Suporte da Microsoft](http://support.microsoft.com/kb/887012).
...
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações ao Copiar e Colar - CVE-2012-0010
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código em Esquema de HTML - CVE-2012-0011
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Divulgação de Informações por Byte Nulo - CVE-2012-0012
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código no VML - CVE-2012-0155
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0010](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0010).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações ao Copiar e Colar - CVE-2012-0010
...
#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações ao Copiar e Colar - CVE-2012-0010
...
-   Não Copie nem Cole conteúdos de fontes não fidedignas.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações ao Copiar e Colar - CVE-2012-0010

**Qual é a abrangência desta vulnerabilidade?**
Trata-se de uma vulnerabilidade ao nível da divulgação de informações.

**O que provoca a vulnerabilidade?**
Durante as operações de copiar e colar, o Internet Explorer não valida suficientemente os dados, permitindo que os intrusos tenham acesso e leiam conteúdos de domínios diferentes.
...
Um intruso poderia alojar um Web site especialmente concebido para o efeito e que fosse concebido para explorar esta vulnerabilidade através do Internet Explorer, convencer um utilizador a executar uma operação de cópia em algum conteúdo apresentado neste Web site e convencer então o utilizador a colar este conteúdo num Web site de destino. O intruso também poderia tirar partido de Web sites corrompidos ou Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos pelo utilizador. Estes Web sites podem conter conteúdos especialmente concebidos para o efeito, que poderiam ajudar a explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Em vez disso, o intruso teria de persuadir os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação numa mensagem de correio electrónico, ou num pedido de mensagem instantânea que leva o utilizador para o Web site do intruso.
...
A actualização resolve a vulnerabilidade modificando a forma como o Internet Explorer lida com os conteúdos durante processos de copiar e colar.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0011).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código em Esquema de HTML - CVE-2012-0011
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código em Esquema de HTML - CVE-2012-0011
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código em Esquema de HTML - CVE-2012-0011
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0012](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0012).

#### Factores Atenuantes para a Vulnerabilidade de Divulgação de Informações por Byte Nulo - CVE-2012-0012
...
#### Soluções Alternativas para a Vulnerabilidade de Divulgação de Informações por Byte Nulo - CVE-2012-0012
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações por Byte Nulo - CVE-2012-0012
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0155](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0155).

#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código no VML - CVE-2012-0155
...
#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código no VML - CVE-2012-0155
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código no VML - CVE-2012-0155
...
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2647516$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB2647516-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie8updates\KB2647516-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2647516">Artigo 2647516 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   [Jan Schejbal](http://janschejbal.wordpress.com/), por fornecer informações sobre a Vulnerabilidade de Divulgação de Informações ao Copiar e Colar (CVE-2012-0010)  
-   Stephen Fewer, da [Harmony Security](http://www.harmonysecurity.com/), a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código em Esquema de HTML (CVE-2012-0011)  
-   Jason Hullinger, da [HP Cloud Services](http://www.hpcloud.com/), por fornecer informações sobre a Vulnerabilidade de Divulgação de Informações por Byte Nulo (CVE-2012-0012)  
-   Stephen Fewer, da [Harmony Security](http://www.harmonysecurity.com/), a trabalhar com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código no VML (CVE-2012-0155)
