---
TOCTitle: 'MS12-001'
Title: 'Microsoft Security Bulletin MS12-001 - Importante'
ms:assetid: 'ms12-001'
ms:contentKeyID: 61235082
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms12-001(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS12-001 - Importante
=================================================

Vulnerabilidade no Kernel do Windows Poderia Permitir que Funcionalidade de Segurança fosse Ignorada (2644615)
--------------------------------------------------------------------------------------------------------------

Data de publicação: 10 de janeiro de 2012 | Updated: 22 de fevereiro de 2012
...
**Questões conhecidas.** O [Artigo 2644615 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2644615) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|-------------------------------------|---------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                                                 | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                                                 | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                                     | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                                      | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                                       | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                                           | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                                      | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                                 | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                               | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                             | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | Funcionalidade de Segurança Ignorada | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >Vulnerabilidade em que a Funcionalidade SafeSEH é Ignorada no Kernel do Windows - CVE-2012-0001</th>
...
Vulnerabilidade em que a Funcionalidade SafeSEH é Ignorada no Kernel do Windows - CVE-2012-0001  
-----------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade em que a funcionalidade de segurança é ignorada no Windows devido à forma como o kernel carrega as tabelas de processamento de excepções estruturadas. Um intruso que explorasse esta vulnerabilidade com sucesso poderia ignorar o mecanismo de defesa profunda SafeSEH para facilitar a exploração de outras vulnerabilidades.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001).
  
#### Factores Atenuantes para a Vulnerabilidade em que a Funcionalidade SafeSEH é Ignorada no Kernel do Windows - CVE-2012-0001
...
-   Apenas as aplicações de software compiladas utilizando o Microsoft Visual C++ .NET 2003 podem ser utilizadas para explorar esta vulnerabilidade.
  
    **Nota** Para ajudar a determinar o produto utilizado para compilar uma determinada aplicação de software, consulte o [Artigo 2644615 da Base de Dados da Microsoft](http://support.microsoft.com/kb/2644615).
  
#### Soluções Alternativas para a Vulnerabilidade em que a Funcionalidade SafeSEH é Ignorada no Kernel do Windows - CVE-2012-0001
...
-   **Recompilar** **o software** **utilizando** **uma versão mais recente do** **Microsoft Visual** **C++**
  
    Apenas as aplicações de software compiladas utilizando o Microsoft Visual C++ .NET 2003 podem ser utilizadas para explorar esta vulnerabilidade. Para resolver este problema, recompile o modelo utilizando o Microsoft Visual C++ 2005, Microsoft Visual C++ 2008 ou o Microsoft Visual C++ 2010.
  
-   **Active a** **Protecção contra Substituição no Processamento de Excepções Estruturadas (SEHOP)**
  
    Para os sistemas Windows Vista, Windows 7, Windows Server 2008 e Windows Server 2008 R2, consulte [Como activar a Protecção contra Substituição no Processamento de Excepções Estruturadas (SEHOP) em sistemas operativos Windows](http://support.microsoft.com/kb/956607) para obter instruções sobre a activação da SEHOP para aplicações existentes.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade em que a Funcionalidade SafeSEH é Ignorada no Kernel do Windows - CVE-2012-0001
  
**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade em que uma funcionalidade de segurança é ignorada. Um intruso que explorasse esta vulnerabilidade com sucesso poderia ignorar a funcionalidade de segurança SafeSEH para facilitar a exploração de outras vulnerabilidades.
  
**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o kernel do Windows carrega uma tabela de processamento de excepção estruturada para o cabeçalho PE "Carregar Configuração" durante a execução de binário.
...
O Ntdll.dll é o componente afectado pela vulnerabilidade.
  
**Como poderia um intruso utilizar a vulnerabilidade?**  
Um intruso que explorasse esta vulnerabilidade com sucesso poderia ignorar a funcionalidade de segurança SafeSEH numa aplicação de software. Um intruso poderia então utilizar outras vulnerabilidades para utilizar o processador de excepções estruturadas para executar código arbitrário.
  
**Como poderia um intruso explorar a** **vulnerabilidade?**  
Para utilizar esta vulnerabilidade para executar código arbitrário, um intruso teria de ignorar a funcionalidade de segurança SafeSEH e tirar partido desta condição em que a segurança é ignorada para explorar outra vulnerabilidade para executar código arbitrário.
  
**O que é** **o Processador de** **Excepções** **Estruturadas?**  
O Processador de Excepções Estruturadas (SEH) é um mecanismo numa aplicação de software para processar excepções de hardware e software. O SEH permite que os programadores tenham controlo total sobre o processamento de excepções, fornece suporte para depuradores e pode ser utilizado em todas as linguagens de programação e máquinas.
  
**O que é a** **SafeSEH?**  
A SafeSEH é uma funcionalidade de segurança que protege o Processador de Excepções Estruturadas contra danos ou manipulação caso a capacidade da memória intermédia seja excedida.
  
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
As estações de trabalho e os servidores estão susceptíveis a esta vulnerabilidade.
  
**O que faz a actualização?**  
A actualização resolve a vulnerabilidade modificando a forma como o kernel do Windows carrega tabelas de processamento de excepções estruturadas.
...
<td style="border:1px solid black;">Utilize o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2644615$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2644615">Artigo 2644615 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilize o item **Adicionar ou Remover Programas** no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\\$NTUninstallKB2644615$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consulte o [Artigo 2644615 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2644615)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Joshua J. Drake, da [Accuvant LABS](http://www.accuvant.com/), por fornecer informações sobre a Vulnerabilidade em que a Funcionalidade SafeSEH é Ignorada no Kernel do Windows (CVE-2012-0001)
...
-   V1.1 (22 de Fevereiro de 2012): Ligação adicionada para o Artigo 2644615 da Base de Dados de Conhecimento da Microsoft, na secção Questões Conhecidas, no Resumo Executivo.
