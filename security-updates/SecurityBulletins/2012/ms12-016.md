...
ms:assetid: 'ms12-016'
ms:contentKeyID: 61235097
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms12-016(v=Security.10)'
author: SharonSears
...
Vulnerabilidades no .NET Framework e no Microsoft Silverlight Poderiam Permitir Execução Remota de Código (2651026)
-------------------------------------------------------------------------------------------------------------------

Data de publicação: 14 de fevereiro de 2012 | Updated: 15 de fevereiro de 2012
...
Esta actualização de segurança está classificada como Crítica para o Microsoft .NET Framework 2.0 Service Pack 2, Microsoft .NET Framework 3.5.1 e Microsoft .NET Framework 4 em todas as edições suportadas do Microsoft Windows e para o Microsoft Silverlight 4. Para obter mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades corrigindo a forma como o Microsoft .NET Framework e o Microsoft Silverlight utilizam objectos não geridos. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
<td style="border:1px solid black;">
KB2539631 em [MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) substituído por KB2633880  
KB2539636 em [MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) substituído por KB2633870
</td>
</tr>
...
<td style="border:1px solid black;">
KB2539633 em [MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) substituído por KB2633874  
KB2539636 em [MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) substituído por KB2633870
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
KB2539634 em [MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) substituído por KB2633879  
KB2539636 em [MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) substituído por KB2633870
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
KB2539635 em [MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) substituído por KB2633873  
KB2539636 em [MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) substituído por KB2633870
</td>
</tr>
<tr>
...
| Microsoft Silverlight 5 quando instalado em todas as edições de clientes Microsoft Windows   |
| Microsoft Silverlight 5 quando instalado em todas as edições de servidores Microsoft Windows |

Perguntas Mais Frequentes relativas a Esta Actualização de Segurança
--------------------------------------------------------------------

<span></span>
**Por que razão foi revisto este boletim a 14 de Fevereiro de 2012?**
A Microsoft reviu este boletim para anunciar uma alteração de detecção para KB2668562 para o Microsoft Silverlight 4 quando instalado em clientes e servidores Windows para corrigir uma questão relacionada com a instalação. Esta é apenas uma alteração de detecção. Não foram efectuadas alterações aos ficheiros de actualização de segurança. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.

**O Microsoft .NET Framework 3.5 e o Microsoft .NET Framework 4.5** **n** **o Windows** **Developer Preview** **e o Microsoft .NET Framework 4.5 Developer Preview** são afectados por esta vulnerabilidade?
...
|-----------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| Microsoft .NET Framework 3.5 no Windows Developer Preview                                                 | [Artigo 2633877 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2633877) |
| Microsoft .NET Framework 4.5 no Windows Developer Preview                                                 | [Artigo 2633869 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2633869) |
| Microsoft .NET Framework 4.5 Developer Preview no Windows Server 2008, Windows 7 e Windows Server 2008 R2 | [Artigo 2638804 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2638804) |
...
O Microsoft Silverlight compilação 4.1.10111, que é a compilação actual do Microsoft Silverlight na data da primeira publicação deste boletim, resolve as vulnerabilidades e não é afectado. As compilações do Microsoft Silverlight anteriores a 4.1.10111 são afectadas.
...
A versão instalada com esta actualização de segurança é a 4.1.10111. Se o número da sua versão for igual ou superior a este número de versão, o seu sistema não está vulnerável.
...
Este boletim descreve uma vulnerabilidade na camada de funcionalidades do .NET Framework 2.0. O programa de instalação do .NET Framework 3.0 Service Pack 2 encadeia a instalação do .NET Framework 2.0 Service Pack 2, pelo que, ao instalar o primeiro, também instala o segundo. Como tal, os clientes que tenham instalado o .NET Framework 3.0 Service Pack 2 devem instalar as actualizações de segurança do .NET Framework 2.0 Service Pack 2.

**Tenho o .NET Framework 3.5 Service Pack 1 instalado. Preciso de instalar alguma actualização?**
Este boletim descreve uma vulnerabilidade na camada de funcionalidades do .NET Framework 2.0. O programa de instalação do .NET Framework 3.5 Service Pack 1 encadeia a instalação tanto do .NET Framework 2.0 Service Pack 2 como do .NET Framework 3.0 Service Pack 2. Como tal, os clientes que tenham instalado o .NET Framework 3.5 Service Pack 1 devem instalar as actualizações de segurança do .NET Framework 2.0 Service Pack 2.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Objectos Não Geridos no .NET Framework - CVE-2012-0014
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção na Área Dinâmica para Dados no .NET Framework - CVE-2012-0015
</th>
<th colspan="2">
Classificação de Gravidade Agregada
</th>
...
<span></span>
Existe uma vulnerabilidade de execução remota de código no Microsoft .NET Framework e no Silverlight que poderia permitir que uma aplicação Microsoft .NET Framework especialmente concebida para o efeito acedesse à memória de uma forma não segura. Um intruso que explorasse esta vulnerabilidade com sucesso poderia executar código arbitrário no contexto de segurança do utilizador com sessão iniciada. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0014](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0014).

#### Factores Atenuantes para a Vulnerabilidade de Objectos Não Geridos no .NET Framework - CVE-2012-0014
...
-   Por predefinição, as aplicações ASP.NET com fidedignidade parcial não recebem SocketPermission. Como tal, num cenário de servidor, esta vulnerabilidade não pode ser explorada em aplicações ASP.NET com um nível de confiança médio ou inferior, a menos que essas aplicações recebam explicitamente SocketPermission por parte do administrador. Para obter mais informações acerca dos níveis de confiança ASP.NET, consulte o artigo MSDN sobre [Níveis de Confiança ASP.NET e Ficheiros de Políticas](http://msdn.microsoft.com/en-us/library/wyts434y.aspx).

#### Soluções Alternativas para a Vulnerabilidade de Objectos Não Geridos no .NET Framework - CVE-2012-0014
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Objectos Não Geridos no .NET Framework - CVE-2012-0014
...
A vulnerabilidade é causada quando o Microsoft .NET Framework e o Microsoft Silverlight utilizam inadequadamente objectos não geridos.
...
A actualização resolve a vulnerabilidade corrigindo a forma como o Microsoft .NET Framework e o Microsoft Silverlight utilizam objectos não geridos.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código no Microsoft .NET Framework devido ao facto de este calcular inadequadamente um comprimento de memória intermédia ao processar entradas especialmente concebidas para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção na Área Dinâmica para Dados no .NET Framework - CVE-2012-0015
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção na Área Dinâmica para Dados no .NET Framework - CVE-2012-0015
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção na Área Dinâmica para Dados no .NET Framework - CVE-2012-0015

**Qual é a abrangência desta vulnerabilidade?**
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

**O que provoca a vulnerabilidade?**
A vulnerabilidade é causada quando o .NET Framework calcula inadequadamente um comprimento de memória intermédia ao processar entradas especialmente concebidas para o efeito.
...
**O que faz a actualização?**
A actualização resolve a vulnerabilidade corrigindo a forma como o Microsoft .NET Framework calcula comprimentos de memória intermédia.

**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2012-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015).
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2651026">Artigo 2651026 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
...
**Instalação da Actualização** **para o Microsoft .NET** **Framework 2.0 Service Pack 2**
...
**Instalação da Actualização** **para o** **Microsoft .NET Framework 4**

Esta actualização de segurança suporta os seguintes parâmetros de configuração para o Microsoft .NET Framework 4.
...
**Instalação da Actualização** **para o** **Microsoft** **.NET Framework 3.5.1**

Esta actualização de segurança suporta os seguintes parâmetros de configuração para o Microsoft .NET Framework 3.5.1.
...
-   Jeroen Frijters, da [Sumatra](http://www.sumatra.nl/), por fornecer informações sobre a Vulnerabilidade de Objectos Não Geridos no .NET Framework (CVE-2012-0014)
...
-   V1.1 (14 de Fevereiro de 2012): Adição de uma entrada à actualização de Perguntas Frequentes para anunciar uma alteração de detecção para KB2668562 para o Microsoft Silverlight 4 quando instalado em clientes e servidores Windows para corrigir uma questão relacionada com a instalação. Esta é apenas uma alteração de detecção. Não foram efectuadas alterações aos ficheiros de actualização de segurança. Os clientes que já tenham aplicado esta actualização com sucesso não necessitam de efectuar qualquer acção.
-   V1.2 (15 de Fevereiro de 2012): Foi removida uma referência errada das questões conhecidas do **Resumo Executivo**.
