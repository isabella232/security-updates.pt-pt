...
ms:assetid: 'ms12-014'
ms:contentKeyID: 61235095
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms12-014(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Codec Indeo Poderia Permitir Execução Remota de Código (2661637)
-----------------------------------------------------------------------------------

Data de publicação: 14 de fevereiro de 2012 | Updated: 22 de fevereiro de 2012
...
Esta actualização de segurança está classificada como Importante para o Windows XP Service Pack 3. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o Codec Indeo carrega bibliotecas externas. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Questões conhecidas.** O [Artigo 2661637 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2661637) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
|----------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=32e5c9ad-b610-4afb-b6f0-bb0b5fbdd1f6) | Execução Remota de Código   | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >
Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Codec Indeo - CVE-2010-3138
</th>
<th colspan="2">
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Codec Indeo processa o carregamento de ficheiros DLL. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138).

#### Factores Atenuantes para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Codec Indeo - CVE-2010-3138
...
-   Para um ataque poder ser bem sucedido, um utilizador teria de visitar uma localização não fidedigna do sistema de ficheiros remoto ou partilha WebDAV e abrir um ficheiro multimédia (por exemplo, um ficheiro .avi).

#### Soluções Alternativas para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Codec Indeo - CVE-2010-3138
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Codec Indeo - CVE-2010-3138
...
A vulnerabilidade é provocada quando o Codec Indeo restringe incorrectamente o caminho utilizado para carregar bibliotecas externas.

**O que é o Codec Indeo?**
O Codec Indeo é um codec que descomprime ficheiros multimédia digitais para utilização em aplicações como o Windows Media Player. Para obter mais informação sobre codecs, consulte as informações sobre [Codecs: perguntas mais frequentes](http://windows.microsoft.com/en-us/windows7/codecs-frequently-asked-questions).

**O que é um ficheiro multimédia AVI?**
O Audio Video Interleave (AVI) é um formato de conteúdos multimédia, definido pela Microsoft, que utiliza o Resource Interchange File Format (RIFF). O AVI é definido pela Microsoft. O formato de ficheiro AVI é comum para dados de áudio e vídeo num computador.
...
Um intruso poderia convencer um utilizador a abrir um ficheiro multimédia legítimo (por exemplo, um ficheiro .avi) localizado no mesmo directório de rede que um ficheiro de biblioteca de hiperligação dinâmica (DLL) especialmente concebido para o efeito. Então, ao abrir o ficheiro legítimo, o Codec Indeo poderia tentar carregar o ficheiro DLL e executar qualquer código nele contido.

Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade ao enviar um ficheiro legítimo (como um ficheiro .avi) a um utilizador e convencer o utilizador a colocar o anexo num directório que contenha um ficheiro DLL especialmente concebido e depois a abrir o ficheiro legítimo. Então, ao abrir o ficheiro legítimo, o Codec Indeo poderia tentar carregar o ficheiro DLL e executar qualquer código nele contido.

Num cenário de ataque através da rede, um intruso poderia colocar um ficheiro legítimo (como um ficheiro .avi) e um ficheiro DLL especialmente concebido para o efeito numa partilha de rede, UNC ou WebDAV, e convencer o utilizador a abrir o ficheiro.

**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**
As estações de trabalho onde os utilizadores podem ter de abrir ficheiros de localizações de rede não fidedignas estão mais susceptíveis.

**O que faz a actualização?**
A actualização resolve esta vulnerabilidade corrigindo a forma como o Codec Indeo carrega bibliotecas externas.
...
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138).
...
<td style="border:1px solid black;">Utilize o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2661637$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2661637">Artigo 2661637 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   V1.1 (22 de Fevereiro de 2012): Ligação adicionada para o Artigo 2661637 da Base de Dados de Conhecimento da Microsoft, na secção Questões Conhecidas, no Resumo Executivo.
