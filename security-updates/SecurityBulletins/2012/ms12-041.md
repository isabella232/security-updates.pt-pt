---
TOCTitle: 'MS12-041'
Title: 'Microsoft Security Bulletin MS12-041 - Importante'
ms:assetid: 'ms12-041'
ms:contentKeyID: 61235122
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms12-041(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS12-041 - Importante
=================================================

Vulnerabilidades nos Controladores de Modo de Kernel do Windows Poderiam Permitir Elevação de Privilégios (2709162)
-------------------------------------------------------------------------------------------------------------------
...
<td style="border:1px solid black;">
KB2641653 no [MS12-018](http://go.microsoft.com/fwlink/?linkid=235364) substituído por KB2709162
</td>
</tr>
...
<th style="border:1px solid black;" >
Vulnerabilidade no Processamento do Nome de Classe Atom de Cadeia - CVE-2012-1864
</th>
<th style="border:1px solid black;" >
Vulnerabilidade no Processamento do Nome de Classe Atom de Cadeia - CVE-2012-1865
</th>
<th style="border:1px solid black;" >
Vulnerabilidade no Processamento do Nome Atom do Formato da Área de Transferência - CVE-2012-1866
</th>
</tr>
<tr>
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
Vulnerabilidade de Excesso de Número Inteiro em Contador de Referência de Recurso de Tipo de Letra - CVE-2012-1867
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Condição Race Win32k.sys - CVE-2012-1868
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-1864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1864).

#### Factores Atenuantes para a Vulnerabilidade no Processamento do Nome de Classe Atom de Cadeia - CVE-2012-1864
...
#### Soluções Alternativas para a Vulnerabilidade no Processamento do Nome de Classe Atom de Cadeia - CVE-2012-1864

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade no Processamento do Nome de Classe Atom de Cadeia - CVE-2012-1864
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-1865](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1865).

#### Factores Atenuantes para a Vulnerabilidade no Processamento do Nome de Classe Atom de Cadeia - CVE-2012-1865

O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade no Processamento do Nome de Classe Atom de Cadeia - CVE-2012-1865

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade no Processamento do Nome de Classe Atom de Cadeia - CVE-2012-1865
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-1866](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1866).

#### Factores Atenuantes para a Vulnerabilidade no Processamento do Nome Atom do Formato da Área de Transferência - CVE-2012-1866

O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade no Processamento do Nome Atom do Formato da Área de Transferência - CVE-2012-1866

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade no Processamento do Nome Atom do Formato da Área de Transferência - CVE-2012-1866
...
<span></span>
Existe uma vulnerabilidade de elevação de privilégios porque os controladores de modo de kernel do Windows não atribuem memória adequadamente quando se processam tipos de letra. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-1867](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1867).

#### Factores Atenuantes para a Vulnerabilidade de Excesso de Número Inteiro em Contador de Referência de Recurso de Tipo de Letra - CVE-2012-1867

O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Excesso de Número Inteiro em Contador de Referência de Recurso de Tipo de Letra - CVE-2012-1867

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Excesso de Número Inteiro em Contador de Referência de Recurso de Tipo de Letra - CVE-2012-1867

**Qual é a abrangência desta vulnerabilidade?**
Esta é uma vulnerabilidade de elevação de privilégios.

**O que provoca a vulnerabilidade?**
A vulnerabilidade é provocada quando um controlador de modo de kernel do Windows não processa correctamente o carregamento do tipo de letra TrueType.
...
**O que faz a actualização?**
A actualização resolve a vulnerabilidade corrigindo a forma como os controladores de modo de kernel do Windows processam o carregamento do tipo de letra TrueType.
...
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no kernel do Windows devido à forma como este lida com tentativas de criação de threads específicos. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2012-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1868).

#### Factores Atenuantes para a Vulnerabilidade de Condição Race Win32k.sys - CVE-2012-1868

O factor atenuante refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Condição Race Win32k.sys - CVE-2012-1868

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Condição Race Win32k.sys - CVE-2012-1868

**Qual é a abrangência desta vulnerabilidade?**
Esta é uma vulnerabilidade de elevação de privilégios.

**O que provoca a vulnerabilidade?**
Esta vulnerabilidade é provocada por uma condição race que pode ocorrer durante a criação de tipos específicos de threads.
...
**O que faz a actualização?**
A actualização resolve esta vulnerabilidade introduzindo validação de runtime adicional ao mecanismo de criação de threads.
...
<td style="border:1px solid black;">Utilize o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB2709162$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2709162">Artigo 2709162 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Utilize o item **Adicionar ou Remover Programas** no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\\$NTUninstallKB2709162$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Consulte o [Artigo 2709162 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/2709162)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Tarjei Mandt, da [Azimuth Security](http://www.azimuthsecurity.com/), por fornecer informações sobre a Vulnerabilidade no Processamento do Nome de Classe Atom de Cadeia (CVE-2012-1864)  
-   Tarjei Mandt, da [Azimuth Security](http://www.azimuthsecurity.com/), por fornecer informações sobre a Vulnerabilidade de Condição Race Win32k.sys (CVE-2012-1865)  
-   Tarjei Mandt, [Azimuth Security](http://www.azimuthsecurity.com/), por fornecer informações sobre a Vulnerabilidade no Processamento do Nome Atom do Formato da Área de Transferência (CVE-2012-1866)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org), da [Google Inc.](http://www.google.com), por fornecer informações sobre a Vulnerabilidade no Processamento do Nome Atom do Formato da Área de Transferência (CVE-2012-1867)
