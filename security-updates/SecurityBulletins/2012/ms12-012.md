---
TOCTitle: 'MS12-012'
Title: 'Microsoft Security Bulletin MS12-012 - Importante'
ms:assetid: 'ms12-012'
ms:contentKeyID: 61235093
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms12-012(v=Security.10)'
---
...
Vulnerabilidade na Cor do Painel de Controlo Poderia Permitir Execução Remota de Código (2643719)
-------------------------------------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Importante para todas as edições suportadas do Windows Server 2008 e Windows Server 2008 R2. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como a Cor do Painel de Controlo carrega bibliotecas externas. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3f6f89b3-3bc8-4325-b8d8-9a5a398b99c6)\*\*                                                                    | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=35e6bd04-594f-42ef-97f8-abcf578b4f10)\*\*                                                               | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d1d51b26-2d01-42a9-9bb1-9fb82c1fb914)                                                               | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8c51e09b-51c3-4860-836e-6bcffde75f04)\*\*     | Execução Remota de Código   | Importante                          | Nenhum                                      |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=fba58a1b-9d9f-4a10-b1df-08a0ebfa2358) | Execução Remota de Código   | Importante                          | Nenhum                                      |
...
<th style="border:1px solid black;" >Vulnerabilidade de Carregamento de Biblioteca sem Segurança na Cor do Painel de Controlo - CVE-2010-5082</th>
...
Vulnerabilidade de Carregamento de Biblioteca sem Segurança na Cor do Painel de Controlo - CVE-2010-5082  
--------------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como a Cor do Painel de Controlo processa o carregamento de ficheiros DLL. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082).
  
#### Factores Atenuantes para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança na Cor do Painel de Controlo - CVE-2010-5082
...
-   Para um ataque poder ser bem sucedido, um utilizador teria de visitar uma localização não fidedigna do sistema de ficheiros remoto ou partilha WebDAV e abrir um ficheiro legítimo (por exemplo, um ficheiro .icm ou .icc).  
...
#### Soluções Alternativas para a Vulnerabilidade de Carregamento de Biblioteca sem Segurança na Cor do Painel de Controlo - CVE-2010-5082
...
-   **Instalar a Experiência de Utilização no Windows Server 2008 e no Windows Server 2008 R2**
  
    Os sistemas com a funcionalidade Experiência de Utilização instalada não são afectados por esta vulnerabilidade.
  
    Para mais informações, incluindo instruções sobre como instalar e retirar a Experiência de Utilização, consulte artigo TechNet sobre a [Visão Geral da Experiência de Utilização](http://technet.microsoft.com/en-us/library/cc772567.aspx).
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Carregamento de Biblioteca sem Segurança na Cor do Painel de Controlo - CVE-2010-5082
...
A vulnerabilidade resulta do facto de a Cor do Painel de Controlo restringir incorrectamente o caminho utilizado ao carregar bibliotecas externas.
  
**O que é a** **funcionalidade** **Experiência de Utilização no Windows Server 2008?**  
Há várias funcionalidades no ambiente de trabalho, tal como a Cor do Painel de Controlo, que não são instalados por predefinição no Windows Server 2008. Em vez disso, pode instalá-las ao mesmo tempo instalando a funcionalidade Experiência de Utilização no Windows Server 2008. Para mais informações, consulte o artigo TechNet sobre a [Visão Geral da Experiência de Utilização](http://technet.microsoft.com/en-us/library/cc772567.aspx).
...
Um intruso poderia convencer um utilizador a abrir um ficheiro legítimo ( como um ficheiro .icm ou .icc) localizado no mesmo directório de rede que um ficheiro de biblioteca de hiperligação dinâmica (DLL) especialmente concebido. Então, ao abrir o ficheiro legítimo, a Cor do Painel de Controlo poderia tentar carregar o ficheiro DLL e executar qualquer código nele contido.
  
Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade ao enviar um ficheiro legítimo (como um ficheiro .icm ou .icc) a um utilizador e convencer o utilizador a colocar o anexo num directório que contenha um ficheiro DLL especialmente concebido e depois a abrir o ficheiro legítimo. Então, ao abrir o ficheiro legítimo, a Cor do Painel de Controlo poderia tentar carregar o ficheiro DLL e executar qualquer código nele contido.
  
Num cenário de ataque através da rede, um intruso poderia colocar um ficheiro legítimo (como um ficheiro .icm ou .icc) e um ficheiro DLL especialmente concebido para o efeito numa partilha de rede, UNC ou WebDAV, e convencer o utilizador a abrir o ficheiro.
  
**Quais os sistemas mais susceptíveis a esta vulnerabilidade?**  
Os servidores onde os utilizadores podem ter de abrir ficheiros de localizações de rede não fidedignas estão mais susceptíveis.
  
**O que faz a actualização?**  
A actualização de segurança resolve esta vulnerabilidade corrigindo a forma como a Cor do Painel de Controlo carrega bibliotecas externas.
...
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082).
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2643719">Artigo 2643719 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
