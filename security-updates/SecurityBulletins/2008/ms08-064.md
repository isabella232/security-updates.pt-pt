---
TOCTitle: 'MS08-064'
Title: 'Microsoft Security Bulletin MS08-064 - Importante'
ms:assetid: 'ms08-064'
ms:contentKeyID: 61234705
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms08-064(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS08-064 - Importante
=================================================

Vulnerabilidade na Manipulação do Descritor de Endereço Virtual Poderia Permitir Elevação de Privilégios (956841)
-----------------------------------------------------------------------------------------------------------------
...
Esta actualização de segurança resolve uma vulnerabilidade comunicada de forma privada sobre o Descritor de Endereço Virtual. A vulnerabilidade poderia permitir elevação de privilégios se um utilizador executasse uma aplicação especialmente concebida para o efeito. Um intruso autenticado que conseguisse explorar esta vulnerabilidade com sucesso poderia obter uma elevação de privilégios num sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.

Esta actualização de segurança está classificada como Importante para todas as edições suportadas do Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

Esta actualização de segurança resolve a vulnerabilidade modificando a forma como o Descritor de Endereço Virtual processa as variáveis de atribuição de memória. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|------------------------------------------------------------------------------------|
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c)                                                                                                     | Elevação de Privilégios     | Importante                          | [MS07-022](http://go.microsoft.com/fwlink/?linkid=85165)                           |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c)                                                                                                     | Elevação de Privilégios     | Importante                          | Nenhum                                                                             |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=50fae854-0bde-46f8-9444-b9e0d9bfecad)                                      | Elevação de Privilégios     | Importante                          | [Aviso de Segurança da Microsoft (932596)](http://support.microsoft.com/kb/932596) |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e8ef3d5f-dd8e-4945-92cd-9d3e30b16667)                                                       | Elevação de Privilégios     | Importante                          | [MS07-022](http://go.microsoft.com/fwlink/?linkid=85165)                           |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c2e754f9-086a-494c-bc19-5feed7df8b65)                                              | Elevação de Privilégios     | Importante                          | [Aviso de Segurança da Microsoft (932596)](http://support.microsoft.com/kb/932596) |
| [Windows Server 2003 com SP1 para sistemas baseados em Itanium e Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=5a3832ec-3f8f-42c1-a603-b1330d527547) | Elevação de Privilégios     | Importante                          | Nenhum                                                                             |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2)                                                                                                                 | Elevação de Privilégios     | Importante                          | [MS07-066](http://go.microsoft.com/fwlink/?linkid=104898)                          |
| [Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2)                                                                                                  | Elevação de Privilégios     | Importante                          | Nenhum                                                                             |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3)                                                                                                     | Elevação de Privilégios     | Importante                          | [MS07-066](http://go.microsoft.com/fwlink/?linkid=104898)                          |
| [Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3)                                                                                      | Elevação de Privilégios     | Importante                          | Nenhum                                                                             |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=ec9eeb82-0497-4c55-94bb-9a47cb3521b4)\*                                                                                | Elevação de Privilégios     | Importante                          | Nenhum                                                                             |
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=0bc178b8-f8ae-4f41-8f88-fb6a75be1bca)\*                                                                           | Elevação de Privilégios     | Importante                          | Nenhum                                                                             |
| [Windows Server 2008 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0af72663-4945-4916-8c55-090ba4d82793)                                                                         | Elevação de Privilégios     | Importante                          | Nenhum                                                                             |
...
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 956841 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/956841).
...
<th style="border:1px solid black;" >Vulnerabilidade de Elevação de Privilégios no Descritor de Endereço Virtual - CVE-2008-4036</th>
...
Vulnerabilidade de Elevação de Privilégios no Descritor de Endereço Virtual - CVE-2008-4036  
-------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na forma como o Gestor de Memória processa a atribuição de memória e os Descritores de Endereço Virtual (VADs). A vulnerabilidade poderia permitir elevação de privilégios se um intruso autenticado executasse um programa especialmente concebido para o efeito num sistema afectado. Um intruso que conseguisse explorar esta vulnerabilidade com sucesso poderia obter uma elevação de privilégios no sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-4036](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4036).
  
#### Factores Atenuantes para a Vulnerabilidade de Elevação de Privilégios no Descritor de Endereço Virtual - CVE-2008-4036
...
#### Soluções Alternativas para a Vulnerabilidade de Elevação de Privilégios no Descritor de Endereço Virtual - CVE-2008-4036
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Elevação de Privilégios no Descritor de Endereço Virtual - CVE-2008-4036
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso que conseguisse explorar esta vulnerabilidade com sucesso poderia obter uma elevação de privilégios no sistema afectado. Um intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios administrativos.
  
**O que provoca a vulnerabilidade?**    
O gestor de memória não processa correctamente uma sobrecarga total quando há um decréscimo de variáveis, causando um erro durante o mapeamento de atribuição de memória.
  
**O que é o Descritor de Endereço Virtual?**    
O VAD é uma forma de memória virtual das aplicações que permite que duas aplicações tenham o seu próprio espaço de endereço. Para mais informações sobre o VAD, consulte os artigos MSDN sobre o [Gestor de memória virtual no Windows NT](http://msdn.microsoft.com/en-us/library/ms810616.aspx) e sobre a [Gestão de memória virtual no Win32](http://msdn.microsoft.com/en-us/library/ms810627.aspx).
...
Um intruso autenticado poderia executar um programa especialmente concebido para o efeito, o que poderia provocar uma sobrecarga total, danificando a memória de tal modo que permitiria a execução de código.
  
**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**    
Os sistemas com o Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008 estão susceptíveis a esta vulnerabilidade.
  
**O que faz a actualização?**    
A vulnerabilidade foi provocada por uma sobrecarga total. A actualização remove a vulnerabilidade adicionando validação adicional aos parâmetros VAD.
...
<td style="border:1px solid black;">Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB956841$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/956841">Artigo 956841 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB956841$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/956841">Artigo 956841 da Base de Dados de Conhecimento da Microsoft</a></td>
...
-   V1.1 (15 de Outubro de 2008): Foi corrigida a ligação a um artigo MSDN de referência nas **Perguntas Mais Frequentes para a Vulnerabilidade de Elevação de Privilégios no Descritor de Endereço Virtual - CVE-2008-4036**.
