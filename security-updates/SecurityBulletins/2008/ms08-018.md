...
ms:assetid: 'ms08-018'
ms:contentKeyID: 61234339
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms08-018(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Microsoft Project poderia permitir Execução Remota de Código (950183)
----------------------------------------------------------------------------------------

Data de publicação: 8 de abril de 2008 | Updated: 10 de setembro de 2008
...
Esta actualização de segurança corrige uma vulnerabilidade comunicada de forma privada no Microsoft Project que poderia permitir execução remota de código se um utilizador abrisse um ficheiro Project especialmente concebido para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Esta actualização de segurança está classificada como Crítica para o Microsoft Project 2000 Service Release 1 e como Importante para o Microsoft Project 2002 Service Pack 1 e para o Microsoft Project 2003 Service Pack 2. Para mais informações consulte a subsecção Software Afectado e Software Não Afectado, nesta secção.

Esta actualização de segurança resolve esta vulnerabilidade modificando a forma como o Microsoft Project calcula a memória que é necessário atribuir ao abrir o Project. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.

**Recomendação.** A Microsoft recomenda que os clientes apliquem de imediato a actualização

**Questões conhecidas.** [O Artigo 950183 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/950183) documenta as questões actualmente conhecidas e soluções recomendadas que os clientes poderão verificar quando instalam esta actualização de segurança. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
<span></span>
**Por que razão esta actualização é Crítica para o Project 2000 mas apenas Importante para todas as outras versões do Project afectadas?**    
...
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 950183 da Base de Dados de Conhecimento.](http://support.microsoft.com/kb/950183)
...
**Utilizo o Microsoft Project 2003 Service Pack 3. Por que razão também recebo esta actualização?**    
O Microsoft Project 2003 Service Pack 3 não é afectado pelas vulnerabilidades de segurança documentadas neste boletim. Contudo, os utilizadores continuarão a receber esta actualização porque os ficheiros actualizados do Microsoft Project 2003 Service Pack 3 são mais recentes (com números de versão superiores) do que os ficheiros actualmente no seu sistema. Esta actualização foi testada minuciosamente, mas tal como em todas as actualizações, recomendamos que os utilizadores executem os testes apropriados no respectivo ambiente e na configuração dos seus sistemas.
  
**Esta oferta de actualização de uma versão não vulnerável do Microsoft Project constitui uma falha no mecanismo de actualização da Microsoft?**    
...
**O que está incluído na actualização do Microsoft Project que faz com que a versão dos ficheiros de actualização seja superior?**    
Os ficheiros de actualização incluem modificações para suportar alterações de estabilidade no Microsoft Project e modificações adicionais para suportar alterações de ambientes empresariais solicitadas pelos clientes. Esta actualização foi testada minuciosamente, mas tal como em todas as actualizações, recomendamos que os utilizadores executem os testes apropriados no respectivo ambiente e na configuração dos seus sistemas.
...
<th style="border:1px solid black;" >Vulnerabilidade de Validação de Memória no Project – CVE-2008-1088</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Validação de Memória no Project – CVE-2008-1088  
------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Project processa ficheiros Project especialmente concebidos para o efeito. Um intruso poderia explorar a vulnerabilidade enviando um ficheiro mal formado que poderia estar incluído como anexo numa mensagem de correio electrónico ou alojado num Web site corrompido ou especialmente concebido para o efeito.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-1088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1088).
  
#### Factores Atenuantes para a Vulnerabilidade de Validação de Memória no Project - CVE-2008-1088
...
#### Soluções Alternativas para a Vulnerabilidade de Validação de Memória no Project - CVE-2008-1088
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação de Memória no Project - CVE-2008-1088
...
O Microsoft Project não valida adequadamente atribuições de recursos de memória ao abrir ficheiros Project.
...
Esta vulnerabilidade requer que um utilizador abra um ficheiro Project mal formado usando uma versão afectada do Microsoft Project.
  
Num cenário de ataque com base em correio electrónico, um intruso poderia explorar a vulnerabilidade enviando um ficheiro Project mal formado ao utilizador e convencendo-o a abrir esse ficheiro.
...
Os sistemas em que o Microsoft Project é utilizado estão mais susceptíveis. Os servidores podem estar mais sujeitos a risco se os administradores permitirem que os utilizadores iniciem sessão nos servidores e executem programas. Contudo, os procedimentos recomendados desencorajam essa acção.
  
**O que faz a actualização?**    
A actualização remove a vulnerabilidade modificando a forma como o Microsoft Project valida atribuições de memória ao abrir ficheiros Project do disco para a memória.
...
**Nota** Para os clientes que usam software antigo não suportado pelo MBSA 2.0.1, Microsoft Update e Windows Server Update Services: visite o Microsoft Baseline Security Analyzer e consulte a secção Legacy Product Support (Suporte para Produtos Antigos) para saber como criar sistemas de detecção de actualizações de segurança abrangentes com as ferramentas antigas.
...
-   Para versões suportadas do Microsoft Office 2003, consulte [Criar um ponto de instalação administrativa](http://office.microsoft.com/en-us/ork2003/ha011401931033.aspx). Para obter mais informações sobre como alterar a fonte de um computador cliente, a partir de um ponto de instalação administrativa actualizado, para uma fonte com linha de base original Office 2003 ou Service Pack 2 (SP2), consulte o Artigo 902349 da Base de Dados de Conhecimento da Microsoft.  
    **Nota** Se planear gerir actualizações de software centralmente a partir de uma imagem administrativa actualizada, pode encontrar mais informações no artigo Distribuir actualizações de produtos do Office 2003.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/950183">Artigo 950183 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   [National Cyber Security Center](http://www.ncsc.go.kr/eng/), da República da Coreia, por fornecer informações sobre a Vulnerabilidade de Validação de Memória no Project - CVE-2008-1088.
...
-   V1.1 (9 de Abril de 2008): Boletim actualizado para adicionar o Microsoft Project 2003 Service Pack 3 à tabela de software não afectado, para adicionar uma ligação para o Artigo 950183 da Base de Dados de Conhecimento da Microsoft na secção de Questões Conhecidas e para adicionar uma secção para Microsoft Project 2003 Service Pack 3 à secção de Perguntas Mais Frequentes.  
-   V1.2 (16 de Abril de 2008): Boletim actualizado: Adicionada entrada às Perguntas Mais Frequentes sobre a Actualização para descrever funcionalidades de segurança adicionais incluídas para o Microsoft Office 2003 Service Pack 2. Tabelas do Microsoft Baseline Security Analyzer e do Systems Management Server actualizadas em correspondência com a tabela de Software Afectado.  
-   V1.3 (10 de Setembro de 2008): Boletim actualizado: Adicionada entrada às Perguntas Mais Frequentes sobre a Actualização para clarificar a razão pela qual esta actualização é classificada como Crítica para o Project 2000 mas apenas classificada como Importante para todas as outras versões afectadas do Project.
