...
ms:assetid: 'ms08-066'
ms:contentKeyID: 61234707
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms08-066(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Controlador de Função Auxiliar da Microsoft Poderia Permitir Elevação de Privilégios (956803)
----------------------------------------------------------------------------------------------------------------

Data de publicação: 14 de outubro de 2008 | Updated: 13 de janeiro de 2009
...
Esta actualização de segurança resolve uma vulnerabilidade comunicada de forma privada no Controlador de Função Auxiliar da Microsoft. Um intruso local que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Esta é uma actualização de segurança importante para todas as edições suportadas do Windows XP e Windows Server 2003. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

Esta actualização de segurança resolve a vulnerabilidade validando correctamente as entradas transmitidas para o kernel do Windows do modo de utilizador para o componente AFD. Para mais informações sobre esta vulnerabilidade, consulte a subsecção de Perguntas mais frequentes na secção seguinte, **Informações sobre as vulnerabilidades**.

**Recomendação.** A Microsoft recomenda que os clientes instalem esta actualização na primeira oportunidade.

**Questões conhecidas.** O [Artigo 956803 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/956803) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9)                                                                         | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5b607efc-c6fb-4079-8478-e4f3262386d3)                                      | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074)                                                       | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ab4d94d3-458c-4946-ab7f-03a279629d25)                                              | Elevação de Privilégios     | Importante                          | Nenhum                                      |
| [Windows Server 2003 com SP1 para sistemas baseados em Itanium e Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=63234f85-6e5d-4ef6-b7cf-d1d2c78a5517) | Elevação de Privilégios     | Importante                          | Nenhum                                      |
...
A Microsoft reviu este boletim de segurança para anunciar uma alteração na detecção para esta actualização de segurança. Como resultado desta correcção, a detecção oferece aos sistemas afectados a actualização de segurança que anteriormente não tinha sido disponibilizada. Os clientes que actualizaram os seus sistemas com sucesso não necessitam de reinstalar esta actualização.

**Onde estão os pormenores sobre as informações do ficheiro?**  
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 956803 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/956803).

**Quais são as questões conhecidas que os clientes poderão experimentar quando instalam esta actualização de segurança?**  
O [Artigo 956803 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/956803) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
<th style="border:1px solid black;" >Vulnerabilidade de Substituição no Kernel AFD - CVE-2008-3464</th>
...
Vulnerabilidade de Substituição no Kernel AFD - CVE-2008-3464  
-------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no Controlador de Função Auxiliar (afd.sys) devido a uma validação inadequada por parte do Windows quanto a entradas transmitidas do modo de utilizador para o kernel. A vulnerabilidade poderia permitir que um intruso executasse código com privilégios elevados. Um intruso local que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. O intruso poderia então instalar programas, ver, alterar ou eliminar dados, ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-3464](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464).
  
#### Factores Atenuantes para a Vulnerabilidade de Substituição no Kernel AFD - CVE-2008-3464
...
#### Soluções Alternativas para a Vulnerabilidade de Substituição no Kernel AFD - CVE-2008-3464
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Substituição no Kernel AFD - CVE-2008-3464
...
A actualização remove a vulnerabilidade validando correctamente as entradas transmitidas para o kernel do Windows do modo de utilizador para o componente AFD.
...
<td style="border:1px solid black;">Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB956803$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/956803">Artigo 956803 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB956803$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/956803">Artigo 956803 da Base de Dados de Conhecimento da Microsoft</a></td>
...
-   Fabien Le Mentec, da [SkyRecon](http://www.skyrecon.com/), por fornecer informações sobre a Vulnerabilidade de Substituição no Kernel AFD (CVE-2008-3464)
...
-   V1.1 (13 de Janeiro de 2009): Adicionada uma entrada à secção de **Perguntas Mais Frequentes relativas a esta Actualização de Segurança** com a explicação de que a revisão consiste numa alteração à detecção para esta actualização de segurança. A detecção correcta oferece a actualização de segurança para os sistemas afectados aos quais não foi disponibilizada anteriormente a actualização de segurança. Os clientes que actualizaram os seus sistemas com sucesso não necessitam de reinstalar esta actualização.
