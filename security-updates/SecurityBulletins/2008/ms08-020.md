...
ms:assetid: 'ms08-020'
ms:contentKeyID: 61234341
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms08-020(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Cliente DNS poderia permitir Ocultação de Conteúdos (945553)
-------------------------------------------------------------------------------
...
Esta actualização de segurança resolve uma vulnerabilidade comunicada de forma privada. Esta vulnerabilidade de ocultação existe nos conteúdos de clientes DNS do Windows e poderia permitir que um intruso enviasse respostas especialmente concebidas para o efeito a pedidos de DNS, ocultando conteúdos ou redireccionando tráfego de Internet a partir de localizações legítimas.

Esta é uma actualização de segurança importante para o Windows Vista, Windows Vista x64 Edition e para todas as edições suportadas do Microsoft Windows 2000, Windows XP e Windows Server 2003. Para mais informações, consulte a subsecção, **Software Afectado e Software Não Afectado**, nesta secção.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=41326ade-96b6-47ce-9291-d4e3039471c4)                                                                                         | Spoofing                    | Importante                          | Nenhum                                      |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=893f4cef-0395-4c44-ba28-7a10b6e7dd48)                                                                                                     | Spoofing                    | Importante                          | Nenhum                                      |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8fdd1207-6e93-4c43-bacc-fe3623a6ebe7)                                      | Spoofing                    | Importante                          | Nenhum                                      |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=214bd8f5-6eb2-414c-b013-c516a306d692)                                                       | Spoofing                    | Importante                          | Nenhum                                      |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fd123394-a5d6-4b55-be74-2938f52ce922)                                              | Spoofing                    | Importante                          | Nenhum                                      |
| [Windows Server 2003 com SP1 para sistemas baseados em Itanium e Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=e0e63f03-904d-47ee-94fc-51a8dea668eb) | Spoofing                    | Importante                          | Nenhum                                      |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=8203d303-c855-4579-9bbf-b06ddf5c1b87)                                                                                                                 | Spoofing                    | Importante                          | Nenhum                                      |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=73f3a234-3973-4467-be7e-69efa7ee978c)                                                                                                     | Spoofing                    | Importante                          | Nenhum                                      |
...
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 945553 da Base de Dados de Conhecimento.](http://support.microsoft.com/kb/945553)
...
<th style="border:1px solid black;" >Vulnerabilidade de Ataque ao DNS que poderia permitir Ocultação de Conteúdos – CVE-2008-0087</th>
...
Vulnerabilidade de Ataque ao DNS que poderia permitir Ocultação de Conteúdos – CVE-2008-0087  
--------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de ocultação de conteúdos nos clientes DNS do Windows. A vulnerabilidade poderia permitir que um intruso não autenticado enviasse respostas maliciosas a pedidos de DNS efectuados por clientes vulneráveis e, assim, ocultar conteúdos ou redireccionar tráfego de Internet a partir de localizações legítimas.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-0087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0087).
  
#### Factores Atenuantes para a Vulnerabilidade de Ataque ao DNS que poderia permitir Ocultação de Conteúdos – CVE-2008-0087
...
#### Soluções Alternativas para a Vulnerabilidade de Ataque ao DNS que poderia permitir Ocultação de Conteúdos – CVE-2008-0087
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Ataque ao DNS que poderia permitir Ocultação de Conteúdos – CVE-2008-0087
  
**Qual é a abrangência desta vulnerabilidade? **  
Existe uma vulnerabilidade de ocultação de conteúdos nos clientes DNS do Windows. Um intruso que explorasse esta vulnerabilidade com sucesso poderia fazer-se passar por um endereço legítimo.
  
**O que provoca a vulnerabilidade? **  
O serviço de cliente DNS do Windows não fornece entropia suficiente na aplicação de aleatoriedade dos valores de transacção quando executa consultas de DNS.
  
**Como poderia um intruso utilizar a vulnerabilidade? **  
Um intruso que conseguisse obter informações sobre IDs de transacção do cliente DNS poderia usar essa informação para enviar respostas maliciosas a pedidos de DNS.
  
**Como poderia um intruso explorar a vulnerabilidade? **  
Um intruso que explorasse esta vulnerabilidade com sucesso poderia responder a uma consulta de DNS com informações falsas ou enganadoras, redireccionando o tráfego de Internet a partir de localizações legítimas para um endereço escolhido pelo intruso.
  
**O que é o Sistema de Nomes de Domínio (DNS)?**  
O Sistema de Nomes de Domínio (DNS) é um dos conjuntos de protocolos padrão da indústria que incluem o TCP/IP. O DNS é implementado usando dois componentes de software: o servidor DNS e o cliente DNS (ou resolução). Ambos os componentes são executados como aplicações de serviços em plano de fundo. Os recursos de rede são identificados por endereços IP numéricos, mas estes endereços IP são difíceis de recordar por parte dos utilizadores de rede. A base de dados de DNS contém registos, que mapeiam nomes alfanuméricos fáceis de utilizar para recursos de rede, para o endereço de IP usado por esses recursos para efeitos de comunicação. Deste modo, o DNS funciona como um dispositivo mnemónico, tornando os recursos de rede mais fáceis de lembrar para utilizadores de rede. Para mais informações e para ver diagramas lógicos que ilustram a forma como o DNS se ajusta a outras tecnologias Windows, consulte o artigo sobre [Como funciona o DNS](http://technet2.microsoft.com/windowsserver/en/library/ff937311-03ce-4d04-b72c-b39c4d51cb361033.mspx).
  
**A vulnerabilidade poderia ser explorada a partir da Internet? **  
Sim, um intruso poderia explorar esta vulnerabilidade pela Internet enviando respostas específicas para um sistema cliente voltado para a Internet que execute consultas de DNS.
  
**Quais os sistemas mais susceptíveis a esta vulnerabilidade? **  
Qualquer sistema Windows que esteja ligado a uma rede ou à Internet poderia estar susceptível. O Windows Vista SP1 e o Windows Server 2008 não são afectados por esta vulnerabilidade.
  
**O que faz a actualização? **  
A actualização de segurança remove esta vulnerabilidade reforçando a aleatoriedade de IDs de transacção em comunicações do cliente DNS.
...
<td style="border:1px solid black;">Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB945553$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/945553">Artigo 945553 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas as edições baseadas em x64 do Windows XP suportadas:
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou a ferramenta de desinstalação de SP localizada em %Windir%\$NTUninstallKB945553$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/945553">Artigo 945553 da Base de Dados de Conhecimento da Microsoft</a></td>
...
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB945553$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/945553">Artigo 945553 da Base de Dados de Conhecimento da Microsoft</a></td>
...
-   Amit Klein, da [Trusteer](http://www.trusteer.com/), por fornecer informações sobre a Vulnerabilidade de Ataque ao DNS que poderia permitir Ocultação de Conteúdos – (CVE-2008-0087).  
-   Alla Berzroutchko, da [Scanit](http://www.scanit.be/), por fornecer informações sobre a Vulnerabilidade de Ataque ao DNS que poderia permitir Ocultação de Conteúdos - (CVE-2008-0087).  
-   Roy Arends, da [Nominet UK](http://www.nominet.org.uk/), por fornecer informações sobre a Vulnerabilidade de Ataque ao DNS que poderia permitir Ocultação de Conteúdos - (CVE-2008-0087).
...
-   V1.1 (9 de Abril de 2008): Boletim actualizado para adicionar Windows Vista x64 Edition à lista software afectado no Resumo Executivo.  
