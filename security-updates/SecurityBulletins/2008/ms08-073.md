...
ms:assetid: 'ms08-073'
ms:contentKeyID: 61234714
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms08-073(v=Security.10)'
author: SharonSears
...
Actualização de Segurança Cumulativa para o Internet Explorer (958215)
----------------------------------------------------------------------
...
Esta actualização de segurança está classificada como Crítica para o Internet Explorer 5.01 e Internet Explorer 6 Service Pack 1 executados no Microsoft Windows 2000, Internet Explorer 6 executado no Windows XP e Internet Explorer 7. Esta actualização de segurança está classificada como Moderada para o Internet Explorer 6 executado no Windows Server 2003. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve estas vulnerabilidades modificando a forma como o Internet Explorer valida os parâmetros, processa o erro que resulta numa condição de possível exploração e processa dados extra ao incorporar objectos em páginas Web. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes na secção seguinte, **Informações sobre as vulnerabilidades**.
...
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 958215 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/958215).
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Validação de Parâmetros - CVE-2008-4258
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2008-4259
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória não Inicializada - CVE-2008-4260
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória no Processamento de HTML - CVE-2008-4261
</th>
<th style="border:1px solid black;" >
Classificação de Gravidade Agregada
</th>
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer processa determinados métodos de navegação. Um intruso poderia explorar a vulnerabilidade criando uma página web especialmente concebida para o efeito. Quando um utilizador visualizasse a página Web, a vulnerabilidade poderia permitir a execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-4258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4258).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Validação de Parâmetros - CVE-2008-4258
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Validação de Parâmetros - CVE-2008-4258
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Validação de Parâmetros - CVE-2008-4258
...
O Internet Explorer não valida correctamente parâmetros definidos durante uma chamada de método no browser. Como resultado desta operação, a memória pode ficar corrompida de uma forma que pode permitir que um intruso execute código arbitrário no contexto do utilizador com sessão iniciada.
...
A actualização modifica a forma como o Internet Explorer valida parâmetros durante chamadas de métodos específicas.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-4259](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4259).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2008-4259
...
-   O Microsoft Internet Explorer 6 não é afectado por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2008-4259

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   **Desactivar o serviço WebClient**

    Para desactivar o serviço WebClient através da linha de comandos, siga os seguintes passos:

    1.  Clique em **Iniciar**, clique em **Executar**, escreva **Services.msc** e a seguir clique em **OK**.
    2.  Clique com o botão do lado direito do rato em **Serviço WebClient** e seleccione **Propriedades**.
    ...
    **Como anular esta solução alternativa.**
    ...
    Para reactivar o serviço WebDAV através da linha de comandos, siga estes passos:
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2008-4259
...
**O que faz a actualização?**  
A actualização modifica a forma como o Internet Explorer processa o erro ao tentar aceder a memória não inicializada.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-4260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4260).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória não Inicializada – CVE-2008-4260
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória não Inicializada – CVE-2008-4260
...
**O que provoca a vulnerabilidade?**  
O Internet Explorer tenta aceder a um objecto que foi eliminado. Como resultado desta operação, a memória pode ficar corrompida de uma forma que pode permitir que um intruso execute código arbitrário no contexto do utilizador com sessão iniciada.
...
**O que faz a actualização?**  
A actualização modifica a forma como o Internet Explorer processa erros quando são realizadas chamadas para objectos que foram eliminados.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer incorpora objectos numa página Web. Um intruso poderia explorar a vulnerabilidade criando uma página web especialmente concebida para o efeito. Quando um utilizador visualizasse a página Web, a vulnerabilidade poderia permitir a execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-4261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4261).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória no Processamento de HTML - CVE-2008-4261
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória no Processamento de HTML - CVE-2008-4261

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória no Processamento de HTML - CVE-2008-4261
...
**O que provoca a vulnerabilidade? **
Quando o Internet Explorer apresenta uma página Web que contém dados inesperados, ao incorporar um objecto na página, a memória pode ser corrompida de tal forma que permite a um intruso executar código arbitrário.
...
Um utilizador teria de ter sessão iniciada e visitar um Web site para que pudesse ocorrer uma acção nociva. Deste modo, qualquer sistema onde o Internet Explorer seja frequentemente utilizado, como as estações de trabalho ou servidores de terminal dos utilizadores, está mais susceptível a esta vulnerabilidade.

**O que faz a actualização? **
A actualização modifica a forma como o Internet Explorer processa dados extra ao incorporar objectos.
...
<td style="border:1px solid black;">Para o Internet Explorer 5.01 Service Pack 4 em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB958215-IE501SP4-20081016.120000$\Spuninst<br />
<br />
Para o Internet Explorer 6 Service Pack 1 quando instalado em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB958215-IE6SP1-20081016.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958215">Artigo 958215 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstal\KB958215$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para Windows XP:<br />
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB958215-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958215">Artigo 958215 da Base de Dados de Conhecimento da Microsoft</a></td>
...
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB958215$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   Carlo Di Dato (também conhecido como shinnai), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Validação de Parâmetros (CVE-2008-4258)  
-   Brett Moore, em colaboração com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objectos HTML (CVE-2008-4259)  
-   Chris Weber, da [Casaba Security](http://www.casabasecurity.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória não Inicializada (CVE-2008-4260)  
-   Jun Mao, da [Verisign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória no Processamento de HTML (CVE-2008-4261)
