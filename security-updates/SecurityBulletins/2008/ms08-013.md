...
ms:assetid: 'ms08-013'
ms:contentKeyID: 61234334
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms08-013(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Microsoft Office poderia permitir Execução Remota de Código (947108)
---------------------------------------------------------------------------------------

Data de publicação: 12 de fevereiro de 2008 | Updated: 12 de janeiro de 2010
...
Esta actualização de segurança crítica resolve uma vulnerabilidade no Microsoft Office comunicada de forma privada. A vulnerabilidade poderia permitir a execução remota de código se um utilizador abrisse um ficheiro Microsoft Office especialmente concebido para o efeito com um objecto mal formado inserido no documento. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Esta é uma actualização de segurança crítica para todas as edições suportadas do Microsoft Office 2000 e uma actualização de segurança importante para o Microsoft Office XP, Microsoft Office 2003 e Microsoft Office 2004 para Mac. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

Esta actualização de segurança resolve a vulnerabilidade modificando a forma como o Microsoft Office carrega documentos com objectos inseridos. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Após instalar esta actualização, por que razão não a posso remover?**  
Existe uma questão no Microsoft Office XP e no Office 2003 que faz com que o Office seja parcialmente desinstalado quando actualizações para determinados componentes são instaladas ou desinstaladas. Esta actualização corrige o problema. Contudo, quando esta actualização é desinstalada, o problema é reintroduzido e o Office é parcialmente desinstalado. De forma a impedir esta situação, a Microsoft definiu não ser possível instalar esta actualização.
...
**Na tabela de Software Afectado não é apresentada a suite completa do Microsoft Office, mas apenas uma das aplicações de componentes como o Word. Receberei a actualização de segurança para o meu sistema?**    
A vulnerabilidade abordada por este boletim de segurança afecta apenas a suite completa do Microsoft Office listada na secção de Software Afectado. No entanto, algumas aplicações específicas do Microsoft Office utilizam alguns dos mesmos ficheiros utilizados pela suite completa do Microsoft Office a que se aplica a actualização de segurança. Recomendamos que instale a actualização, para evitar que a actualização de segurança seja oferecida novamente.
...
<th style="border:1px solid black;" >Vulnerabilidade de Salto na Execução do Microsoft Office - CVE-2008-0103</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de Salto na Execução do Microsoft Office - CVE-2008-0103  
------------------------------------------------------------------------
  
<span></span>
A vulnerabilidade poderia permitir a execução remota de código se um utilizador abrisse um documento Microsoft Office especialmente concebido para o efeito com um objecto mal formado inserido no documento. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-0103](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0103).
  
#### Factores Atenuantes para a Vulnerabilidade de Salto na Execução do Microsoft Office - CVE-2008-0103
...
#### Soluções Alternativas para a Vulnerabilidade de Salto na Execução do Microsoft Office - CVE-2008-0103
  
Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:
  
-   Restringir o acesso ao VBE6.dll
  
    Para restringir o acesso ao VBE6.dll, escreva o seguinte na linha de comandos:
    ...
    **Impacto da solução alternativa:** A implementação desta solução alternativa fará com que os ficheiros Microsoft Office com conteúdos VBA (como os que contêm macros) deixem de poder ser carregados.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Salto na Execução do Microsoft Office - CVE-2008-0103
  
**Qual é a abrangência desta vulnerabilidade? **  
Esta é uma vulnerabilidade de execução remota de código no Microsoft Office. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
  
**O que provoca a vulnerabilidade? **  
A vulnerabilidade é causada por um erro de processamento da memória no Microsoft Office quando um utilizador abre um ficheiro Office especialmente concebido para o efeito contendo objectos mal formados. O erro pode corromper a memória do sistema de tal modo que um intruso poderia executar código arbitrário.
...
A actualização elimina a vulnerabilidade modificando a forma como o Office gere atribuições de memória ao abrir documentos do Office com informações de objectos inseridas nos documentos.
...
|------------------|-----------|-------------|-------|-----------|  
| Vbe6.dll         | 6.5.10.24 | 10-Mai-2007 | 00:19 | 2,585,936 |
...
-   Shaun Colley, da [NGSSoftware](http://www.ngssoftware.com/), por fornecer informações sobre a Vulnerabilidade de Salto na Execução do Microsoft Office (CVE-2008-0103).
...
-   V1.1 (13 de Fevereiro de 2008): Boletim actualizado para reflectir que não existem questões conhecidas relacionadas com a instalação desta actualização de segurança.  
-   V1.2 (27 de Fevereiro de 2008): Boletim actualizado para reflectir a razão pela qual esta actualização não pode ser desinstalada para o Office XP e Office 2003.  
-   V1.3 (16 de Abril de 2008): Boletim actualizado: Adicionada entrada às Perguntas Mais Frequentes sobre a Actualização para descrever funcionalidades de segurança adicionais incluídas para o Microsoft Office 2003 Service Pack 2.  
-   V1.4 (12 de Janeiro de 2010): Boletim actualizado: Correcção de informações de substituição do boletim para o Microsoft Office 2003 Service Pack 2.
