...
#### Soluções Alternativas para a Vulnerabilidade entre Domínios de Propriedades de Localização de Janelas - CVE-2008-2947
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade entre Domínios de Propriedades de Localização de Janelas - CVE-2008-2947
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade entre Domínios de Elementos HTML - CVE-2008-3472
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade entre Domínios de Processamento de Eventos - CVE-2008-3473
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Divulgação de Informações entre Domínios - CVE-2008-3474
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória não Inicializada - CVE-2008-3475
...
**O que faz a actualização?**    
A actualização modifica a forma como o Internet Explorer processa erros ao efectuar chamadas para objectos não inicializados ou eliminados.
...
Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2008-3476  
------------------------------------------------------------------------
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte o boletim [CVE-2008-3476](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3476).
  
#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2008-3476
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2008-3476
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2008-3476
...
<td style="border:1px solid black;">Para o Internet Explorer 5.01 Service Pack 4 em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB956390-IE501SP4-20080820.120000$\Spuninst<br />
<br />
Para o Internet Explorer 6 Service Pack 1 quando instalado em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB956390-IE6SP1-20080820.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/956390">Artigo 956390 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstal\KB956390$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para Windows XP:<br />
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB956390-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/956390">Artigo 956390 da Base de Dados de Conhecimento da Microsoft</a></td>
...
Utilize a ferramenta Adicionar ou Remover Programas no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB956390$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   David Bloom, por fornecer informações sobre a Vulnerabilidade entre Domínios de Elementos HTML (CVE-2008-3472)  
-   Gregory Rubin, por fornecer informações sobre a Vulnerabilidade entre Domínios de Processamento de Eventos (CVE-2008-3473)  
-   [Ivan Fratric](http://ifsec.blogspot.com/), a trabalhar com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória não Inicializada (CVE-2008-3475)  
-   Thierry Zoller, da [n.runs](http://www.nruns.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Objectos HTML (CVE-2008-3476)  
-   Lee Dagon, da [Composica](http://www.composica.com/), por fornecer informações sobre a Vulnerabilidade de Divulgação de Informações entre Domínios (CVE-2008-3474)
...
-   V1.1 (15 de Outubro de 2008): Corrigida uma entrada de verificação da chave de registo para o Windows Server 2003 e corrigidas ligações a Informações de Ficheiros.  
-   V1.2 (12 de Novembro de 2008): Correcção de uma entrada de verificação da chave de registo para o Internet Explorer 6 para todas as edições baseadas em x64 do Windows Server 2003 suportadas.
