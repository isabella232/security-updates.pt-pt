...
ms:assetid: 'ms09-023'
ms:contentKeyID: 61234742
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-023(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Windows Search poderia permitir a Divulgação de Informações (963093)
---------------------------------------------------------------------------------------
...
**Questões conhecidas.** O [Artigo 963093 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/963093) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões.
...
|-------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|---------------------------------------------|
| Windows XP Service Pack 2 e Windows XP Service Pack 3 | [Windows Search 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=759f22cb-ea7f-49dd-a200-19cb83fffd8d) | Divulgação de Informações   | Moderada                            | Nenhum                                      |
| Windows XP Professional x64 Edition Service Pack 2    | [Windows Search 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=50c56dd6-c34d-4632-a779-8bcf8fdb341b) | Divulgação de Informações   | Moderada                            | Nenhum                                      |
| Windows Server 2003 Service Pack 2                    | [Windows Search 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=e72ef31f-5161-4fe6-8ed3-6206e02cef31) | Divulgação de Informações   | Moderada                            | Nenhum                                      |
| Windows Server 2003 x64 Edition Service Pack 2        | [Windows Search 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=7ffc3680-f9bf-423b-96a7-102f4cc9c240) | Divulgação de Informações   | Moderada                            | Nenhum                                      |
...
| Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2 | Windows Search 4.0 |
...
<th style="border:1px solid black;" >Vulnerabilidade na Execução de Scripts no Windows Search - CVE-2009-0239</th>
...
Vulnerabilidade na Execução de Scripts no Windows Search - CVE-2009-0239  
------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de divulgação de informações no Windows Search devido à forma como são geradas as pré-visualizações de ficheiros. As tentativas de exploração desta vulnerabilidade requerem interacção com o utilizador. Um intruso que explorasse esta vulnerabilidade com sucesso poderia executar um script malicioso de HTML que poderia divulgar informações, reencaminhar dados do utilizador para terceiros ou aceder a quaisquer dados nos sistemas afectados a que o utilizador com sessão iniciada tivesse acesso. Tenha em atenção que a vulnerabilidade não permitiria que um intruso executasse código ou elevasse directamente os seus privilégios de utilizador, mas poderia ser utilizada para produzir informações que poderiam ser usadas para comprometer ainda mais o sistema afectado.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0239](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0239).
  
#### Factores Atenuantes para a Vulnerabilidade na Execução de Scripts no Windows Search - CVE-2009-0239
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Por predefinição, o componente do Windows Search não é pré-instalado no Microsoft Windows XP e Windows Server 2003. É um componente opcional disponível para transferência.  
-   O Windows Search instalado em edições suportadas do Windows Vista e Windows Server 2008 não é afectado por esta vulnerabilidade.
  
#### Soluções Alternativas para a Vulnerabilidade na Execução de Scripts no Windows Search - CVE-2009-0239
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade na Execução de Scripts no Windows Search - CVE-2009-0239
...
O Windows Search não restringe adequadamente o ambiente em que são executados scripts.
  
**O que é a Pesquisa do Windows?**    
O Windows Search permite capacidades de pesquisa instantânea dos ficheiros e tipos de dados mais comuns, como correio electrónico, contactos, calendário, agenda, documentos, fotografias, multimédia e outros formatos fornecidos por outras empresas. Estas capacidades permitem que os consumidores e os trabalhadores da informação possam encontrar, gerir e organizar de forma eficaz a crescente quantidade de dados comuns em ambientes domésticos e empresariais. Para obter mais informações, consulte o [Artigo 940157 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/940157).
  
**Como poderia um intruso utilizar a vulnerabilidade?**    
Um intruso que explorasse esta vulnerabilidade com sucesso poderia executar um script malicioso do lado do cliente. Se este script nocivo fosse executado, seria executado com permissão especial que normalmente não seria concedida a um script executado numa página Web na Internet. Estas permissões poderiam permitir a divulgação de informações confidenciais, o reencaminhamento de dados do utilizador para terceiros ou o acesso a dados nos sistemas afectados a que o utilizador com sessão iniciada tinha acesso.
  
**Como poderia um intruso explorar a vulnerabilidade?**    
Esta vulnerabilidade requer que um ficheiro especialmente concebido para o efeito seja colocado no sistema ou numa mensagem de correio electrónico numa caixa de correio indexado. Se um utilizador executasse uma pesquisa cujo primeiro resultado fosse este ficheiro, poderia ocorrer execução arbitrária de script de HTML. Se o ficheiro especialmente concebido para o efeito não for o primeiro resultado, o utilizador terá de seleccionar e pré-visualizar o ficheiro para que ocorra exploração.
...
A actualização de segurança resolve esta vulnerabilidade modificando a forma como o Windows Search restringe o ambiente em que são executados scripts.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB963093$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/963093">Artigo 963093 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Yair Amit, da [IBM Rational Application Security](http://www-01.ibm.com/software/rational/offerings/websecurity/webappsecurity.html), por fornecer informações sobre a Vulnerabilidade na Execução de Scripts no Windows Search (CVE-2009-0239)
