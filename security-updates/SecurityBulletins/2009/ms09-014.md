...
ms:assetid: 'ms09-014'
ms:contentKeyID: 61234733
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-014(v=Security.10)'
author: SharonSears
...
Data de publicação: 14 de abril de 2009 | Updated: 25 de agosto de 2009
...
Esta actualização de segurança resolve quatro vulnerabilidades comunicadas de forma privada e duas vulnerabilidades divulgadas publicamente no Internet Explorer. As vulnerabilidades poderiam permitir a execução remota de código se um utilizador visualizasse uma página Web especialmente concebida para o efeito utilizando o Internet Explorer ou se um utilizador se ligasse a um servidor de um intruso através de um protocolo HTTP. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Esta actualização de segurança está classificada como Crítica para o Internet Explorer 5.01 e Internet Explorer 6 Service Pack 1, executados em edições suportadas do Microsoft Windows 2000; Internet Explorer 6 e Internet Explorer 7 executados em edições suportadas do Windows XP; e Internet Explorer 7 executado em edições suportadas do Windows Vista. Para o Internet Explorer 6 e para o Internet Explorer 7 executados em edições suportadas do Windows Server 2003 e Windows Server 2008, esta actualização de segurança está classificada como Importante. Para mais informações consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve estas vulnerabilidades modificando a forma como o Internet Explorer procura ficheiros no sistema para carregar, executa a validação das respostas de autenticação, processa erros de transição quando navega entre páginas Web e processa objectos de memória. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Questões conhecidas.** O [Artigo 963027 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/963027) documenta as questões actualmente conhecidas que os clientes podem verificar quando instalam esta actualização de segurança. O artigo também documenta soluções recomendadas para estas questões. Quando as questões actualmente conhecidas e soluções recomendadas software dizem respeito apenas às edições específicas deste software, este artigo não fornece ligações a outros artigos.
...
| Windows Server 2003 com SP1 para sistemas baseados em Itanium e Windows Server 2003 com SP2 para sistemas baseados em Itanium | Windows Internet Explorer 8 |
...
| Windows Server 2008 para sistemas baseados em Itanium                                                                         | Windows Internet Explorer 8 |
...
Os pormenores sobre as informações do ficheiro podem ser encontrados no [Artigo 963027 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/963027).

**Como é que esta actualização de segurança está relacionada com o boletim MS09-013?**  
A Vulnerabilidade de Reflexão de Credenciais WinINet, [CVE-2009-0550](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550), descrita neste boletim de segurança, também afecta os serviços HTTP do Windows. A Microsoft recomenda que os utilizadores instalem também a actualização de segurança fornecida pelo boletim [MS09-013](http://go.microsoft.com/fwlink/?linkid=139852), Vulnerabilidades nos Serviços HTTP do Windows poderiam permitir Execução Remota de Código (960803).

**Como é que esta actualização de segurança está relacionada com o boletim MS09-015?**  
A Vulnerabilidade de Execução Remota de Código de Ameaça Mista, [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540), descrita neste boletim de segurança, também afecta a função SearchPath no Windows. A Microsoft recomenda que os utilizadores instalem também a actualização de segurança fornecida pelo boletim [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803), Vulnerabilidade de Ameaça Mista no SearchPath poderia permitir Elevação de Privilégios (959426).

**Esta actualização contém outras alterações de segurança em termos de funcionalidade?**  
Sim. Para além das alterações indicadas na secção de **Informações sobre as vulnerabilidades** deste boletim, esta actualização inclui as seguintes alterações defensivas profundas:

-   Uma alteração que corresponde à correcção no boletim [MS09-010](http://go.microsoft.com/fwlink/?linkid=139849) (Vulnerabilidade nos Conversores de Texto do WordPad e do Office poderia permitir Execução Remota de Código (960477))
-   Uma alteração de reforço do protocolo **About:** para restringir falsificações (spoofing)
-   Alteração que corresponde à correcção no boletim [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803) (Vulnerabilidade de Ameaça Mista no SearchPath poderia permitir Elevação de Privilégios (959426)). Tal fornece factores atenuantes para a questão de ameaça combinada que envolve o Safari da Apple, o Microsoft Windows e o Microsoft Internet Explorer, que foi conhecida publicamente e a que foi atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540). Consulte também as Perguntas Mais Frequentes abaixo sobre a ameaça mista**.**

**Esta actualização resolve a questão conhecida para o boletim MS09-002, documentada no Artigo 967941 da Base de Dados de Conhecimento da Microsoft?**  
Sim, esta actualização resolve a questão conhecida para o boletim [MS09-002](http://go.microsoft.com/fwlink/?linkid=139814), documentada no [Artigo 967941 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/967941): "A navegação é cancelada quando navega para páginas Web que se encontram em diferentes zonas de segurança do Internet Explorer".

**Se eu já tiver aplicado a solução alternativa para o registo quanto à questão documentada no Artigo 967941 da Base de Dados de Conhecimento da Microsoft, necessito de fazer mais alguma coisa?**  
Se seguiu as instruções no [Artigo 967941 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/967941) para editar manualmente ou executar o assistente para editar o registo a fim de activar a chave de controlo de funcionalidade que desactiva a funcionalidade introduzida no boletim [MS09-002](http://go.microsoft.com/fwlink/?linkid=139814), então agora deve reverter esta chave de controlo de funcionalidade. Para obter instruções, consulte o [Artigo 967941 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/967941).

**Se aplicar apenas esta actualização, estarei completamente protegido contra a ameaça mista descrita em CVE-2008-2540?**  
Não. Terá de activar separadamente a protecção defensiva profunda fornecida nesta Actualização de Segurança Cumulativa para o Internet Explorer, além de aplicar o boletim [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803) (Vulnerabilidade de Ameaça Mista no SearchPath poderia permitir Elevação de Privilégios (959426)). No entanto, deve verificar se a activação da protecção defensiva profunda contra a ameaça mista é apropriada para o seu ambiente.

Para activar a protecção defensiva profunda, execute os seguintes passos:

1.  Guarde o que se segue num ficheiro com a extensão .REG, como por exemplo, Enable\_SearchPath.reg, para adicionar a chave de controlo de funcionalidade:
...
2.  Depois execute Enable\_SearchPath.reg, usando o seguinte comando numa linha de comandos com privilégios elevados:
    Regedit.exe /s Enable\_SearchPath.reg

Para mais informações sobre a questão da ameaça mista, consulte o boletim [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803) (Vulnerabilidade de Ameaça Mista no SearchPath poderia permitir Elevação de Privilégios (959426)) e o número de Vulnerabilidade e Exposição Comum [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540).

**É possível activar a protecção defensiva profunda no Internet Explorer para a vulnerabilidade de ameaça mista no Microsoft Windows 2000?**
Não. Devido a alterações ao nível da arquitectura, a protecção defensiva profunda incluída com este boletim para a vulnerabilidade de ameaça mista, [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540), não é aplicável à plataforma do Microsoft Windows 2000. A activação da protecção defensiva profunda para o Internet Explorer no Microsoft Windows 2000 não será afectada. No entanto, a Microsoft não tem conhecimento de quaisquer vectores de ataque válidos dirigidos a esta vulnerabilidade em sistemas com o Microsoft Windows 2000.
...
<th style="border:1px solid black;" >
Vulnerabilidade de Execução Remota de Código de Ameaça Mista - CVE-2008-2540
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Reflexão de Credenciais WinINet - CVE-2009-0550
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória de Transição de Páginas - CVE-2009-0551
</th>
<th style="border:1px solid black;" >
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Internet Explorer 7 no Windows Vista x64 Edition e no Windows Vista x64 Edition Service Pack 1
</td>
<td style="border:1px solid black;">
Não aplicável
</td>
...
#### Factores Atenuantes para a Vulnerabilidade de Execução Remota de Código de Ameaça Mista - CVE-2008-2540

A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:

-   O Windows Internet Explorer 8 não é afectado por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Execução Remota de Código de Ameaça Mista - CVE-2008-2540

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Execução Remota de Código de Ameaça Mista - CVE-2008-2540
...
Um intruso poderia explorar esta vulnerabilidade criando um ficheiro especialmente concebido para o efeito para que o utilizador o transferisse para a área de trabalho utilizando o Safari da Apple. Então, o intruso poderia alojar um Web site especialmente concebido para o efeito, destinado a explorar esta vulnerabilidade através do Internet Explorer, persuadindo depois um utilizador a ver o Web site em questão. O intruso também poderia tirar partido de Web sites corrompidos ou Web sites que aceitam ou alojam conteúdos ou anúncios fornecidos pelo utilizador. Estes Web sites podem conter conteúdos especialmente concebidos para o efeito, que poderiam explorar esta vulnerabilidade. Contudo, em qualquer dos casos, o intruso não teria forma de forçar os utilizadores a visitar estes Web sites. Em vez disso, o intruso teria de persuadir os utilizadores a visitar o Web site, levando-os normalmente a clicar numa hiperligação numa mensagem de correio electrónico, ou num pedido de mensagem instantânea que leva o utilizador para o Web site do intruso. Também poderia ser possível exibir conteúdos Web nocivos concebidos especialmente para o efeito, usando espaços de publicidade como banners, ou usando outros métodos para entregar conteúdos Web a sistemas afectados.

**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**  
Todos os sistemas, tais como estações de trabalho e servidores, em que os utilizadores transferem ficheiros e iniciam aplicações estão susceptíveis a esta vulnerabilidade.

**O que faz a actualização?**  
A actualização modifica a forma como o Internet Explorer carrega ficheiros a partir da área de trabalho.

**Por que razão é atribuído a esta vulnerabilidade e à Vulnerabilidade de Elevação de Privilégios de Ameaça Mista o mesmo número de CVE (CVE-2008-2540) no boletim MS09-015, Vulnerabilidade de Ameaça Mista no SearchPath poderia permitir Elevação de Privilégios (959426)?**
Por um lado, o [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540) afecta tanto o Internet Explorer 7 para o Windows XP Service Pack 2 e Windows XP Service Pack 3 como o Internet Explorer 7 para o Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2 e, por outro lado, afecta a função SearchPath do Windows. A Microsoft recomenda que os utilizadores instalem também a actualização de segurança fornecida pelo boletim [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803), Vulnerabilidade de Ameaça Mista no SearchPath poderia permitir Elevação de Privilégios (959426). Uma alteração defensiva profunda para esta vulnerabilidade nesta actualização também corresponde à correcção no boletim [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803). Consulte também nas Perguntas Mais Frequentes "Esta actualização contém outras alterações de segurança em termos de funcionalidade?", na secção de **Perguntas Mais Frequentes relativas a esta Actualização de Segurança.**

**Quando este boletim de segurança foi publicado, esta vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Esta vulnerabilidade foi divulgada publicamente. Foi-lhe atribuído o número de Vulnerabilidade e Exposição Comum [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540). Esta vulnerabilidade foi previamente descrita no [Aviso de Segurança da Microsoft 953818](http://technet.microsoft.com/security/advisory/953818).
...
#### Factores Atenuantes para a Vulnerabilidade de Reflexão de Credenciais WinINet - CVE-2009-0550
...
-   O vector de ataque mais provável para explorar esta vulnerabilidade seria o SMB. A firewall do Windows Vista bloqueia o tráfego SMB por predefinição. Um cliente vulnerável necessitaria de estar a executar um serviço que aceitasse autenticação NTLM para que um ataque fosse bem sucedido e que, consequentemente, as credenciais fossem reflectidas. Por predefinição, se um sistema Vista não estiver implementado num ambiente de domínio Windows, o perfil da firewall do Windows Vista é "público", bloqueando assim o tráfego SMB.
-   O Internet Explorer não fornece credenciais automaticamente à zona da Internet. Um utilizador teria de fornecer credenciais através do browser.
-   O Windows Internet Explorer 8 não é afectado por esta vulnerabilidade.

#### Soluções Alternativas para a Vulnerabilidade de Reflexão de Credenciais WinINet - CVE-2009-0550

A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Reflexão de Credenciais WinINet - CVE-2009-0550

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**O que provoca a vulnerabilidade?**  
O WinINet não dá a permissão correcta às protecções de reflexão de credenciais NTLM para garantir que as credenciais do utilizador não são reflectidas para um intruso e usadas contra o utilizador.
...
**Como poderia um intruso explorar a vulnerabilidade?**  
Esta vulnerabilidade requer que um utilizador com uma implementação afectada do WinINet aceda a um servidor especialmente concebido para o efeito.
...
**O que é o WinINet?**  
O WinINet refere-se à interface de programação da aplicação (API) de Internet do Windows que permite que as aplicações interajam com os protocolos de padrões como o FTP e o HTTP para aceder aos recursos de Internet. À medida que os padrões evoluem, o WinINet processa as alterações nos protocolos subjacentes, activando as aplicações para manter um comportamento consistente.

**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**  
Esta vulnerabilidade necessita que um utilizador tenha iniciado sessão, visite um Web site e tenha uma partilha de ficheiros e de impressora que permita tráfego SMB para que ocorram quaisquer acções nocivas. Deste modo, qualquer sistema onde o Internet Explorer seja frequentemente utilizado num ambiente de domínio, como as estações de trabalho ou servidores de terminal, está mais susceptível a esta vulnerabilidade.

**O que faz a actualização?**  
A actualização modifica a forma como o WinINet executa a validação das respostas de autenticação para impedir a reprodução de credenciais.

**Por que razão é atribuído a esta vulnerabilidade e à Vulnerabilidade de Reflexão de Credenciais dos Serviços HTTP do Windows o mesmo número de CVE (CVE-2009-0550) no boletim MS09-013, Vulnerabilidades nos Serviços HTTP do Windows poderiam permitir Execução Remota de Código (960803)?**
O CVE-2009-0550 afecta tanto o WinINet, conforme utilizado pelo Internet Explorer, como os Serviços HTTP do Windows, um componente do sistema operativo Windows. A Microsoft recomenda que os utilizadores instalem também a actualização de segurança fornecida pelo boletim [MS09-013](http://go.microsoft.com/fwlink/?linkid=139852), Vulnerabilidades nos Serviços HTTP do Windows poderiam permitir Execução Remota de Código (960803).
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer processa a transição ao navegar entre páginas Web. Deste modo, a memória do sistema pode ser corrompida de um modo que permitiria que um intruso executasse um código arbitrário se um utilizador visitasse um Web especialmente concebido para o efeito. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Se um utilizador tiver sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0551).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória de Transição de Páginas - CVE-2009-0551
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Transição de Páginas - CVE-2009-0551
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória de Transição de Páginas - CVE-2009-0551

**Qual é a abrangência desta vulnerabilidade?**  
Esta é uma vulnerabilidade de execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

**O que provoca a vulnerabilidade?**  
Quando o Internet Explorer processa a transição ao navegar entre páginas Web, a memória pode ficar corrompida de tal forma que um intruso poderia executar código arbitrário no contexto do utilizador com sessão iniciada.
...
**O que faz a actualização?**  
A actualização modifica a forma como o Internet Explorer processa erros de transição ao navegar entre páginas Web.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0552](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0552).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0552
...
-   Como pré-definição, todas as versões suportadas do Microsoft Outlook e do Microsoft Outlook Express abrem mensagens de correio electrónico em HTML na zona de Sites restritos. A zona de Sites restritos ajuda a atenuar ataques que tentem explorar esta vulnerabilidade, ao impedir a utilização de Scripts Activos e controlos ActiveX durante a leitura de mensagens de correio electrónico em HTML. Contudo, se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003 e no Windows Server 2008 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://go.microsoft.com/fwlink/?linkid=92039). Este modo define o nível de segurança para a zona da Internet como Alto. Este é um factor atenuante para Web sites que não adicionou à Zona de sites fidedignos do Internet Explorer. Consulte a subsecção de Perguntas Mais Frequentes desta secção da vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Windows Internet Explorer 7 e o Windows Internet Explorer 8 não são afectados por esta vulnerabilidade.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0552
...
**O que faz a actualização?**  
A actualização modifica a forma como o Internet Explorer processa objectos de memória.
...
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0553).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0553
...
-   Como pré-definição, todas as versões suportadas do Microsoft Outlook e do Microsoft Outlook Express abrem mensagens de correio electrónico em HTML na zona de Sites restritos. A zona de Sites restritos ajuda a atenuar ataques que tentem explorar esta vulnerabilidade, ao impedir a utilização de Scripts Activos e controlos ActiveX durante a leitura de mensagens de correio electrónico em HTML. Contudo, se um utilizador clicar numa hiperligação numa mensagem de correio electrónico, poderá continuar vulnerável à exploração desta vulnerabilidade através do cenário de ataque baseado na Web.
-   Por predefinição, o Internet Explorer no Windows Server 2003 e no Windows Server 2008 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://go.microsoft.com/fwlink/?linkid=92039). Este modo define o nível de segurança para a zona da Internet como Alto. Este é um factor atenuante para Web sites que não adicionou à Zona de sites fidedignos do Internet Explorer. Consulte a subsecção de Perguntas Mais Frequentes desta secção da vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.
-   O Microsoft Internet Explorer 5.01 Service Pack 4 e o Windows Internet Explorer 8 não são afectados por esta vulnerabilidade.
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0553
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acede a um objecto que não tenha sido inicializado ou que tenha sido eliminado. Um intruso poderia explorar a vulnerabilidade criando uma página web especialmente concebida para o efeito. Quando um utilizador visualizasse a página Web, a vulnerabilidade poderia permitir a execução remota de código. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador com sessão iniciada.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0554).

#### Factores Atenuantes para a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0554
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada - CVE-2009-0554
...
<td style="border:1px solid black;">Para o Internet Explorer 5.01 Service Pack 4 em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB963027-IE501SP4-20090303.120000$\Spuninst<br />
<br />
Para o Internet Explorer 6 Service Pack 1 quando instalado em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB963027-IE6SP1-20090303.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/963027">Artigo 963027 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 for all supported editions of Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB963027$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\ie7updates\KB963027-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/963027">Artigo 963027 da Base de Dados de Conhecimento da Microsoft</a></td>
...
-   [Aviv Raff](http://aviv.raffon.net/), por fornecer informações sobre a Vulnerabilidade de Execução Remota de Código de Ameaça Mista (CVE-2008-2540)  
-   Michal Zalewski, da [Google Inc.](http://www.google.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória de Transição de Páginas (CVE-2009-0551)  
-   Ivan Fratric, da [iSIGHT Partners Labs](http://www.isightpartners.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2009-0552)  
-   Skylined, da [Google Inc.](http://www.google.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2009-0553)  
-   ADLab, da [VenusTech](http://www.venustech.com.cn/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2009-0554)
...
-   V1.1 (15 de Abril de 2009): Entradas adicionadas à secção de **Perguntas Mais Frequentes relativas a esta Actualização de Segurança**, assim como na secção da Vulnerabilidade sobre o CVE-2008-2540 para explicar a relação entre o CVE-2008-2540 neste boletim e no boletim MS09-015.  
-   V1.2 (22 de Abril de 2009): Corrigida a pergunta "É possível activar a protecção defensiva profunda no Internet Explorer para a vulnerabilidade de ameaça mista no Microsoft Windows 2000?", na secção de **Perguntas Mais Frequentes relativas a esta Actualização de Segurança**.  
-   V1.3 (25 de Agosto de 2009): Corrigida a chave de controlo de funcionalidade SearchPath especificada na entrada sobre CVE-2008-2540 na secção **Perguntas Mais Frequentes relativas a esta Actualização de Segurança**.
