...
Como exemplo, o seguinte valor de registo permite a utilização da Chave de Controlo de Funcionalidade, **FEATURE\_RESTRICT\_OBJECT\_DATA\_ATTRIBUTE**, para todos processos.
...
#### Soluções Alternativas para a Vulnerabilidade de Corrupção de Memória de Objectos HTML - CVE-2009-1918
...
<td style="border:1px solid black;">Para o Internet Explorer 5.01 Service Pack 4 em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo, ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB972260-IE501SP4- 20090722.120000$\Spuninst<br />
<br />
Para o Internet Explorer 6 Service Pack 1* quando instalado em todas as edições suportadas do Windows 2000:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo, ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB972260-IE6SP1-20090722.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/972260">Artigo 972260 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
**\***Os clientes que estão a reinstalar a actualização para o Internet Explorer 6 Service Pack 1 nas versões de idioma coreano do Internet Explorer 6 Service Pack 1 para corrigir uma questão conhecida, devem consultar a entrada respeitante à revisão datada de 4 de Agosto de 2009 na secção **Perguntas Mais Frequentes relativas a esta Actualização de Segurança**.
...
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 for all supported editions of Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB972260$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está na pasta %Windir%\ie7updates\KB972260-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas do Windows XP:<br />
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está na pasta %Windir%\ie8updates\KB972260-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/972260">Artigo 972260 da Base de Dados de Conhecimento da Microsoft</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas baseadas em Itanium do Windows Server 2003:<br />
...
Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está na pasta %Windir%\$NTUninstallKB972260$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições suportadas baseadas em Itanium do Windows Server 2008:<br />
...
-   Peter Vreugdenhil, da [VeriSign iDefense Labs](http://labs.idefense.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória (CVE-2009-1917)  
-   Wushi e Ling, da [team509](http://www.team509.com/), a trabalhar com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecerem informações sobre a Vulnerabilidade de Corrupção de Memória de Objectos HTML (CVE-2009-1918)  
-   Peter Vreugdenhil, a trabalhar com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre a Vulnerabilidade de Corrupção de Memória Não Inicializada (CVE-2009-1919)
...
-   V2.0 (4 de Agosto de 2009): Actualização publicada de novo para o Microsoft Internet Explorer 6 Service Pack 1 no Microsoft Windows 2000 Service Pack 4. Todos os clientes que já tenham instalado a actualização original para o Internet Explorer 6 Service Pack 1 no Microsoft Windows 2000 Service Pack 4 já estão protegidos contra esta vulnerabilidade. No entanto, os clientes que utilizam a versão de idioma coreano do Internet Explorer 6 Service Pack 1 podem reinstalar a actualização para o Internet Explorer 6 Service Pack 1 nos seus sistemas Windows 2000 de forma a obterem as mesmas protecções, para além de resolverem um problema de impressão. Consulte a entrada na secção **Perguntas Mais Frequentes relativas a esta Actualização de Segurança**.
