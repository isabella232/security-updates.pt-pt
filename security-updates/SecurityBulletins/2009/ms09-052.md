---
TOCTitle: 'MS09-052'
Title: 'Microsoft Security Bulletin MS09-052 - Crítica'
ms:assetid: 'ms09-052'
ms:contentKeyID: 61234771
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-052(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS09-052 - Crítica
==============================================

Vulnerabilidade no Windows Media Player poderia permitir a Execução Remota de Código (974112)
---------------------------------------------------------------------------------------------
...
Esta actualização de segurança resolve uma vulnerabilidade no Windows Media Player, comunicada de forma privada. A vulnerabilidade poderia permitir execução remota de código se um ficheiro ASF especialmente concebido para o efeito fosse reproduzido no Microsoft Windows Media Player 6.4. Um intruso que conseguisse explorar esta vulnerabilidade com êxito poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.

Esta actualização de segurança está classificada como Crítica para o Microsoft Windows Media Player 6.4 quando instalado em todas as edições suportadas do Microsoft Windows 2000, Windows XP e Windows Server 2003. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve a vulnerabilidade corrigindo a forma como o Windows Media Player 6.4 processa ficheiros ASF especialmente concebidos para o efeito. Para mais informações sobre a vulnerabilidade, consulte a subsecção de Perguntas Mais Frequentes (FAQ) quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
|-------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                 | [Microsoft Windows Media Planger 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=13035ef7-7e47-487c-8b7c-7795d33ce7de) | Execução Remota de Código   | Crítica                             | Nenhum                                                    |
| Windows XP Service Pack 2 e Windows XP Service Pack 3 | [Microsoft Windows Media Planger 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=b2efe1ac-d8d7-41bb-b87d-fc5e22afef0f) | Execução Remota de Código   | Crítica                             | [MS08-076](http://go.microsoft.com/fwlink/?linkid=125419) |
| Windows XP Professional x64 Edition Service Pack 2    | [Microsoft Windows Media Planger 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=a9e7dfd8-7ba1-4f14-8e60-92ef00d91467) | Execução Remota de Código   | Crítica                             | [MS08-076](http://go.microsoft.com/fwlink/?linkid=125419) |
| Windows Server 2003 Service Pack 2                    | [Microsoft Windows Media Planger 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=5f82d01c-573e-425e-b9f2-86a54f377b19) | Execução Remota de Código   | Crítica                             | [MS08-076](http://go.microsoft.com/fwlink/?linkid=125419) |
| Windows Server 2003 x64 Edition Service Pack 2        | [Microsoft Windows Media Planger 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=65e9036e-2e1b-40ff-a84b-c507107bcce8) | Execução Remota de Código   | Crítica                             | [MS08-076](http://go.microsoft.com/fwlink/?linkid=125419) |
...
| Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2                                                   | Não aplicável |
| Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2               | Não aplicável |
| Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2                   | Não aplicável |
| Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2         | Não aplicável |
...
<span></span>
**Não tenho o Windows Media Player 6.4 no meu sistema. Por que razão está a ser-me oferecida esta actualização?**  
Depois de fazer a actualização do Microsoft Windows Media Player 6.4 para uma versão posterior do Windows Media Player, alguns componentes relacionados com o Microsoft Windows Media Player 6.4 não são completamente removidos do sistema para garantir retrocompatibilidade. Estes componentes são actualizados por este boletim. Embora as versões posteriores do Windows Media Player não sejam afectadas por esta vulnerabilidade, um utilizador poderia ainda estar vulnerável se um programa chamasse explicitamente estes componentes mais antigos durante a reprodução de conteúdos multimédia. Se não aplicou esta actualização depois da actualização do Microsoft Windows Media Player 6.4, as ferramentas de análise automáticas como o MBSA indicarão que o seu sistema está vulnerável, mesmo que o Microsoft Windows Media Player 6.4 não seja o leitor multimédia predefinido no seu sistema. O Microsoft Windows Media Player 6.4 é a única versão do Windows Media Player afectado pela questão resolvida neste boletim. Contudo, todos os clientes que recebam automaticamente a actualização devem aplicá-la para garantir que estão protegidos contra esta vulnerabilidade.
...
**De que forma este boletim está relacionado com as vulnerabilidades descritas no boletim MS09-051, Vulnerabilidade no Runtime do Windows Media Player poderia permitir a Execução Remota de Código?**  
Este boletim não está relacionado com o boletim [MS09-051](http://go.microsoft.com/fwlink/?linkid=125438), Vulnerabilidade no Runtime do Windows Media Player poderia permitir a Execução Remota de Código. Os utilizadores devem instalar ambas as actualizações para garantir que estão totalmente protegidos.
...
<th style="border:1px solid black;" >Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados no WMP - CVE-2009-2527</th>
<th style="border:1px solid black;" >Classificação de Gravidade Agregada</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 no Microsoft Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><strong>Crítica</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 no Windows XP Service Pack 2 e Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><strong>Crítica</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 no Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 no Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows Media Player 6.4 no Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
...
Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados no WMP - CVE-2009-2527  
--------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código no Windows Media Player 6.4. Um intruso poderia explorar a vulnerabilidade construindo um ficheiro ASF especialmente concebido para o efeito que poderia permitir a execução remota de código quando reproduzido utilizando o Windows Media Player 6.4. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-2527](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2527).
  
#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados no WMP - CVE-2009-2527
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso que explorasse com sucesso esta vulnerabilidade poderia obter os mesmos privilégios que o utilizador local. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.  
-   A vulnerabilidade não pode ser automaticamente explorada através de correio electrónico. Para um ataque de correio electrónico poder ser bem sucedido, é necessário que um utilizador abra um anexo recebido numa mensagem de correio electrónico.  
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados no WMP - CVE-2009-2527
  
Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:
  
-   **Modificar a Lista de Controlo de Acesso (ACL) no ficheiro strmdll.dll**
  
    Para modificar a ACL no strmdll.dll para ser mais restrita no Windows XP e Windows Server 2003, execute o seguinte comando a partir de uma linha de comandos com privilégios de administrador:
    ...
    **Impacto da solução alternativa.** O Windows Media Player 6.4 não poderá reproduzir ficheiros multimédia.
  
    **Como anular esta solução alternativa.**
  
    No Windows XP e Windows Server 2003, execute o seguinte comando a partir de uma linha de comandos com privilégios de administrador:
...
-   **Para tipos de pastas não-multimédia, o vector de ataque da Shell do Windows poder ser atenuado utilizando pastas clássicas do Windows**
    ...
    Para alterar as opções de pastas, execute os seguintes passos:
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados no WMP - CVE-2009-2527
...
O Windows Media Player 6.4 processa incorrectamente ficheiros ASF especialmente concebidos para o efeito.
...
Se um ficheiro ASF malicioso estiver alojado num computador com o software afectado, navegar na pasta no Windows Explorer analisará o ficheiro o suficiente para activar a vulnerabilidade.
  
**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**    
Qualquer sistema que utilize o Windows Media Player 6.4, como estações de trabalho ou servidores de terminal, estaria susceptível a esta vulnerabilidade.
  
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade corrigindo a forma como o Windows Media Player 6.4 processa ficheiros ASF especialmente concebidos para o efeito.
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo, ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB974112_WM41$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/974112">Artigo 974112 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo, ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB974112$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/974112">Artigo 974112 da Base de Dados de Conhecimento da Microsoft</a></td>
...
-   Yamata Li, da [Palo Alto Networks](http://www.paloaltonetworks.com/). por fornecer informações sobre a Vulnerabilidade de Sobrecarga de Área Dinâmica para Dados no WMP (CVE-2009-2527)
...
-   V1.1 (29 de Outubro de 2009): Remoção de uma solução alternativa. Foi também adicionada uma entrada na secção de **Perguntas Mais Frequentes relativas a esta Actualização de Segurança** para clarificar a razão pela qual alguns clientes sem o Windows Media Player 6.4 nos seus sistemas poderão estar a receber esta actualização.
-   V1.2 (12 de Janeiro de 2010): Correcção de chaves de registo para o Windows Media Player 6.4 no Microsoft Windows 2000 Service Pack 4. Trata-se apenas de uma actualização informativa.
