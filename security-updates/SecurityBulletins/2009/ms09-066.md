...
ms:assetid: 'ms09-066'
ms:contentKeyID: 61234785
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-066(v=Security.10)'
author: SharonSears
...
Vulnerabilidade no Active Directory poderia permitir Negação de Serviço (973309)
--------------------------------------------------------------------------------
...
<th style="border:1px solid black;" >
Vulnerabilidade de Sobrecarga de Pilha Recursiva em LSASS - CVE-2009-1928  
</th>
<th style="border:1px solid black;" >
...
<span></span>
Existe uma vulnerabilidade de negação de serviço em implementações do Active Directory no Microsoft Windows 2000 Server, Windows Server 2003 e Windows Server 2008. A vulnerabilidade também existe em implementações do Active Directory Application Mode (ADAM) quando instalado no Windows XP e Windows Server 2003 e do Active Directory Lightweight Directory Services (AD LDS) no Windows Server 2008. A vulnerabilidade deve-se à exaustão de espaço de pilha durante a execução de determinados tipos de pedidos LDAP ou LDAPS. Um intruso que explorasse esta vulnerabilidade com sucesso poderia fazer com que o sistema afectado deixasse de responder.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-1928](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1928).

#### Factores Atenuantes para a Vulnerabilidade de Sobrecarga de Pilha Recursiva em LSASS - CVE-2009-1928
...
#### Soluções Alternativas para a Vulnerabilidade de Sobrecarga de Pilha Recursiva em LSASS - CVE-2009-1928
...
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Sobrecarga de Pilha Recursiva em LSASS - CVE-2009-1928
...
O serviço LDAP processa incorrectamente pedidos LDAP ou LDAPS específicos de uma forma que pode provocar exaustão do espaço de pilha.
...
O Active Directory Lightweight Directory Services (AD LDS) é um modo independente do Active Directory que fornece serviços de directório dedicados para aplicações. O AD LDS está disponível no Windows Server 2008 e posteriores e substitui o Active Directory Application Mode (ADAM), que estava disponível no Windows XP e Windows Server 2003.
...
Por predefinição, o tráfego LDAP é transmitido de forma não segura. Contudo, é possível tornar confidencial o tráfego LDAP e protegê-lo contra modificação através da utilização da tecnologia Secure Sockets Layer (SSL) / Transport Layer Security (TLS). Os administradores podem activar o LDAP através de SSL (LDAPS) instalando um certificado digital devidamente formatado de uma autoridade com certificação da Microsoft (CA) ou de uma entidade CA que não seja da Microsoft, de acordo com as orientações no [Artigo 321051 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/321051).
...
Um intruso que explorasse esta vulnerabilidade com sucesso poderia fazer com que o sistema de um utilizador deixasse de responder e tivesse de ser reiniciado.

**Como poderia um intruso explorar a vulnerabilidade?**  
Um intruso poderia tentar explorar a vulnerabilidade enviando um pacote LDAP ou LDAPS especialmente concebido para o efeito para o servidor ADAM, AD LDS ou Active Directory. No Microsoft Windows 2000 Server, um utilizador anónimo com acesso à rede visada poderia entregar um pacote de rede especialmente concebido para o efeito ao sistema afectado de forma a explorar esta vulnerabilidade. Em todas as outras plataformas afectadas, o intruso teria de ter credenciais de autenticação válidas para explorar esta vulnerabilidade.

**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**  
O Lightweight Directory Access Protocol (LDAP) é necessário para o Active Directory, ADAM e AD LDS. Por isso, qualquer sistema executado como servidor ADAM, AD LDS ou Active Directory é afectado por esta vulnerabilidade.

**O que faz a actualização?**  
A actualização resolve a vulnerabilidade processando correctamente pedidos LDAP ou LDAPS mal formados.
...
<td style="border:1px solid black;">Para o Active Directory no Microsoft Windows 2000 Server:<br />
...
<td style="border:1px solid black;">Para o Active Directory no Microsoft Windows 2000 Server, utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo, ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB973037$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/973037">Artigo 973037 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para o Active Directory Application Mode (ADAM) no Windows XP Service Pack 2 e Windows XP Service Pack 3:<br />
WindowsXP-KB973039-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory Application Mode (ADAM) no Windows XP Professional x64 Edition Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo, ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB973039$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/973039">Artigo 973039 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory Application Mode (ADAM) no Windows Server 2003 Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory Application Mode (ADAM) no Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB973039-x64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory Application Mode (ADAM) no Windows Server 2003:<br />
KB973039.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Informações adicionais</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Remoção</strong></td>
<td style="border:1px solid black;">Para o Active Directory, utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo, ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB973037$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory Application Mode (ADAM), utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB973039$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Para o Active Directory no Windows Server 2003, consulte o <a href="http://support.microsoft.com/kb/973037">Artigo 973037 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory Application Mode (ADAM) no Windows Server 2003, consulte o <a href="http://support.microsoft.com/kb/973039">Artigo 973039 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Para o Active Directory no Windows Server 2003:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalação sem intervenção do utilizador</td>
<td style="border:1px solid black;">Para o Active Directory e o Active Directory Lightweight Directory Service (AD LDS) em todas edições suportadas de 32 bits do Windows Server 2008:<br />
Windows6.0-KB973037-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Active Directory e o Active Directory Lightweight Directory Service (AD LDS) em todas edições suportadas baseadas em x64 do Windows Server 2008:<br />
