...
ms:assetid: 'ms09-058'
ms:contentKeyID: 61234777
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-058(v=Security.10)'
---
...
Vulnerabilidades no Kernel do Windows poderiam permitir Elevação de Privilégios (971486)
----------------------------------------------------------------------------------------

Data de publicação: 13 de outubro de 2009 | Updated: 21 de dezembro de 2009
...
Esta actualização de segurança resolve várias vulnerabilidades no kernel do Windows, comunicadas de forma privada. A mais severa das vulnerabilidades poderia permitir elevação de privilégios se um intruso iniciasse sessão no sistema e executasse uma aplicação especialmente concebida para o efeito. Um intruso teria que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar qualquer uma destas vulnerabilidades. As vulnerabilidades não poderiam ser exploradas remotamente ou por utilizadores anónimos.

Esta actualização de segurança está classificada como Importante para edições suportadas do Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008; e Moderada para o Service Pack 2 de todas as edições do Windows Vista e Windows Server 2008. Para mais informações, consulte a subsecção **Software Afectado e Software Não Afectado**, nesta secção.

A actualização de segurança resolve as vulnerabilidades garantindo que o kernel do Windows executa correctamente a truncagem de valores de 64 bits, garantindo que o kernel do Windows valida correctamente dados num ficheiro executável, e garantindo que o kernel do Windows limpa excepções sob condições de erro. Para mais informações sobre as vulnerabilidades, consulte a subsecção de Perguntas Mais Frequentes quanto à vulnerabilidade específica na secção seguinte, **Informações sobre as vulnerabilidades**.
...
**Questões conhecidas.** [Microsoft Knowledge Base Article 971486](http://support.microsoft.com/kb/971486) documenta a questão que os clientes podem encontrar ao instalar esta actualização de segurança. O artigo documenta também srecomendações de solução para esta questão.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|-------------------------------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=bdfa6583-28a2-4d6b-91d2-157a8518b664)                                | Elevação de Privilégios     | Importante                          | [MS07-022](http://go.microsoft.com/fwlink/?linkid=85165)  |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cece4c55-0756-4357-9d2d-6709e8426068)                | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5459b7d4-1fab-4a04-ab9d-b8323505c1e2)                   | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1e3f3842-f8fd-4969-a2cf-706db38d7580)                                   | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=95286b8d-4b53-4e6c-af59-e9e18fad3559)                       | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2003 com SP2 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=faef714b-5f46-47f2-bea7-881df05a1bc0)        | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=acf6f3e6-282e-4f05-9060-8d0ebb874b97)                         | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
...
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=13a3fe0b-e300-4568-aa08-d586ab8d5434) | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
...
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=71aec6f6-a36b-465e-8885-b094dfd30423)\*                       | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
...
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=88f4189f-71fe-404a-869e-3f76692acf94)\*                  | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
...
| [Windows Server 2008 para sistemas baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c)                | Elevação de Privilégios     | Importante                          | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2008 para sistemas baseados em Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c) | Negação de Serviço          | Moderada                            | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Fluxo Insuficiente de Números Inteiros no Kernel do Windows - CVE-2009-2515</th>
<th style="border:1px solid black;" >Vulnerabilidade de Não Referência no Apontador INVÁLIDA no Kernel do Windows - CVE-2009-2516</th>
<th style="border:1px solid black;" >Vulnerabilidade no Processador de Excepções do Kernel do Windows - CVE-2009-2517</th>
...
Vulnerabilidade de Fluxo Insuficiente de Números Inteiros no Kernel do Windows - CVE-2009-2515  
----------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no kernel do Windows devido à truncagem incorrecta de um valor de 64 bits para um valor de 32 bits. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-2515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2515).
  
#### Factores Atenuantes para a Vulnerabilidade de Fluxo Insuficiente de Números Inteiros no Kernel do Windows - CVE-2009-2515
...
-   Em sistemas de 32 bits, esta vulnerabilidade apenas pode ser activada se o sistema utilizar o Physical Address Extension (PAE).
  
#### Soluções Alternativas para a Vulnerabilidade de Fluxo Insuficiente de Números Inteiros no Kernel do Windows - CVE-2009-2515
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Fluxo Insuficiente de Números Inteiros no Kernel do Windows - CVE-2009-2515
...
O kernel do Windows não executa correctamente a truncagem de um valor de 64 bits para um valor de 32 bits. Isto resulta num fluxo insuficiente de números inteiros quando o valor é posteriormente subtraído de outro valor.
...
**O que é o Physical Address Extension (PAE)?**    
O PAE é uma extensão de endereço de memória fornecida pela Intel que activa o suporte para memórias físicas com mais de 4 GB para a maioria das plataformas Intel Pentium Pro de 32 bits (IA-32) e posteriores. Embora o suporte para a memória PAE seja normalmente associado a mais de 4 GB de RAM, o PAE pode ser activado no Windows XP SP2, Windows Server 2003, e versões de 32 bits posteriores do Windows para suportar hardware [Prevenção de Execução de Dados](http://www.microsoft.com/technet/prodtechnol/winxppro/maintain/sp2mempr.mspx). Para obter mais informações sobre o PAE, consulte o artigo, [Extensão de Endereço Físico - Memória PAE e Windows](http://www.microsoft.com/whdc/system/platform/server/pae/paedrv.mspx).
...
A actualização resolve a vulnerabilidade garantindo que o kernel do Windows executa correctamente a truncagem de valores de 64 bits.
...
Vulnerabilidade de Não Referência no Apontador INVÁLIDA no Kernel do Windows - CVE-2009-2516  
--------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios no kernel do Windows devido à validação insuficiente de determinados dados transmitidos do modo de utilizador. Um intruso que explorasse esta vulnerabilidade poderia executar código arbitrário no modo de kernel. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-2516](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2516).
  
#### Factores Atenuantes para a Vulnerabilidade de Não Referência no Apontador INVÁLIDA no Kernel do Windows - CVE-2009-2516
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso terá de colocar uma aplicação especialmente concebida para o efeito num sistema para explorar este vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade de Não Referência no Apontador INVÁLIDA no Kernel do Windows - CVE-2009-2516
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Não Referência no Apontador INVÁLIDA no Kernel do Windows - CVE-2009-2516
  
**Qual é a abrangência desta vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégios. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia executar código arbitrário e obter controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.
  
**O que provoca a vulnerabilidade?**    
O kernel do Windows não valida adequadamente determinados dados transmitidos do modo de utilizador.
...
**Como poderia um intruso explorar a vulnerabilidade?**    
Para explorar esta vulnerabilidade, um intruso teria de colocar uma aplicação especialmente concebida para o efeito num sistema de destino. Se um utilizador navegasse até ao directório onde se encontra a aplicação concebida, seria o suficiente para explorar a vulnerabilidade e assumir total controlo sobre o sistema afectado. O utilizador não necessita de executar a aplicação para que ocorra uma exploração. O utilizador apenas necessita de navegar até ao directório onde se encontra a aplicação concebida.
  
Um intruso também poderia colocar a aplicação especialmente concebida para o efeito numa partilha de rede. Neste caso, se um utilizador navegasse para a partilha de rede, a aplicação especialmente concebida para o efeito faria com que o sistema deixasse de responder e reiniciasse. O utilizador não necessita de executar a aplicação para que ocorra uma exploração. O utilizador apenas necessita de navegar até à partilha de rede onde se encontra a aplicação concebida.
  
**Quais os sistemas mais susceptíveis face a esta vulnerabilidade?**    
Os sistemas afectados são principalmente estações de trabalho e servidores de terminais. Os servidores podem estar mais sujeitos a risco se os administradores permitirem que os utilizadores iniciem sessão nos servidores e executem programas. Contudo, os procedimentos recomendados desencorajam essa acção.
  
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade garantindo que o kernel do Windows valida correctamente os dados num ficheiro executável.
...
Vulnerabilidade no Processador de Excepções do Kernel do Windows - CVE-2009-2517  
--------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço no kernel do Windows devido à forma como o kernel processa determinadas excepções. Um intruso poderia explorar a vulnerabilidade executando uma aplicação especialmente concebida para o efeito que provocasse o reinício do sistema.
  
Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-2517](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2517).
  
#### Factores Atenuantes para a Vulnerabilidade no Processador de Excepções do Kernel do Windows - CVE-2009-2517
  
A atenuação refere-se a uma definição, uma configuração comum ou uma prática recomendada geral, que existe num estado predefinido, que poderia reduzir a gravidade da exploração de uma vulnerabilidade. Os seguintes factores atenuantes podem ser úteis para a sua situação:
  
-   Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. A vulnerabilidade não poderia ser explorada remotamente ou por utilizadores anónimos.
  
#### Soluções Alternativas para a Vulnerabilidade no Processador de Excepções do Kernel do Windows - CVE-2009-2517
  
A Microsoft não identificou quaisquer soluções alternativas para esta vulnerabilidade.
  
#### Perguntas Mais Frequentes sobre a Vulnerabilidade no Processador de Excepções do Kernel do Windows - CVE-2009-2517
...
**O que faz a actualização?**    
A actualização resolve a vulnerabilidade assegurando que o kernel do Windows limpa as excepções sob condições de erro.
...
| **Implementação**                        |                                                                                                                                                                                    |  
| Instalação sem intervenção do utilizador | Windows2000-kb971486-x86-enu /quiet                                                                                                                                                |  
| Instalação sem reiniciar                 | Windows2000-kb971486-x86-enu /norestart                                                                                                                                            |  
| Ficheiro log da actualização             | kb971486.log                                                                                                                                                                       |  
...
| **Informações de Remoção**               | Utilize a ferramenta **Adicionar ou Remover Programas** no Painel de Controlo, ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\\$NTUninstallKB971486$\\Spuninst |  
| **Informações de Ficheiros**             | Consulte o [Artigo 971486 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/971486)                                                                   |  
| **Verificação da Chave de Registo**      | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971486\\Filelist                                                                                          |
...
<td style="border:1px solid black;">Utilize a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controlo, ou o utilitário Spuninst.exe que está localizado na pasta %Windir%\$NTUninstallKB971486$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/971486">Artigo 971486 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
-   Tavis Ormandy e Neel Mehta, da [Google Inc.](http://www.google.com/), por fornecerem informações sobre a Vulnerabilidade de Fluxo Insuficiente de Números Inteiros no Kernel do Windows (CVE-2009-2515)  
-   [NSFocus Security Team](http://www.nsfocus.com/), por fornecer informações sobre a Vulnerabilidade de Não Referência no Apontador INVÁLIDA no Kernel do Windows (CVE-2009-2516)  
-   Tavis Ormandy e Neel Mehta, da [Google Inc.](http://www.google.com/), por fornecerem informações sobre a Vulnerabilidade de Processador de Excepções no Kernel do Windows (CVE-2009-2517)
...
-   V1.1 (21 de Dezembro de 2009): Adicionado link na Base de Dados de Conhecimento da Microsoft Artigo 971486 na por baixo de questões conhecidas no sumário de execução.
