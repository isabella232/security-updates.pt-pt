---
TOCTitle: 'MS09-074'
Title: 'Microsoft Security Bulletin MS09-074 - Crítica'
ms:assetid: 'ms09-074'
ms:contentKeyID: 61234875
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms09-074(v=Security.10)'
author: SharonSears
...
Microsoft Security Bulletin MS09-074 - Crítica
==============================================

Vulnerabilidade no Microsoft Office Project poderia permitir Execução Remota de Código (967183)
-----------------------------------------------------------------------------------------------
...
<th style="border:1px solid black;" >
Vulnerabilidade de Validação de Memória no Project - CVE-2009-0102  
</th>
<th style="border:1px solid black;" >
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na forma como o Microsoft Office Project processa ficheiros Project especialmente concebidos para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios.

Para visualizar esta vulnerabilidade como uma entrada comum na lista de Vulnerabilidades e Exposições Comuns, consulte [CVE-2009-0102](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0102).

#### Factores Atenuantes para a Vulnerabilidade de Validação de Memória no Project - CVE-2009-0102
...
#### Soluções Alternativas para a Vulnerabilidade de Validação de Memória no Project - CVE-2009-0102

Uma solução alternativa refere-se a uma definição ou alteração de configuração que não corrige a vulnerabilidade subjacente, mas que ajudaria a bloquear vectores de ataque conhecidos antes de aplicar a actualização. A Microsoft testou as seguintes soluções alternativas e estados na discussão acerca de casos em que uma solução alternativa reduz a funcionalidade:

-   Não abra ficheiros Project (como ficheiros com uma extensão .mpp) que tenha recebido de fontes não fidedignas, ou que recebeu de fontes fidedignas mas que de alguma forma não correspondem ao que é habitual. É possível tirar partido desta vulnerabilidade quando um utilizador abre um ficheiro especialmente concebido para o efeito.

#### Perguntas Mais Frequentes sobre a Vulnerabilidade de Validação de Memória no Project - CVE-2009-0102
...
O Microsoft Office Project não valida adequadamente atribuições de recursos de memória ao abrir ficheiros Project.
...
Esta vulnerabilidade requer que um utilizador abra um ficheiro Project mal formado usando uma versão afectada do Microsoft Office Project.
...
|----------------------------------------------|---------|-------------------|-------------------|----------------------------|
| Microsoft Project 2000 Service Release 1     | Não     | Não               | Não               | Não                        |
| Microsoft Project 2002 Service Pack 1        | Não     | Não               | Sim               | Sim                        |
| Microsoft Office Project 2003 Service Pack 3 | Não     | Não               | Sim               | Sim                        |
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/961083">Artigo 961083 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/961079">Artigo 961079 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações de Ficheiros</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/961082">Artigo 961082 da Base de Dados de Conhecimento da Microsoft</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registo</strong></td>
<td style="border:1px solid black;">Não aplicável</td>
...
-   Bing Liu, da [FortiGuard Labs da Fortinet](http://www.fortiguard.com), por fornecer informações sobre a Vulnerabilidade de Validação de Memória no Project (CVE-2009-0102)
