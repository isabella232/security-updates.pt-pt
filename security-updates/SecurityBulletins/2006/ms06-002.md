---
TOCTitle: 'MS06-002'
Title: 'Microsoft Security Bulletin MS06-002 - Crítica'
ms:assetid: 'ms06-002'
ms:contentKeyID: 61234078
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms06-002(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS06-002 - Crítica
==============================================

Vulnerabilidade em Tipos de Letra Web Incorporados poderia permitir Execução Remota de Código (908519)
------------------------------------------------------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 – [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=dc6c2fe8-3c81-4661-994b-4146775bf590)
-   Microsoft Windows XP Service Pack 1 e Microsoft Windows XP Service Pack 2 – [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=6daea2af-3723-4cdf-b5bd-b21ac75b5243)
-   Microsoft Windows XP Professional x64 Edition – [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=1990b2cf-ae88-4849-aeab-3f833969e197)
-   Microsoft Windows Server 2003 e Microsoft Windows Server 2003 Service Pack 1 – [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=5fc12654-486f-45bf-8d34-bdf0998869c5)
-   Microsoft Windows Server 2003 para sistemas baseados em Itanium e Microsoft Windows Server 2003 com SP1 para sistemas baseados em Itanium – [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=e39d2e29-8934-4aa1-844d-11efa57d9cc5)
-   Microsoft Windows Server 2003 x64 Edition - [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=80b05c56-5bce-4262-8142-af0d8a7bc388)
...
Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo de um sistema afectado. Se um utilizador tiver sessão iniciada com privilégios administrativos, um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter controlo total sobre um sistema afectado. Um intruso poderia então instalar programas; ver, alterar ou eliminar dados; ou ainda criar novas contas com todos os privilégios. Os utilizadores cujas contas estão configuradas com menos direitos de utilização no sistema podem correr menos riscos do que os utilizadores que trabalham com direitos de utilização de administrador.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Vulnerabilidade em Tipos de Letra Web Incorporados no Windows - [CVE-2006-0010](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0010) | Execução Remota de Código  | Crítica               | Crítica      | Crítica                   | Crítica                   | Importante          | Importante                         |
...
-   Esloveno – [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=1daf5e13-9d0c-4f0c-b0c5-5257893f3632&displaylang=sl)
-   Eslovaco – [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=1daf5e13-9d0c-4f0c-b0c5-5257893f3632&displaylang=sk)
-   Tailandês – [Transferir a actualização](http://www.microsoft.com/downloads/details.aspx?familyid=1daf5e13-9d0c-4f0c-b0c5-5257893f3632&displaylang=th)
...
<span></span>
#### Vulnerabilidade em Tipos de Letra Web Incorporados no Windows - CVE-2006-0010:

Existe uma vulnerabilidade de execução remota de código no Windows, devido à forma como este processa tipos de letra Web incorporados mal-formados. Um intruso poderia explorar a vulnerabilidade construindo um tipo de letra Web incorporado malicioso que pudesse potencialmente permitir a execução remota de código se um utilizador visitasse um Web site malicioso ou visualizasse uma mensagem de correio electrónico especialmente concebida para o efeito. Um intruso que conseguisse tirar partido desta vulnerabilidade poderia obter o controlo total de um sistema afectado.

#### Factores atenuantes para a Vulnerabilidade em Tipos de Letra Web Incorporados no Windows - CVE-2006-0010:
...
-   Por predefinição, o Internet Explorer do Windows Server 2003 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp). Este modo atenua esta vulnerabilidade no que toca ao vector de correio electrónico, embora clicar numa hiperligação continue a colocar estes utilizadores em risco. No Windows Server 2003, o Microsoft Outlook Express utiliza por predefinição texto simples para ler e enviar mensagens. Quando responder a uma mensagem de correio electrónico que tenha sido enviada noutro formato, a resposta é formatada para texto simples. Consulte a secção de Perguntas mais frequentes desta vulnerabilidade para obter mais informações acerca da Configuração de Segurança Avançada do Internet Explorer.

#### Soluções alternativas para a Vulnerabilidade em Tipos de Letra Web Incorporados no Windows - CVE-2006-0010:
...
-   **Configure a transferência de tipos de letra para “Pedir ou desactivar” nas zonas de Internet e de Intranet local.**

    **Impacto da solução alternativa:** Os Web sites que dependem de tipos de letra incorporados poderão não ser processados.
    ...
    3.  Para alterar a configuração para a zona **Internet**, seleccione **Internet** e prima o botão **Personalizar nível**.
    ...
    5.  Prima OK para fechar a caixa de diálogo **Definições de segurança**.
    6.  Prima OK para fechar a caixa de diálogo **Opções da Internet**.

#### Perguntas mais frequentes sobre a Vulnerabilidade em Tipos de Letra Web Incorporados no Windows - CVE-2006-0010:
...
Quando o Windows apresenta um tipo de letra Web incorporado, pode danificar a memória do sistema de tal forma que é possível a um intruso executar código arbitrário.
...
Um intruso poderia explorar esta vulnerabilidade criando uma página Web, ou uma mensagem de correio electrónico em HTML nociva, e convencer o utilizador a visitar esta página, ou a visualizar a mensagem de correio electrónico em HTML. Se o utilizador visitasse a página ou visualizasse a mensagem de correio electrónico, o intruso poderia aceder a informações a partir de outros Web sites, ou a ficheiros locais em localizações pré-determinadas no sistema, ou provocar a execução de código nocivo, no contexto de segurança definido para o utilizador com sessão iniciada localmente. Um intruso também poderia tentar comprometer um Web site e fazer com que este apresentasse conteúdo nocivo. Além disso, poderia ser possível exibir conteúdos Web nocivos concebidos especialmente para o efeito, usando espaços de publicidade como banners, ou usando outros métodos para entregar conteúdos Web a sistemas afectados.
...
Sim. Por predefinição, o Internet Explorer do Windows Server 2003 é executado no modo restrito, conhecido como a [Configuração de Segurança Avançada](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp). Este modo atenua esta vulnerabilidade no que toca ao vector de correio electrónico, embora clicar numa hiperligação continue a colocar estes utilizadores em risco. No Windows Server 2003, o Microsoft Outlook Express utiliza por predefinição texto simples para ler e enviar mensagens. Quando responder a uma mensagem de correio electrónico que tenha sido enviada noutro formato, a resposta é formatada para texto simples.

**O que é a Configuração de Segurança Avançada do Internet Explorer?**
A [Configuração de Segurança Avançada](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp) do Internet Explorer é um grupo de definições pré-configuradas do Internet Explorer que reduz a probabilidade de um utilizador ou de um administrador transferir e executar conteúdos da Web maliciosos num servidor. A [Configuração de Segurança Avançada](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp) do Internet Explorer reduz o risco, modificando muitas definições relacionadas com segurança. Isso inclui as definições no separador **Segurança** e o separador **Avançado** na caixa de diálogo das **Opções da Internet**. Algumas das modificações importantes incluem o seguinte:
...
A actualização elimina a vulnerabilidade ao modificar a forma como o Windows valida o comprimento de uma mensagem, antes de o transmitir para a memória intermédia atribuída quando manipula tipos de letras Web.
...
Os administradores de sistema podem também utilizar o utilitário Spuninst.exe para remover esta actualização de segurança. O utilitário Spuninst.exe está localizado na pasta %Windir%\\$NTUninstallKB908519$\\Spuninst.
...
|------------------|---------------|-------------|-------|---------|--------|
| Fontsub.dll      | 5.2.3790.426  | 17-Out-2005 | 21:33 | 78,848  | RTMGDR |
| T2embed.dll      | 5.2.3790.426  | 17-Out-2005 | 21:33 | 113,664 | RTMGDR |
| Fontsub.dll      | 5.2.3790.426  | 17-Out-2005 | 21:44 | 78,848  | RTMQFE |
| T2embed.dll      | 5.2.3790.426  | 17-Out-2005 | 21:44 | 113,664 | RTMQFE |
| Fontsub.dll      | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 81,408  | SP1GDR |
| T2embed.dll      | 5.2.3790.2549 | 17-Out-2005 | 21:59 | 118.272 | SP1GDR |
| Fontsub.dll      | 5.2.3790.2549 | 17-Out-2005 | 21:43 | 81,408  | SP1QFE |
| T2embed.dll      | 5.2.3790.2549 | 17-Out-2005 | 21:43 | 118.272 | SP1QFE |
...
|------------------|---------------|-------------|-------|---------|-------|-------------|
| Fontsub.dll      | 5.2.3790.426  | 17-Out-2005 | 23:48 | 187,392 | IA-64 | RTMGDR      |
| T2embed.dll      | 5.2.3790.426  | 17-Out-2005 | 23:48 | 299,520 | IA-64 | RTMGDR      |
| Wfontsub.dll     | 5.2.3790.426  | 17-Out-2005 | 23:48 | 78,848  | x86   | RTMGDR\\WOW |
| Wt2embed.dll     | 5.2.3790.426  | 17-Out-2005 | 23:48 | 113,664 | x86   | RTMGDR\\WOW |
| Fontsub.dll      | 5.2.3790.426  | 17-Out-2005 | 23:48 | 187,392 | IA-64 | RTMQFE      |
| T2embed.dll      | 5.2.3790.426  | 17-Out-2005 | 23:48 | 299,520 | IA-64 | RTMQFE      |
| Wfontsub.dll     | 5.2.3790.426  | 17-Out-2005 | 23:48 | 78,848  | x86   | RTMQFE\\WOW |
| Wt2embed.dll     | 5.2.3790.426  | 17-Out-2005 | 23:48 | 113,664 | x86   | RTMQFE\\WOW |
| Fontsub.dll      | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 210,944 | IA-64 | SP1GDR      |
| T2embed.dll      | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 331,776 | IA-64 | SP1GDR      |
| Wfontsub.dll     | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 81,408  | x86   | SP1GDR\\WOW |
| Wt2embed.dll     | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 118.272 | x86   | SP1GDR\\WOW |
| Fontsub.dll      | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 210,944 | IA-64 | SP1QFE      |
| T2embed.dll      | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 331,776 | IA-64 | SP1QFE      |
| Wfontsub.dll     | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 81,408  | x86   | SP1QFE\\WOW |
| Wt2embed.dll     | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 118.272 | x86   | SP1QFE\\WOW |
...
| Nome do Ficheiro | Versão        | Data        | Hora  | Tamanho | CPU | Pasta       |
|------------------|---------------|-------------|-------|---------|-----|-------------|
| Fontsub.dll      | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 135,680 | x64 | SP1GDR      |
| T2embed.dll      | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 208,896 | x64 | SP1GDR      |
| Wfontsub.dll     | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 81,408  | x86 | SP1GDR\\WOW |
| Wt2embed.dll     | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 118.272 | x86 | SP1GDR\\WOW |
| Fontsub.dll      | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 135,680 | x64 | SP1QFE      |
| T2embed.dll      | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 208,896 | x64 | SP1QFE      |
| Wfontsub.dll     | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 81,408  | x86 | SP1QFE\\WOW |
| Wt2embed.dll     | 5.2.3790.2549 | 17-Out-2005 | 23:48 | 118.272 | x86 | SP1QFE\\WOW |
...
-   **Verificação da Chave de Registo**
    ...
    **Nota** Esta chave de registo poderá não conter uma lista completa dos ficheiros instalados. Além disso, esta chave de registo poderá não ser criada correctamente se um administrador ou um OEM integrar ou associar a actualização de segurança 908519 aos ficheiros de origem de instalação do Windows.
...
| Nome do Ficheiro | Versão        | Data        | Hora  | Tamanho | Pasta  |
|------------------|---------------|-------------|-------|---------|--------|
| Fontsub.dll      | 5.1.2600.1762 | 17-Out-2005 | 21:29 | 77,824  | SP1QFE |
| T2embed.dll      | 5.1.2600.1762 | 17-Out-2005 | 21:29 | 111,616 | SP1QFE |
| Fontsub.dll      | 5.1.2600.2777 | 17-Out-2005 | 21:14 | 80,896  | SP2GDR |
| T2embed.dll      | 5.1.2600.2777 | 17-Out-2005 | 21:14 | 118.272 | SP2GDR |
| Fontsub.dll      | 5.1.2600.2777 | 17-Out-2005 | 21:21 | 80,896  | SP2QFE |
| T2embed.dll      | 5.1.2600.2777 | 17-Out-2005 | 21:21 | 117,760 | SP2QFE |
...
-   **Verificação da Chave de Registo**
    ...
    **Nota** Estas chaves de registo poderão não conter uma lista completa dos ficheiros instalados. Além disso, estas chaves de registo poderão não ser criadas correctamente se um administrador ou um OEM integrar ou associar a actualização de segurança 908519 aos ficheiros de origem de instalação do Windows.
...
-   **Verificação da Chave de Registo**
    ...
    **Nota** Esta chave de registo poderá não conter uma lista completa dos ficheiros instalados. Além disso, esta chave de registo poderá não ser criada correctamente quando um administrador ou um OEM integrar ou associar a actualização de segurança 908519 aos ficheiros de origem de instalação do Windows.
...
-   [eEye Digital Security](http://www.eeye.com) por fornecer informações sobre a Vulnerabilidade em Tipos de Letra Web Incorporados no Windows - (CVE-2006-0010).
