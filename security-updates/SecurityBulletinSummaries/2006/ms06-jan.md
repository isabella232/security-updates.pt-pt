---
TOCTitle: 'MS06-JAN'
Title: Resumo dos Boletins de Segurança Microsoft de Janeiro 2006
ms:assetid: 'ms06-jan'
ms:contentKeyID: 61235132
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms06-jan(v=Security.10)'
---

Security Bulletin Summary

Resumo dos Boletins de Segurança Microsoft de Janeiro 2006
==========================================================

Data de publicação: 5 de janeiro de 2006 | Updated: 10 de janeiro de 2006
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-001                                                                                                                       |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade no Motor de Processamento de Gráficos poderia permitir Execução Remota de Código (912919)**](http://go.microsoft.com/fwlink/?linkid=58471) |
...
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-002                                                                                                                    |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade em Tipos de Letra Web Incorporados poderia permitir Execução Remota de Código (908519)**](http://go.microsoft.com/fwlink/?linkid=55919) |
| **Resumo executivo**                  | Existe uma vulnerabilidade na visualização de tipos de letra Web incorporados que poderia levar à execução remota de código.                               |
| **Classificação de Gravidade Máxima** | [Crítica](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                                    |
| **Impacto da Vulnerabilidade**        | Execução Remota de Código                                                                                                                                  |
| **Software Afectado**                 | **Windows.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                                         |

| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-003                                                                                                                                                     |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade na Descodificação TNEF no Microsoft Outlook e no Microsoft Exchange poderia permitir Execução Remota de Código (902412)**](http://go.microsoft.com/fwlink/?linkid=44168) |
| **Resumo executivo**                  | Existe uma vulnerabilidade nas mensagens TNEF que poderia permitir a execução remota de código.                                                                                             |
| **Classificação de Gravidade Máxima** | [Crítica](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                                                                     |
| **Impacto da Vulnerabilidade**        | Execução Remota de Código                                                                                                                                                                   |
| **Software Afectado**                 | **Exchange e Office.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                                                                |
...
<sup>[1]</sup> As actualizações de segurança críticas para estas plataformas estão disponíveis, são fornecidas como parte deste boletim de segurança e podem ser transferidas do Web site do Windows Update. 
...
-   Dan Hubbard, da [WebSense](http://websense.com/), por trabalhar connosco numa questão descrita no boletim [MS06-001](http://go.microsoft.com/fwlink/?linkid=58471).  
-   eEye Digital Security por fornecer informações sobre esta questão descrita no boletim [MS06-002](http://technet.microsoft.com/security/bulletin/ms06-002).  
-   John Heasman e Mark Litchfield da [NGS Software](http://www.ngssoftware.com/index.htm) por fornecerem informações sobre a questão descrita no boletim [MS06-003](http://technet.microsoft.com/security/bulletin/ms06-003).
...
-   V2.0 (10 de Janeiro de 2006): Actualização que inclui Boletins de Segurança Microsoft adicionais.
