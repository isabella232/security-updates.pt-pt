---
TOCTitle: 'MS06-OCT'
Title: Resumo dos Boletins de Segurança Microsoft de Outubro 2006
ms:assetid: 'ms06-oct'
ms:contentKeyID: 61235137
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms06-oct(v=Security.10)'
author: SharonSears
...
Resumo dos Boletins de Segurança Microsoft de Outubro 2006
==========================================================
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-057                                                                                                     |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade na Shell do Windows poderia permitir Execução Remota de Código (923191)**](http://go.microsoft.com/fwlink/?linkid=73859) |
...
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-058                                                                                                           |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidades no Microsoft PowerPoint poderiam permitir Execução Remota de Código (924163)**](http://go.microsoft.com/fwlink/?linkid=74173) |
| **Resumo Executivo**                  | Esta actualização resolve vulnerabilidades no PowerPoint que poderiam permitir a execução remota de código.                                       |
| **Classificação de Gravidade Máxima** | [Crítica](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                           |
| **Impacto da Vulnerabilidade**        | Execução Remota de Código                                                                                                                         |
| **Software Afectado**                 | **Office, PowerPoint.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                     |

| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-059                                                                                                      |
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidades no Microsoft Excel poderiam permitir Execução Remota de Código (924164)**](http://go.microsoft.com/fwlink/?linkid=74172) |
...
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-060                                                                                                     |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidades no Microsoft Word poderiam permitir Execução Remota de Código (924554)**](http://go.microsoft.com/fwlink/?linkid=74174) |
| **Resumo Executivo**                  | Esta actualização resolve várias vulnerabilidades no Microsoft Word, a mais crítica das quais poderia permitir a execução remota de código. |
| **Classificação de Gravidade Máxima** | [Crítica](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                     |
| **Impacto da Vulnerabilidade**        | Execução Remota de Código                                                                                                                   |
| **Software Afectado**                 | **Office, Word.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                     |

| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-061                                                                                                                   |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidades no Microsoft XML Core Services poderiam permitir Execução Remota de Código (924191))**](http://go.microsoft.com/fwlink/?linkid=73836) |
...
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-062                                                                                                       |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidades no Microsoft Office poderiam permitir Execução Remota de Código (922581)**](http://go.microsoft.com/fwlink/?linkid=74175) |
| **Resumo Executivo**                  | Esta actualização resolve vulnerabilidades no Office que poderiam permitir a execução remota de código.                                       |
| **Classificação de Gravidade Máxima** | [Crítica](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                       |
| **Impacto da Vulnerabilidade**        | Execução Remota de Código                                                                                                                     |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-063                                                                                                                             |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade no Serviço de Servidor poderia permitir Negação de Serviço e Execução Remota de Código (923414)**](http://go.microsoft.com/fwlink/?linkid=73850) |
| **Resumo Executivo**                  | Esta actualização resolve vulnerabilidades no Windows que poderiam permitir negação de serviço e execução remota de código.                                         |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-056                                                                                            |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade no ASP.NET poderia permitir Divulgação de Informações (922770)**](http://go.microsoft.com/fwlink/?linkid=67168) |
| **Resumo Executivo**                  | Esta actualização resolve uma vulnerabilidade no ASP.NET que poderia permitir a divulgação de informações.                         |
...
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-065                                                                                                                  |
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade no Gestor de Objectos do Windows poderia permitir Execução Remota de Código (924496)**](http://go.microsoft.com/fwlink/?linkid=73851) |
| **Resumo Executivo**                  | Esta actualização resolve uma vulnerabilidade no Gestor de Objectos que poderia permitir a execução remota de código.                                    |
| **Classificação de Gravidade Máxima** | [Moderada](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                                 |
| **Impacto da Vulnerabilidade**        | Execução Remota de Código                                                                                                                                |
| **Software Afectado**                 | **Windows.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                                       |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-064                                                                                     |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidades no TCP/IP poderia permitir Negação de Serviço (922819)**](http://go.microsoft.com/fwlink/?linkid=73864) |
| **Resumo Executivo**                  | Esta actualização resolve várias vulnerabilidades no Windows, a mais crítica das quais poderia permitir negação de serviço. |
| **Classificação de Gravidade Máxima** | [Baixa](http://go.microsoft.com/fwlink/?linkid=21140)                                                                       |
...
Por exemplo, o boletim de segurança **MS06-061** fornece diversas actualizações de segurança que poderão ser necessárias, conforme o software e componentes afectados que tenha instalado.

#### Localizações do Software Afectado e das Transferências MS06-056 a MS06-061
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=34c375aa-2f54-4416-b1fc-b73378492aa6">Moderada</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=756f53a7-28dc-422a-a691-c1bbfcbf3d0c">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f9d16d74-1785-4c33-b1fc-df5258dd1089">Crítica</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows XP Service Pack 1</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=34c375aa-2f54-4416-b1fc-b73378492aa6">Moderada</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=235bca55-8d43-4eaf-8970-a55bc3165e3d">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8a455c3b-213c-4395-87e9-9895f2b9a6ed">Crítica</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=34c375aa-2f54-4416-b1fc-b73378492aa6">Moderada</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=96271f96-0d8e-4ab1-b131-2b37fca7e6e7">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5593333f-bcd5-4750-a23d-4f7fccda6493">Crítica</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=34c375aa-2f54-4416-b1fc-b73378492aa6">Moderada</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=48f2314b-b268-468c-919c-593e06af4453">Moderada</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=09b77b2a-a4fd-46e2-af15-2385790c9ee7">Crítica</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=34c375aa-2f54-4416-b1fc-b73378492aa6">Moderada</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6507e201-b84e-432a-8797-23b586ad15ae">Moderada</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=31c88513-29df-475b-b9ae-a2f5c1f32a8c">Crítica</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=34c375aa-2f54-4416-b1fc-b73378492aa6">Moderada</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2b39693f-aabc-49c6-9d1a-6791f80f8f22">Moderada</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6183a9d2-89f5-4b25-be8b-090c6e050740">Crítica</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=961f3c95-ec4e-4561-ab27-b3180e9139c5">Crítica</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fd513435-fa6d-407c-bedc-5fd03e5b7d6c">Crítica</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8a37c111-d8e9-4c2e-9674-169b3331491c">Crítica</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a4b2a672-481b-4af6-89fe-de8d321d99e0">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=14a61fda-bfe2-47ca-8313-40b772359994">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=cfc85449-4941-4da5-a919-1da388054e83">Crítica</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
...
#### Localizações do Software Afectado e das Transferências MS06-062 a MS06-065
...
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140"><strong>Baixa</strong></a></td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=21140"><strong>Moderada</strong></a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Software Windows Afectado:</strong></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9fd73d12-ff7c-411d-944d-a6f147b20775">Baixa</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=86c2b78e-53bf-4ddd-88f6-5d12c6d18c90">Moderada</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Service Pack 2</td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fc98f55c-520e-4a68-a3c3-0df51c6122bb">Baixa</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2ac72356-7772-41b6-b4a6-7215c89f7347">Baixa</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003</td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=102591a0-2b58-497b-bc20-593571b96e9c">Baixa</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e2f5b9f9-4481-44f9-9aef-1af0afae8319">Baixa</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1</td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=12515d47-134d-4d1f-9ae7-f0a7167ec424">Baixa</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8c9a22a6-bd61-4fd4-9aa4-012d745046da">Baixa</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 com SP1 para sistemas baseados em Itanium</td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c5faba34-48f5-4875-a0fa-6b8207f9b276">Baixa</a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ec4f4f72-8467-4964-ad28-ed9ea7562e0b">Baixa</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Software Office Afectado:</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Office 2000 Service Pack3</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e0c7e1e4-7859-4c7e-898e-1cf05014885b">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;">Project 2000 Service Pack 1</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=266a9870-cd03-45ca-877b-b5ad2c873fe5">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
...
-   Jaswinder Hayre por fornecer informações sobre uma questão descrita no boletim [MS06-056](http://go.microsoft.com/fwlink/?linkid=67168).  
-   Arnaud Dovi, a trabalhar com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre uma questão descrita no boletim [MS06-058](http://go.microsoft.com/fwlink/?linkid=74173).  
-   Chris Ries, da [VigilantMinds Inc.](http://www.vigilantminds.com), por fornecer informações sobre uma questão descrita no boletim [MS06-058](http://go.microsoft.com/fwlink/?linkid=74173).  
-   Djun Meng da [Fortinet Inc.](http://www.fortinet.com/) por fornecer informações sobre um problema descrito no boletim [MS06-058](http://go.microsoft.com/fwlink/?linkid=74173).  
-   A [Equipa de Segurança da NSFocus](mailto:security@nsfocus.com) por fornecer informações sobre um problema descrito no boletim [MS06-059](http://go.microsoft.com/fwlink/?linkid=74172).  
-   Manuel Santamarina Suarez, a trabalhar com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre uma questão descrita no boletim [MS06-059](http://go.microsoft.com/fwlink/?linkid=74172).  
-   Chen Xiaobo da [McAfee Avert Labs](http://www.avertlabs.com/) por fornecer informações sobre uma questão descrita no boletim [MS06-060.](http://go.microsoft.com/fwlink/?linkid=74174)  
-   Cu Fang por fornecer informações sobre uma questão descrita no boletim [MS06-060](http://go.microsoft.com/fwlink/?linkid=74174).  
-   Djun Meng da [Fortinet Inc.](http://www.fortinet.com/) por fornecer informações sobre um problema descrito no boletim [MS06-062](http://go.microsoft.com/fwlink/?linkid=74175).  
-   Arnaud Dovi, a trabalhar com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por fornecer informações sobre uma questão descrita no boletim [MS06-062](http://go.microsoft.com/fwlink/?linkid=74175).  
-   Sowhat da [Nevis Labs](http://www.nevisnetworks.com/) por fornecer informações sobre uma questão descrita no boletim [MS06-062](http://go.microsoft.com/fwlink/?linkid=74175).  
-   Gerardo Richarte, da [Core Security Technologies](http://www.coresecurity.com/), por fornecer informações sobre uma questão descrita no boletim [MS06-063](http://go.microsoft.com/fwlink/?linkid=73850).  
-   [Fortinet Inc.](http://www.fortinet.com/) por fornecer informações sobre uma questão descrita no boletim [MS06-063](http://go.microsoft.com/fwlink/?linkid=73850).  
-   Matthew Amdur da [VMware](http://www.vmware.com/) por fornecer informações sobre uma questão descrita no boletim [MS06-063](http://go.microsoft.com/fwlink/?linkid=73850)  
-   Andreas Sandblad, da [Secunia Research](http://www.secunia.com/), por fornecer informações sobre uma questão descrita no boletim [MS06-065](http://go.microsoft.com/fwlink/?linkid=73851).
...
-   V1.1 (11 de Outubro de 2006): Boletim revisto para clarificar o impacto associado ao boletim MS06-063 como negação de serviço e execução remota de código.
