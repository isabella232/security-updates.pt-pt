---
TOCTitle: 'MS06-FEB'
Title: Resumo dos Boletins de Segurança Microsoft de Fevereiro 2006
ms:assetid: 'ms06-feb'
...
Resumo dos Boletins de Segurança Microsoft de Fevereiro 2006
============================================================
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-004                                                                                    |
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Actualização de Segurança Cumulativa para o Internet Explorer (910620)**](http://go.microsoft.com/fwlink/?linkid=57064) |
| **Resumo executivo**                  | Existe uma vulnerabilidade no Motor de Processamento de Gráficos que poderia permitir a execução remota de código.         |
...
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-005                                                                                                           |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | **Vulnerabilidade no Windows Media Player poderia permitir a Execução Remota de Código (911565)**                                                 |
| **Resumo executivo**                  | Existe uma vulnerabilidade na forma como o Windows Media Player processa determinados ficheiros que poderia permitir a execução remota de código. |
| **Classificação de Gravidade Máxima** | [Crítica](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                           |
| **Impacto da Vulnerabilidade**        | Execução Remota de Código                                                                                                                         |
| **Software Afectado**                 | **Windows.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                                |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-006                                                                                                                                                           |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | **Vulnerabilidade no Plug-in do Windows Media Player com Browsers da Internet que não sejam da Microsoft poderia permitir a Execução Remota de Código (911564)**                                  |
| **Resumo Executivo**                  | Existe uma vulnerabilidade de execução remota de código no plug-in do Windows Media Player para browsers da Internet que não sejam da Microsoft que poderia permitir a execução remota de código. |
| **Classificação de Gravidade Máxima** | [Importante](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                                                                        |
| **Impacto da Vulnerabilidade**        | Execução Remota de Código                                                                                                                                                                         |
| **Software Afectado**                 | **Windows.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                                                                                |

| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-007                                                                                                                                                          |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade no TCP/IP poderia permitir Negação de Serviço (913446)**](http://go.microsoft.com/fwlink/?linkid=59797)                                                                       |
| **Resumo Executivo**                  | Existe uma vulnerabilidade que poderia permitir que um intruso enviasse um pacote IGMP especialmente concebido para o efeito que poderia fazer com que o sistema afectado deixasse de responder. |
| **Classificação de Gravidade Máxima** | [Importante](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                                                                       |
| **Impacto da Vulnerabilidade**        | Negação de Serviço                                                                                                                                                                               |
| **Software Afectado**                 | **Windows.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                                                                               |

| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-008                                                                                                                                                                                                                                                        |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade no Serviço Web Client poderia permitir a Execução Remota de Código (911927)**](http://go.microsoft.com/fwlink/?linkid=59441)                                                                                                                                                |
| **Resumo Executivo**                  | Existe uma vulnerabilidade no serviço Web Client do Windows que poderia permitir que um intruso obtivesse controlo total sobre um sistema afectado. Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. |
| **Classificação de Gravidade Máxima** | [Importante](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                                                                                                                                                                     |
| **Impacto da Vulnerabilidade**        | Execução Remota de Código                                                                                                                                                                                                                                                                      |
| **Software Afectado**                 | **Windows.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                                                                                                                                                                             |

| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-009                                                                                                                                                                                                                                                                                     |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade no Editor de Método de Entrada (IME) Coreano poderia permitir a Elevação de Privilégios (901190)**](http://go.microsoft.com/fwlink/?linkid=49512)                                                                                                                                                        |
| **Resumo Executivo**                  | Existe uma vulnerabilidade no Editor de Método de Entrada Coreano do Windows e do Office que poderia permitir que um intruso obtivesse controlo total sobre um sistema afectado. Um intruso tem que ter credenciais de início de sessão válidas e conseguir iniciar a sessão localmente para explorar esta vulnerabilidade. |
| **Classificação de Gravidade Máxima** | [Importante](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                                                                                                                                                                                                  |
| **Impacto da Vulnerabilidade**        | Elevação de Privilégios                                                                                                                                                                                                                                                                                                     |
| **Software Afectado**                 | **Windows e Office.** Para obter mais informações consulte a secção Localizações do Software Afectado e das Transferências.                                                                                                                                                                                                 |

| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-010:                                                                          |
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | **Vulnerabilidade no PowerPoint 2000 poderia permitir a Divulgação de Informações (889167)**                      |
| **Resumo Executivo**                  | Existe uma vulnerabilidade no PowerPoint que poderia permitir a divulgação de informações.                        |
| **Classificação de Gravidade Máxima** | [Importante](http://go.microsoft.com/fwlink/?linkid=21140)                                                        |
...
#### Localizações do Software Afectado e das Transferências para boletins de MS06-004 até MS06-007
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c0df2fc3-2075-46b5-945f-6e0bd6806151">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 7.1 quando instalado no Windows 98, 98 SE, ME e Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Media Player para XP no Microsoft Windows XP Service Pack 1</td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 9 quando instalado no Windows 98, 98 SE, ME, Windows 2000 Service Pack 4 e Windows XP Service Pack 1</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Media Player 9 no Microsoft Windows XP Service Pack 2 ou Windows Server 2003</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=182735e1-9382-4f2e-a624-d2316a96b411">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
</tbody>
...
#### Localizações do Software Afectado e das Transferências para boletins de MS06-008 até MS06-010
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fa073183-0c83-4f1c-be46-a2ee8a1a1440">Moderada</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e2f5413a-0b77-4c18-9bab-e2470d3d3f4e">Moderada</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 para sistemas baseados em Itanium</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e186e149-208a-4035-a0fc-e1cbde4e6fef">Moderada</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Multilingual User Interface Packs para Office 2003</td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Multilingual User Interface Packs para Office Project 2003</td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Multilingual User Interface Packs para Office Visio 2003</td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Ferramentas de Verificação do Office 2003</td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/pt-PT/library///www.microsoft.com/downloads/details.aspx?familyid=8e6f16e9-cd73-47d5-887e-616db9b09591(v=Security.10)">Importante</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/pt-PT/library///www.microsoft.com/downloads/details.aspx?familyid=e51b27c8-2f31-4e99-b868-ce626fed5b7d(v=Security.10)">Importante</a></td>
</tr>
</tbody>
</table>
...
**<sup>[1]</sup>** Existe uma actualização de segurança disponível para este sistema operativo. Consulte a tabela para o componente afectado, o Microsoft Internet Explorer ou o Windows Media Player. Consulte depois o boletim de segurança apropriado para obter mais detalhes.
...
-   Marc Maiffret, da eEye, por fornecer informações sobre a questão descrita no boletim [MS06-005](http://technet.microsoft.com/security/bulletin/ms06-005).  
-   John Cobb, da iDefense, por fornecer informações sobre a questão descrita no boletim [MS06-006](http://technet.microsoft.com/security/bulletin/ms06-006).  
-   Douglas Nascimento, da Datacom, por fornecer informações sobre a questão descrita no boletim [MS06-007](http://technet.microsoft.com/security/bulletin/ms06-007).  
-   Kostya Kortchinsky, da [EADS/CRC](http://www.eads.net/), por fornecer informações sobre a questão descrita no boletim [MS06-008](http://technet.microsoft.com/security/bulletin/ms06-008).  
-   [Ryan Lee](mailto:newrun@gmail.com), por fornecer informações sobre a questão descrita no boletim [MS06-009](http://technet.microsoft.com/security/bulletin/ms06-009).  
-   Andreas Sandblad, por fornecer informações sobre a questão descrita no boletim [MS06-010](http://technet.microsoft.com/security/bulletin/ms06-010).  
-   Yorick Koster, da ITsec Security Services, por fornecer informações sobre a questão descrita no boletim [MS06-010](http://technet.microsoft.com/security/bulletin/ms06-010).  
-   **Obter Outras Actualizações de Segurança:**
    ...
    -   Durante este mês, pode obter as actualizações de segurança oferecidas no Windows Update no ficheiro de imagem de CD 2006 Security and Critical Releases ISO Image. Para obter mais informações, consulte o [Artigo 913086 da Base de Dados de Conhecimento da Microsoft](http://support.microsoft.com/kb/913086).
