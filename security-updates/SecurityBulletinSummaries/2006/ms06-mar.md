---
TOCTitle: 'MS06-MAR'
Title: Resumo dos Boletins de Segurança Microsoft de Março 2006
ms:assetid: 'ms06-mar'
ms:contentKeyID: 61235135
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms06-mar(v=Security.10)'
---

Security Bulletin Summary

Resumo dos Boletins de Segurança Microsoft de Março 2006
========================================================
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-012                                                                                                       |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidades no Microsoft Office poderiam permitir Execução Remota de Código (905413)**](http://go.microsoft.com/fwlink/?linkid=57006) |
| **Resumo executivo**                  | Existem vulnerabilidades no Microsoft Office que podem permitir a execução remota de código.                                                  |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança Microsoft MS06-011                                                                                                                                        |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**DACLs de Serviços Windows Permissivos poderiam conduzir a Elevação de Privilégios (914798)**](http://go.microsoft.com/fwlink/?linkid=62074)                                 |
| **Resumo executivo**                  | Existe uma vulnerabilidade de elevação de privilégios que poderia permitir que um utilizador com credenciais válidas de início de sessão tomasse controlo absoluto do sistema. |
...
Por exemplo, o boletim de segurança **MS06-012** fornece diversas actualizações de segurança que poderão ser necessárias, conforme o software e componentes afectados que tenha instalado.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b8d2d18f-8d2a-495b-83ff-1696ec1e5ea1">Moderada</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b1ab9b42-80cd-4002-88fa-7a83ab15c2ee">Moderada</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">Multilingual User Interface Packs para Office XP</td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=cd2179fd-37f5-4d09-b653-0174651cf5e4">Crítica</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Excel 2000</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c9433440-31ef-4c18-a0c7-b595ea23f6fc">Crítica</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Outlook 2000</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2b231231-ac83-4688-9c8d-dcdcb544fb3c">Crítica</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">PowerPoint 2000</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f24d4bd0-4771-4688-b52a-02d4eabb1574">Crítica</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">MultiLanguage Packs para Office 2000</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f24d4bd0-4771-4688-b52a-02d4eabb1574">Crítica</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Excel X para Mac</td>
<td style="border:1px solid black;"></td>
...
-   Andres Tarasco da [SIA Group](http://www.siainternational.com/) por ter trabalhado connosco numa questão detectada no boletim [MS06-011](http://go.microsoft.com/fwlink/?linkid=62074).  
-   Ollie Whitehouse da [Symantec](http://symantec.com/) por ter fornecido informações relacionadas com uma questão descrita no boletim [MS06-012](http://go.microsoft.com/fwlink/?linkid=57006).  
-   [FelicioX](mailto:feliciox@gmail.com) por ter trabalhado connosco numa questão descrita no boletim [MS06-012](http://go.microsoft.com/fwlink/?linkid=57006).  
-   Peter Winter-Smith da [NGS Software](http://www.ngssoftware.com/index.htm) por ter fornecido informações relacionadas com uma questão descrita no boletim [MS06-012](http://go.microsoft.com/fwlink/?linkid=57006).  
-   Dejun da [Fortinet Security Response Team](http://www.fortinet.com/) por ter fornecido informações relacionadas com uma questão descrita no boletim [MS06-012](http://go.microsoft.com/fwlink/?linkid=57006).  
-   [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/) por terem fornecido informações relacionadas com uma questão descrita no boletim [MS06-012](http://go.microsoft.com/fwlink/?linkid=57006).  
-   Eyas da [XFOCUS Security Team](http://www.xfocus.org/) por ter fornecido informações relacionadas com uma questão descrita no boletim [MS06-012](http://go.microsoft.com/fwlink/?linkid=57006).
