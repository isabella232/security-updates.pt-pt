---
TOCTitle: 'MS11-MAR'
Title: Resumo dos Boletins de Segurança Microsoft de Março 2011
ms:assetid: 'ms11-mar'
ms:contentKeyID: 61235173
ms:mtpsurl: 'https://technet.microsoft.com/pt-PT/library/ms11-mar(v=Security.10)'
author: SharonSears
...
Resumo dos Boletins de Segurança Microsoft de Março 2011
========================================================
...
Este resumo dos boletins apresenta uma lista dos boletins de segurança publicados em Março de 2011.

Com a publicação dos boletins de segurança de Março de 2011, este resumo dos boletins substitui a notificação antecipada de boletins publicada a 3 de Março de 2011. Para mais informações sobre o serviço de boletins de notificação antecipada, consulte a [Notificação Antecipada de Boletins de Segurança da Microsoft](http://technet.microsoft.com/security/bulletin/advance).
...
A Microsoft fará um webcast para responder a questões dos clientes sobre estes boletins no dia 9 de Março de 2011, às 11:00, hora do Pacífico (Estados Unidos e Canadá). [Registe-se agora para o webcast de boletins de segurança de Março](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032455049&eventcategory=4). Depois desta data, o webcast estará disponível mediante pedido. Para mais informações, consulte [Webcast e resumos de boletins de segurança da Microsoft](http://technet.microsoft.com/security/bulletin/summary).
...
<td style="border:1px solid black;"><strong>Vulnerabilidades no Windows Media Poderiam Permitir Execução Remota de Código (2510030)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidade no Microsoft Groove Poderia Permitir Execução Remota de Código (2494047)</strong><br />
<br />
...
|-----------------------------------------------------------|--------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|  
| [MS11-016](http://go.microsoft.com/fwlink/?linkid=209774) | Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Microsoft Groove            | [CVE-2010-3146](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3146) | [1](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Provável código de exploração consistente | **Esta vulnerabilidade foi divulgada publicamente e o código de prova de conceito poderá estar disponível** |  
| [MS11-017](http://go.microsoft.com/fwlink/?linkid=207892) | Vulnerabilidade de Carregamento de Biblioteca sem Segurança no Ambiente de Trabalho Remoto | [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029) | [1](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Provável código de exploração consistente | **Esta vulnerabilidade foi divulgada publicamente**                                                         |  
| [MS11-015](http://go.microsoft.com/fwlink/?linkid=207841) | Vulnerabilidade de Carregamento de Biblioteca sem Segurança no DirectShow                  | [CVE-2011-0032](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0032) | [1](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Provável código de exploração consistente | **Esta vulnerabilidade foi divulgada publicamente e o código de prova de conceito poderá estar disponível** |  
| [MS11-015](http://go.microsoft.com/fwlink/?linkid=207841) | Vulnerabilidade no DVR-MS                                                                  | [CVE-2011-0042](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0042) | [1](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Provável código de exploração consistente | (Nenhuma)                                                                                                   |
...
<td style="border:1px solid black;">
[Cliente de Ligação ao Ambiente de Trabalho Remoto 5.2](http://www.microsoft.com/downloads/details.aspx?familyid=1aed6080-feab-4b5e-9d26-6a3f4b92434d)  
(KB2483618)  
(Importante)  
[Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1](http://www.microsoft.com/downloads/details.aspx?familyid=d67e4d8c-aeb9-45e6-9555-7456c5540475)  
(KB2481109)  
(Importante)  
[Cliente de Ligação ao Ambiente de Trabalho Remoto 7.0](http://www.microsoft.com/downloads/details.aspx?familyid
  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1](http://www.microsoft.com/downloads/details.aspx?familyid=5b0a8eb5-4bc2-4054-b952-58aa645afcf5)\*\*  
(KB2481109)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1](http://www.microsoft.com/downloads/details.aspx?familyid=25da7e00-745d-4d98-9dd8-52a8a4340404)  
(KB2481109)  
(Importante)
</td>
</tr>
...
[Cliente de Ligação ao Ambiente de Trabalho Remoto 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=0768a5f4-da28-4b2e-8aff-d68f890df3e6)  
(KB2483614)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=56fb24ce-65c7-4573-b613-e424ccc1a3a6)  
(KB2479943)  
(Crítica)
</td>
<td style="border:1px solid black;">
Apenas Windows 7 para sistemas baseados em x64:  
[Cliente de Ligação ao Ambiente de Trabalho Remoto 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=935adb10-1e7e-4501-b543-8247b88f6d18)  
(KB2483614)  
(Importante)
</td>
</tr>
...
[Cliente de Ligação ao Ambiente de Trabalho Remoto 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=3fcb2e11-591e-484a-a992-2f1d563e6d17)\*\*  
(KB2483614)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Cliente de Ligação ao Ambiente de Trabalho Remoto 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=c29b6487-78f0-421c-810c-c5e45d6a2352)  
(KB2483614)  
(Importante)
</td>
</tr>
...
**Notas para o MS11-017**

<sup>[1]</sup>Esta transferência actualiza o Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0 para uma versão não afectada do Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1.

<sup>[2]</sup>Esta transferência actualiza a Multilingual User Interface (MUI) do Cliente de Ligação ao Ambiente de Trabalho Remoto 6.0 para uma versão não afectada da Multilingual User Interface (MUI) do Cliente de Ligação ao Ambiente de Trabalho Remoto 6.1.
...
-   Matthew Watchinski, da [Sourcefire VRT](http://www.sourcefire.com/services/sf_vrt.html), por fornecer informações sobre uma questão descrita no boletim MS11-015
-   HD Moore, da [Rapid 7](http://www.rapid7.com/), por fornecer informações sobre uma questão descrita no boletim MS11-016
-   Eyal Gruner, da [Versafe Anti Fraud](http://www.versafe-login.com/), por fornecer informações sobre uma questão descrita no boletim MS11-017
...
-   V1.0 (8 de Março de 2011): Publicação do Resumo dos Boletins.
-   V1.1 (16 de Março de 2011): Removida uma referência errada ao Windows XP Home Edition Service Pack 3 e Windows XP Tablet PC Edition Service Pack 3 como software não afectado nas notas para o MS11-015 em **Localizações do Software Afectado e das Transferências**. Trata-se de uma alteração informativa apenas. Não foram efectuadas alterações aos ficheiros da actualização de segurança ou à lógica de detecção. Para os clientes que executam estas edições do Windows XP e que ainda não tenham aplicado esta actualização, a Microsoft recomenda que apliquem de imediato a actualização. Os clientes que já tenham aplicado a actualização não necessitam de efectuar qualquer acção.
