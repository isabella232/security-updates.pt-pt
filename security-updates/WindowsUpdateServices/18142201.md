...
ms:contentKeyID: 18142201
ms:mtpsurl: 'https://technet.microsoft.com/pt-pt/library/Cc708476(v=WS.10)'
---
...
<td style="border:1px solid black;">Uninstall the product. Also uninstalls the Base de dados interna do Windows instance if it is installed.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Path to Base de dados interna do Windows data directory.</td>
</tr>
<tr class="even">
