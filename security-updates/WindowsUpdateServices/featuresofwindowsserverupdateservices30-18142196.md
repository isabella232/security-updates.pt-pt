...
ms:contentKeyID: 18142196
ms:mtpsurl: 'https://technet.microsoft.com/pt-pt/library/Cc708464(v=WS.10)'
---
...
-   The Base de dados interna do Windows® database that WSUS can install during setup on Windows Server 2003.
