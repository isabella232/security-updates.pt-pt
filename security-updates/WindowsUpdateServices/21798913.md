...
ms:contentKeyID: 21798913
ms:mtpsurl: 'https://technet.microsoft.com/pt-pt/library/Dd939791(v=WS.10)'
---
...
The WSUS Operations Guide, available at [http://go.microsoft.com/fwlink/?LinkId=139838](http://go.microsoft.com/fwlink/?linkid=139838), includes other types of migration documentation, such as migrating from Base de dados interna do Windows to Microsoft SQL Server.
