...
ms:contentKeyID: 18142319
ms:mtpsurl: 'https://technet.microsoft.com/pt-pt/library/Cc708592(v=WS.10)'
---
...
If you are using Base de dados interna do Windows as the WSUS database, use the following string in place of *SqlServerName* in the above command:
