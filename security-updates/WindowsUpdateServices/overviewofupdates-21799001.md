...
ms:contentKeyID: 21799001
ms:mtpsurl: 'https://technet.microsoft.com/pt-pt/library/Dd939871(v=WS.10)'
---
...
1.  Determine an overall update management plan based on your network topology and bandwidth, company needs, and organizational structure. Considerations might include the following:
    ...
    -   Which database to use for update metadata (for example, Base de dados interna do Windows®, SQL Server 2005).
